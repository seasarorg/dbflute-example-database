...
public class VendorFunctionTest extends UnitContainerTestCase {
        ...
        cb.specify()
                ...
                .max(new SubQuery<PurchaseCB>() {
                    public void query(PurchaseCB subCB) {
                        ...
                        new DerivedReferrerOption().coalesce("1192-09-11 12:34:56.789").trunc("dd"));
        assertTrue(cb.toDisplaySql().contains("trunc("));
    ...
    public void test_ColumnQuery_dateAdd_collaboration() {
        ...
        }).plus(123).convert(new ColumnConversionOption().addDay(7)).minus(789);
    ...
    public void test_ColumnQuery_dateAdd_derived_bothSide() {
        ...
        }, Member.ALIAS_latestLoginDatetime, new DerivedReferrerOption().addDay(3));
        cb.columnQuery(new SpecifyQuery<MemberCB>() {
            public void specify(MemberCB cb) {
                cb.specify().derivedPurchaseList().max(new SubQuery<PurchaseCB>() {
                    public void query(PurchaseCB subCB) {
        ...
        }).left().convert(new ColumnConversionOption().addDay(3)).right()
                .convert(new ColumnConversionOption().addDay(3));
