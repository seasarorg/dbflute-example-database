...
import com.example.dbflute.oracle.dbflute.exbhv.pmbean.ResolvedPackageNamePmb;
import com.example.dbflute.oracle.dbflute.exbhv.pmbean.SimpleMemberPmb;
import com.example.dbflute.oracle.dbflute.exbhv.pmbean.UnpaidSummaryMemberPmb;
import com.example.dbflute.oracle.dbflute.exentity.Member;
import com.example.dbflute.oracle.dbflute.exentity.MemberLogin;
...
import com.example.dbflute.oracle.dbflute.exentity.customize.PurchaseMaxPriceMember;
import com.example.dbflute.oracle.dbflute.exentity.customize.SimpleMember;
import com.example.dbflute.oracle.dbflute.exentity.customize.UnpaidSummaryMember;
...
public class BehaviorPlatinumTest extends UnitContainerTestCase {
    ...
    public void test_insert_disableCommonColumnAutoSetup() {
        ...
        final Date registerDatetime = actualMember.getRegisterDatetime();
        final String registerUser = actualMember.getRegisterUser();
        final String registerProcess = actualMember.getRegisterProcess();
        final Date updateDatetime = actualMember.getUpdateDatetime();
        ...
        assertEquals(expectedDate, registerDatetime);
        ...
        assertEquals(expectedDate, updateDatetime);
