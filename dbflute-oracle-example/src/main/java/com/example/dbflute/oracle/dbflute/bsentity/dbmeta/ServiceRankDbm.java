...
public class ServiceRankDbm extends AbstractDBMeta {
    ...
    public static class EpgNewAcceptableFlg implements PropertyGateway {
        ...
        public void write(Entity et, Object vl) { ((ServiceRank)et).setNewAcceptableFlg(ctb(vl)); }
    }
    ...
    public static class EpgDisplayOrder implements PropertyGateway {
        ...
        public void write(Entity et, Object vl) { ((ServiceRank)et).setDisplayOrder(ctb(vl)); }
    }
    ...
    protected final ColumnInfo _columnServiceRankName = cci("SERVICE_RANK_NAME", "SERVICE_RANK_NAME", null, null, String.class, "serviceRankName", null, false, false, true, "VARCHAR2", 50, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnServicePointIncidence = cci("SERVICE_POINT_INCIDENCE", "SERVICE_POINT_INCIDENCE", null, null, java.math.BigDecimal.class, "servicePointIncidence", null, false, false, true, "NUMBER", 5, 3, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnNewAcceptableFlg = cci("NEW_ACCEPTABLE_FLG", "NEW_ACCEPTABLE_FLG", null, null, java.math.BigDecimal.class, "newAcceptableFlg", null, false, false, true, "NUMBER", 22, 0, null, false, null, null, null, null, CDef.DefMeta.Flg);
