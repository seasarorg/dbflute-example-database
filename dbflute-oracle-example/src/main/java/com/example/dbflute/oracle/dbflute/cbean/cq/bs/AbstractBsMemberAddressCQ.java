...
public abstract class AbstractBsMemberAddressCQ extends AbstractConditionQuery {
     ...
     */
    public void setMemberAddressId_Equal(Long memberAddressId) {
        doSetMemberAddressId_Equal(memberAddressId);
    }

    protected void doSetMemberAddressId_Equal(Long memberAddressId) {
     ...
     */
    public void setMemberAddressId_GreaterThan(Long memberAddressId) {
     ...
     */
    public void setMemberAddressId_LessThan(Long memberAddressId) {
     ...
     */
    public void setMemberAddressId_GreaterEqual(Long memberAddressId) {
     ...
     */
    public void setMemberAddressId_LessEqual(Long memberAddressId) {
    ...
    protected void doSetMemberAddressId_InScope(Collection<Long> memberAddressIdList) {
    ...
    protected void doSetMemberAddressId_NotInScope(Collection<Long> memberAddressIdList) {
