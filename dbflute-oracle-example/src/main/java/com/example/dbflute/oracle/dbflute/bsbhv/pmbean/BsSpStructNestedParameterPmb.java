...
/**
 * The base class for procedure parameter-bean of SpStructNestedParameter. <br />
 * This is related to "<span style="color: #AD4747">SP_STRUCT_NESTED_PARAMETER</span>".
 * @author oracleman
 */
public class BsSpStructNestedParameterPmb implements ProcedurePmb, FetchBean {
    ...
    public static final ValueType VInFooBean_VALUE_TYPE
            = new DBFluteConfig.ImplementedOracleStructType
                  ("NESTED_FOO_BEAN", NestedFooBean.class);
    ...
    //                                                                           Attribute
    //                                                                           =========
    /** The parameter of VInFooBean: {EXAMPLEDB.NESTED_FOO_BEAN as In}. */
    protected NestedFooBean _vInFooBean;

    /** The parameter of VOutFooBean: {EXAMPLEDB.NESTED_FOO_BEAN as Out}. */
    protected NestedFooBean _vOutFooBean;
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of SpStructNestedParameter. <br />
     * This is related to "<span style="color: #AD4747">SP_STRUCT_NESTED_PARAMETER</span>".
     */
    public BsSpStructNestedParameterPmb() {
    }
    ...
    //                                                                            ========
    /**
     * [get] VInFooBean: {EXAMPLEDB.NESTED_FOO_BEAN as In} <br />
     * @return The value of VInFooBean. (NullAllowed, NotEmptyString(when String): if empty string, returns null)
     */
    public NestedFooBean getVInFooBean() {
        return _vInFooBean;
    }

    /**
     * [set] VInFooBean: {EXAMPLEDB.NESTED_FOO_BEAN as In} <br />
     * @param vInFooBean The value of VInFooBean. (NullAllowed)
     */
    public void setVInFooBean(NestedFooBean vInFooBean) {
        _vInFooBean = vInFooBean;
    }

    /**
     * [get] VOutFooBean: {EXAMPLEDB.NESTED_FOO_BEAN as Out} <br />
     * @return The value of VOutFooBean. (NullAllowed, NotEmptyString(when String): if empty string, returns null)
     */
    public NestedFooBean getVOutFooBean() {
        return _vOutFooBean;
    }

    /**
     * [set] VOutFooBean: {EXAMPLEDB.NESTED_FOO_BEAN as Out} <br />
     * @param vOutFooBean The value of VOutFooBean. (NullAllowed)
     */
    public void setVOutFooBean(NestedFooBean vOutFooBean) {
