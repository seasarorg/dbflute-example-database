...
/**
 * The referrer loader of (会員)SYNONYM_MEMBER as SYNONYM. <br />
 * <pre>
 * [primary key]
 *     MEMBER_ID
 *
 ...
 * @author oracleman
 */
public class LoaderOfSynonymMember {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<SynonymMember> _selectedList;
    protected BehaviorSelector _selector;
    protected SynonymMemberBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfSynonymMember ready(List<SynonymMember> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected SynonymMemberBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(SynonymMemberBhv.class); return _myBhv; } }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<SynonymMember> getSelectedList() { return _selectedList; }
