...
public abstract class AbstractBsMemberStatusCQ extends AbstractConditionQuery {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">existsMemberVendorSynonymList</span>(new SubQuery&lt;MemberVendorSynonymCB&gt;() {
    ...
    public void existsMemberVendorSynonymList(SubQuery<MemberVendorSynonymCB> subQuery) {
        ...
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_ExistsReferrer_MemberVendorSynonymList(cb.query());
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">existsSynonymMemberList</span>(new SubQuery&lt;SynonymMemberCB&gt;() {
    ...
    public void existsSynonymMemberList(SubQuery<SynonymMemberCB> subQuery) {
        ...
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_ExistsReferrer_SynonymMemberList(cb.query());
    ...
    public void existsSynonymMemberLoginList(SubQuery<SynonymMemberLoginCB> subQuery) {
        ...
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_ExistsReferrer_SynonymMemberLoginList(cb.query());
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">existsVendorSynonymMemberList</span>(new SubQuery&lt;VendorSynonymMemberCB&gt;() {
    ...
    public void existsVendorSynonymMemberList(SubQuery<VendorSynonymMemberCB> subQuery) {
        ...
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_ExistsReferrer_VendorSynonymMemberList(cb.query());
     ...
     * (会員)MEMBER_VENDOR_SYNONYM by MEMBER_STATUS_CODE, named 'memberVendorSynonymAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">notExistsMemberVendorSynonymList</span>(new SubQuery&lt;MemberVendorSynonymCB&gt;() {
     *     public void query(MemberVendorSynonymCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
    ...
    public void notExistsMemberVendorSynonymList(SubQuery<MemberVendorSynonymCB> subQuery) {
        ...
        MemberVendorSynonymCB cb = new MemberVendorSynonymCB(); cb.xsetupForExistsReferrer(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_NotExistsReferrer_MemberVendorSynonymList(cb.query());
     ...
     * (会員)SYNONYM_MEMBER by MEMBER_STATUS_CODE, named 'synonymMemberAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">notExistsSynonymMemberList</span>(new SubQuery&lt;SynonymMemberCB&gt;() {
     *     public void query(SynonymMemberCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
    ...
    public void notExistsSynonymMemberList(SubQuery<SynonymMemberCB> subQuery) {
        ...
        SynonymMemberCB cb = new SynonymMemberCB(); cb.xsetupForExistsReferrer(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_NotExistsReferrer_SynonymMemberList(cb.query());
    ...
    public void notExistsSynonymMemberLoginList(SubQuery<SynonymMemberLoginCB> subQuery) {
        ...
        SynonymMemberLoginCB cb = new SynonymMemberLoginCB(); cb.xsetupForExistsReferrer(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_NotExistsReferrer_SynonymMemberLoginList(cb.query());
     ...
     * (会員)VENDOR_SYNONYM_MEMBER by MEMBER_STATUS_CODE, named 'vendorSynonymMemberAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">notExistsVendorSynonymMemberList</span>(new SubQuery&lt;VendorSynonymMemberCB&gt;() {
     *     public void query(VendorSynonymMemberCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
    ...
    public void notExistsVendorSynonymMemberList(SubQuery<VendorSynonymMemberCB> subQuery) {
        ...
        VendorSynonymMemberCB cb = new VendorSynonymMemberCB(); cb.xsetupForExistsReferrer(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_NotExistsReferrer_VendorSynonymMemberList(cb.query());
    ...
    public void inScopeMemberVendorSynonymList(SubQuery<MemberVendorSynonymCB> subQuery) {
        ...
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_InScopeRelation_MemberVendorSynonymList(cb.query());
    ...
    public void inScopeSynonymMemberList(SubQuery<SynonymMemberCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        SynonymMemberCB cb = new SynonymMemberCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_InScopeRelation_SynonymMemberList(cb.query());
    ...
    public void inScopeSynonymMemberLoginList(SubQuery<SynonymMemberLoginCB> subQuery) {
        ...
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_InScopeRelation_SynonymMemberLoginList(cb.query());
    ...
    public void inScopeVendorSynonymMemberList(SubQuery<VendorSynonymMemberCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        VendorSynonymMemberCB cb = new VendorSynonymMemberCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_InScopeRelation_VendorSynonymMemberList(cb.query());
    ...
    public void notInScopeMemberVendorSynonymList(SubQuery<MemberVendorSynonymCB> subQuery) {
        ...
        MemberVendorSynonymCB cb = new MemberVendorSynonymCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_NotInScopeRelation_MemberVendorSynonymList(cb.query());
    ...
    public void notInScopeSynonymMemberList(SubQuery<SynonymMemberCB> subQuery) {
        ...
        SynonymMemberCB cb = new SynonymMemberCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_NotInScopeRelation_SynonymMemberList(cb.query());
    ...
    public void notInScopeSynonymMemberLoginList(SubQuery<SynonymMemberLoginCB> subQuery) {
        ...
        SynonymMemberLoginCB cb = new SynonymMemberLoginCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_NotInScopeRelation_SynonymMemberLoginList(cb.query());
    ...
    public void notInScopeVendorSynonymMemberList(SubQuery<VendorSynonymMemberCB> subQuery) {
        ...
        VendorSynonymMemberCB cb = new VendorSynonymMemberCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_NotInScopeRelation_VendorSynonymMemberList(cb.query());
    ...
    public void xsderiveMemberVendorSynonymList(String fn, SubQuery<MemberVendorSynonymCB> sq, String al, DerivedReferrerOption op) {
        ...
        try { lock(); sq.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_SpecifyDerivedReferrer_MemberVendorSynonymList(cb.query());
    ...
    public void xsderiveSynonymMemberList(String fn, SubQuery<SynonymMemberCB> sq, String al, DerivedReferrerOption op) {
        ...
        try { lock(); sq.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_SpecifyDerivedReferrer_SynonymMemberList(cb.query());
    ...
    public void xsderiveSynonymMemberLoginList(String fn, SubQuery<SynonymMemberLoginCB> sq, String al, DerivedReferrerOption op) {
        ...
        try { lock(); sq.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_SpecifyDerivedReferrer_SynonymMemberLoginList(cb.query());
    ...
    public void xsderiveVendorSynonymMemberList(String fn, SubQuery<VendorSynonymMemberCB> sq, String al, DerivedReferrerOption op) {
        ...
        try { lock(); sq.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_SpecifyDerivedReferrer_VendorSynonymMemberList(cb.query());
     ...
     * (会員)MEMBER_VENDOR_SYNONYM by MEMBER_STATUS_CODE, named 'memberVendorSynonymAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedMemberVendorSynonymList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;MemberVendorSynonymCB&gt;() {
     *     public void query(MemberVendorSynonymCB subCB) {
     *         subCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
     *     }
    ...
    public void xqderiveMemberVendorSynonymList(String fn, SubQuery<MemberVendorSynonymCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        ...
        MemberVendorSynonymCB cb = new MemberVendorSynonymCB(); cb.xsetupForDerivedReferrer(this);
        try { lock(); sq.query(cb); } finally { unlock(); }
        String sqpp = keepMemberStatusCode_QueryDerivedReferrer_MemberVendorSynonymList(cb.query()); String prpp = keepMemberStatusCode_QueryDerivedReferrer_MemberVendorSynonymListParameter(vl);
     ...
     * (会員)SYNONYM_MEMBER by MEMBER_STATUS_CODE, named 'synonymMemberAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedSynonymMemberList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;SynonymMemberCB&gt;() {
     *     public void query(SynonymMemberCB subCB) {
     *         subCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
     *     }
    ...
    public void xqderiveSynonymMemberList(String fn, SubQuery<SynonymMemberCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        ...
        SynonymMemberCB cb = new SynonymMemberCB(); cb.xsetupForDerivedReferrer(this);
        try { lock(); sq.query(cb); } finally { unlock(); }
        String sqpp = keepMemberStatusCode_QueryDerivedReferrer_SynonymMemberList(cb.query()); String prpp = keepMemberStatusCode_QueryDerivedReferrer_SynonymMemberListParameter(vl);
    ...
    public void xqderiveSynonymMemberLoginList(String fn, SubQuery<SynonymMemberLoginCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        ...
        SynonymMemberLoginCB cb = new SynonymMemberLoginCB(); cb.xsetupForDerivedReferrer(this);
        try { lock(); sq.query(cb); } finally { unlock(); }
        String sqpp = keepMemberStatusCode_QueryDerivedReferrer_SynonymMemberLoginList(cb.query()); String prpp = keepMemberStatusCode_QueryDerivedReferrer_SynonymMemberLoginListParameter(vl);
     ...
     * (会員)VENDOR_SYNONYM_MEMBER by MEMBER_STATUS_CODE, named 'vendorSynonymMemberAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedVendorSynonymMemberList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;VendorSynonymMemberCB&gt;() {
     *     public void query(VendorSynonymMemberCB subCB) {
     *         subCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
     *     }
    ...
    public void xqderiveVendorSynonymMemberList(String fn, SubQuery<VendorSynonymMemberCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        ...
        VendorSynonymMemberCB cb = new VendorSynonymMemberCB(); cb.xsetupForDerivedReferrer(this);
        try { lock(); sq.query(cb); } finally { unlock(); }
        String sqpp = keepMemberStatusCode_QueryDerivedReferrer_VendorSynonymMemberList(cb.query()); String prpp = keepMemberStatusCode_QueryDerivedReferrer_VendorSynonymMemberListParameter(vl);
