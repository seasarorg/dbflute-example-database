...
public abstract class BsWhiteDiffWorldBhv extends AbstractBehaviorWritable<WhiteDiffWorld, WhiteDiffWorldCB> {
    ...
    protected WhiteDiffWorld facadeSelectEntity(WhiteDiffWorldCB cb) {
    ...
    public WhiteDiffWorld selectByPKValue(Long diffWorldId) {
        return facadeSelectByPKValue(diffWorldId);
    }

    protected WhiteDiffWorld facadeSelectByPKValue(Long diffWorldId) {
    ...
    public WhiteDiffWorld selectByPKValueWithDeletedCheck(Long diffWorldId) {
        return doSelectByPKWithDeletedCheck(diffWorldId, typeOfSelectedEntity());
    }

    protected <ENTITY extends WhiteDiffWorld> ENTITY doSelectByPKWithDeletedCheck(Long diffWorldId, Class<ENTITY> tp) {
        return doSelectEntityWithDeletedCheck(xprepareCBAsPK(diffWorldId), tp);
    }
     ...
     */
    public void load(List<WhiteDiffWorld> whiteDiffWorldList, ReferrerLoaderHandler<LoaderOfWhiteDiffWorld> handler) {
        xassLRArg(whiteDiffWorldList, handler);
        handler.handle(new LoaderOfWhiteDiffWorld().ready(whiteDiffWorldList, _behaviorSelector));
    }
     ...
     * @param handler The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(WhiteDiffWorld whiteDiffWorld, ReferrerLoaderHandler<LoaderOfWhiteDiffWorld> handler) {
        xassLRArg(whiteDiffWorld, handler);
        handler.handle(new LoaderOfWhiteDiffWorld().ready(xnewLRAryLs(whiteDiffWorld), _behaviorSelector));
    }
    ...
    public void varyingInsertOrUpdate(WhiteDiffWorld whiteDiffWorld, InsertOption<WhiteDiffWorldCB> insertOption, UpdateOption<WhiteDiffWorldCB> updateOption) {
        ...
        doInsertOrUpdate(whiteDiffWorld, insertOption, updateOption);
    }
    ...
    public OutsideSqlBasicExecutor<WhiteDiffWorldBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<WhiteDiffWorldBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteDiffWorld> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.oracle.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteDiffWorld> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
