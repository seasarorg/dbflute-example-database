...
/**
 * The base class for procedure parameter-bean of MainPkgSpPkgInOutParameter. <br />
 * This is related to "<span style="color: #AD4747">MAIN_PKG.SP_PKG_IN_OUT_PARAMETER</span>".
 * @author oracleman
 */
public class BsMainPkgSpPkgInOutParameterPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of MainPkgSpPkgInOutParameter. <br />
     * This is related to "<span style="color: #AD4747">MAIN_PKG.SP_PKG_IN_OUT_PARAMETER</span>".
     */
    public BsMainPkgSpPkgInOutParameterPmb() {
    }
