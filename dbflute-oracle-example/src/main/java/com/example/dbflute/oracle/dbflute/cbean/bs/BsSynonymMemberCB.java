...
public class BsSynonymMemberCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;SynonymMemberCB&gt;() {
    ...
    public void union(UnionQuery<SynonymMemberCB> unionQuery) {
        final SynonymMemberCB cb = new SynonymMemberCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;SynonymMemberCB&gt;() {
     *     public void query(SynonymMemberCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * ... = synonymMember.<span style="color: #DD4747">getMemberStatus()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     */
     ...
     * cb.query().setFoo...(value);
     * SynonymMember synonymMember = synonymMemberBhv.selectEntityWithDeletedCheck(cb);
     * ... = synonymMember.<span style="color: #DD4747">getSynonymMemberWithdrawalAsOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<SynonymMemberCQ> {
        ...
        public HpSDRFunction<SynonymMemberLoginCB, SynonymMemberCQ> derivedSynonymMemberLoginList() {
            ...
            return new HpSDRFunction<SynonymMemberLoginCB, SynonymMemberCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<SynonymMemberLoginCB, SynonymMemberCQ>() {
                public void setup(String fn, SubQuery<SynonymMemberLoginCB> sq, SynonymMemberCQ cq, String al, DerivedReferrerOption op) {
        ...
        public HpSDRFunction<SynonymMemberCB, SynonymMemberCQ> myselfDerived() {
            ...
            return new HpSDRFunction<SynonymMemberCB, SynonymMemberCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<SynonymMemberCB, SynonymMemberCQ>() {
                public void setup(String fn, SubQuery<SynonymMemberCB> sq, SynonymMemberCQ cq, String al, DerivedReferrerOption op) {
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;SynonymMemberCB&gt;() {
    ...
    public HpColQyOperand<SynonymMemberCB> columnQuery(final SpecifyQuery<SynonymMemberCB> leftSpecifyQuery) {
        return xcreateColQyOperand(new HpColQyHandler<SynonymMemberCB>() {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;SynonymMemberCB&gt;() {
     ...
     *     public void query(SynonymMemberCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;SynonymMemberCB&gt;() {
