...
public abstract class BsSynonymMemberWithdrawalBhv extends AbstractBehaviorWritable<SynonymMemberWithdrawal, SynonymMemberWithdrawalCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends SynonymMemberWithdrawal> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.oracle.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends SynonymMemberWithdrawal> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
