 ...
 * @author oracleman
 */
public abstract class BsVendorCheckDecimalSum implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.oracle.dbflute.bsentity.customize.dbmeta.VendorCheckDecimalSumDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        ...
        BsVendorCheckDecimalSum otherEntity = (BsVendorCheckDecimalSum)other;
    ...
    //                                                                            ========
    /**
     * [get] DECIMAL_DIGIT_SUM: {NUMBER(22)} <br />
    ...
    /**
     * [set] DECIMAL_DIGIT_SUM: {NUMBER(22)} <br />
