...
/**
 * The entity of SYNONYM_MEMBER_WITHDRAWAL as SYNONYM. <br />
 * 退会するとInsertされる
 * <pre>
 * [primary-key]
 *     MEMBER_ID
...
public abstract class BsSynonymMemberWithdrawal implements EntityDefinedCommonColumn, Serializable, Cloneable {
    ...
    public String getTablePropertyName() { // according to Java Beans rule
        return "synonymMemberWithdrawal";
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSynonymMemberWithdrawal)) { return false; }
        BsSynonymMemberWithdrawal otherEntity = (BsSynonymMemberWithdrawal)other;
    ...
    //                                                                            ========
    /**
     * [get] MEMBER_ID: {PK, NotNull, NUMBER(16), FK to MEMBER_VENDOR_SYNONYM} <br />
    ...
    /**
     * [set] MEMBER_ID: {PK, NotNull, NUMBER(16), FK to MEMBER_VENDOR_SYNONYM} <br />
