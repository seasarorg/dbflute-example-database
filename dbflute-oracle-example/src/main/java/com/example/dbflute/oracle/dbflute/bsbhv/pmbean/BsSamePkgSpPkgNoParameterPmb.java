...
/**
 * The base class for procedure parameter-bean of SamePkgSpPkgNoParameter. <br />
 * This is related to "<span style="color: #AD4747">SAME_PKG.SP_PKG_NO_PARAMETER</span>".
 * @author oracleman
 */
public class BsSamePkgSpPkgNoParameterPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of SamePkgSpPkgNoParameter. <br />
     * This is related to "<span style="color: #AD4747">SAME_PKG.SP_PKG_NO_PARAMETER</span>".
     */
    public BsSamePkgSpPkgNoParameterPmb() {
    }
    ...
    public String getProcedureName() {
        return "SAME_PKG.SP_PKG_NO_PARAMETER";
    }
