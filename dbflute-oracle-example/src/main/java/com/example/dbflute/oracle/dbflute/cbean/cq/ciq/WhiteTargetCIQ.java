...
public class WhiteTargetCIQ extends AbstractBsWhiteTargetCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteTargetCIQ(ConditionQuery childQuery, SqlClause sqlClause
    ...
    public String keepTargetId_QueryDerivedReferrer_WhiteRefTargetListParameter(Object pv)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
