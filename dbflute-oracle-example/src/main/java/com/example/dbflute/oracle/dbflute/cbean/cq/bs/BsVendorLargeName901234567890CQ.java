...
public class BsVendorLargeName901234567890CQ extends AbstractBsVendorLargeName901234567890CQ {
    ...
    public String keepVendorLargeName901234567Id_ExistsReferrer_VendorLargeName90123456RefList(VendorLargeName90123456RefCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_vendorLargeName901234567Id_ExistsReferrer_VendorLargeName90123456RefListMap.size() + 1);
        _vendorLargeName901234567Id_ExistsReferrer_VendorLargeName90123456RefListMap.put(key, subQuery); return "vendorLargeName901234567Id_ExistsReferrer_VendorLargeName90123456RefList." + key;
    }
    ...
    public String keepVendorLargeName901234567Id_NotExistsReferrer_VendorLargeName90123456RefList(VendorLargeName90123456RefCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_vendorLargeName901234567Id_NotExistsReferrer_VendorLargeName90123456RefListMap.size() + 1);
        _vendorLargeName901234567Id_NotExistsReferrer_VendorLargeName90123456RefListMap.put(key, subQuery); return "vendorLargeName901234567Id_NotExistsReferrer_VendorLargeName90123456RefList." + key;
    }
    ...
    public String keepVendorLargeName901234567Id_SpecifyDerivedReferrer_VendorLargeName90123456RefList(VendorLargeName90123456RefCQ subQuery) {
    ...
    public String keepVendorLargeName901234567Id_InScopeRelation_VendorLargeName90123456RefList(VendorLargeName90123456RefCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_vendorLargeName901234567Id_InScopeRelation_VendorLargeName90123456RefListMap.size() + 1);
        _vendorLargeName901234567Id_InScopeRelation_VendorLargeName90123456RefListMap.put(key, subQuery); return "vendorLargeName901234567Id_InScopeRelation_VendorLargeName90123456RefList." + key;
    }
    ...
    public String keepVendorLargeName901234567Id_NotInScopeRelation_VendorLargeName90123456RefList(VendorLargeName90123456RefCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_vendorLargeName901234567Id_NotInScopeRelation_VendorLargeName90123456RefListMap.size() + 1);
        _vendorLargeName901234567Id_NotInScopeRelation_VendorLargeName90123456RefListMap.put(key, subQuery); return "vendorLargeName901234567Id_NotInScopeRelation_VendorLargeName90123456RefList." + key;
    }
    ...
    public String keepVendorLargeName901234567Id_QueryDerivedReferrer_VendorLargeName90123456RefList(VendorLargeName90123456RefCQ subQuery) {
    ...
    public String keepVendorLargeName901234567Id_QueryDerivedReferrer_VendorLargeName90123456RefListParameter(Object parameterValue) {
