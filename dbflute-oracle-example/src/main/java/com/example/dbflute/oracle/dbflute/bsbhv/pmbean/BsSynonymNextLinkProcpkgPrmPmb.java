...
/**
 * The base class for procedure parameter-bean of SynonymNextLinkProcpkgPrm. <br />
 * This is related to "<span style="color: #AD4747">SYNONYM_NEXT_LINK_PROCPKG_PRM</span>".
 * @author oracleman
 */
public class BsSynonymNextLinkProcpkgPrmPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of SynonymNextLinkProcpkgPrm. <br />
     * This is related to "<span style="color: #AD4747">SYNONYM_NEXT_LINK_PROCPKG_PRM</span>".
     */
    public BsSynonymNextLinkProcpkgPrmPmb() {
    }
    ...
    public String getProcedureName() {
        return "SYNONYM_NEXT_LINK_PROCPKG_PRM";
    }
