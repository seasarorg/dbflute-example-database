...
public abstract class BsMemberLoginBhv extends AbstractBehaviorWritable<MemberLogin, MemberLoginCB> {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<MemberLogin> selectByUniqueOf(Long memberId, java.util.Date loginDatetime) {
        return facadeSelectByUniqueOf(memberId, loginDatetime);
    }

    protected OptionalEntity<MemberLogin> facadeSelectByUniqueOf(Long memberId, java.util.Date loginDatetime) {
        return doSelectByUniqueOf(memberId, loginDatetime, typeOfSelectedEntity());
    }

    protected <ENTITY extends MemberLogin> OptionalEntity<ENTITY> doSelectByUniqueOf(Long memberId, java.util.Date loginDatetime, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(memberId, loginDatetime), tp), memberId, loginDatetime);
    }

    protected MemberLoginCB xprepareCBAsUniqueOf(Long memberId, java.util.Date loginDatetime) {
