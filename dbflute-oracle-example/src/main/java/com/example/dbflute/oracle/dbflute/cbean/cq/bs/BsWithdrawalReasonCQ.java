...
public class BsWithdrawalReasonCQ extends AbstractBsWithdrawalReasonCQ {
    ...
    public Map<String, SynonymMemberWithdrawalCQ> getWithdrawalReasonCode_ExistsReferrer_SynonymMemberWithdrawalList() { return xgetSQueMap("withdrawalReasonCode_ExistsReferrer_SynonymMemberWithdrawalList"); }
    public String keepWithdrawalReasonCode_ExistsReferrer_SynonymMemberWithdrawalList(SynonymMemberWithdrawalCQ sq) { return xkeepSQue("withdrawalReasonCode_ExistsReferrer_SynonymMemberWithdrawalList", sq); }
    ...
    public Map<String, SynonymMemberWithdrawalCQ> getWithdrawalReasonCode_NotExistsReferrer_SynonymMemberWithdrawalList() { return xgetSQueMap("withdrawalReasonCode_NotExistsReferrer_SynonymMemberWithdrawalList"); }
    public String keepWithdrawalReasonCode_NotExistsReferrer_SynonymMemberWithdrawalList(SynonymMemberWithdrawalCQ sq) { return xkeepSQue("withdrawalReasonCode_NotExistsReferrer_SynonymMemberWithdrawalList", sq); }
    ...
    public Map<String, SynonymMemberWithdrawalCQ> getWithdrawalReasonCode_InScopeRelation_SynonymMemberWithdrawalList() { return xgetSQueMap("withdrawalReasonCode_InScopeRelation_SynonymMemberWithdrawalList"); }
    public String keepWithdrawalReasonCode_InScopeRelation_SynonymMemberWithdrawalList(SynonymMemberWithdrawalCQ sq) { return xkeepSQue("withdrawalReasonCode_InScopeRelation_SynonymMemberWithdrawalList", sq); }
    ...
    public Map<String, SynonymMemberWithdrawalCQ> getWithdrawalReasonCode_NotInScopeRelation_SynonymMemberWithdrawalList() { return xgetSQueMap("withdrawalReasonCode_NotInScopeRelation_SynonymMemberWithdrawalList"); }
    public String keepWithdrawalReasonCode_NotInScopeRelation_SynonymMemberWithdrawalList(SynonymMemberWithdrawalCQ sq) { return xkeepSQue("withdrawalReasonCode_NotInScopeRelation_SynonymMemberWithdrawalList", sq); }
    ...
    public Map<String, SynonymMemberWithdrawalCQ> getWithdrawalReasonCode_SpecifyDerivedReferrer_SynonymMemberWithdrawalList() { return xgetSQueMap("withdrawalReasonCode_SpecifyDerivedReferrer_SynonymMemberWithdrawalList"); }
    public String keepWithdrawalReasonCode_SpecifyDerivedReferrer_SynonymMemberWithdrawalList(SynonymMemberWithdrawalCQ sq) { return xkeepSQue("withdrawalReasonCode_SpecifyDerivedReferrer_SynonymMemberWithdrawalList", sq); }
    ...
    public Map<String, SynonymMemberWithdrawalCQ> getWithdrawalReasonCode_QueryDerivedReferrer_SynonymMemberWithdrawalList() { return xgetSQueMap("withdrawalReasonCode_QueryDerivedReferrer_SynonymMemberWithdrawalList"); }
    public String keepWithdrawalReasonCode_QueryDerivedReferrer_SynonymMemberWithdrawalList(SynonymMemberWithdrawalCQ sq) { return xkeepSQue("withdrawalReasonCode_QueryDerivedReferrer_SynonymMemberWithdrawalList", sq); }
    public Map<String, Object> getWithdrawalReasonCode_QueryDerivedReferrer_SynonymMemberWithdrawalListParameter() { return xgetSQuePmMap("withdrawalReasonCode_QueryDerivedReferrer_SynonymMemberWithdrawalList"); }
