...
public abstract class BsProductStatusBhv extends AbstractBehaviorWritable<ProductStatus, ProductStatusCB> {
    ...
    protected OptionalEntity<ProductStatus> facadeSelectByUniqueOf(String productStatusName) {
        return doSelectByUniqueOf(productStatusName, typeOfSelectedEntity());
    }

    protected <ENTITY extends ProductStatus> OptionalEntity<ENTITY> doSelectByUniqueOf(String productStatusName, Class<? extends ENTITY> tp) {
    ...
    { return helpExtractListInternally(productStatusList, "productStatusName"); }
