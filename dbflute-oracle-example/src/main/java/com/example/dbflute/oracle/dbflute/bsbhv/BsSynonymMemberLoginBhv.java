...
public abstract class BsSynonymMemberLoginBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends SynonymMemberLogin> ENTITY doSelectEntity(SynonymMemberLoginCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectEntityInternally(cb, tp, new InternalSelectEntityCallback<ENTITY, SynonymMemberLoginCB>() {
            public List<ENTITY> callbackSelectList(SynonymMemberLoginCB lcb, Class<ENTITY> ltp) { return doSelectList(lcb, ltp); } });
    }
    ...
    public SynonymMemberLogin selectByPKValue(Long memberLoginId) {
        return doSelectByPK(memberLoginId, SynonymMemberLogin.class);
    }

    protected <ENTITY extends SynonymMemberLogin> ENTITY doSelectByPK(Long memberLoginId, Class<ENTITY> entityType) {
        return doSelectEntity(xprepareCBAsPK(memberLoginId), entityType);
    }

    protected <ENTITY extends SynonymMemberLogin> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberLoginId, Class<ENTITY> entityType) {
    ...
    public SynonymMemberLogin selectByPKValueWithDeletedCheck(Long memberLoginId) {
        return doSelectByPKWithDeletedCheck(memberLoginId, SynonymMemberLogin.class);
    }

    protected <ENTITY extends SynonymMemberLogin> ENTITY doSelectByPKWithDeletedCheck(Long memberLoginId, Class<ENTITY> entityType) {
    ...
    protected SynonymMemberLoginCB xprepareCBAsPK(Long memberLoginId) {
        ...
        SynonymMemberLoginCB cb = newMyConditionBean(); cb.acceptPrimaryKey(memberLoginId);
        return cb;
    }
    ...
    public OptionalEntity<SynonymMemberLogin> selectByUniqueOf(Long memberId, java.util.Date loginDatetime) {
        return doSelectByUniqueOf(memberId, loginDatetime, SynonymMemberLogin.class);
    }

    protected <ENTITY extends SynonymMemberLogin> OptionalEntity<ENTITY> doSelectByUniqueOf(Long memberId, java.util.Date loginDatetime, Class<ENTITY> entityType) {
    ...
    protected SynonymMemberLoginCB xprepareCBAsUniqueOf(Long memberId, java.util.Date loginDatetime) {
        ...
        SynonymMemberLoginCB cb = newMyConditionBean(); cb.acceptUniqueOf(memberId, loginDatetime);
        return cb;
    }
    ...
    protected <ENTITY extends SynonymMemberLogin> ListResultBean<ENTITY> doSelectList(SynonymMemberLoginCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectListInternally(cb, tp, new InternalSelectListCallback<ENTITY, SynonymMemberLoginCB>() {
            public List<ENTITY> callbackSelectList(SynonymMemberLoginCB lcb, Class<ENTITY> ltp) { return delegateSelectList(lcb, ltp); } });
    }
    ...
    public List<MemberStatus> pulloutMemberStatus(List<SynonymMemberLogin> synonymMemberLoginList) {
        return helpPulloutInternally(synonymMemberLoginList, new InternalPulloutCallback<SynonymMemberLogin, MemberStatus>() {
            public MemberStatus getFr(SynonymMemberLogin et)
    ...
    public List<MemberVendorSynonym> pulloutMemberVendorSynonym(List<SynonymMemberLogin> synonymMemberLoginList) {
        return helpPulloutInternally(synonymMemberLoginList, new InternalPulloutCallback<SynonymMemberLogin, MemberVendorSynonym>() {
            public MemberVendorSynonym getFr(SynonymMemberLogin et)
    ...
    public List<SynonymMember> pulloutSynonymMember(List<SynonymMemberLogin> synonymMemberLoginList) {
        return helpPulloutInternally(synonymMemberLoginList, new InternalPulloutCallback<SynonymMemberLogin, SynonymMember>() {
            public SynonymMember getFr(SynonymMemberLogin et)
    ...
    public List<VendorSynonymMember> pulloutVendorSynonymMember(List<SynonymMemberLogin> synonymMemberLoginList) {
        return helpPulloutInternally(synonymMemberLoginList, new InternalPulloutCallback<SynonymMemberLogin, VendorSynonymMember>() {
            public VendorSynonymMember getFr(SynonymMemberLogin et)
