...
public class Vendor$DollarDbm extends AbstractDBMeta {
    ...
    public static class EpgVendor$DollarId implements PropertyGateway {
        ...
        public void write(Entity e, Object v) { ((Vendor$Dollar)e).setVendor$DollarId(ctl(v)); }
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.oracle.dbflute.exentity.Vendor$Dollar"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.oracle.dbflute.cbean.Vendor$DollarCB"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.oracle.dbflute.exbhv.Vendor$DollarBhv"; }
