...
public class BsMemberVendorSynonymCQ extends AbstractBsMemberVendorSynonymCQ {
     ...
     * @return this. (NotNull)
     */
    public BsMemberVendorSynonymCQ addSpecifiedDerivedOrderBy_Asc(String aliasName) { registerSpecifiedDerivedOrderBy_Asc(aliasName); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMemberVendorSynonymCQ addSpecifiedDerivedOrderBy_Desc(String aliasName) { registerSpecifiedDerivedOrderBy_Desc(aliasName); return this; }
    ...
    protected MemberStatusCQ xcreateQueryMemberStatus() {
        String nrp = xresolveNRP("MEMBER_VENDOR_SYNONYM", "memberStatus"); String jan = xresolveJAN(nrp, xgetNNLvl());
    ...
    protected SynonymMemberWithdrawalCQ xcreateQuerySynonymMemberWithdrawalAsOne() {
        String nrp = xresolveNRP("MEMBER_VENDOR_SYNONYM", "synonymMemberWithdrawalAsOne"); String jan = xresolveJAN(nrp, xgetNNLvl());
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, MemberVendorSynonymCQ> getScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(MemberVendorSynonymCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, MemberVendorSynonymCQ> getSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(MemberVendorSynonymCQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, MemberVendorSynonymCQ> getQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    public String keepQueryMyselfDerived(MemberVendorSynonymCQ sq) { return xkeepSQue("queryMyselfDerived", sq); }
    ...
    public Map<String, MemberVendorSynonymCQ> getMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(MemberVendorSynonymCQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, MemberVendorSynonymCQ> getMyselfInScope() { return xgetSQueMap("myselfInScope"); }
    public String keepMyselfInScope(MemberVendorSynonymCQ sq) { return xkeepSQue("myselfInScope", sq); }
