...
public class BsMemberVendorSynonymCQ extends AbstractBsMemberVendorSynonymCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsMemberVendorSynonymCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    protected void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
        MemberVendorSynonymCQ baseQuery = (MemberVendorSynonymCQ)baseQueryAsSuper;
        MemberVendorSynonymCQ unionQuery = (MemberVendorSynonymCQ)unionQueryAsSuper;
    ...
    public String keepScalarCondition(MemberVendorSynonymCQ subQuery) {
    ...
    public String keepSpecifyMyselfDerived(MemberVendorSynonymCQ subQuery) {
    ...
    public String keepQueryMyselfDerived(MemberVendorSynonymCQ subQuery) {
    ...
    public String keepMyselfExists(MemberVendorSynonymCQ subQuery) {
    ...
    public String keepMyselfInScope(MemberVendorSynonymCQ subQuery) {
