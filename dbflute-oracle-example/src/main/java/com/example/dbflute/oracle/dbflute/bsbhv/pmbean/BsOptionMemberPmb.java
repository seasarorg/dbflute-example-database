...
public class BsOptionMemberPmb implements ListHandlingPmb<MemberBhv, OptionMember>, EntityHandlingPmb<MemberBhv, OptionMember>, FetchBean {
    ...
    /** The parameter of displayOrder:ref(MemberStatus) :: refers to DISPLAY_ORDER: {UQ, NotNull, NUMBER(16)}. */
    protected Integer _displayOrder;

    /** The parameter of birthdate:fromDate | ref(Member) :: refers to (生年月日)BIRTHDATE: {DATE(7)}. */
    protected Date _birthdate;

    /** The parameter of status:cls(MemberStatus)|ref(Member.MEMBER_STATUS_CODE) :: refers to (会員ステータスコード)MEMBER_STATUS_CODE: {NotNull, CHAR(3), FK to MEMBER_STATUS, classification=MemberStatus}. */
    ...
    /**
     * [get] displayOrder:ref(MemberStatus) :: refers to DISPLAY_ORDER: {UQ, NotNull, NUMBER(16)} <br />
    ...
    /**
     * [set] displayOrder:ref(MemberStatus) :: refers to DISPLAY_ORDER: {UQ, NotNull, NUMBER(16)} <br />
    ...
    /**
     * [get] birthdate:fromDate | ref(Member) :: refers to (生年月日)BIRTHDATE: {DATE(7)} <br />
    ...
    /**
     * [set as fromDate] birthdate:fromDate | ref(Member) :: refers to (生年月日)BIRTHDATE: {DATE(7)} <br />
    ...
    /**
     * [get] status:cls(MemberStatus)|ref(Member.MEMBER_STATUS_CODE) :: refers to (会員ステータスコード)MEMBER_STATUS_CODE: {NotNull, CHAR(3), FK to MEMBER_STATUS, classification=MemberStatus} <br />
    ...
    /**
     * [set] status:cls(MemberStatus)|ref(Member.MEMBER_STATUS_CODE) :: refers to (会員ステータスコード)MEMBER_STATUS_CODE: {NotNull, CHAR(3), FK to MEMBER_STATUS, classification=MemberStatus} <br />
    ...
    /**
     * [set as Formalized] status:cls(MemberStatus)|ref(Member.MEMBER_STATUS_CODE) :: refers to (会員ステータスコード)MEMBER_STATUS_CODE: {NotNull, CHAR(3), FK to MEMBER_STATUS, classification=MemberStatus} <br />
     * as formal member, allowed to use all service
     */
    ...
    /**
     * [set as Withdrawal] status:cls(MemberStatus)|ref(Member.MEMBER_STATUS_CODE) :: refers to (会員ステータスコード)MEMBER_STATUS_CODE: {NotNull, CHAR(3), FK to MEMBER_STATUS, classification=MemberStatus} <br />
     * withdrawal is fixed, not allowed to use service
     */
    ...
    /**
     * [set as Provisional] status:cls(MemberStatus)|ref(Member.MEMBER_STATUS_CODE) :: refers to (会員ステータスコード)MEMBER_STATUS_CODE: {NotNull, CHAR(3), FK to MEMBER_STATUS, classification=MemberStatus} <br />
     * first status after entry, allowed to use only part of service
     */
