...
/**
 * The base class for procedure parameter-bean of SynonymNextPkgProcedurePrm. <br />
 * This is related to "<span style="color: #AD4747">SYNONYM_NEXT_PKG_PROCEDURE_PRM</span>".
 * @author oracleman
 */
public class BsSynonymNextPkgProcedurePrmPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of SynonymNextPkgProcedurePrm. <br />
     * This is related to "<span style="color: #AD4747">SYNONYM_NEXT_PKG_PROCEDURE_PRM</span>".
     */
    public BsSynonymNextPkgProcedurePrmPmb() {
    }
    ...
    public String getProcedureName() {
        return "SYNONYM_NEXT_PKG_PROCEDURE_PRM";
    }
