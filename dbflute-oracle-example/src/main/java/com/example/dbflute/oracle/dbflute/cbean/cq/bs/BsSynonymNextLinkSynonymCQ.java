...
public class BsSynonymNextLinkSynonymCQ extends AbstractBsSynonymNextLinkSynonymCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSynonymNextLinkSynonymCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @return this. (NotNull)
     */
    public BsSynonymNextLinkSynonymCQ addSpecifiedDerivedOrderBy_Asc(String aliasName)
     ...
     * @return this. (NotNull)
     */
    public BsSynonymNextLinkSynonymCQ addSpecifiedDerivedOrderBy_Desc(String aliasName)
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    protected Map<String, SynonymNextLinkSynonymCQ> _scalarConditionMap;
    public Map<String, SynonymNextLinkSynonymCQ> getScalarCondition() { return _scalarConditionMap; }
    ...
    //                                                                       MyselfDerived
    //                                                                       =============
    protected Map<String, SynonymNextLinkSynonymCQ> _specifyMyselfDerivedMap;
    public Map<String, SynonymNextLinkSynonymCQ> getSpecifyMyselfDerived() { return _specifyMyselfDerivedMap; }
    ...
    protected Map<String, SynonymNextLinkSynonymCQ> _queryMyselfDerivedMap;
    public Map<String, SynonymNextLinkSynonymCQ> getQueryMyselfDerived() { return _queryMyselfDerivedMap; }
    ...
    public Map<String, SynonymNextLinkSynonymCQ> getMyselfExists() { return _myselfExistsMap; }
    ...
    //                                                                       MyselfInScope
    //                                                                       =============
    protected Map<String, SynonymNextLinkSynonymCQ> _myselfInScopeMap;
    public Map<String, SynonymNextLinkSynonymCQ> getMyselfInScope() { return _myselfInScopeMap; }
    public String keepMyselfInScope(SynonymNextLinkSynonymCQ sq) {
