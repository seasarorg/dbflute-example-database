...
public class BsSynonymNextLinkSynonymCQ extends AbstractBsSynonymNextLinkSynonymCQ {
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, SynonymNextLinkSynonymCQ> getScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(SynonymNextLinkSynonymCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, SynonymNextLinkSynonymCQ> getSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(SynonymNextLinkSynonymCQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, SynonymNextLinkSynonymCQ> getQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    ...
    public Map<String, SynonymNextLinkSynonymCQ> getMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(SynonymNextLinkSynonymCQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, SynonymNextLinkSynonymCQ> getMyselfInScope() { return xgetSQueMap("myselfInScope"); }
