...
public abstract class BsVendor$DollarBhv extends AbstractBehaviorWritable<Vendor$Dollar, Vendor$DollarCB> {
    ...
    protected <ENTITY extends Vendor$Dollar> ENTITY doSelectByPK(Long vendor$DollarId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(vendor$DollarId), tp);
    }

    protected <ENTITY extends Vendor$Dollar> OptionalEntity<ENTITY> doSelectOptionalByPK(Long vendor$DollarId, Class<? extends ENTITY> tp) {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends Vendor$Dollar> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.oracle.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends Vendor$Dollar> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
