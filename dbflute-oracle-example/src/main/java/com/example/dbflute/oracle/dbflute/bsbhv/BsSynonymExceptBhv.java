...
public abstract class BsSynonymExceptBhv extends AbstractBehaviorWritable<SynonymExcept, SynonymExceptCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends SynonymExcept> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.oracle.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends SynonymExcept> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
