...
public abstract class BsServiceRankBhv extends AbstractBehaviorWritable {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ServiceRank> selectByUniqueOf(java.math.BigDecimal displayOrder) {
        return doSelectByUniqueOf(displayOrder, ServiceRank.class);
    }

    protected <ENTITY extends ServiceRank> OptionalEntity<ENTITY> doSelectByUniqueOf(java.math.BigDecimal displayOrder, Class<ENTITY> entityType) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(displayOrder), entityType), displayOrder);
    }

    protected ServiceRankCB xprepareCBAsUniqueOf(java.math.BigDecimal displayOrder) {
     ...
     * @return The list of the column value. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<java.math.BigDecimal> extractDisplayOrderList(List<ServiceRank> serviceRankList) {
        return helpExtractListInternally(serviceRankList, new InternalExtractCallback<ServiceRank, java.math.BigDecimal>() {
            public java.math.BigDecimal getCV(ServiceRank et) { return et.getDisplayOrder(); }
        });
    }
