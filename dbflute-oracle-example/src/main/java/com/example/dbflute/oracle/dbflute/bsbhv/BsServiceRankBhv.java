...
public abstract class BsServiceRankBhv extends AbstractBehaviorWritable<ServiceRank, ServiceRankCB> {
    ...
    protected OptionalEntity<ServiceRank> facadeSelectByUniqueOf(java.math.BigDecimal displayOrder) {
        return doSelectByUniqueOf(displayOrder, typeOfSelectedEntity());
    }

    protected <ENTITY extends ServiceRank> OptionalEntity<ENTITY> doSelectByUniqueOf(java.math.BigDecimal displayOrder, Class<? extends ENTITY> tp) {
