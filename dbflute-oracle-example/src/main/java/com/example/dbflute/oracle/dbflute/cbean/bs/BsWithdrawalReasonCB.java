...
public class BsWithdrawalReasonCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public WithdrawalReasonCB acceptUniqueOf(Long displayOrder) {
    ...
    public static class HpSpecification extends HpAbstractSpecification<WithdrawalReasonCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #DD4747">derivedSynonymMemberWithdrawalList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;SynonymMemberWithdrawalCB&gt;() {
         *     public void query(SynonymMemberWithdrawalCB subCB) {
         *         subCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, SynonymMemberWithdrawal.<span style="color: #DD4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<SynonymMemberWithdrawalCB, WithdrawalReasonCQ> derivedSynonymMemberWithdrawalList() {
            ...
            return new HpSDRFunction<SynonymMemberWithdrawalCB, WithdrawalReasonCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<SynonymMemberWithdrawalCB, WithdrawalReasonCQ>() {
                public void setup(String fn, SubQuery<SynonymMemberWithdrawalCB> sq, WithdrawalReasonCQ cq, String al, DerivedReferrerOption op) {
