...
public abstract class BsMemberVendorSynonymBhv extends AbstractBehaviorWritable<MemberVendorSynonym, MemberVendorSynonymCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public MemberVendorSynonymDbm getDBMeta() { return MemberVendorSynonymDbm.getInstance(); }
    ...
    protected <ENTITY extends MemberVendorSynonym> ENTITY doSelectByPK(Long memberId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberId), tp);
    }

    protected <ENTITY extends MemberVendorSynonym> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberId, Class<? extends ENTITY> tp) {
    ...
    public OutsideSqlBasicExecutor<MemberVendorSynonymBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<MemberVendorSynonymBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends MemberVendorSynonym> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.oracle.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends MemberVendorSynonym> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
