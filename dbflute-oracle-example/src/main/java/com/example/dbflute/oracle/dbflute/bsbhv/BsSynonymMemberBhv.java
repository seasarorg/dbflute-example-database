...
public abstract class BsSynonymMemberBhv extends AbstractBehaviorWritable<SynonymMember, SynonymMemberCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends SynonymMember> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.oracle.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends SynonymMember> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
