...
public abstract class BsSynonymMemberBhv extends AbstractBehaviorWritable {
    ...
    protected int facadeSelectCount(SynonymMemberCB cb) {
    ...
    protected SynonymMember facadeSelectEntityWithDeletedCheck(SynonymMemberCB cb) {
    ...
    protected <ENTITY extends SynonymMember> ENTITY doSelectByPK(Long memberId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberId), tp);
    }

    protected <ENTITY extends SynonymMember> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberId, Class<ENTITY> tp) {
    ...
    protected <ENTITY extends SynonymMember> OptionalEntity<ENTITY> doSelectByUniqueOf(String memberAccount, Class<ENTITY> tp) {
    ...
    protected ListResultBean<SynonymMember> facadeSelectList(SynonymMemberCB cb) {
    ...
    protected PagingResultBean<SynonymMember> facadeSelectPage(SynonymMemberCB cb) {
    ...
    protected void facadeSelectCursor(SynonymMemberCB cb, EntityRowHandler<SynonymMember> entityRowHandler) {
    ...
    protected <RESULT> HpSLSFunction<SynonymMemberCB, RESULT> facadeScalarSelect(Class<RESULT> resultType) {
        return doScalarSelect(resultType, newConditionBean());
    }

    protected <RESULT, CB extends SynonymMemberCB> HpSLSFunction<CB, RESULT> doScalarSelect(final Class<RESULT> tp, final CB cb) {
    ...
    protected void doInsert(SynonymMember et, InsertOption<SynonymMemberCB> op) {
        assertObjectNotNull("synonymMember", et); prepareInsertOption(op); delegateInsert(et, op);
    }
    ...
    protected void doUpdate(SynonymMember et, UpdateOption<SynonymMemberCB> op) {
        assertObjectNotNull("synonymMember", et); prepareUpdateOption(op); helpUpdateInternally(et, op);
    }
    ...
    { SynonymMemberCB cb = newConditionBean(); cb.xsetupForVaryingUpdate(); return cb; }

    protected SynonymMemberCB createCBForSpecifiedUpdate()
    { SynonymMemberCB cb = newConditionBean(); cb.xsetupForSpecifiedUpdate(); return cb; }
    ...
    protected void doUpdateNonstrict(SynonymMember et, UpdateOption<SynonymMemberCB> op) {
        assertObjectNotNull("synonymMember", et); prepareUpdateOption(op); helpUpdateNonstrictInternally(et, op);
    }
    ...
    protected void doInsertOrUpdate(SynonymMember et, InsertOption<SynonymMemberCB> iop, UpdateOption<SynonymMemberCB> uop) {
        assertObjectNotNull("synonymMember", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doInsertOrUpdateNonstrict(SynonymMember et, InsertOption<SynonymMemberCB> iop, UpdateOption<SynonymMemberCB> uop) {
        assertObjectNotNull("synonymMember", et); helpInsertOrUpdateNonstrictInternally(et, iop, uop);
    }
    ...
    protected void doDelete(SynonymMember et, final DeleteOption<SynonymMemberCB> op) {
        assertObjectNotNull("synonymMember", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<SynonymMemberCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected void doDeleteNonstrict(SynonymMember et, final DeleteOption<SynonymMemberCB> op) {
        assertObjectNotNull("synonymMember", et); prepareDeleteOption(op); helpDeleteNonstrictInternally(et, op);
    }
    ...
    protected int[] doBatchInsert(List<SynonymMember> ls, InsertOption<SynonymMemberCB> op) {
        assertObjectNotNull("synonymMemberList", ls);
        InsertOption<SynonymMemberCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainInsertOption(); }
        prepareBatchInsertOption(ls, rlop); // required
        return delegateBatchInsert(ls, rlop);
    }

    protected void prepareBatchInsertOption(List<SynonymMember> ls, InsertOption<SynonymMemberCB> op) {
    ...
    protected int[] doBatchUpdate(List<SynonymMember> ls, UpdateOption<SynonymMemberCB> op) {
        assertObjectNotNull("synonymMemberList", ls);
        UpdateOption<SynonymMemberCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
        prepareBatchUpdateOption(ls, rlop); // required
        return delegateBatchUpdate(ls, rlop);
    }

    protected void prepareBatchUpdateOption(List<SynonymMember> ls, UpdateOption<SynonymMemberCB> op) {
    ...
    protected int[] doBatchUpdateNonstrict(List<SynonymMember> ls, UpdateOption<SynonymMemberCB> op) {
        assertObjectNotNull("synonymMemberList", ls);
        UpdateOption<SynonymMemberCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
    ...
    protected int[] doBatchDelete(List<SynonymMember> ls, DeleteOption<SynonymMemberCB> op) {
        assertObjectNotNull("synonymMemberList", ls);
    ...
    protected int[] doBatchDeleteNonstrict(List<SynonymMember> ls, DeleteOption<SynonymMemberCB> op) {
        assertObjectNotNull("synonymMemberList", ls);
        prepareDeleteOption(op);
    ...
    protected int doQueryInsert(QueryInsertSetupper<SynonymMember, SynonymMemberCB> sp, InsertOption<SynonymMemberCB> op) {
        ...
        SynonymMember et = newEntity(); SynonymMemberCB cb = createCBForQueryInsert();
        return delegateQueryInsert(et, cb, sp.setup(et, cb), op);
    }

    protected SynonymMemberCB createCBForQueryInsert()
    { SynonymMemberCB cb = newConditionBean(); cb.xsetupForQueryInsert(); return cb; }
    ...
    protected int doQueryUpdate(SynonymMember et, SynonymMemberCB cb, UpdateOption<SynonymMemberCB> op) {
        assertObjectNotNull("synonymMember", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<SynonymMember> typeOfSelectedEntity() { return SynonymMember.class; }
    protected SynonymMember downcast(Entity et) { return helpEntityDowncastInternally(et, SynonymMember.class); }
    protected SynonymMemberCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, SynonymMemberCB.class); }
    @SuppressWarnings("unchecked")
    protected List<SynonymMember> downcast(List<? extends Entity> ls) { return (List<SynonymMember>)ls; }
    @SuppressWarnings("unchecked")
    protected InsertOption<SynonymMemberCB> downcast(InsertOption<? extends ConditionBean> op) { return (InsertOption<SynonymMemberCB>)op; }
    @SuppressWarnings("unchecked")
    protected UpdateOption<SynonymMemberCB> downcast(UpdateOption<? extends ConditionBean> op) { return (UpdateOption<SynonymMemberCB>)op; }
    @SuppressWarnings("unchecked")
    protected DeleteOption<SynonymMemberCB> downcast(DeleteOption<? extends ConditionBean> op) { return (DeleteOption<SynonymMemberCB>)op; }
    @SuppressWarnings("unchecked")
