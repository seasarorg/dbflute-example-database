...
/**
 * The base class for procedure parameter-bean of SynonymNextLinkProcedure. <br />
 * This is related to "<span style="color: #AD4747">SYNONYM_NEXT_LINK_PROCEDURE</span>".
 * @author oracleman
 */
public class BsSynonymNextLinkProcedurePmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of SynonymNextLinkProcedure. <br />
     * This is related to "<span style="color: #AD4747">SYNONYM_NEXT_LINK_PROCEDURE</span>".
     */
    public BsSynonymNextLinkProcedurePmb() {
    }
    ...
    public String getProcedureName() {
        return "SYNONYM_NEXT_LINK_PROCEDURE";
    }
