...
public abstract class BsNextSchemaProductBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends NextSchemaProduct> ENTITY doSelectByPKValue(Long productId, Class<ENTITY> entityType) {
    ...
    protected <ENTITY extends NextSchemaProduct> ENTITY doSelectByPKValueWithDeletedCheck(Long productId, Class<ENTITY> entityType) {
        return doSelectEntityWithDeletedCheck(buildPKCB(productId), entityType);
    }

    private NextSchemaProductCB buildPKCB(Long productId) {
     ...
     * nextSchemaProductBhv.<span style="color: #FD4747">updateNonstrict</span>(nextSchemaProduct);
     * </pre>
     * @param nextSchemaProduct The entity of update target. (NotNull, PrimaryKeyNotNull)
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void updateNonstrict(final NextSchemaProduct nextSchemaProduct) {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//nextSchemaProduct.setVersionNo(value);</span>
     * nextSchemaProductBhv.<span style="color: #FD4747">deleteNonstrict</span>(nextSchemaProduct);
     * </pre>
     * @param nextSchemaProduct The entity of delete target. (NotNull, PrimaryKeyNotNull)
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//nextSchemaProduct.setVersionNo(value);</span>
     * nextSchemaProductBhv.<span style="color: #FD4747">deleteNonstrictIgnoreDeleted</span>(nextSchemaProduct);
     ...
     * nextSchemaProductBhv.<span style="color: #FD4747">varyingUpdateNonstrict</span>(nextSchemaProduct, option);
     * </pre>
     * @param nextSchemaProduct The entity of update target. (NotNull, PrimaryKeyNotNull)
     * @param option The option of update for varying requests. (NotNull)
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
    ...
    public void varyingInsertOrUpdateNonstrict(NextSchemaProduct nextSchemaProduct, InsertOption<NextSchemaProductCB> insertOption, UpdateOption<NextSchemaProductCB> updateOption) {
        assertInsertOptionNotNull(insertOption); assertUpdateOptionNotNull(updateOption);
        doInesrtOrUpdateNonstrict(nextSchemaProduct, insertOption, updateOption);
    }
