...
/**
 * The base class for procedure parameter-bean of SynonymMainPkgProcedureNop. <br />
 * This is related to "<span style="color: #AD4747">SYNONYM_MAIN_PKG_PROCEDURE_NOP</span>".
 * @author oracleman
 */
public class BsSynonymMainPkgProcedureNopPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of SynonymMainPkgProcedureNop. <br />
     * This is related to "<span style="color: #AD4747">SYNONYM_MAIN_PKG_PROCEDURE_NOP</span>".
     */
    public BsSynonymMainPkgProcedureNopPmb() {
    }
    ...
    public String getProcedureName() {
        return "SYNONYM_MAIN_PKG_PROCEDURE_NOP";
    }
