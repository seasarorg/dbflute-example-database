...
/**
 * The base class for procedure parameter-bean of NextSynonymInOutParameter. <br />
 * This is related to "<span style="color: #AD4747">NEXTEXAMPLEDB.NEXT_SYNONYM_IN_OUT_PARAMETER</span>".
 * @author oracleman
 */
public class BsNextSynonymInOutParameterPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of NextSynonymInOutParameter. <br />
     * This is related to "<span style="color: #AD4747">NEXTEXAMPLEDB.NEXT_SYNONYM_IN_OUT_PARAMETER</span>".
     */
    public BsNextSynonymInOutParameterPmb() {
    }
    ...
    public String getProcedureName() {
        return "NEXTEXAMPLEDB.NEXT_SYNONYM_IN_OUT_PARAMETER";
    }
