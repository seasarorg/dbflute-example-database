...
/**
 * The base class for procedure parameter-bean of SynonymNextFunction. <br />
 * This is related to "<span style="color: #AD4747">SYNONYM_NEXT_FUNCTION</span>".
 * @author oracleman
 */
public class BsSynonymNextFunctionPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of SynonymNextFunction. <br />
     * This is related to "<span style="color: #AD4747">SYNONYM_NEXT_FUNCTION</span>".
     */
    public BsSynonymNextFunctionPmb() {
    }
