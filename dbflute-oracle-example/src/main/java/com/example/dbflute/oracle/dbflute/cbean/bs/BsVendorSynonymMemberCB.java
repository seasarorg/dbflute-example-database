...
public class BsVendorSynonymMemberCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;VendorSynonymMemberCB&gt;() {
    ...
    public void union(UnionQuery<VendorSynonymMemberCB> unionQuery) {
        final VendorSynonymMemberCB cb = new VendorSynonymMemberCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;VendorSynonymMemberCB&gt;() {
     *     public void query(VendorSynonymMemberCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * ... = vendorSynonymMember.<span style="color: #FD4747">getMemberStatus()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * cb.query().setFoo...(value);
     * VendorSynonymMember vendorSynonymMember = vendorSynonymMemberBhv.selectEntityWithDeletedCheck(cb);
     * ... = vendorSynonymMember.<span style="color: #FD4747">getSynonymMemberWithdrawalAsOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<VendorSynonymMemberCQ> {
        ...
        public HpSDRFunction<SynonymMemberLoginCB, VendorSynonymMemberCQ> derivedSynonymMemberLoginList() {
            ...
            return new HpSDRFunction<SynonymMemberLoginCB, VendorSynonymMemberCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<SynonymMemberLoginCB, VendorSynonymMemberCQ>() {
                public void setup(String function, SubQuery<SynonymMemberLoginCB> subQuery, VendorSynonymMemberCQ cq, String aliasName, DerivedReferrerOption option) {
        ...
        public HpSDRFunction<VendorSynonymMemberCB, VendorSynonymMemberCQ> myselfDerived() {
            ...
            return new HpSDRFunction<VendorSynonymMemberCB, VendorSynonymMemberCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<VendorSynonymMemberCB, VendorSynonymMemberCQ>() {
                public void setup(String function, SubQuery<VendorSynonymMemberCB> subQuery, VendorSynonymMemberCQ cq, String aliasName, DerivedReferrerOption option) {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;VendorSynonymMemberCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;VendorSynonymMemberCB&gt;() {
     ...
     *     public void query(VendorSynonymMemberCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;VendorSynonymMemberCB&gt;() {
