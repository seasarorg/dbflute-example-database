...
public abstract class BsSynonymProductBhv extends AbstractBehaviorWritable<SynonymProduct, SynonymProductCB> {
    ...
    public OutsideSqlBasicExecutor<SynonymProductBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<SynonymProductBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends SynonymProduct> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.oracle.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends SynonymProduct> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
