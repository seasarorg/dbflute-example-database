...
public abstract class BsWithdrawalReasonBhv extends AbstractBehaviorWritable {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<WithdrawalReason> selectByUniqueOf(Long displayOrder) {
        return doSelectByUniqueOf(displayOrder, WithdrawalReason.class);
    }

    protected <ENTITY extends WithdrawalReason> OptionalEntity<ENTITY> doSelectByUniqueOf(Long displayOrder, Class<ENTITY> entityType) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(displayOrder), entityType), displayOrder);
    }

    protected WithdrawalReasonCB xprepareCBAsUniqueOf(Long displayOrder) {
     ...
     * <pre>
     * withdrawalReasonBhv.<span style="color: #DD4747">loadSynonymMemberWithdrawalList</span>(withdrawalReasonList, new ConditionBeanSetupper&lt;SynonymMemberWithdrawalCB&gt;() {
     ...
     * <span style="color: #3F7E5E">//});</span>
     * for (WithdrawalReason withdrawalReason : withdrawalReasonList) {
     *     ... = withdrawalReason.<span style="color: #DD4747">getSynonymMemberWithdrawalList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br />
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<SynonymMemberWithdrawal> loadSynonymMemberWithdrawalList(List<WithdrawalReason> withdrawalReasonList, ConditionBeanSetupper<SynonymMemberWithdrawalCB> setupper) {
        xassLRArg(withdrawalReasonList, setupper);
        return doLoadSynonymMemberWithdrawalList(withdrawalReasonList, new LoadReferrerOption<SynonymMemberWithdrawalCB, SynonymMemberWithdrawal>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<SynonymMemberWithdrawal> loadSynonymMemberWithdrawalList(WithdrawalReason withdrawalReason, ConditionBeanSetupper<SynonymMemberWithdrawalCB> setupper) {
        xassLRArg(withdrawalReason, setupper);
        return doLoadSynonymMemberWithdrawalList(xnewLRLs(withdrawalReason), new LoadReferrerOption<SynonymMemberWithdrawalCB, SynonymMemberWithdrawal>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<SynonymMemberWithdrawal> loadSynonymMemberWithdrawalList(WithdrawalReason withdrawalReason, LoadReferrerOption<SynonymMemberWithdrawalCB, SynonymMemberWithdrawal> loadReferrerOption) {
        xassLRArg(withdrawalReason, loadReferrerOption);
        return loadSynonymMemberWithdrawalList(xnewLRLs(withdrawalReason), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerLoader<SynonymMemberWithdrawal> loadSynonymMemberWithdrawalList(List<WithdrawalReason> withdrawalReasonList, LoadReferrerOption<SynonymMemberWithdrawalCB, SynonymMemberWithdrawal> loadReferrerOption) {
        xassLRArg(withdrawalReasonList, loadReferrerOption);
        if (withdrawalReasonList.isEmpty()) { return (NestedReferrerLoader<SynonymMemberWithdrawal>)EMPTY_LOADER; }
        return doLoadSynonymMemberWithdrawalList(withdrawalReasonList, loadReferrerOption);
    }

    protected NestedReferrerLoader<SynonymMemberWithdrawal> doLoadSynonymMemberWithdrawalList(List<WithdrawalReason> withdrawalReasonList, LoadReferrerOption<SynonymMemberWithdrawalCB, SynonymMemberWithdrawal> option) {
        final SynonymMemberWithdrawalBhv referrerBhv = xgetBSFLR().select(SynonymMemberWithdrawalBhv.class);
        return helpLoadReferrerInternally(withdrawalReasonList, option, new InternalLoadReferrerCallback<WithdrawalReason, String, SynonymMemberWithdrawalCB, SynonymMemberWithdrawal>() {
            public String getPKVal(WithdrawalReason et)
            { return et.getWithdrawalReasonCode(); }
            ...
            public String getFKVal(SynonymMemberWithdrawal re) { return re.getWithdrawalReasonCode(); }
     ...
     * @return The list of the column value. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<Long> extractDisplayOrderList(List<WithdrawalReason> withdrawalReasonList) {
        return helpExtractListInternally(withdrawalReasonList, new InternalExtractCallback<WithdrawalReason, Long>() {
            public Long getCV(WithdrawalReason et) { return et.getDisplayOrder(); }
        });
    }
