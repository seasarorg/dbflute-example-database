...
public abstract class BsWithdrawalReasonBhv extends AbstractBehaviorWritable<WithdrawalReason, WithdrawalReasonCB> {
    ...
    protected OptionalEntity<WithdrawalReason> facadeSelectByUniqueOf(Long displayOrder) {
        return doSelectByUniqueOf(displayOrder, typeOfSelectedEntity());
    }

    protected <ENTITY extends WithdrawalReason> OptionalEntity<ENTITY> doSelectByUniqueOf(Long displayOrder, Class<? extends ENTITY> tp) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<SynonymMemberWithdrawal> loadSynonymMemberWithdrawalList(List<WithdrawalReason> withdrawalReasonList, ConditionBeanSetupper<SynonymMemberWithdrawalCB> setupper) {
        xassLRArg(withdrawalReasonList, setupper);
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<SynonymMemberWithdrawal> loadSynonymMemberWithdrawalList(WithdrawalReason withdrawalReason, ConditionBeanSetupper<SynonymMemberWithdrawalCB> setupper) {
        xassLRArg(withdrawalReason, setupper);
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<SynonymMemberWithdrawal> loadSynonymMemberWithdrawalList(WithdrawalReason withdrawalReason, LoadReferrerOption<SynonymMemberWithdrawalCB, SynonymMemberWithdrawal> loadReferrerOption) {
        xassLRArg(withdrawalReason, loadReferrerOption);
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<SynonymMemberWithdrawal> loadSynonymMemberWithdrawalList(List<WithdrawalReason> withdrawalReasonList, LoadReferrerOption<SynonymMemberWithdrawalCB, SynonymMemberWithdrawal> loadReferrerOption) {
        xassLRArg(withdrawalReasonList, loadReferrerOption);
        if (withdrawalReasonList.isEmpty()) { return (NestedReferrerListGateway<SynonymMemberWithdrawal>)EMPTY_NREF_LGWAY; }
        return doLoadSynonymMemberWithdrawalList(withdrawalReasonList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<SynonymMemberWithdrawal> doLoadSynonymMemberWithdrawalList(List<WithdrawalReason> withdrawalReasonList, LoadReferrerOption<SynonymMemberWithdrawalCB, SynonymMemberWithdrawal> option) {
        return helpLoadReferrerInternally(withdrawalReasonList, option, "synonymMemberWithdrawalList");
    }
