...
public class WhiteUqFkWithoutPkCIQ extends AbstractBsWhiteUqFkWithoutPkCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteUqFkWithoutPkCIQ(ConditionQuery childQuery, SqlClause sqlClause
    ...
    public String keepUqFkCode_QueryDerivedReferrer_WhiteUqFkWithoutPkRefListParameter(Object pv)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
