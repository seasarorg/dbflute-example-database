...
public class SynonymProductCIQ extends AbstractBsSynonymProductCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public SynonymProductCIQ(ConditionQuery childQuery, SqlClause sqlClause
    ...
    { return _myCQ.keepProductStatusCode_InScopeRelation_SynonymProductStatus(sq); }
    public String keepProductStatusCode_NotInScopeRelation_SynonymProductStatus(SynonymProductStatusCQ sq)
    { return _myCQ.keepProductStatusCode_NotInScopeRelation_SynonymProductStatus(sq); }
