...
/**
 * The referrer loader of (会員)MEMBER_VENDOR_SYNONYM as SYNONYM. <br />
 * <pre>
 * [primary key]
 *     MEMBER_ID
 *
 ...
 * @author oracleman
 */
public class LoaderOfMemberVendorSynonym {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<MemberVendorSynonym> _selectedList;
    protected BehaviorSelector _selector;
    protected MemberVendorSynonymBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfMemberVendorSynonym ready(List<MemberVendorSynonym> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected MemberVendorSynonymBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(MemberVendorSynonymBhv.class); return _myBhv; } }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<MemberVendorSynonym> getSelectedList() { return _selectedList; }
