...
public abstract class BsMemberServiceBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends MemberService> ENTITY doSelectByPK(Long memberServiceId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberServiceId), tp);
    }

    protected <ENTITY extends MemberService> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberServiceId, Class<ENTITY> tp) {
    ...
    protected <ENTITY extends MemberService> OptionalEntity<ENTITY> doSelectByUniqueOf(Long memberId, Class<ENTITY> tp) {
