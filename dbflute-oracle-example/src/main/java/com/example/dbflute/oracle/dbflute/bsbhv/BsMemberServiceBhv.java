...
public abstract class BsMemberServiceBhv extends AbstractBehaviorWritable {
     ...
     * @param memberServiceId : PK, NotNull, NUMBER(16). (NotNull)
     * @return The entity selected by the PK. (NullAllowed: if no data, it returns null)
     * @exception EntityDuplicatedException When the entity has been duplicated.
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public MemberService selectByPKValue(Long memberServiceId) {
        return doSelectByPK(memberServiceId, MemberService.class);
    }

    protected <ENTITY extends MemberService> ENTITY doSelectByPK(Long memberServiceId, Class<ENTITY> entityType) {
        return doSelectEntity(xprepareCBAsPK(memberServiceId), entityType);
    }

    protected <ENTITY extends MemberService> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberServiceId, Class<ENTITY> entityType) {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public MemberService selectByPKValueWithDeletedCheck(Long memberServiceId) {
        return doSelectByPKWithDeletedCheck(memberServiceId, MemberService.class);
    }

    protected <ENTITY extends MemberService> ENTITY doSelectByPKWithDeletedCheck(Long memberServiceId, Class<ENTITY> entityType) {
        return doSelectEntityWithDeletedCheck(xprepareCBAsPK(memberServiceId), entityType);
    }

    protected MemberServiceCB xprepareCBAsPK(Long memberServiceId) {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<MemberService> selectByUniqueOf(Long memberId) {
        return doSelectByUniqueOf(memberId, MemberService.class);
    }

    protected <ENTITY extends MemberService> OptionalEntity<ENTITY> doSelectByUniqueOf(Long memberId, Class<ENTITY> entityType) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(memberId), entityType), memberId);
    }

    protected MemberServiceCB xprepareCBAsUniqueOf(Long memberId) {
     ...
     */
    public List<Long> extractMemberServiceIdList(List<MemberService> memberServiceList) {
        return helpExtractListInternally(memberServiceList, new InternalExtractCallback<MemberService, Long>() {
            public Long getCV(MemberService et) { return et.getMemberServiceId(); }
        });
    }
     ...
     * @return The list of the column value. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<Long> extractMemberIdList(List<MemberService> memberServiceList) {
        return helpExtractListInternally(memberServiceList, new InternalExtractCallback<MemberService, Long>() {
            public Long getCV(MemberService et) { return et.getMemberId(); }
        });
    }
