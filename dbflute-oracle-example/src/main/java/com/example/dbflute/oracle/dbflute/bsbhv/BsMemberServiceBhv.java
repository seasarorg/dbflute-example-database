...
public abstract class BsMemberServiceBhv extends AbstractBehaviorWritable<MemberService, MemberServiceCB> {
    ...
    protected MemberService facadeSelectByPKValue(Long memberServiceId) {
        return doSelectByPK(memberServiceId, typeOfSelectedEntity());
    }

    protected <ENTITY extends MemberService> ENTITY doSelectByPK(Long memberServiceId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberServiceId), tp);
    }

    protected <ENTITY extends MemberService> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberServiceId, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MemberService> ENTITY doSelectByPKWithDeletedCheck(Long memberServiceId, Class<ENTITY> tp) {
    ...
    protected OptionalEntity<MemberService> facadeSelectByUniqueOf(Long memberId) {
        return doSelectByUniqueOf(memberId, typeOfSelectedEntity());
    }

    protected <ENTITY extends MemberService> OptionalEntity<ENTITY> doSelectByUniqueOf(Long memberId, Class<? extends ENTITY> tp) {
