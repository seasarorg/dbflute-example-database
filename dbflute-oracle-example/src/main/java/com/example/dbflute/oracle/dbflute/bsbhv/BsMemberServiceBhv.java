...
public abstract class BsMemberServiceBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends MemberService> ENTITY doSelectByPKValue(Long memberServiceId, Class<ENTITY> entityType) {
    ...
    protected <ENTITY extends MemberService> ENTITY doSelectByPKValueWithDeletedCheck(Long memberServiceId, Class<ENTITY> entityType) {
        return doSelectEntityWithDeletedCheck(buildPKCB(memberServiceId), entityType);
    }

    private MemberServiceCB buildPKCB(Long memberServiceId) {
