...
/**
 * The condition-query for in-line of VENDOR_SYNONYM_MEMBER.
 * @author oracleman
 */
public class VendorSynonymMemberCIQ extends AbstractBsVendorSynonymMemberCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsVendorSynonymMemberCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public VendorSynonymMemberCIQ(ConditionQuery childQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsVendorSynonymMemberCQ myCQ) {
    ...
    public String keepMemberId_QueryDerivedReferrer_SynonymMemberLoginListParameter(Object pv)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    ...
    protected String xinCB() { return VendorSynonymMemberCB.class.getName(); }
    protected String xinCQ() { return VendorSynonymMemberCQ.class.getName(); }
}
