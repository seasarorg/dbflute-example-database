...
public abstract class AbstractBsSynonymNextLinkTableCQ extends AbstractConditionQuery {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_Equal()</span>.max(new SubQuery&lt;SynonymNextLinkTableCB&gt;() {
    ...
    public HpSSQFunction<SynonymNextLinkTableCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, SynonymNextLinkTableCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;SynonymNextLinkTableCB&gt;() {
     *     public void query(SynonymNextLinkTableCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
    ...
    public HpSSQFunction<SynonymNextLinkTableCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, SynonymNextLinkTableCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;SynonymNextLinkTableCB&gt;() {
     *     public void query(SynonymNextLinkTableCB subCB) {
    ...
    public HpSSQFunction<SynonymNextLinkTableCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, SynonymNextLinkTableCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessThan()</span>.max(new SubQuery&lt;SynonymNextLinkTableCB&gt;() {
     *     public void query(SynonymNextLinkTableCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<SynonymNextLinkTableCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, SynonymNextLinkTableCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;SynonymNextLinkTableCB&gt;() {
     *     public void query(SynonymNextLinkTableCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<SynonymNextLinkTableCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, SynonymNextLinkTableCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;SynonymNextLinkTableCB&gt;() {
     *     public void query(SynonymNextLinkTableCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<SynonymNextLinkTableCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, SynonymNextLinkTableCB.class);
    }
    ...
    public void myselfInScope(SubQuery<SynonymNextLinkTableCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        SynonymNextLinkTableCB cb = new SynonymNextLinkTableCB(); cb.xsetupForMyselfInScope(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMyselfInScope(cb.query());
        registerMyselfInScope(cb.query(), pp);
    }
    public abstract String keepMyselfInScope(SynonymNextLinkTableCQ sq);
