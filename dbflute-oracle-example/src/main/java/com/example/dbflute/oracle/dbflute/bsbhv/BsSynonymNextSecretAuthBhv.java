...
public abstract class BsSynonymNextSecretAuthBhv extends AbstractBehaviorWritable<SynonymNextSecretAuth, SynonymNextSecretAuthCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends SynonymNextSecretAuth> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.oracle.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends SynonymNextSecretAuth> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
