...
public class BsVendorSynonymMemberCQ extends AbstractBsVendorSynonymMemberCQ {
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, VendorSynonymMemberCQ> getScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(VendorSynonymMemberCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, VendorSynonymMemberCQ> getSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(VendorSynonymMemberCQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, VendorSynonymMemberCQ> getQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    ...
    public Map<String, VendorSynonymMemberCQ> getMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(VendorSynonymMemberCQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, VendorSynonymMemberCQ> getMyselfInScope() { return xgetSQueMap("myselfInScope"); }
