...
public class BsVendorSynonymMemberCQ extends AbstractBsVendorSynonymMemberCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsVendorSynonymMemberCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @return this. (NotNull)
     */
    public BsVendorSynonymMemberCQ addSpecifiedDerivedOrderBy_Asc(String aliasName)
     ...
     * @return this. (NotNull)
     */
    public BsVendorSynonymMemberCQ addSpecifiedDerivedOrderBy_Desc(String aliasName)
    ...
    protected void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
        VendorSynonymMemberCQ baseQuery = (VendorSynonymMemberCQ)baseQueryAsSuper;
        VendorSynonymMemberCQ unionQuery = (VendorSynonymMemberCQ)unionQueryAsSuper;
    ...
    protected MemberStatusCQ xcreateQueryMemberStatus() {
        String nrp = resolveNextRelationPath("VENDOR_SYNONYM_MEMBER", "memberStatus");
    ...
    protected SynonymMemberWithdrawalCQ xcreateQuerySynonymMemberWithdrawalAsOne() {
        String nrp = resolveNextRelationPath("VENDOR_SYNONYM_MEMBER", "synonymMemberWithdrawalAsOne");
        String jan = resolveJoinAliasName(nrp, xgetNextNestLevel());
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    protected Map<String, VendorSynonymMemberCQ> _scalarConditionMap;
    public Map<String, VendorSynonymMemberCQ> getScalarCondition() { return _scalarConditionMap; }
    public String keepScalarCondition(VendorSynonymMemberCQ subQuery) {
    ...
    //                                                                       MyselfDerived
    //                                                                       =============
    protected Map<String, VendorSynonymMemberCQ> _specifyMyselfDerivedMap;
    public Map<String, VendorSynonymMemberCQ> getSpecifyMyselfDerived() { return _specifyMyselfDerivedMap; }
    public String keepSpecifyMyselfDerived(VendorSynonymMemberCQ subQuery) {
        if (_specifyMyselfDerivedMap == null) { _specifyMyselfDerivedMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_specifyMyselfDerivedMap.size() + 1);
        _specifyMyselfDerivedMap.put(key, subQuery); return "specifyMyselfDerived." + key;
    }

    protected Map<String, VendorSynonymMemberCQ> _queryMyselfDerivedMap;
    public Map<String, VendorSynonymMemberCQ> getQueryMyselfDerived() { return _queryMyselfDerivedMap; }
    public String keepQueryMyselfDerived(VendorSynonymMemberCQ subQuery) {
    ...
    public Map<String, VendorSynonymMemberCQ> getMyselfExists() { return _myselfExistsMap; }
    public String keepMyselfExists(VendorSynonymMemberCQ subQuery) {
    ...
    //                                                                       MyselfInScope
    //                                                                       =============
    protected Map<String, VendorSynonymMemberCQ> _myselfInScopeMap;
    public Map<String, VendorSynonymMemberCQ> getMyselfInScope() { return _myselfInScopeMap; }
    public String keepMyselfInScope(VendorSynonymMemberCQ subQuery) {
