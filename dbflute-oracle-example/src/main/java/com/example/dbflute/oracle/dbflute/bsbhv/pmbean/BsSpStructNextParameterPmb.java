...
/**
 * The base class for procedure parameter-bean of SpStructNextParameter. <br />
 * This is related to "<span style="color: #AD4747">SP_STRUCT_NEXT_PARAMETER</span>".
 * @author oracleman
 */
public class BsSpStructNextParameterPmb implements ProcedurePmb, FetchBean {
    ...
    public static final ValueType VInFooBean_VALUE_TYPE
            = new DBFluteConfig.ImplementedOracleStructType
                  ("NEXTEXAMPLEDB.NEXT_FOO_BEAN", NextFooBean.class);
    ...
    //                                                                           Attribute
    //                                                                           =========
    /** The parameter of VInFooBean: {NEXTEXAMPLEDB.NEXT_FOO_BEAN as In}. */
    protected NextFooBean _vInFooBean;

    /** The parameter of VOutFooBean: {NEXTEXAMPLEDB.NEXT_FOO_BEAN as Out}. */
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of SpStructNextParameter. <br />
     * This is related to "<span style="color: #AD4747">SP_STRUCT_NEXT_PARAMETER</span>".
     */
    public BsSpStructNextParameterPmb() {
    }
    ...
    public String getProcedureName() {
        return "SP_STRUCT_NEXT_PARAMETER";
    }
    ...
    //                                                                            ========
    /**
     * [get] VInFooBean: {NEXTEXAMPLEDB.NEXT_FOO_BEAN as In} <br />
    ...
    /**
     * [set] VInFooBean: {NEXTEXAMPLEDB.NEXT_FOO_BEAN as In} <br />
    ...
    /**
     * [get] VOutFooBean: {NEXTEXAMPLEDB.NEXT_FOO_BEAN as Out} <br />
    ...
    /**
     * [set] VOutFooBean: {NEXTEXAMPLEDB.NEXT_FOO_BEAN as Out} <br />
