...
public abstract class AbstractBsSynonymNextLinkSynonymCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsSynonymNextLinkSynonymCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_Equal()</span>.max(new SubQuery&lt;SynonymNextLinkSynonymCB&gt;() {
    ...
    public HpSSQFunction<SynonymNextLinkSynonymCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ.getOperand(), SynonymNextLinkSynonymCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;SynonymNextLinkSynonymCB&gt;() {
     *     public void query(SynonymNextLinkSynonymCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
    ...
    public HpSSQFunction<SynonymNextLinkSynonymCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES.getOperand(), SynonymNextLinkSynonymCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;SynonymNextLinkSynonymCB&gt;() {
     *     public void query(SynonymNextLinkSynonymCB subCB) {
    ...
    public HpSSQFunction<SynonymNextLinkSynonymCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT.getOperand(), SynonymNextLinkSynonymCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessThan()</span>.max(new SubQuery&lt;SynonymNextLinkSynonymCB&gt;() {
     *     public void query(SynonymNextLinkSynonymCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<SynonymNextLinkSynonymCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT.getOperand(), SynonymNextLinkSynonymCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;SynonymNextLinkSynonymCB&gt;() {
     *     public void query(SynonymNextLinkSynonymCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<SynonymNextLinkSynonymCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE.getOperand(), SynonymNextLinkSynonymCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;SynonymNextLinkSynonymCB&gt;() {
     *     public void query(SynonymNextLinkSynonymCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<SynonymNextLinkSynonymCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE.getOperand(), SynonymNextLinkSynonymCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSSQOption<CB> op) {
        assertObjectNotNull("subQuery", sq);
        SynonymNextLinkSynonymCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
    ...
    protected SynonymNextLinkSynonymCB xcreateScalarConditionCB() {
        SynonymNextLinkSynonymCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected SynonymNextLinkSynonymCB xcreateScalarConditionPartitionByCB() {
        SynonymNextLinkSynonymCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }
    ...
    public void xsmyselfDerive(String fn, SubQuery<SynonymNextLinkSynonymCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        SynonymNextLinkSynonymCB cb = new SynonymNextLinkSynonymCB(); cb.xsetupForDerivedReferrer(this);
    ...
    public HpQDRFunction<SynonymNextLinkSynonymCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(SynonymNextLinkSynonymCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        SynonymNextLinkSynonymCB cb = new SynonymNextLinkSynonymCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PRODUCT_ID";
    ...
    public void myselfExists(SubQuery<SynonymNextLinkSynonymCB> subQuery) {
        ...
        SynonymNextLinkSynonymCB cb = new SynonymNextLinkSynonymCB(); cb.xsetupForMyselfExists(this);
    ...
    public void myselfInScope(SubQuery<SynonymNextLinkSynonymCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        SynonymNextLinkSynonymCB cb = new SynonymNextLinkSynonymCB(); cb.xsetupForMyselfInScope(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected SynonymNextLinkSynonymCB newMyCB() {
        return new SynonymNextLinkSynonymCB();
    }
