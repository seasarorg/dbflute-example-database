...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable {
    ...
    /**
     * Load referrer of memberVendorSynonymList with the set-upper for condition-bean of referrer. <br />
     * (会員)MEMBER_VENDOR_SYNONYM by MEMBER_STATUS_CODE, named 'memberVendorSynonymList'.
     * <pre>
     * memberStatusBhv.<span style="color: #FD4747">loadMemberVendorSynonymList</span>(memberStatusList, new ConditionBeanSetupper&lt;MemberVendorSynonymCB&gt;() {
     ...
     * });
     * for (MemberStatus memberStatus : memberStatusList) {
     *     ... = memberStatus.<span style="color: #FD4747">getMemberVendorSynonymList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key(and others too) is treated as case-insensitive. <br />
     * The condition-bean that the set-upper provides have settings before you touch it. It is as follows:
     ...
     * @param conditionBeanSetupper The instance of referrer condition-bean set-upper for registering referrer condition. (NotNull)
     */
    public void loadMemberVendorSynonymList(List<MemberStatus> memberStatusList, ConditionBeanSetupper<MemberVendorSynonymCB> conditionBeanSetupper) {
        xassLRArg(memberStatusList, conditionBeanSetupper);
     ...
     * @param loadReferrerOption The option of load-referrer. (NotNull)
     */
    public void loadMemberVendorSynonymList(MemberStatus memberStatus, LoadReferrerOption<MemberVendorSynonymCB, MemberVendorSynonym> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
        loadMemberVendorSynonymList(xnewLRLs(memberStatus), loadReferrerOption);
    }
    /**
     * {Refer to overload method that has an argument of condition-bean setupper.}
     * @param memberStatusList The entity list of memberStatus. (NotNull)
     * @param loadReferrerOption The option of load-referrer. (NotNull)
     */
    public void loadMemberVendorSynonymList(List<MemberStatus> memberStatusList, LoadReferrerOption<MemberVendorSynonymCB, MemberVendorSynonym> loadReferrerOption) {
        xassLRArg(memberStatusList, loadReferrerOption);
        if (memberStatusList.isEmpty()) { return; }
        final MemberVendorSynonymBhv referrerBhv = xgetBSFLR().select(MemberVendorSynonymBhv.class);
        helpLoadReferrerInternally(memberStatusList, loadReferrerOption, new InternalLoadReferrerCallback<MemberStatus, String, MemberVendorSynonymCB, MemberVendorSynonym>() {
            public String getPKVal(MemberStatus et)
            { return et.getMemberStatusCode(); }
     ...
     * @param conditionBeanSetupper The instance of referrer condition-bean set-upper for registering referrer condition. (NotNull)
     */
    public void loadSynonymMemberList(MemberStatus memberStatus, ConditionBeanSetupper<SynonymMemberCB> conditionBeanSetupper) {
        xassLRArg(memberStatus, conditionBeanSetupper);
        loadSynonymMemberList(xnewLRLs(memberStatus), conditionBeanSetupper);
    }
    /**
     * Load referrer of synonymMemberList with the set-upper for condition-bean of referrer. <br />
     * (会員)SYNONYM_MEMBER by MEMBER_STATUS_CODE, named 'synonymMemberList'.
     * <pre>
     * memberStatusBhv.<span style="color: #FD4747">loadSynonymMemberList</span>(memberStatusList, new ConditionBeanSetupper&lt;SynonymMemberCB&gt;() {
     ...
     * });
     * for (MemberStatus memberStatus : memberStatusList) {
     *     ... = memberStatus.<span style="color: #FD4747">getSynonymMemberList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key(and others too) is treated as case-insensitive. <br />
     * The condition-bean that the set-upper provides have settings before you touch it. It is as follows:
     ...
     * @param conditionBeanSetupper The instance of referrer condition-bean set-upper for registering referrer condition. (NotNull)
     */
    public void loadSynonymMemberList(List<MemberStatus> memberStatusList, ConditionBeanSetupper<SynonymMemberCB> conditionBeanSetupper) {
        xassLRArg(memberStatusList, conditionBeanSetupper);
        loadSynonymMemberList(memberStatusList, new LoadReferrerOption<SynonymMemberCB, SynonymMember>().xinit(conditionBeanSetupper));
    }
    /**
     * {Refer to overload method that has an argument of the list of entity.}
     * @param memberStatus The entity of memberStatus. (NotNull)
     * @param loadReferrerOption The option of load-referrer. (NotNull)
     */
    public void loadSynonymMemberList(MemberStatus memberStatus, LoadReferrerOption<SynonymMemberCB, SynonymMember> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
        loadSynonymMemberList(xnewLRLs(memberStatus), loadReferrerOption);
    }
    /**
     * {Refer to overload method that has an argument of condition-bean setupper.}
     * @param memberStatusList The entity list of memberStatus. (NotNull)
     * @param loadReferrerOption The option of load-referrer. (NotNull)
     */
    public void loadSynonymMemberList(List<MemberStatus> memberStatusList, LoadReferrerOption<SynonymMemberCB, SynonymMember> loadReferrerOption) {
        xassLRArg(memberStatusList, loadReferrerOption);
        if (memberStatusList.isEmpty()) { return; }
        final SynonymMemberBhv referrerBhv = xgetBSFLR().select(SynonymMemberBhv.class);
        helpLoadReferrerInternally(memberStatusList, loadReferrerOption, new InternalLoadReferrerCallback<MemberStatus, String, SynonymMemberCB, SynonymMember>() {
            public String getPKVal(MemberStatus et)
            { return et.getMemberStatusCode(); }
     ...
     * @param conditionBeanSetupper The instance of referrer condition-bean set-upper for registering referrer condition. (NotNull)
     */
    public void loadSynonymMemberLoginList(MemberStatus memberStatus, ConditionBeanSetupper<SynonymMemberLoginCB> conditionBeanSetupper) {
        xassLRArg(memberStatus, conditionBeanSetupper);
        loadSynonymMemberLoginList(xnewLRLs(memberStatus), conditionBeanSetupper);
    }
    /**
     ...
     * <pre>
     * memberStatusBhv.<span style="color: #FD4747">loadSynonymMemberLoginList</span>(memberStatusList, new ConditionBeanSetupper&lt;SynonymMemberLoginCB&gt;() {
     ...
     * });
     * for (MemberStatus memberStatus : memberStatusList) {
     *     ... = memberStatus.<span style="color: #FD4747">getSynonymMemberLoginList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key(and others too) is treated as case-insensitive. <br />
     * The condition-bean that the set-upper provides have settings before you touch it. It is as follows:
     ...
     * @param conditionBeanSetupper The instance of referrer condition-bean set-upper for registering referrer condition. (NotNull)
     */
    public void loadSynonymMemberLoginList(List<MemberStatus> memberStatusList, ConditionBeanSetupper<SynonymMemberLoginCB> conditionBeanSetupper) {
        xassLRArg(memberStatusList, conditionBeanSetupper);
        loadSynonymMemberLoginList(memberStatusList, new LoadReferrerOption<SynonymMemberLoginCB, SynonymMemberLogin>().xinit(conditionBeanSetupper));
    }
    /**
     * {Refer to overload method that has an argument of the list of entity.}
     * @param memberStatus The entity of memberStatus. (NotNull)
     * @param loadReferrerOption The option of load-referrer. (NotNull)
     */
    public void loadSynonymMemberLoginList(MemberStatus memberStatus, LoadReferrerOption<SynonymMemberLoginCB, SynonymMemberLogin> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
        loadSynonymMemberLoginList(xnewLRLs(memberStatus), loadReferrerOption);
    }
    /**
     * {Refer to overload method that has an argument of condition-bean setupper.}
     * @param memberStatusList The entity list of memberStatus. (NotNull)
     * @param loadReferrerOption The option of load-referrer. (NotNull)
     */
    public void loadSynonymMemberLoginList(List<MemberStatus> memberStatusList, LoadReferrerOption<SynonymMemberLoginCB, SynonymMemberLogin> loadReferrerOption) {
        xassLRArg(memberStatusList, loadReferrerOption);
        if (memberStatusList.isEmpty()) { return; }
        final SynonymMemberLoginBhv referrerBhv = xgetBSFLR().select(SynonymMemberLoginBhv.class);
        helpLoadReferrerInternally(memberStatusList, loadReferrerOption, new InternalLoadReferrerCallback<MemberStatus, String, SynonymMemberLoginCB, SynonymMemberLogin>() {
            public String getPKVal(MemberStatus et)
            { return et.getMemberStatusCode(); }
     ...
     * @param conditionBeanSetupper The instance of referrer condition-bean set-upper for registering referrer condition. (NotNull)
     */
    public void loadVendorSynonymMemberList(MemberStatus memberStatus, ConditionBeanSetupper<VendorSynonymMemberCB> conditionBeanSetupper) {
        xassLRArg(memberStatus, conditionBeanSetupper);
        loadVendorSynonymMemberList(xnewLRLs(memberStatus), conditionBeanSetupper);
    }
    /**
     * Load referrer of vendorSynonymMemberList with the set-upper for condition-bean of referrer. <br />
     * (会員)VENDOR_SYNONYM_MEMBER by MEMBER_STATUS_CODE, named 'vendorSynonymMemberList'.
     * <pre>
     * memberStatusBhv.<span style="color: #FD4747">loadVendorSynonymMemberList</span>(memberStatusList, new ConditionBeanSetupper&lt;VendorSynonymMemberCB&gt;() {
     ...
     * });
     * for (MemberStatus memberStatus : memberStatusList) {
     *     ... = memberStatus.<span style="color: #FD4747">getVendorSynonymMemberList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key(and others too) is treated as case-insensitive. <br />
     * The condition-bean that the set-upper provides have settings before you touch it. It is as follows:
     ...
     * @param conditionBeanSetupper The instance of referrer condition-bean set-upper for registering referrer condition. (NotNull)
     */
    public void loadVendorSynonymMemberList(List<MemberStatus> memberStatusList, ConditionBeanSetupper<VendorSynonymMemberCB> conditionBeanSetupper) {
        xassLRArg(memberStatusList, conditionBeanSetupper);
     ...
     * @param loadReferrerOption The option of load-referrer. (NotNull)
     */
    public void loadVendorSynonymMemberList(MemberStatus memberStatus, LoadReferrerOption<VendorSynonymMemberCB, VendorSynonymMember> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
        loadVendorSynonymMemberList(xnewLRLs(memberStatus), loadReferrerOption);
    }
    /**
     * {Refer to overload method that has an argument of condition-bean setupper.}
     * @param memberStatusList The entity list of memberStatus. (NotNull)
     * @param loadReferrerOption The option of load-referrer. (NotNull)
     */
    public void loadVendorSynonymMemberList(List<MemberStatus> memberStatusList, LoadReferrerOption<VendorSynonymMemberCB, VendorSynonymMember> loadReferrerOption) {
        xassLRArg(memberStatusList, loadReferrerOption);
        if (memberStatusList.isEmpty()) { return; }
        final VendorSynonymMemberBhv referrerBhv = xgetBSFLR().select(VendorSynonymMemberBhv.class);
        helpLoadReferrerInternally(memberStatusList, loadReferrerOption, new InternalLoadReferrerCallback<MemberStatus, String, VendorSynonymMemberCB, VendorSynonymMember>() {
            public String getPKVal(MemberStatus et)
            { return et.getMemberStatusCode(); }
