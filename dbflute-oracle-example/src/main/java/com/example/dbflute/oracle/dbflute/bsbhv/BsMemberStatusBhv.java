...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<MemberStatus> selectByUniqueOfDisplayOrder(Long displayOrder) {
        return doSelectByUniqueOfDisplayOrder(displayOrder, MemberStatus.class);
    }

    protected <ENTITY extends MemberStatus> OptionalEntity<ENTITY> doSelectByUniqueOfDisplayOrder(Long displayOrder, Class<ENTITY> entityType) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOfDisplayOrder(displayOrder), entityType), displayOrder);
    }

    protected MemberStatusCB xprepareCBAsUniqueOfDisplayOrder(Long displayOrder) {
        assertObjectNotNull("displayOrder", displayOrder);
        MemberStatusCB cb = newMyConditionBean(); cb.acceptUniqueOfDisplayOrder(displayOrder);
        return cb;
    }
    ...
    public OptionalEntity<MemberStatus> selectByUniqueOfMemberStatusName(String memberStatusName) {
        return doSelectByUniqueOfMemberStatusName(memberStatusName, MemberStatus.class);
    }

    protected <ENTITY extends MemberStatus> OptionalEntity<ENTITY> doSelectByUniqueOfMemberStatusName(String memberStatusName, Class<ENTITY> entityType) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOfMemberStatusName(memberStatusName), entityType), memberStatusName);
    }
    ...
    protected MemberStatusCB xprepareCBAsUniqueOfMemberStatusName(String memberStatusName) {
        ...
        MemberStatusCB cb = newMyConditionBean(); cb.acceptUniqueOfMemberStatusName(memberStatusName);
        return cb;
    }
     ...
     * <pre>
     * memberStatusBhv.<span style="color: #DD4747">loadMemberVendorSynonymList</span>(memberStatusList, new ConditionBeanSetupper&lt;MemberVendorSynonymCB&gt;() {
     *     public void setup(MemberVendorSynonymCB cb) {
     *         cb.setupSelect...();
     *         cb.query().setFoo...(value);
     *         cb.query().addOrderBy_Bar...();
     *     }
     ...
     * <span style="color: #3F7E5E">//});</span>
     * for (MemberStatus memberStatus : memberStatusList) {
     *     ... = memberStatus.<span style="color: #DD4747">getMemberVendorSynonymList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br />
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<MemberVendorSynonym> loadMemberVendorSynonymList(List<MemberStatus> memberStatusList, ConditionBeanSetupper<MemberVendorSynonymCB> setupper) {
        xassLRArg(memberStatusList, setupper);
        return doLoadMemberVendorSynonymList(memberStatusList, new LoadReferrerOption<MemberVendorSynonymCB, MemberVendorSynonym>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<MemberVendorSynonym> loadMemberVendorSynonymList(MemberStatus memberStatus, ConditionBeanSetupper<MemberVendorSynonymCB> setupper) {
        xassLRArg(memberStatus, setupper);
        return doLoadMemberVendorSynonymList(xnewLRLs(memberStatus), new LoadReferrerOption<MemberVendorSynonymCB, MemberVendorSynonym>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<MemberVendorSynonym> loadMemberVendorSynonymList(MemberStatus memberStatus, LoadReferrerOption<MemberVendorSynonymCB, MemberVendorSynonym> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
        return loadMemberVendorSynonymList(xnewLRLs(memberStatus), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerLoader<MemberVendorSynonym> loadMemberVendorSynonymList(List<MemberStatus> memberStatusList, LoadReferrerOption<MemberVendorSynonymCB, MemberVendorSynonym> loadReferrerOption) {
        xassLRArg(memberStatusList, loadReferrerOption);
        if (memberStatusList.isEmpty()) { return (NestedReferrerLoader<MemberVendorSynonym>)EMPTY_LOADER; }
        return doLoadMemberVendorSynonymList(memberStatusList, loadReferrerOption);
    }

    protected NestedReferrerLoader<MemberVendorSynonym> doLoadMemberVendorSynonymList(List<MemberStatus> memberStatusList, LoadReferrerOption<MemberVendorSynonymCB, MemberVendorSynonym> option) {
        final MemberVendorSynonymBhv referrerBhv = xgetBSFLR().select(MemberVendorSynonymBhv.class);
        return helpLoadReferrerInternally(memberStatusList, option, new InternalLoadReferrerCallback<MemberStatus, String, MemberVendorSynonymCB, MemberVendorSynonym>() {
            public String getPKVal(MemberStatus et)
            { return et.getMemberStatusCode(); }
            ...
            public void qyFKIn(MemberVendorSynonymCB cb, List<String> ls)
            { cb.query().setMemberStatusCode_InScope(ls); }
            ...
            public List<MemberVendorSynonym> selRfLs(MemberVendorSynonymCB cb) { return referrerBhv.selectList(cb); }
            public String getFKVal(MemberVendorSynonym re) { return re.getMemberStatusCode(); }
            public void setlcEt(MemberVendorSynonym re, MemberStatus le)
            { re.setMemberStatus(le); }
            public String getRfPrNm() { return "memberVendorSynonymList"; }
        });
    }
     ...
     * <pre>
     * memberStatusBhv.<span style="color: #DD4747">loadSynonymMemberList</span>(memberStatusList, new ConditionBeanSetupper&lt;SynonymMemberCB&gt;() {
     *     public void setup(SynonymMemberCB cb) {
     *         cb.setupSelect...();
     *         cb.query().setFoo...(value);
     *         cb.query().addOrderBy_Bar...();
     *     }
     ...
     * <span style="color: #3F7E5E">//});</span>
     * for (MemberStatus memberStatus : memberStatusList) {
     *     ... = memberStatus.<span style="color: #DD4747">getSynonymMemberList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br />
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<SynonymMember> loadSynonymMemberList(List<MemberStatus> memberStatusList, ConditionBeanSetupper<SynonymMemberCB> setupper) {
        xassLRArg(memberStatusList, setupper);
        return doLoadSynonymMemberList(memberStatusList, new LoadReferrerOption<SynonymMemberCB, SynonymMember>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<SynonymMember> loadSynonymMemberList(MemberStatus memberStatus, ConditionBeanSetupper<SynonymMemberCB> setupper) {
        xassLRArg(memberStatus, setupper);
        return doLoadSynonymMemberList(xnewLRLs(memberStatus), new LoadReferrerOption<SynonymMemberCB, SynonymMember>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<SynonymMember> loadSynonymMemberList(MemberStatus memberStatus, LoadReferrerOption<SynonymMemberCB, SynonymMember> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
        return loadSynonymMemberList(xnewLRLs(memberStatus), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerLoader<SynonymMember> loadSynonymMemberList(List<MemberStatus> memberStatusList, LoadReferrerOption<SynonymMemberCB, SynonymMember> loadReferrerOption) {
        xassLRArg(memberStatusList, loadReferrerOption);
        if (memberStatusList.isEmpty()) { return (NestedReferrerLoader<SynonymMember>)EMPTY_LOADER; }
        return doLoadSynonymMemberList(memberStatusList, loadReferrerOption);
    }

    protected NestedReferrerLoader<SynonymMember> doLoadSynonymMemberList(List<MemberStatus> memberStatusList, LoadReferrerOption<SynonymMemberCB, SynonymMember> option) {
        final SynonymMemberBhv referrerBhv = xgetBSFLR().select(SynonymMemberBhv.class);
        return helpLoadReferrerInternally(memberStatusList, option, new InternalLoadReferrerCallback<MemberStatus, String, SynonymMemberCB, SynonymMember>() {
            public String getPKVal(MemberStatus et)
            { return et.getMemberStatusCode(); }
            public void setRfLs(MemberStatus et, List<SynonymMember> ls)
            { et.setSynonymMemberList(ls); }
            public SynonymMemberCB newMyCB() { return referrerBhv.newMyConditionBean(); }
            public void qyFKIn(SynonymMemberCB cb, List<String> ls)
            { cb.query().setMemberStatusCode_InScope(ls); }
            public void qyOdFKAsc(SynonymMemberCB cb) { cb.query().addOrderBy_MemberStatusCode_Asc(); }
            public void spFKCol(SynonymMemberCB cb) { cb.specify().columnMemberStatusCode(); }
            public List<SynonymMember> selRfLs(SynonymMemberCB cb) { return referrerBhv.selectList(cb); }
            public String getFKVal(SynonymMember re) { return re.getMemberStatusCode(); }
            public void setlcEt(SynonymMember re, MemberStatus le)
            { re.setMemberStatus(le); }
            public String getRfPrNm() { return "synonymMemberList"; }
        });
    }
     ...
     * <pre>
     * memberStatusBhv.<span style="color: #DD4747">loadSynonymMemberLoginList</span>(memberStatusList, new ConditionBeanSetupper&lt;SynonymMemberLoginCB&gt;() {
     ...
     * <span style="color: #3F7E5E">//});</span>
     * for (MemberStatus memberStatus : memberStatusList) {
     *     ... = memberStatus.<span style="color: #DD4747">getSynonymMemberLoginList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br />
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<SynonymMemberLogin> loadSynonymMemberLoginList(List<MemberStatus> memberStatusList, ConditionBeanSetupper<SynonymMemberLoginCB> setupper) {
        xassLRArg(memberStatusList, setupper);
        return doLoadSynonymMemberLoginList(memberStatusList, new LoadReferrerOption<SynonymMemberLoginCB, SynonymMemberLogin>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<SynonymMemberLogin> loadSynonymMemberLoginList(MemberStatus memberStatus, ConditionBeanSetupper<SynonymMemberLoginCB> setupper) {
        xassLRArg(memberStatus, setupper);
        return doLoadSynonymMemberLoginList(xnewLRLs(memberStatus), new LoadReferrerOption<SynonymMemberLoginCB, SynonymMemberLogin>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<SynonymMemberLogin> loadSynonymMemberLoginList(MemberStatus memberStatus, LoadReferrerOption<SynonymMemberLoginCB, SynonymMemberLogin> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
        return loadSynonymMemberLoginList(xnewLRLs(memberStatus), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerLoader<SynonymMemberLogin> loadSynonymMemberLoginList(List<MemberStatus> memberStatusList, LoadReferrerOption<SynonymMemberLoginCB, SynonymMemberLogin> loadReferrerOption) {
        xassLRArg(memberStatusList, loadReferrerOption);
        if (memberStatusList.isEmpty()) { return (NestedReferrerLoader<SynonymMemberLogin>)EMPTY_LOADER; }
        return doLoadSynonymMemberLoginList(memberStatusList, loadReferrerOption);
    }

    protected NestedReferrerLoader<SynonymMemberLogin> doLoadSynonymMemberLoginList(List<MemberStatus> memberStatusList, LoadReferrerOption<SynonymMemberLoginCB, SynonymMemberLogin> option) {
        final SynonymMemberLoginBhv referrerBhv = xgetBSFLR().select(SynonymMemberLoginBhv.class);
        return helpLoadReferrerInternally(memberStatusList, option, new InternalLoadReferrerCallback<MemberStatus, String, SynonymMemberLoginCB, SynonymMemberLogin>() {
            public String getPKVal(MemberStatus et)
            { return et.getMemberStatusCode(); }
            ...
            public void qyFKIn(SynonymMemberLoginCB cb, List<String> ls)
            { cb.query().setLoginMemberStatusCode_InScope(ls); }
            public void qyOdFKAsc(SynonymMemberLoginCB cb) { cb.query().addOrderBy_LoginMemberStatusCode_Asc(); }
            public void spFKCol(SynonymMemberLoginCB cb) { cb.specify().columnLoginMemberStatusCode(); }
            public List<SynonymMemberLogin> selRfLs(SynonymMemberLoginCB cb) { return referrerBhv.selectList(cb); }
            public String getFKVal(SynonymMemberLogin re) { return re.getLoginMemberStatusCode(); }
            public void setlcEt(SynonymMemberLogin re, MemberStatus le)
            { re.setMemberStatus(le); }
     ...
     * <pre>
     * memberStatusBhv.<span style="color: #DD4747">loadVendorSynonymMemberList</span>(memberStatusList, new ConditionBeanSetupper&lt;VendorSynonymMemberCB&gt;() {
     *     public void setup(VendorSynonymMemberCB cb) {
     *         cb.setupSelect...();
     *         cb.query().setFoo...(value);
     *         cb.query().addOrderBy_Bar...();
     *     }
     ...
     * <span style="color: #3F7E5E">//});</span>
     * for (MemberStatus memberStatus : memberStatusList) {
     *     ... = memberStatus.<span style="color: #DD4747">getVendorSynonymMemberList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br />
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<VendorSynonymMember> loadVendorSynonymMemberList(List<MemberStatus> memberStatusList, ConditionBeanSetupper<VendorSynonymMemberCB> setupper) {
        xassLRArg(memberStatusList, setupper);
        return doLoadVendorSynonymMemberList(memberStatusList, new LoadReferrerOption<VendorSynonymMemberCB, VendorSynonymMember>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<VendorSynonymMember> loadVendorSynonymMemberList(MemberStatus memberStatus, ConditionBeanSetupper<VendorSynonymMemberCB> setupper) {
        xassLRArg(memberStatus, setupper);
        return doLoadVendorSynonymMemberList(xnewLRLs(memberStatus), new LoadReferrerOption<VendorSynonymMemberCB, VendorSynonymMember>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<VendorSynonymMember> loadVendorSynonymMemberList(MemberStatus memberStatus, LoadReferrerOption<VendorSynonymMemberCB, VendorSynonymMember> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
        return loadVendorSynonymMemberList(xnewLRLs(memberStatus), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerLoader<VendorSynonymMember> loadVendorSynonymMemberList(List<MemberStatus> memberStatusList, LoadReferrerOption<VendorSynonymMemberCB, VendorSynonymMember> loadReferrerOption) {
        xassLRArg(memberStatusList, loadReferrerOption);
        if (memberStatusList.isEmpty()) { return (NestedReferrerLoader<VendorSynonymMember>)EMPTY_LOADER; }
        return doLoadVendorSynonymMemberList(memberStatusList, loadReferrerOption);
    }

    protected NestedReferrerLoader<VendorSynonymMember> doLoadVendorSynonymMemberList(List<MemberStatus> memberStatusList, LoadReferrerOption<VendorSynonymMemberCB, VendorSynonymMember> option) {
        final VendorSynonymMemberBhv referrerBhv = xgetBSFLR().select(VendorSynonymMemberBhv.class);
        return helpLoadReferrerInternally(memberStatusList, option, new InternalLoadReferrerCallback<MemberStatus, String, VendorSynonymMemberCB, VendorSynonymMember>() {
            public String getPKVal(MemberStatus et)
            { return et.getMemberStatusCode(); }
            ...
            public void qyFKIn(VendorSynonymMemberCB cb, List<String> ls)
            { cb.query().setMemberStatusCode_InScope(ls); }
            ...
            public List<VendorSynonymMember> selRfLs(VendorSynonymMemberCB cb) { return referrerBhv.selectList(cb); }
            public String getFKVal(VendorSynonymMember re) { return re.getMemberStatusCode(); }
     ...
     * @return The list of the column value. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<Long> extractDisplayOrderList(List<MemberStatus> memberStatusList) {
        return helpExtractListInternally(memberStatusList, new InternalExtractCallback<MemberStatus, Long>() {
            public Long getCV(MemberStatus et) { return et.getDisplayOrder(); }
        });
    }
    ...
    public List<String> extractMemberStatusNameList(List<MemberStatus> memberStatusList) {
        return helpExtractListInternally(memberStatusList, new InternalExtractCallback<MemberStatus, String>() {
            public String getCV(MemberStatus et) { return et.getMemberStatusName(); }
        });
    }
