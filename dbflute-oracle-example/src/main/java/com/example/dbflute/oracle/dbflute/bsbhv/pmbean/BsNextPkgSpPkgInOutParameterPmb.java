...
/**
 * The base class for procedure parameter-bean of NextPkgSpPkgInOutParameter. <br />
 * This is related to "<span style="color: #AD4747">NEXTEXAMPLEDB.NEXT_PKG.SP_PKG_IN_OUT_PARAMETER</span>".
 * @author oracleman
 */
public class BsNextPkgSpPkgInOutParameterPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of NextPkgSpPkgInOutParameter. <br />
     * This is related to "<span style="color: #AD4747">NEXTEXAMPLEDB.NEXT_PKG.SP_PKG_IN_OUT_PARAMETER</span>".
     */
    public BsNextPkgSpPkgInOutParameterPmb() {
    }
    ...
    public String getProcedureName() {
        return "NEXTEXAMPLEDB.NEXT_PKG.SP_PKG_IN_OUT_PARAMETER";
    }
