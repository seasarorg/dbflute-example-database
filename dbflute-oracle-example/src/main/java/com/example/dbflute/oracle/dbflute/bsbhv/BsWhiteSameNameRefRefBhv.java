...
public abstract class BsWhiteSameNameRefRefBhv extends AbstractBehaviorWritable {
    ...
    protected int facadeSelectCount(WhiteSameNameRefRefCB cb) {
    ...
    protected WhiteSameNameRefRef facadeSelectEntityWithDeletedCheck(WhiteSameNameRefRefCB cb) {
    ...
    protected <ENTITY extends WhiteSameNameRefRef> ENTITY doSelectByPK(Long refRefId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(refRefId), tp);
    }

    protected <ENTITY extends WhiteSameNameRefRef> OptionalEntity<ENTITY> doSelectOptionalByPK(Long refRefId, Class<ENTITY> tp) {
    ...
    protected ListResultBean<WhiteSameNameRefRef> facadeSelectList(WhiteSameNameRefRefCB cb) {
    ...
    protected PagingResultBean<WhiteSameNameRefRef> facadeSelectPage(WhiteSameNameRefRefCB cb) {
    ...
    protected void facadeSelectCursor(WhiteSameNameRefRefCB cb, EntityRowHandler<WhiteSameNameRefRef> entityRowHandler) {
    ...
    protected <RESULT> HpSLSFunction<WhiteSameNameRefRefCB, RESULT> facadeScalarSelect(Class<RESULT> resultType) {
        return doScalarSelect(resultType, newConditionBean());
    }

    protected <RESULT, CB extends WhiteSameNameRefRefCB> HpSLSFunction<CB, RESULT> doScalarSelect(final Class<RESULT> tp, final CB cb) {
    ...
    protected void doInsert(WhiteSameNameRefRef et, InsertOption<WhiteSameNameRefRefCB> op) {
        assertObjectNotNull("whiteSameNameRefRef", et); prepareInsertOption(op); delegateInsert(et, op);
    }
    ...
    protected void doUpdate(WhiteSameNameRefRef et, UpdateOption<WhiteSameNameRefRefCB> op) {
        assertObjectNotNull("whiteSameNameRefRef", et); prepareUpdateOption(op); helpUpdateInternally(et, op);
    }
    ...
    { WhiteSameNameRefRefCB cb = newConditionBean(); cb.xsetupForVaryingUpdate(); return cb; }

    protected WhiteSameNameRefRefCB createCBForSpecifiedUpdate()
    { WhiteSameNameRefRefCB cb = newConditionBean(); cb.xsetupForSpecifiedUpdate(); return cb; }
    ...
    protected void doInsertOrUpdate(WhiteSameNameRefRef et, InsertOption<WhiteSameNameRefRefCB> iop, UpdateOption<WhiteSameNameRefRefCB> uop) {
        assertObjectNotNull("whiteSameNameRefRef", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doDelete(WhiteSameNameRefRef et, final DeleteOption<WhiteSameNameRefRefCB> op) {
        assertObjectNotNull("whiteSameNameRefRef", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<WhiteSameNameRefRefCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int[] doBatchInsert(List<WhiteSameNameRefRef> ls, InsertOption<WhiteSameNameRefRefCB> op) {
        assertObjectNotNull("whiteSameNameRefRefList", ls);
        InsertOption<WhiteSameNameRefRefCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainInsertOption(); }
        prepareBatchInsertOption(ls, rlop); // required
        return delegateBatchInsert(ls, rlop);
    }

    protected void prepareBatchInsertOption(List<WhiteSameNameRefRef> ls, InsertOption<WhiteSameNameRefRefCB> op) {
    ...
    protected int[] doBatchUpdate(List<WhiteSameNameRefRef> ls, UpdateOption<WhiteSameNameRefRefCB> op) {
        assertObjectNotNull("whiteSameNameRefRefList", ls);
        UpdateOption<WhiteSameNameRefRefCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
        prepareBatchUpdateOption(ls, rlop); // required
        return delegateBatchUpdate(ls, rlop);
    }

    protected void prepareBatchUpdateOption(List<WhiteSameNameRefRef> ls, UpdateOption<WhiteSameNameRefRefCB> op) {
    ...
    protected int[] doBatchDelete(List<WhiteSameNameRefRef> ls, DeleteOption<WhiteSameNameRefRefCB> op) {
        assertObjectNotNull("whiteSameNameRefRefList", ls);
    ...
    protected int doQueryInsert(QueryInsertSetupper<WhiteSameNameRefRef, WhiteSameNameRefRefCB> sp, InsertOption<WhiteSameNameRefRefCB> op) {
        ...
        WhiteSameNameRefRef et = newEntity(); WhiteSameNameRefRefCB cb = createCBForQueryInsert();
        return delegateQueryInsert(et, cb, sp.setup(et, cb), op);
    }

    protected WhiteSameNameRefRefCB createCBForQueryInsert()
    { WhiteSameNameRefRefCB cb = newConditionBean(); cb.xsetupForQueryInsert(); return cb; }
    ...
    protected int doQueryUpdate(WhiteSameNameRefRef et, WhiteSameNameRefRefCB cb, UpdateOption<WhiteSameNameRefRefCB> op) {
        assertObjectNotNull("whiteSameNameRefRef", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<WhiteSameNameRefRef> typeOfSelectedEntity() { return WhiteSameNameRefRef.class; }
    protected WhiteSameNameRefRef downcast(Entity et) { return helpEntityDowncastInternally(et, WhiteSameNameRefRef.class); }
    protected WhiteSameNameRefRefCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, WhiteSameNameRefRefCB.class); }
    @SuppressWarnings("unchecked")
    protected List<WhiteSameNameRefRef> downcast(List<? extends Entity> ls) { return (List<WhiteSameNameRefRef>)ls; }
    @SuppressWarnings("unchecked")
    protected InsertOption<WhiteSameNameRefRefCB> downcast(InsertOption<? extends ConditionBean> op) { return (InsertOption<WhiteSameNameRefRefCB>)op; }
    @SuppressWarnings("unchecked")
    protected UpdateOption<WhiteSameNameRefRefCB> downcast(UpdateOption<? extends ConditionBean> op) { return (UpdateOption<WhiteSameNameRefRefCB>)op; }
    @SuppressWarnings("unchecked")
    protected DeleteOption<WhiteSameNameRefRefCB> downcast(DeleteOption<? extends ConditionBean> op) { return (DeleteOption<WhiteSameNameRefRefCB>)op; }
    @SuppressWarnings("unchecked")
