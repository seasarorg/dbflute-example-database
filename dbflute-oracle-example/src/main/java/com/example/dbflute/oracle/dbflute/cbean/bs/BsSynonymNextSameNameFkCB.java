...
public class BsSynonymNextSameNameFkCB extends AbstractConditionBean {
    ...
    public SynonymNextSameNameFkCQ getConditionQuery() { // public for parameter comment and internal
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;SynonymNextSameNameFkCB&gt;() {
     *     public void query(SynonymNextSameNameFkCB unionCB) {
     ...
     */
    public void union(UnionQuery<SynonymNextSameNameFkCB> unionQuery) {
        final SynonymNextSameNameFkCB cb = new SynonymNextSameNameFkCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;SynonymNextSameNameFkCB&gt;() {
     *     public void query(SynonymNextSameNameFkCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<SynonymNextSameNameFkCB> unionQuery) {
        final SynonymNextSameNameFkCB cb = new SynonymNextSameNameFkCB();
        cb.xsetupForUnion(this); xsyncUQ(cb); unionQuery.query(cb); xsaveUCB(cb);
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<SynonymNextSameNameFkCQ>() {
                public boolean has() { return true; }
                public SynonymNextSameNameFkCQ qy() { return getConditionQuery(); }
            }
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;SynonymNextSameNameFkCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;SynonymNextSameNameFkCB&gt;() {
     ...
     *     public void query(SynonymNextSameNameFkCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;SynonymNextSameNameFkCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<SynonymNextSameNameFkCB> andQuery) {
        xorSQAP((SynonymNextSameNameFkCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        ...
        specify().xsetSyncQyCall(new HpSpQyCall<SynonymNextSameNameFkCQ>() {
            public boolean has() { return true; }
            public SynonymNextSameNameFkCQ qy() { return cb.query(); }
        });
    }
    ...
    protected String getConditionBeanClassNameInternally() { return SynonymNextSameNameFkCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return SynonymNextSameNameFkCQ.class.getName(); }
