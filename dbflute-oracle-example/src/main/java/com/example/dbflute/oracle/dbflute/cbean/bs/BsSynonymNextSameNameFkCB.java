...
public class BsSynonymNextSameNameFkCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;SynonymNextSameNameFkCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;SynonymNextSameNameFkCB&gt;() {
     *     public void query(SynonymNextSameNameFkCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;SynonymNextSameNameFkCB&gt;() {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;SynonymNextSameNameFkCB&gt;() {
     ...
     *     public void query(SynonymNextSameNameFkCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;SynonymNextSameNameFkCB&gt;() {
