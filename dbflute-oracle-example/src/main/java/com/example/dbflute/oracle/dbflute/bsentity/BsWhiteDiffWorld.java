 ...
 * @author oracleman
 */
public abstract class BsWhiteDiffWorld implements Entity, Serializable, Cloneable {
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String dm = ", ";
        sb.append(dm).append(getDiffWorldId());
        sb.append(dm).append(getDiffWorldName());
    ...
    public void setDiffWorldName(String diffWorldName) {
        ...
        this._diffWorldName = diffWorldName;
    }
}
