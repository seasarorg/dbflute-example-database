...
public abstract class BsMemberSecurityBhv extends AbstractBehaviorWritable {
    ...
    protected MemberSecurity facadeSelectByPKValue(Long memberId) {
        return doSelectByPK(memberId, typeOfSelectedEntity());
    }

    protected <ENTITY extends MemberSecurity> ENTITY doSelectByPK(Long memberId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberId), tp);
    }

    protected <ENTITY extends MemberSecurity> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberId, Class<ENTITY> tp) {
    ...
    protected <ENTITY extends MemberSecurity> ENTITY doSelectByPKWithDeletedCheck(Long memberId, Class<ENTITY> tp) {
