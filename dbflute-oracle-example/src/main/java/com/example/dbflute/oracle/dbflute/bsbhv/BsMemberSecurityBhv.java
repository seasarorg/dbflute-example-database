...
public abstract class BsMemberSecurityBhv extends AbstractBehaviorWritable {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public MemberSecurity selectByPKValue(Long memberId) {
        return doSelectByPK(memberId, MemberSecurity.class);
    }

    protected <ENTITY extends MemberSecurity> ENTITY doSelectByPK(Long memberId, Class<ENTITY> entityType) {
        return doSelectEntity(xprepareCBAsPK(memberId), entityType);
    }

    protected <ENTITY extends MemberSecurity> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberId, Class<ENTITY> entityType) {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public MemberSecurity selectByPKValueWithDeletedCheck(Long memberId) {
        return doSelectByPKWithDeletedCheck(memberId, MemberSecurity.class);
    }

    protected <ENTITY extends MemberSecurity> ENTITY doSelectByPKWithDeletedCheck(Long memberId, Class<ENTITY> entityType) {
    ...
    public List<Long> extractMemberIdList(List<MemberSecurity> memberSecurityList) {
        return helpExtractListInternally(memberSecurityList, new InternalExtractCallback<MemberSecurity, Long>() {
            public Long getCV(MemberSecurity et) { return et.getMemberId(); }
        });
    }
