...
public abstract class BsMemberSecurityBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends MemberSecurity> ENTITY doSelectByPKValue(Long memberId, Class<ENTITY> entityType) {
    ...
    protected <ENTITY extends MemberSecurity> ENTITY doSelectByPKValueWithDeletedCheck(Long memberId, Class<ENTITY> entityType) {
        return doSelectEntityWithDeletedCheck(buildPKCB(memberId), entityType);
    }

    private MemberSecurityCB buildPKCB(Long memberId) {
