...
public class VendorCheckDecimalSumDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnDecimalDigitSum = cci("DECIMAL_DIGIT_SUM", "DECIMAL_DIGIT_SUM", null, null, java.math.BigDecimal.class, "decimalDigitSum", null, false, false, false, "NUMBER", 22, 0, null, false, null, null, null, null, null);

    /**
     * DECIMAL_DIGIT_SUM: {NUMBER(22)}
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.oracle.dbflute.exentity.customize.VendorCheckDecimalSum"; }
