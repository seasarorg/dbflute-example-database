...
public abstract class BsSynonymNextLinkTableBhv extends AbstractBehaviorWritable<SynonymNextLinkTable, SynonymNextLinkTableCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends SynonymNextLinkTable> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.oracle.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends SynonymNextLinkTable> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
