...
/**
 * The entity of SYNONYM_NEXT_LINK_SYNONYM as SYNONYM. <br />
 * <pre>
 * [primary-key]
 *     PRODUCT_ID
 * 
 ...
 * @author oracleman
 */
public abstract class BsSynonymNextLinkSynonym implements EntityDefinedCommonColumn, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSynonymNextLinkSynonym)) { return false; }
        BsSynonymNextLinkSynonym otherEntity = (BsSynonymNextLinkSynonym)other;
     ...
     */
    public SynonymNextLinkSynonym clone() {
        try {
            return (SynonymNextLinkSynonym)super.clone();
