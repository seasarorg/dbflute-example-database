...
public class MemberDbm extends AbstractDBMeta {
    ...
    public static class EpgRegisterDatetime implements PropertyGateway {
        ...
        public void write(Entity e, Object v) { ((Member)e).setRegisterDatetime((java.util.Date)v); }
    }
    ...
    public static class EpgUpdateDatetime implements PropertyGateway {
        ...
        public void write(Entity e, Object v) { ((Member)e).setUpdateDatetime((java.util.Date)v); }
    }
    ...
    public ForeignInfo foreignMemberLoginAsLatest() {
        ...
        return cfi("FK_MEMBER_MEMBER_LOGIN_LATEST", "memberLoginAsLatest", this, MemberLoginDbm.getInstance(), map, 2, true, true, false, true, "$$foreignAlias$$.LOGIN_DATETIME = (select max(LOGIN_DATETIME)\n                                     from MEMBER_LOGIN\n                                    where MEMBER_ID = $$localAlias$$.MEMBER_ID)", null, false, null);
    }
