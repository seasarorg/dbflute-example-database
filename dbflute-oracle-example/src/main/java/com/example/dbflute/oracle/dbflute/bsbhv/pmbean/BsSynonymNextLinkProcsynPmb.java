...
/**
 * The base class for procedure parameter-bean of SynonymNextLinkProcsyn. <br />
 * This is related to "<span style="color: #AD4747">SYNONYM_NEXT_LINK_PROCSYN</span>".
 * @author oracleman
 */
public class BsSynonymNextLinkProcsynPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of SynonymNextLinkProcsyn. <br />
     * This is related to "<span style="color: #AD4747">SYNONYM_NEXT_LINK_PROCSYN</span>".
     */
    public BsSynonymNextLinkProcsynPmb() {
    }
    ...
    public String getProcedureName() {
        return "SYNONYM_NEXT_LINK_PROCSYN";
    }
