...
public abstract class BsSynonymNextLinkSecretBhv extends AbstractBehaviorWritable<SynonymNextLinkSecret, SynonymNextLinkSecretCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends SynonymNextLinkSecret> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.oracle.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends SynonymNextLinkSecret> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
