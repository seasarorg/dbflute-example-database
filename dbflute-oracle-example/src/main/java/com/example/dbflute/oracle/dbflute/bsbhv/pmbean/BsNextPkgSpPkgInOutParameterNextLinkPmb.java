...
/**
 * The base class for procedure parameter-bean of NextPkgSpPkgInOutParameterNextLink. <br />
 * This is related to "<span style="color: #AD4747">NEXT_PKG.SP_PKG_IN_OUT_PARAMETER@NEXT_LINK</span>".
 * @author oracleman
 */
public class BsNextPkgSpPkgInOutParameterNextLinkPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of NextPkgSpPkgInOutParameterNextLink. <br />
     * This is related to "<span style="color: #AD4747">NEXT_PKG.SP_PKG_IN_OUT_PARAMETER@NEXT_LINK</span>".
     */
    public BsNextPkgSpPkgInOutParameterNextLinkPmb() {
    }
    ...
    public String getProcedureName() {
        return "NEXT_PKG.SP_PKG_IN_OUT_PARAMETER@NEXT_LINK";
    }
