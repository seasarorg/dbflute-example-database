...
/**
 * The base class for procedure parameter-bean of SynonymNextPkgProcedureNop. <br />
 * This is related to "<span style="color: #AD4747">SYNONYM_NEXT_PKG_PROCEDURE_NOP</span>".
 * @author oracleman
 */
public class BsSynonymNextPkgProcedureNopPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of SynonymNextPkgProcedureNop. <br />
     * This is related to "<span style="color: #AD4747">SYNONYM_NEXT_PKG_PROCEDURE_NOP</span>".
     */
    public BsSynonymNextPkgProcedureNopPmb() {
    }
    ...
    public String getProcedureName() {
        return "SYNONYM_NEXT_PKG_PROCEDURE_NOP";
    }
