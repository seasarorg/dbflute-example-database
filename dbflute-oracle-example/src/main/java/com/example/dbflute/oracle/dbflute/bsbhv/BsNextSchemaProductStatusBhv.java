...
public abstract class BsNextSchemaProductStatusBhv extends AbstractBehaviorWritable<NextSchemaProductStatus, NextSchemaProductStatusCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public NextSchemaProductStatusDbm getDBMeta() { return NextSchemaProductStatusDbm.getInstance(); }
    ...
    public OutsideSqlBasicExecutor<NextSchemaProductStatusBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<NextSchemaProductStatusBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends NextSchemaProductStatus> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.oracle.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends NextSchemaProductStatus> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
