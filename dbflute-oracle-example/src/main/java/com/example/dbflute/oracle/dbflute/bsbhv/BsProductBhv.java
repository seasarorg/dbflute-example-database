...
public abstract class BsProductBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends Product> ENTITY doSelectByPKValue(Long productId, Class<ENTITY> entityType) {
    ...
    protected <ENTITY extends Product> ENTITY doSelectByPKValueWithDeletedCheck(Long productId, Class<ENTITY> entityType) {
    ...
    public void loadPurchaseList(List<Product> productList, LoadReferrerOption<PurchaseCB, Purchase> loadReferrerOption) {
        ...
        helpLoadReferrerInternally(productList, loadReferrerOption, new InternalLoadReferrerCallback<Product, Long, PurchaseCB, Purchase>() {
