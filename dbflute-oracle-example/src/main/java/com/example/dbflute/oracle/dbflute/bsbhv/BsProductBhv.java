...
public abstract class BsProductBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends Product> ENTITY doSelectByPK(Long productId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(productId), tp);
    }

    protected <ENTITY extends Product> OptionalEntity<ENTITY> doSelectOptionalByPK(Long productId, Class<ENTITY> tp) {
