...
public abstract class BsProductBhv extends AbstractBehaviorWritable {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public Product selectByPKValue(Long productId) {
        return doSelectByPK(productId, Product.class);
    }

    protected <ENTITY extends Product> ENTITY doSelectByPK(Long productId, Class<ENTITY> entityType) {
        return doSelectEntity(xprepareCBAsPK(productId), entityType);
    }

    protected <ENTITY extends Product> OptionalEntity<ENTITY> doSelectOptionalByPK(Long productId, Class<ENTITY> entityType) {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public Product selectByPKValueWithDeletedCheck(Long productId) {
        return doSelectByPKWithDeletedCheck(productId, Product.class);
    }

    protected <ENTITY extends Product> ENTITY doSelectByPKWithDeletedCheck(Long productId, Class<ENTITY> entityType) {
        return doSelectEntityWithDeletedCheck(xprepareCBAsPK(productId), entityType);
    }

    protected ProductCB xprepareCBAsPK(Long productId) {
    ...
    protected NestedReferrerLoader<Purchase> doLoadPurchaseList(List<Product> productList, LoadReferrerOption<PurchaseCB, Purchase> option) {
        ...
        return helpLoadReferrerInternally(productList, option, new InternalLoadReferrerCallback<Product, Long, PurchaseCB, Purchase>() {
            public Long getPKVal(Product et)
            ...
            public Long getFKVal(Purchase re) { return re.getProductId(); }
     ...
     */
    public List<Long> extractProductIdList(List<Product> productList) {
        return helpExtractListInternally(productList, new InternalExtractCallback<Product, Long>() {
            public Long getCV(Product et) { return et.getProductId(); }
        });
    }
