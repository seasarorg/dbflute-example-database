...
public abstract class BsProductBhv extends AbstractBehaviorWritable<Product, ProductCB> {
    ...
    protected Product facadeSelectByPKValue(Long productId) {
        return doSelectByPK(productId, typeOfSelectedEntity());
    }

    protected <ENTITY extends Product> ENTITY doSelectByPK(Long productId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(productId), tp);
    }

    protected <ENTITY extends Product> OptionalEntity<ENTITY> doSelectOptionalByPK(Long productId, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends Product> ENTITY doSelectByPKWithDeletedCheck(Long productId, Class<ENTITY> tp) {
