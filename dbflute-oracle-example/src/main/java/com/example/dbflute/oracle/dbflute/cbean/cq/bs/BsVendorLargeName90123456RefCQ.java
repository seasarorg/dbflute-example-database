...
public class BsVendorLargeName90123456RefCQ extends AbstractBsVendorLargeName90123456RefCQ {
    ...
    public String keepVendorLargeName901234567Id_InScopeRelation_VendorLargeName901234567890(VendorLargeName901234567890CQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_vendorLargeName901234567Id_InScopeRelation_VendorLargeName901234567890Map.size() + 1);
        _vendorLargeName901234567Id_InScopeRelation_VendorLargeName901234567890Map.put(key, subQuery); return "vendorLargeName901234567Id_InScopeRelation_VendorLargeName901234567890." + key;
    }
    ...
    public String keepVendorLargeName901234567Id_NotInScopeRelation_VendorLargeName901234567890(VendorLargeName901234567890CQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_vendorLargeName901234567Id_NotInScopeRelation_VendorLargeName901234567890Map.size() + 1);
        _vendorLargeName901234567Id_NotInScopeRelation_VendorLargeName901234567890Map.put(key, subQuery); return "vendorLargeName901234567Id_NotInScopeRelation_VendorLargeName901234567890." + key;
    }
