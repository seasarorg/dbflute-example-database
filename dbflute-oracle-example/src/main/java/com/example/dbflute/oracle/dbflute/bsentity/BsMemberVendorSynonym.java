...
/**
 * The entity of (会員)MEMBER_VENDOR_SYNONYM as SYNONYM. <br />
 * 会員登録時にInsertされる。<br />
 * 物理削除されることはない
 * <pre>
 * [primary-key]
 ...
 * @author oracleman
 */
public abstract class BsMemberVendorSynonym extends AbstractEntity implements EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMemberVendorSynonym) {
            BsMemberVendorSynonym other = (BsMemberVendorSynonym)obj;
    ...
    protected String doBuildRelationString(String dm) {
        ...
        if (_synonymMemberWithdrawalAsOne != null) { sb.append(dm).append("synonymMemberWithdrawalAsOne"); }
    ...
    @Override
    public MemberVendorSynonym clone() {
        return (MemberVendorSynonym)super.clone();
    }
