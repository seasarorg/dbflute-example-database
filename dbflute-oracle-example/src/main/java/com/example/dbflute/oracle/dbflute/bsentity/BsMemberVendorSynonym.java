 ...
 * @author oracleman
 */
public abstract class BsMemberVendorSynonym implements EntityDefinedCommonColumn, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMemberVendorSynonym)) { return false; }
        BsMemberVendorSynonym otherEntity = (BsMemberVendorSynonym)other;
