...
public class BsVendorLargeName90123456RefCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;VendorLargeName90123456RefCB&gt;() {
    ...
    public void union(UnionQuery<VendorLargeName90123456RefCB> unionQuery) {
        final VendorLargeName90123456RefCB cb = new VendorLargeName90123456RefCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;VendorLargeName90123456RefCB&gt;() {
     *     public void query(VendorLargeName90123456RefCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">setupSelect_VendorLargeName901234567890()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * VendorLargeName90123456Ref vendorLargeName90123456Ref = vendorLargeName90123456RefBhv.selectEntityWithDeletedCheck(cb);
     * ... = vendorLargeName90123456Ref.<span style="color: #FD4747">getVendorLargeName901234567890()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;VendorLargeName90123456RefCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;VendorLargeName90123456RefCB&gt;() {
     ...
     *     public void query(VendorLargeName90123456RefCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;VendorLargeName90123456RefCB&gt;() {
