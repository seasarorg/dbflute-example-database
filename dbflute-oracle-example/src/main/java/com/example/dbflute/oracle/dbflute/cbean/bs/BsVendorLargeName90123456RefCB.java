...
public class BsVendorLargeName90123456RefCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public VendorLargeName90123456RefCB acceptPK(Long vendorLargeName90123RefId) {
        ...
        return (VendorLargeName90123456RefCB)this;
    }
    ...
    public HpColQyOperand<VendorLargeName90123456RefCB> columnQuery(final SpecifyQuery<VendorLargeName90123456RefCB> leftSpecifyQuery) {
        return xcreateColQyOperand(new HpColQyHandler<VendorLargeName90123456RefCB>() {
