...
public abstract class BsMemberWithdrawalBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends MemberWithdrawal> ENTITY doSelectByPK(Long memberId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberId), tp);
    }

    protected <ENTITY extends MemberWithdrawal> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberId, Class<ENTITY> tp) {
