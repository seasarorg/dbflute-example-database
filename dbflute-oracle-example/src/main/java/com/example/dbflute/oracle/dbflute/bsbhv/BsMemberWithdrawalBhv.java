...
public abstract class BsMemberWithdrawalBhv extends AbstractBehaviorWritable {
    ...
    public List<Long> extractMemberIdList(List<MemberWithdrawal> memberWithdrawalList) {
        return helpExtractListInternally(memberWithdrawalList, new InternalExtractCallback<MemberWithdrawal, Long>() {
            public Long getCV(MemberWithdrawal et) { return et.getMemberId(); }
        });
    }
