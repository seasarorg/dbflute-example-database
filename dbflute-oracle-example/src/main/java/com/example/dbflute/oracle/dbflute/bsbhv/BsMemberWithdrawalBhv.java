...
public abstract class BsMemberWithdrawalBhv extends AbstractBehaviorWritable<MemberWithdrawal, MemberWithdrawalCB> {
    ...
    protected MemberWithdrawal facadeSelectByPKValue(Long memberId) {
        return doSelectByPK(memberId, typeOfSelectedEntity());
    }

    protected <ENTITY extends MemberWithdrawal> ENTITY doSelectByPK(Long memberId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberId), tp);
    }

    protected <ENTITY extends MemberWithdrawal> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberId, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MemberWithdrawal> ENTITY doSelectByPKWithDeletedCheck(Long memberId, Class<ENTITY> tp) {
     ...
     */
    public List<Long> extractMemberIdList(List<MemberWithdrawal> memberWithdrawalList)
