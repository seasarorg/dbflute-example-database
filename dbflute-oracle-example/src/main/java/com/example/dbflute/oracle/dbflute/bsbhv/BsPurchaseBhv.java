...
public abstract class BsPurchaseBhv extends AbstractBehaviorWritable<Purchase, PurchaseCB> {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<Purchase> selectByUniqueOf(Long memberId, Long productId, java.sql.Timestamp purchaseDatetime) {
        return facadeSelectByUniqueOf(memberId, productId, purchaseDatetime);
    }

    protected OptionalEntity<Purchase> facadeSelectByUniqueOf(Long memberId, Long productId, java.sql.Timestamp purchaseDatetime) {
        return doSelectByUniqueOf(memberId, productId, purchaseDatetime, typeOfSelectedEntity());
    }

    protected <ENTITY extends Purchase> OptionalEntity<ENTITY> doSelectByUniqueOf(Long memberId, Long productId, java.sql.Timestamp purchaseDatetime, Class<? extends ENTITY> tp) {
    ...
    protected PurchaseCB xprepareCBAsUniqueOf(Long memberId, Long productId, java.sql.Timestamp purchaseDatetime) {
