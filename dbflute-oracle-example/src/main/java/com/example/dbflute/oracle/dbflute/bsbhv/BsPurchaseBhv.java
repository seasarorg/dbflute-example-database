...
public abstract class BsPurchaseBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends Purchase> OptionalEntity<ENTITY> doSelectByUniqueOf(Long memberId, Long productId, java.sql.Timestamp purchaseDatetime, Class<ENTITY> tp) {
