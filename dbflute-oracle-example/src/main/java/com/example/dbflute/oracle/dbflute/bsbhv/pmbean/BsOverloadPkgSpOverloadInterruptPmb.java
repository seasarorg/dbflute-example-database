...
/**
 * The base class for procedure parameter-bean of OverloadPkgSpOverloadInterrupt. <br />
 * This is related to "<span style="color: #AD4747">OVERLOAD_PKG.SP_OVERLOAD_INTERRUPT</span>".
 * @author oracleman
 */
public class BsOverloadPkgSpOverloadInterruptPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of OverloadPkgSpOverloadInterrupt. <br />
     * This is related to "<span style="color: #AD4747">OVERLOAD_PKG.SP_OVERLOAD_INTERRUPT</span>".
     */
    public BsOverloadPkgSpOverloadInterruptPmb() {
    }
    ...
    public String getProcedureName() {
        return "OVERLOAD_PKG.SP_OVERLOAD_INTERRUPT";
    }
