...
/**
 * The entity of SpResultSetParameterWithCurMember. <br />
 * <pre>
 * [primary-key]
 *     
 * 
 ...
 * @author oracleman
 */
public abstract class BsSpResultSetParameterWithCurMember implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.oracle.dbflute.bsentity.customize.dbmeta.SpResultSetParameterWithCurMemberDbm.getInstance();
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsSpResultSetParameterWithCurMember)) { return false; }
        BsSpResultSetParameterWithCurMember other = (BsSpResultSetParameterWithCurMember)obj;
     ...
     */
    public SpResultSetParameterWithCurMember clone() {
        try {
            return (SpResultSetParameterWithCurMember)super.clone();
