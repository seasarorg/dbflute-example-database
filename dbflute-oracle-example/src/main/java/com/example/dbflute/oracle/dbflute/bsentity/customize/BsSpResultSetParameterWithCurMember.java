...
public abstract class BsSpResultSetParameterWithCurMember implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSpResultSetParameterWithCurMember)) { return false; }
        BsSpResultSetParameterWithCurMember otherEntity = (BsSpResultSetParameterWithCurMember)other;
