 ...
 * @author oracleman
 */
public abstract class BsSpResultSetParameterWithCurMember extends AbstractEntity implements CustomizeEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSpResultSetParameterWithCurMember) {
