...
public abstract class BsWhiteRefNextExceptBhv extends AbstractBehaviorWritable<WhiteRefNextExcept, WhiteRefNextExceptCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteRefNextExcept> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.oracle.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteRefNextExcept> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
