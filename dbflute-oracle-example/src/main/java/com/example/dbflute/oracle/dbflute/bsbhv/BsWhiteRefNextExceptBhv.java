...
public abstract class BsWhiteRefNextExceptBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends WhiteRefNextExcept> ENTITY doSelectEntity(final WhiteRefNextExceptCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends WhiteRefNextExcept> ENTITY doSelectEntityWithDeletedCheck(final WhiteRefNextExceptCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends WhiteRefNextExcept> ListResultBean<ENTITY> doSelectList(WhiteRefNextExceptCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectListInternally(cb, tp, new InternalSelectListCallback<ENTITY, WhiteRefNextExceptCB>() {
            public List<ENTITY> callbackSelectList(WhiteRefNextExceptCB cb, Class<ENTITY> tp) { return delegateSelectList(cb, tp); } });
    }
