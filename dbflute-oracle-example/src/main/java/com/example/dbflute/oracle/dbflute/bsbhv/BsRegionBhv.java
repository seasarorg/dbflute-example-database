...
public abstract class BsRegionBhv extends AbstractBehaviorWritable {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public Region selectByPKValue(java.math.BigDecimal regionId) {
        return doSelectByPK(regionId, Region.class);
    }

    protected <ENTITY extends Region> ENTITY doSelectByPK(java.math.BigDecimal regionId, Class<ENTITY> entityType) {
        return doSelectEntity(xprepareCBAsPK(regionId), entityType);
    }

    protected <ENTITY extends Region> OptionalEntity<ENTITY> doSelectOptionalByPK(java.math.BigDecimal regionId, Class<ENTITY> entityType) {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public Region selectByPKValueWithDeletedCheck(java.math.BigDecimal regionId) {
        return doSelectByPKWithDeletedCheck(regionId, Region.class);
    }

    protected <ENTITY extends Region> ENTITY doSelectByPKWithDeletedCheck(java.math.BigDecimal regionId, Class<ENTITY> entityType) {
        return doSelectEntityWithDeletedCheck(xprepareCBAsPK(regionId), entityType);
    }

    protected RegionCB xprepareCBAsPK(java.math.BigDecimal regionId) {
    ...
    protected NestedReferrerLoader<MemberAddress> doLoadMemberAddressList(List<Region> regionList, LoadReferrerOption<MemberAddressCB, MemberAddress> option) {
        ...
        return helpLoadReferrerInternally(regionList, option, new InternalLoadReferrerCallback<Region, java.math.BigDecimal, MemberAddressCB, MemberAddress>() {
            public java.math.BigDecimal getPKVal(Region et)
            ...
            public void qyFKIn(MemberAddressCB cb, List<java.math.BigDecimal> ls)
            ...
            public java.math.BigDecimal getFKVal(MemberAddress re) { return re.getRegionId(); }
    ...
    public List<java.math.BigDecimal> extractRegionIdList(List<Region> regionList) {
        return helpExtractListInternally(regionList, new InternalExtractCallback<Region, java.math.BigDecimal>() {
            public java.math.BigDecimal getCV(Region et) { return et.getRegionId(); }
        });
    }
