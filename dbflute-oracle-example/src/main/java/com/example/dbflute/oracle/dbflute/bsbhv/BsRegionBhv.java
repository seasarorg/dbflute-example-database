...
public abstract class BsRegionBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends Region> ENTITY doSelectByPK(java.math.BigDecimal regionId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(regionId), tp);
    }

    protected <ENTITY extends Region> OptionalEntity<ENTITY> doSelectOptionalByPK(java.math.BigDecimal regionId, Class<ENTITY> tp) {
