...
public abstract class BsRegionBhv extends AbstractBehaviorWritable<Region, RegionCB> {
    ...
    protected Region facadeSelectByPKValue(java.math.BigDecimal regionId) {
        return doSelectByPK(regionId, typeOfSelectedEntity());
    }

    protected <ENTITY extends Region> ENTITY doSelectByPK(java.math.BigDecimal regionId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(regionId), tp);
    }

    protected <ENTITY extends Region> OptionalEntity<ENTITY> doSelectOptionalByPK(java.math.BigDecimal regionId, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends Region> ENTITY doSelectByPKWithDeletedCheck(java.math.BigDecimal regionId, Class<ENTITY> tp) {
