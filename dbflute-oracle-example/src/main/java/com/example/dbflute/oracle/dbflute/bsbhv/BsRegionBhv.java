...
public abstract class BsRegionBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends Region> ENTITY doSelectByPKValue(java.math.BigDecimal regionId, Class<ENTITY> entityType) {
    ...
    protected <ENTITY extends Region> ENTITY doSelectByPKValueWithDeletedCheck(java.math.BigDecimal regionId, Class<ENTITY> entityType) {
        return doSelectEntityWithDeletedCheck(buildPKCB(regionId), entityType);
    }

    private RegionCB buildPKCB(java.math.BigDecimal regionId) {
    ...
    public void loadMemberAddressList(List<Region> regionList, LoadReferrerOption<MemberAddressCB, MemberAddress> loadReferrerOption) {
        ...
        helpLoadReferrerInternally(regionList, loadReferrerOption, new InternalLoadReferrerCallback<Region, java.math.BigDecimal, MemberAddressCB, MemberAddress>() {
