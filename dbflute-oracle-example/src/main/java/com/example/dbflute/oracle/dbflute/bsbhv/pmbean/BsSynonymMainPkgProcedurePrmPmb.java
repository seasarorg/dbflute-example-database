...
/**
 * The base class for procedure parameter-bean of SynonymMainPkgProcedurePrm. <br />
 * This is related to "<span style="color: #AD4747">SYNONYM_MAIN_PKG_PROCEDURE_PRM</span>".
 * @author oracleman
 */
public class BsSynonymMainPkgProcedurePrmPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of SynonymMainPkgProcedurePrm. <br />
     * This is related to "<span style="color: #AD4747">SYNONYM_MAIN_PKG_PROCEDURE_PRM</span>".
     */
    public BsSynonymMainPkgProcedurePrmPmb() {
    }
    ...
    public String getProcedureName() {
        return "SYNONYM_MAIN_PKG_PROCEDURE_PRM";
    }
