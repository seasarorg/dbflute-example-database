...
public class BsWhiteRefNextTargetCQ extends AbstractBsWhiteRefNextTargetCQ {
    ...
    public String keepNextTargetCode_InScopeRelation_NextSchemaProductStatus(NextSchemaProductStatusCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_nextTargetCode_InScopeRelation_NextSchemaProductStatusMap.size() + 1);
        _nextTargetCode_InScopeRelation_NextSchemaProductStatusMap.put(key, subQuery); return "nextTargetCode_InScopeRelation_NextSchemaProductStatus." + key;
    }
    ...
    public String keepNextTargetCode_NotInScopeRelation_NextSchemaProductStatus(NextSchemaProductStatusCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_nextTargetCode_NotInScopeRelation_NextSchemaProductStatusMap.size() + 1);
        _nextTargetCode_NotInScopeRelation_NextSchemaProductStatusMap.put(key, subQuery); return "nextTargetCode_NotInScopeRelation_NextSchemaProductStatus." + key;
    }
    ...
    protected void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
        WhiteRefNextTargetCQ baseQuery = (WhiteRefNextTargetCQ)baseQueryAsSuper;
        WhiteRefNextTargetCQ unionQuery = (WhiteRefNextTargetCQ)unionQueryAsSuper;
    ...
    public String keepScalarCondition(WhiteRefNextTargetCQ subQuery) {
    ...
    public String keepSpecifyMyselfDerived(WhiteRefNextTargetCQ subQuery) {
    ...
    public String keepQueryMyselfDerived(WhiteRefNextTargetCQ subQuery) {
    ...
    public String keepMyselfExists(WhiteRefNextTargetCQ subQuery) {
    ...
    public String keepMyselfInScope(WhiteRefNextTargetCQ subQuery) {
