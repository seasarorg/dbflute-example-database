...
public abstract class BsSynonymNextSameNameFkBhv extends AbstractBehaviorWritable<SynonymNextSameNameFk, SynonymNextSameNameFkCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public SynonymNextSameNameFkDbm getDBMeta() { return SynonymNextSameNameFkDbm.getInstance(); }
    ...
    public OutsideSqlBasicExecutor<SynonymNextSameNameFkBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<SynonymNextSameNameFkBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends SynonymNextSameNameFk> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.oracle.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends SynonymNextSameNameFk> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
