...
public abstract class BsMemberBhv extends AbstractBehaviorWritable {
    ...
    public static final String PATH_various_pmbcheck_selectCompareDate = "various:pmbcheck:selectCompareDate";
     ...
     * @param memberId (会員ID): PK, NotNull, NUMBER(16), FK to MEMBER_ADDRESS. (NotNull)
     * @return The entity selected by the PK. (NullAllowed: if no data, it returns null)
     * @exception EntityDuplicatedException When the entity has been duplicated.
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public Member selectByPKValue(Long memberId) {
        return doSelectByPK(memberId, Member.class);
    }

    protected <ENTITY extends Member> ENTITY doSelectByPK(Long memberId, Class<ENTITY> entityType) {
        return doSelectEntity(xprepareCBAsPK(memberId), entityType);
    }

    protected <ENTITY extends Member> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberId, Class<ENTITY> entityType) {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public Member selectByPKValueWithDeletedCheck(Long memberId) {
        return doSelectByPKWithDeletedCheck(memberId, Member.class);
    }

    protected <ENTITY extends Member> ENTITY doSelectByPKWithDeletedCheck(Long memberId, Class<ENTITY> entityType) {
    ...
    protected NestedReferrerLoader<MemberAddress> doLoadMemberAddressList(List<Member> memberList, LoadReferrerOption<MemberAddressCB, MemberAddress> option) {
        ...
        return helpLoadReferrerInternally(memberList, option, new InternalLoadReferrerCallback<Member, Long, MemberAddressCB, MemberAddress>() {
            public Long getPKVal(Member et)
            ...
            public void qyFKIn(MemberAddressCB cb, List<Long> ls)
            ...
            public Long getFKVal(MemberAddress re) { return re.getMemberId(); }
    ...
    protected NestedReferrerLoader<MemberLogin> doLoadMemberLoginList(List<Member> memberList, LoadReferrerOption<MemberLoginCB, MemberLogin> option) {
        ...
        return helpLoadReferrerInternally(memberList, option, new InternalLoadReferrerCallback<Member, Long, MemberLoginCB, MemberLogin>() {
            public Long getPKVal(Member et)
            { return et.getMemberId(); }
            ...
            public void qyFKIn(MemberLoginCB cb, List<Long> ls)
            { cb.query().setMemberId_InScope(ls); }
            ...
            public Long getFKVal(MemberLogin re) { return re.getMemberId(); }
    ...
    protected NestedReferrerLoader<Purchase> doLoadPurchaseList(List<Member> memberList, LoadReferrerOption<PurchaseCB, Purchase> option) {
        ...
        return helpLoadReferrerInternally(memberList, option, new InternalLoadReferrerCallback<Member, Long, PurchaseCB, Purchase>() {
            public Long getPKVal(Member et)
            { return et.getMemberId(); }
            ...
            public void qyFKIn(PurchaseCB cb, List<Long> ls)
            { cb.query().setMemberId_InScope(ls); }
            ...
            public Long getFKVal(Purchase re) { return re.getMemberId(); }
    ...
    public List<Long> extractMemberIdList(List<Member> memberList) {
        return helpExtractListInternally(memberList, new InternalExtractCallback<Member, Long>() {
            public Long getCV(Member et) { return et.getMemberId(); }
        });
    }
