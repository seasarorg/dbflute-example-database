...
public abstract class BsMemberBhv extends AbstractBehaviorWritable {
    ...
    public void loadMemberAddressList(List<Member> memberList, LoadReferrerOption<MemberAddressCB, MemberAddress> loadReferrerOption) {
        ...
        helpLoadReferrerInternally(memberList, loadReferrerOption, new InternalLoadReferrerCallback<Member, Long, MemberAddressCB, MemberAddress>() {
            ...
            public Long getFKVal(MemberAddress e) { return e.getMemberId(); }
    ...
    public void loadMemberLoginList(List<Member> memberList, LoadReferrerOption<MemberLoginCB, MemberLogin> loadReferrerOption) {
        ...
        helpLoadReferrerInternally(memberList, loadReferrerOption, new InternalLoadReferrerCallback<Member, Long, MemberLoginCB, MemberLogin>() {
            ...
            public Long getFKVal(MemberLogin e) { return e.getMemberId(); }
    ...
    public void loadPurchaseList(List<Member> memberList, LoadReferrerOption<PurchaseCB, Purchase> loadReferrerOption) {
        ...
        helpLoadReferrerInternally(memberList, loadReferrerOption, new InternalLoadReferrerCallback<Member, Long, PurchaseCB, Purchase>() {
            ...
            public Long getFKVal(Purchase e) { return e.getMemberId(); }
    ...
    public List<Long> extractMemberIdList(List<Member> memberList) {
        return helpExtractListInternally(memberList, new InternalExtractCallback<Member, Long>() {
            public Long getCV(Member e) { return e.getMemberId(); }
        });
    }
