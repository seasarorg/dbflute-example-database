 ...
 * @author oracleman
 */
public abstract class BsVendorSynonymMember implements EntityDefinedCommonColumn, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsVendorSynonymMember)) { return false; }
        BsVendorSynonymMember otherEntity = (BsVendorSynonymMember)other;
