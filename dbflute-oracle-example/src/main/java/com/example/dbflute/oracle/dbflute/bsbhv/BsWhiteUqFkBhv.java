...
public abstract class BsWhiteUqFkBhv extends AbstractBehaviorWritable {
    ...
    protected void doInsert(WhiteUqFk et, InsertOption<WhiteUqFkCB> op) {
        assertObjectNotNull("whiteUqFk", et); prepareInsertOption(op); delegateInsert(et, op);
    }
    ...
    protected void doUpdate(WhiteUqFk et, UpdateOption<WhiteUqFkCB> op) {
        assertObjectNotNull("whiteUqFk", et); prepareUpdateOption(op); helpUpdateInternally(et, op);
    }
    ...
    protected void doInsertOrUpdate(WhiteUqFk et, InsertOption<WhiteUqFkCB> iop, UpdateOption<WhiteUqFkCB> uop) {
        assertObjectNotNull("whiteUqFk", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doDelete(WhiteUqFk et, final DeleteOption<WhiteUqFkCB> op) {
        assertObjectNotNull("whiteUqFk", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<WhiteUqFkCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int doQueryInsert(QueryInsertSetupper<WhiteUqFk, WhiteUqFkCB> sp, InsertOption<WhiteUqFkCB> op) {
        ...
        WhiteUqFk et = newEntity(); WhiteUqFkCB cb = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(WhiteUqFk et, WhiteUqFkCB cb, UpdateOption<WhiteUqFkCB> op) {
        assertObjectNotNull("whiteUqFk", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<WhiteUqFk> typeOfSelectedEntity() { return WhiteUqFk.class; }
    protected WhiteUqFk downcast(Entity et) { return helpEntityDowncastInternally(et, WhiteUqFk.class); }
    protected WhiteUqFkCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, WhiteUqFkCB.class); }
    @SuppressWarnings("unchecked")
    protected List<WhiteUqFk> downcast(List<? extends Entity> ls) { return (List<WhiteUqFk>)ls; }
    @SuppressWarnings("unchecked")
