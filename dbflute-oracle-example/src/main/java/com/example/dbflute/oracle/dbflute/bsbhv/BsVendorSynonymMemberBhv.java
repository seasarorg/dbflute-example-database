...
public abstract class BsVendorSynonymMemberBhv extends AbstractBehaviorWritable<VendorSynonymMember, VendorSynonymMemberCB> {
    ...
    protected <ENTITY extends VendorSynonymMember> ENTITY doSelectByPK(Long memberId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberId), tp);
    }

    protected <ENTITY extends VendorSynonymMember> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberId, Class<? extends ENTITY> tp) {
    ...
    public OutsideSqlBasicExecutor<VendorSynonymMemberBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<VendorSynonymMemberBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends VendorSynonymMember> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.oracle.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends VendorSynonymMember> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
