...
/**
 * The base class for procedure parameter-bean of SamePkgSpPkgInOutParameter. <br />
 * This is related to "<span style="color: #AD4747">SAME_PKG.SP_PKG_IN_OUT_PARAMETER</span>".
 * @author oracleman
 */
public class BsSamePkgSpPkgInOutParameterPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of SamePkgSpPkgInOutParameter. <br />
     * This is related to "<span style="color: #AD4747">SAME_PKG.SP_PKG_IN_OUT_PARAMETER</span>".
     */
    public BsSamePkgSpPkgInOutParameterPmb() {
    }
    ...
    public String getProcedureName() {
        return "SAME_PKG.SP_PKG_IN_OUT_PARAMETER";
    }
