...
public abstract class BsMemberAddressBhv extends AbstractBehaviorWritable<MemberAddress, MemberAddressCB> {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public MemberAddress selectByPKValue(Long memberAddressId) {
        return facadeSelectByPKValue(memberAddressId);
    }

    protected MemberAddress facadeSelectByPKValue(Long memberAddressId) {
        return doSelectByPK(memberAddressId, typeOfSelectedEntity());
    }

    protected <ENTITY extends MemberAddress> ENTITY doSelectByPK(Long memberAddressId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberAddressId), tp);
    }

    protected <ENTITY extends MemberAddress> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberAddressId, Class<? extends ENTITY> tp) {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public MemberAddress selectByPKValueWithDeletedCheck(Long memberAddressId) {
        return doSelectByPKWithDeletedCheck(memberAddressId, typeOfSelectedEntity());
    }

    protected <ENTITY extends MemberAddress> ENTITY doSelectByPKWithDeletedCheck(Long memberAddressId, Class<ENTITY> tp) {
        return doSelectEntityWithDeletedCheck(xprepareCBAsPK(memberAddressId), tp);
    }

    protected MemberAddressCB xprepareCBAsPK(Long memberAddressId) {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<MemberAddress> selectByUniqueOf(Long memberId, java.util.Date validBeginDate) {
        return facadeSelectByUniqueOf(memberId, validBeginDate);
    }

    protected OptionalEntity<MemberAddress> facadeSelectByUniqueOf(Long memberId, java.util.Date validBeginDate) {
        return doSelectByUniqueOf(memberId, validBeginDate, typeOfSelectedEntity());
    }

    protected <ENTITY extends MemberAddress> OptionalEntity<ENTITY> doSelectByUniqueOf(Long memberId, java.util.Date validBeginDate, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(memberId, validBeginDate), tp), memberId, validBeginDate);
    }

    protected MemberAddressCB xprepareCBAsUniqueOf(Long memberId, java.util.Date validBeginDate) {
     ...
     */
    public List<Long> extractMemberAddressIdList(List<MemberAddress> memberAddressList)
