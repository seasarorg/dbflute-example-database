...
public abstract class BsMemberAddressBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends MemberAddress> ENTITY doSelectByPK(Long memberAddressId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberAddressId), tp);
    }

    protected <ENTITY extends MemberAddress> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberAddressId, Class<ENTITY> tp) {
    ...
    protected <ENTITY extends MemberAddress> OptionalEntity<ENTITY> doSelectByUniqueOf(Long memberId, java.util.Date validBeginDate, Class<ENTITY> tp) {
