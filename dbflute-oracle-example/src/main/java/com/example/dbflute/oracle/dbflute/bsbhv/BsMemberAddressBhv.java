...
public abstract class BsMemberAddressBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends MemberAddress> ENTITY doSelectByPK(Long memberAddressId, Class<ENTITY> entityType) {
        return doSelectEntity(xprepareCBAsPK(memberAddressId), entityType);
    }

    protected <ENTITY extends MemberAddress> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberAddressId, Class<ENTITY> entityType) {
    ...
    protected <ENTITY extends MemberAddress> ENTITY doSelectByPKWithDeletedCheck(Long memberAddressId, Class<ENTITY> entityType) {
    ...
    protected <ENTITY extends MemberAddress> OptionalEntity<ENTITY> doSelectByUniqueOf(Long memberId, java.util.Date validBeginDate, Class<ENTITY> entityType) {
    ...
    public List<Long> extractMemberAddressIdList(List<MemberAddress> memberAddressList) {
        return helpExtractListInternally(memberAddressList, new InternalExtractCallback<MemberAddress, Long>() {
            public Long getCV(MemberAddress et) { return et.getMemberAddressId(); }
        });
    }
