...
public abstract class BsMemberAddressBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends MemberAddress> ENTITY doSelectByPKValue(Long memberAddressId, Class<ENTITY> entityType) {
    ...
    protected <ENTITY extends MemberAddress> ENTITY doSelectByPKValueWithDeletedCheck(Long memberAddressId, Class<ENTITY> entityType) {
        return doSelectEntityWithDeletedCheck(buildPKCB(memberAddressId), entityType);
    }

    private MemberAddressCB buildPKCB(Long memberAddressId) {
