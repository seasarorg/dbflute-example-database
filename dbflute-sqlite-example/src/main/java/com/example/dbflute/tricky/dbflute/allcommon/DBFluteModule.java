...
public class DBFluteModule extends AbstractModule {
    ...
    protected DBFluteInitializer createDBFluteInitializer() {
        return new com.example.dbflute.tricky.dbflute.allcommon.DBFluteInitializer();
    }
    ...
    protected ImplementedInvokerAssistant createImplementedInvokerAssistant() {
        ImplementedInvokerAssistant invokerAssistant = new com.example.dbflute.tricky.dbflute.nogen.ExtendedInvokerAssistant();
    ...
    protected ImplementedCommonColumnAutoSetupper createImplementedCommonColumnAutoSetupper() {
        return new com.example.dbflute.tricky.dbflute.allcommon.ImplementedCommonColumnAutoSetupper();
    }
