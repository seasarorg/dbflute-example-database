...
public class ServiceRankDbm extends AbstractDBMeta {
    ...
    public static class EpgServicePointIncidence implements PropertyGateway {
        ...
        public void write(Entity e, Object v) { ((ServiceRank)e).setServicePointIncidence((String)v); }
    }
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnServiceRankCode = cci("SERVICE_RANK_CODE", "SERVICE_RANK_CODE", null, null, true, "serviceRankCode", String.class, true, false, "TEXT", 2000000000, 10, null, false, null, null, null, "memberServiceList", null);
    protected final ColumnInfo _columnServiceRankName = cci("SERVICE_RANK_NAME", "SERVICE_RANK_NAME", null, null, true, "serviceRankName", String.class, false, false, "TEXT", 2000000000, 10, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnServicePointIncidence = cci("SERVICE_POINT_INCIDENCE", "SERVICE_POINT_INCIDENCE", null, null, true, "servicePointIncidence", String.class, false, false, "REAL", 2000000000, 10, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnNewAcceptableFlg = cci("NEW_ACCEPTABLE_FLG", "NEW_ACCEPTABLE_FLG", null, null, true, "newAcceptableFlg", Integer.class, false, false, "INTEGER", 2000000000, 10, null, false, null, null, null, null, CDef.DefMeta.Flg);
    protected final ColumnInfo _columnDescription = cci("DESCRIPTION", "DESCRIPTION", null, null, true, "description", String.class, false, false, "TEXT", 2000000000, 10, null, false, null, null, null, null, null);
    ...
    public ReferrerInfo referrerMemberServiceList() {
        ...
        return cri("FK_MEMBER_SERVICE_SERVICE_RANK_CODE_SERVICE_RANK", "memberServiceList", this, MemberServiceDbm.getInstance(), map, false, "serviceRank");
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.tricky.dbflute.exentity.ServiceRank"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.tricky.dbflute.cbean.ServiceRankCB"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.tricky.dbflute.exbhv.ServiceRankBhv"; }
