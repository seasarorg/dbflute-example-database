...
public class MemberAddressDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnValidBeginDate = cci("VALID_BEGIN_DATE", "VALID_BEGIN_DATE", null, null, java.util.Date.class, "validBeginDate", null, false, false, true, "DATE", 2000000000, 10, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnValidEndDate = cci("VALID_END_DATE", "VALID_END_DATE", null, null, java.util.Date.class, "validEndDate", null, false, false, true, "DATE", 2000000000, 10, null, false, null, null, null, null, null);
    ...
    public ForeignInfo foreignMember() {
        ...
        return cfi("FK_MEMBER_ADDRESS_MEMBER_ID_MEMBER", "member", this, MemberDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "memberAddressList");
    }
    /**
    ...
    public ForeignInfo foreignRegion() {
        ...
        return cfi("FK_MEMBER_ADDRESS_REGION_ID_REGION", "region", this, RegionDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "memberAddressList");
    }
