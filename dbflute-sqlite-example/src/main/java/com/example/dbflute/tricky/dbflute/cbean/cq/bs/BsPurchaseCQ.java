...
public class BsPurchaseCQ extends AbstractBsPurchaseCQ {
    ...
    public ConditionValue getPurchaseRegisterDatetime() {
        if (_purchaseRegisterDatetime == null) { _purchaseRegisterDatetime = nCV(); }
        return _purchaseRegisterDatetime;
    }
    protected ConditionValue getCValuePurchaseRegisterDatetime() { return getPurchaseRegisterDatetime(); }
    ...
    public ConditionValue getPurchaseRegisterUser() {
        if (_purchaseRegisterUser == null) { _purchaseRegisterUser = nCV(); }
        return _purchaseRegisterUser;
    }
    protected ConditionValue getCValuePurchaseRegisterUser() { return getPurchaseRegisterUser(); }
    ...
    public ConditionValue getPurchaseRegisterProcess() {
        if (_purchaseRegisterProcess == null) { _purchaseRegisterProcess = nCV(); }
        return _purchaseRegisterProcess;
    }
    protected ConditionValue getCValuePurchaseRegisterProcess() { return getPurchaseRegisterProcess(); }
    ...
    public ConditionValue getPurchaseUpdateDatetime() {
        if (_purchaseUpdateDatetime == null) { _purchaseUpdateDatetime = nCV(); }
        return _purchaseUpdateDatetime;
    }
    protected ConditionValue getCValuePurchaseUpdateDatetime() { return getPurchaseUpdateDatetime(); }
    ...
    public ConditionValue getPurchaseUpdateUser() {
        if (_purchaseUpdateUser == null) { _purchaseUpdateUser = nCV(); }
        return _purchaseUpdateUser;
    }
    protected ConditionValue getCValuePurchaseUpdateUser() { return getPurchaseUpdateUser(); }
    ...
    public ConditionValue getPurchaseUpdateProcess() {
        if (_purchaseUpdateProcess == null) { _purchaseUpdateProcess = nCV(); }
        return _purchaseUpdateProcess;
    }
    protected ConditionValue getCValuePurchaseUpdateProcess() { return getPurchaseUpdateProcess(); }
