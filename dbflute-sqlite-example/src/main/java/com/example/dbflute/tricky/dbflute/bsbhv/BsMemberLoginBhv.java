...
public abstract class BsMemberLoginBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends MemberLogin> ENTITY doSelectByPK(Integer memberLoginId, Class<ENTITY> entityType) {
        return doSelectEntity(xprepareCBAsPK(memberLoginId), entityType);
    }

    protected <ENTITY extends MemberLogin> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer memberLoginId, Class<ENTITY> entityType) {
    ...
    protected <ENTITY extends MemberLogin> ENTITY doSelectByPKWithDeletedCheck(Integer memberLoginId, Class<ENTITY> entityType) {
    ...
    public List<Integer> extractMemberLoginIdList(List<MemberLogin> memberLoginList) {
        return helpExtractListInternally(memberLoginList, new InternalExtractCallback<MemberLogin, Integer>() {
            public Integer getCV(MemberLogin et) { return et.getMemberLoginId(); }
        });
    }
