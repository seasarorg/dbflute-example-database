...
public class MemberServiceDbm extends AbstractDBMeta {
    ...
    public static class EpgVersionNo implements PropertyGateway {
        ...
        public void write(Entity e, Object v) { ((MemberService)e).setVersionNo(cti(v)); }
    }
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberServiceId = cci("MEMBER_SERVICE_ID", "MEMBER_SERVICE_ID", null, null, true, "memberServiceId", Integer.class, true, true, "INTEGER", 2000000000, 10, null, false, null, null, null, null, null);
    ...
    protected final ColumnInfo _columnServicePointCount = cci("SERVICE_POINT_COUNT", "SERVICE_POINT_COUNT", null, null, true, "servicePointCount", Integer.class, false, false, "INTEGER", 2000000000, 10, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnServiceRankCode = cci("SERVICE_RANK_CODE", "SERVICE_RANK_CODE", null, null, true, "serviceRankCode", String.class, false, false, "TEXT", 2000000000, 10, null, false, null, null, "serviceRank", null, null);
    ...
    public ForeignInfo foreignMember() {
        ...
        return cfi("FK_MEMBER_SERVICE_MEMBER_ID_MEMBER", "member", this, MemberDbm.getInstance(), map, 0, false, false, false, false, null, null, false, "memberServiceList");
    }
    public ForeignInfo foreignServiceRank() {
        ...
        return cfi("FK_MEMBER_SERVICE_SERVICE_RANK_CODE_SERVICE_RANK", "serviceRank", this, ServiceRankDbm.getInstance(), map, 1, false, false, false, false, null, null, false, "memberServiceList");
    }
