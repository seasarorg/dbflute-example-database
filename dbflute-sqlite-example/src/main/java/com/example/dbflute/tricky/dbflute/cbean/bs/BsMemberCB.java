package com.example.dbflute.tricky.dbflute.cbean.bs;
...
import com.example.dbflute.tricky.dbflute.allcommon.DBFluteConfig;
import com.example.dbflute.tricky.dbflute.allcommon.DBMetaInstanceHandler;
import com.example.dbflute.tricky.dbflute.allcommon.ImplementedInvokerAssistant;
import com.example.dbflute.tricky.dbflute.allcommon.ImplementedSqlClauseCreator;
import com.example.dbflute.tricky.dbflute.cbean.*;
import com.example.dbflute.tricky.dbflute.cbean.cq.*;
import com.example.dbflute.tricky.dbflute.cbean.nss.*;
...
public class BsMemberCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnMemberRegisterDatetime() { return doColumn("MEMBER_REGISTER_DATETIME"); }
        /**
         * MEMBER_REGISTER_USER: {NotNull, TEXT(2000000000, 10)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnMemberRegisterUser() { return doColumn("MEMBER_REGISTER_USER"); }
        /**
         * MEMBER_REGISTER_PROCESS: {NotNull, TEXT(2000000000, 10)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnMemberRegisterProcess() { return doColumn("MEMBER_REGISTER_PROCESS"); }
        /**
         * MEMBER_UPDATE_DATETIME: {NotNull, DATETIME(2000000000, 10)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnMemberUpdateDatetime() { return doColumn("MEMBER_UPDATE_DATETIME"); }
        /**
         * MEMBER_UPDATE_USER: {NotNull, TEXT(2000000000, 10)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnMemberUpdateUser() { return doColumn("MEMBER_UPDATE_USER"); }
        /**
         * MEMBER_UPDATE_PROCESS: {NotNull, TEXT(2000000000, 10)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnMemberUpdateProcess() { return doColumn("MEMBER_UPDATE_PROCESS"); }
        /**
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MemberServiceCB, MemberCQ> derivedMemberServiceList() {
            assertDerived("memberServiceList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return new HpSDRFunction<MemberServiceCB, MemberCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<MemberServiceCB, MemberCQ>() {
                public void setup(String function, SubQuery<MemberServiceCB> subQuery, MemberCQ cq, String aliasName, DerivedReferrerOption option) {
