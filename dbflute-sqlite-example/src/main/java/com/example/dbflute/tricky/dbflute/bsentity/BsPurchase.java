...
public abstract class BsPurchase implements EntityDefinedCommonColumn, Serializable, Cloneable {
    ...
    protected String buildColumnString() {
        ...
        sb.append(delimiter).append(getPurchaseRegisterDatetime());
        sb.append(delimiter).append(getPurchaseRegisterUser());
        sb.append(delimiter).append(getPurchaseRegisterProcess());
        sb.append(delimiter).append(getPurchaseUpdateDatetime());
        sb.append(delimiter).append(getPurchaseUpdateUser());
        sb.append(delimiter).append(getPurchaseUpdateProcess());
