...
public abstract class AbstractBsServiceRankCQ extends AbstractConditionQuery {
    ...
    public void doSetServicePointIncidence_InScope(Collection<String> servicePointIncidenceList) {
    ...
    public void doSetServicePointIncidence_NotInScope(Collection<String> servicePointIncidenceList) {
     ...
     * PrefixSearch {like 'xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br />
     * SERVICE_POINT_INCIDENCE: {NotNull, REAL(2000000000, 10)}
     * @param servicePointIncidence The value of servicePointIncidence as prefixSearch. (NullAllowed: if null (or empty), no condition)
     */
    public void setServicePointIncidence_PrefixSearch(String servicePointIncidence) {
        setServicePointIncidence_LikeSearch(servicePointIncidence, cLSOP());
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br />
     * SERVICE_POINT_INCIDENCE: {NotNull, REAL(2000000000, 10)} <br />
     * <pre>e.g. setServicePointIncidence_LikeSearch("xxx", new <span style="color: #FD4747">LikeSearchOption</span>().likeContain());</pre>
    ...
    public void setServicePointIncidence_LikeSearch(String servicePointIncidence, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(servicePointIncidence), getCValueServicePointIncidence(), "SERVICE_POINT_INCIDENCE", likeSearchOption);
    }
    ...
    public void setServicePointIncidence_NotLikeSearch(String servicePointIncidence, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(servicePointIncidence), getCValueServicePointIncidence(), "SERVICE_POINT_INCIDENCE", likeSearchOption);
    }
