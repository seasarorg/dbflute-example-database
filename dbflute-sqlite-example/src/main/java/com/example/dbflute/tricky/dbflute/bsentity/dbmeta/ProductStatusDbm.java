...
public class ProductStatusDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductStatusCode = cci("PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", null, null, true, "productStatusCode", String.class, true, false, "TEXT", 2000000000, 10, null, false, null, null, null, "productList,summaryProductList", null);
    protected final ColumnInfo _columnProductStatusName = cci("PRODUCT_STATUS_NAME", "PRODUCT_STATUS_NAME", null, null, true, "productStatusName", String.class, false, false, "TEXT", 2000000000, 10, null, false, null, null, null, null, null);
    ...
    public ReferrerInfo referrerProductList() {
        ...
        return cri("FK_PRODUCT_PRODUCT_STATUS_CODE_PRODUCT_STATUS", "productList", this, ProductDbm.getInstance(), map, false, "productStatus");
    }
