...
public class WithdrawalReasonDbm extends AbstractDBMeta {
    ...
    public ReferrerInfo referrerMemberWithdrawalList() {
        ...
        return cri("FK_MEMBER_WITHDRAWAL_WITHDRAWAL_REASON_CODE_WITHDRAWAL_REASON", "memberWithdrawalList", this, MemberWithdrawalDbm.getInstance(), map, false, "withdrawalReason");
    }
