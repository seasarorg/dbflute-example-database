...
public class RegionDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnRegionId = cci("REGION_ID", "REGION_ID", null, null, true, "regionId", Integer.class, true, false, "INTEGER", 2000000000, 10, null, false, null, null, null, "memberAddressList", null);
    protected final ColumnInfo _columnRegionName = cci("REGION_NAME", "REGION_NAME", null, null, true, "regionName", String.class, false, false, "TEXT", 2000000000, 10, null, false, null, null, null, null, null);
    ...
    public ReferrerInfo referrerMemberAddressList() {
        ...
        return cri("FK_MEMBER_ADDRESS_REGION_ID_REGION", "memberAddressList", this, MemberAddressDbm.getInstance(), map, false, "region");
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.tricky.dbflute.exentity.Region"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.tricky.dbflute.cbean.RegionCB"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.tricky.dbflute.exbhv.RegionBhv"; }
