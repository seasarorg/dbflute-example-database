...
public abstract class BsPurchaseBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends Purchase> ENTITY doSelectByPKValue(Integer purchaseId, Class<ENTITY> entityType) {
    ...
    protected <ENTITY extends Purchase> ENTITY doSelectByPKValueWithDeletedCheck(Integer purchaseId, Class<ENTITY> entityType) {
        return doSelectEntityWithDeletedCheck(buildPKCB(purchaseId), entityType);
    }

    private PurchaseCB buildPKCB(Integer purchaseId) {
