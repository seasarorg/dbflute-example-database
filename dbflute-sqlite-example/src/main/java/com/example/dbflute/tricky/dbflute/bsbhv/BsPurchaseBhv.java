...
public abstract class BsPurchaseBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends Purchase> ENTITY doSelectByPK(Integer purchaseId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(purchaseId), tp);
    }

    protected <ENTITY extends Purchase> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer purchaseId, Class<ENTITY> tp) {
