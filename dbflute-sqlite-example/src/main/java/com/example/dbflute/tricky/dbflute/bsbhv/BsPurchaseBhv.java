...
public abstract class BsPurchaseBhv extends AbstractBehaviorWritable {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public Purchase selectByPKValue(Integer purchaseId) {
        return doSelectByPK(purchaseId, Purchase.class);
    }

    protected <ENTITY extends Purchase> ENTITY doSelectByPK(Integer purchaseId, Class<ENTITY> entityType) {
        return doSelectEntity(xprepareCBAsPK(purchaseId), entityType);
    }

    protected <ENTITY extends Purchase> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer purchaseId, Class<ENTITY> entityType) {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public Purchase selectByPKValueWithDeletedCheck(Integer purchaseId) {
        return doSelectByPKWithDeletedCheck(purchaseId, Purchase.class);
    }

    protected <ENTITY extends Purchase> ENTITY doSelectByPKWithDeletedCheck(Integer purchaseId, Class<ENTITY> entityType) {
    ...
    public List<Integer> extractPurchaseIdList(List<Purchase> purchaseList) {
        return helpExtractListInternally(purchaseList, new InternalExtractCallback<Purchase, Integer>() {
            public Integer getCV(Purchase et) { return et.getPurchaseId(); }
        });
    }
