...
public abstract class BsPurchaseBhv extends AbstractBehaviorWritable<Purchase, PurchaseCB> {
    ...
    protected Purchase facadeSelectByPKValue(Integer purchaseId) {
    ...
    protected <ENTITY extends Purchase> ENTITY doSelectByPKWithDeletedCheck(Integer purchaseId, Class<ENTITY> tp) {
