...
import com.example.dbflute.tricky.dbflute.bsbhv.loader.*;
...
public abstract class BsMemberBhv extends AbstractBehaviorWritable<Member, MemberCB> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MemberService> loadMemberServiceList(List<Member> memberList, ConditionBeanSetupper<MemberServiceCB> setupper) {
        xassLRArg(memberList, setupper);
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MemberService> loadMemberServiceList(Member member, ConditionBeanSetupper<MemberServiceCB> setupper) {
        xassLRArg(member, setupper);
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MemberService> loadMemberServiceList(Member member, LoadReferrerOption<MemberServiceCB, MemberService> loadReferrerOption) {
        xassLRArg(member, loadReferrerOption);
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<MemberService> loadMemberServiceList(List<Member> memberList, LoadReferrerOption<MemberServiceCB, MemberService> loadReferrerOption) {
        xassLRArg(memberList, loadReferrerOption);
        if (memberList.isEmpty()) { return (NestedReferrerListGateway<MemberService>)EMPTY_NREF_LGWAY; }
        return doLoadMemberServiceList(memberList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MemberService> doLoadMemberServiceList(List<Member> memberList, LoadReferrerOption<MemberServiceCB, MemberService> option) {
    ...
    protected <RESULT extends Member> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.tricky.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }
    ...
    protected <RESULT extends Member> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.tricky.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }
