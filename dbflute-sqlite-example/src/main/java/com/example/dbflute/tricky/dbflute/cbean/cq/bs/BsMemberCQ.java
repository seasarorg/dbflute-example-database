...
public class BsMemberCQ extends AbstractBsMemberCQ {
    ...
    public String keepMemberId_ExistsReferrer_MemberServiceList(MemberServiceCQ sq) {
        ...
        String ky = "subQueryMapKey" + (_memberId_ExistsReferrer_MemberServiceListMap.size() + 1);
        _memberId_ExistsReferrer_MemberServiceListMap.put(ky, sq); return "memberId_ExistsReferrer_MemberServiceList." + ky;
    }
    ...
    public String keepMemberId_NotExistsReferrer_MemberServiceList(MemberServiceCQ sq) {
        ...
        String ky = "subQueryMapKey" + (_memberId_NotExistsReferrer_MemberServiceListMap.size() + 1);
        _memberId_NotExistsReferrer_MemberServiceListMap.put(ky, sq); return "memberId_NotExistsReferrer_MemberServiceList." + ky;
    }
    ...
    public String keepMemberId_SpecifyDerivedReferrer_MemberServiceList(MemberServiceCQ sq) {
        ...
        String ky = "subQueryMapKey" + (_memberId_SpecifyDerivedReferrer_MemberServiceListMap.size() + 1);
        _memberId_SpecifyDerivedReferrer_MemberServiceListMap.put(ky, sq); return "memberId_SpecifyDerivedReferrer_MemberServiceList." + ky;
    }
    ...
    public String keepMemberId_InScopeRelation_MemberServiceList(MemberServiceCQ sq) {
        ...
        String ky = "subQueryMapKey" + (_memberId_InScopeRelation_MemberServiceListMap.size() + 1);
        _memberId_InScopeRelation_MemberServiceListMap.put(ky, sq); return "memberId_InScopeRelation_MemberServiceList." + ky;
    }
    ...
    public String keepMemberId_NotInScopeRelation_MemberServiceList(MemberServiceCQ sq) {
        ...
        String ky = "subQueryMapKey" + (_memberId_NotInScopeRelation_MemberServiceListMap.size() + 1);
        _memberId_NotInScopeRelation_MemberServiceListMap.put(ky, sq); return "memberId_NotInScopeRelation_MemberServiceList." + ky;
    }
    ...
    public String keepMemberId_QueryDerivedReferrer_MemberServiceList(MemberServiceCQ sq) {
        ...
        String ky = "subQueryMapKey" + (_memberId_QueryDerivedReferrer_MemberServiceListMap.size() + 1);
        _memberId_QueryDerivedReferrer_MemberServiceListMap.put(ky, sq); return "memberId_QueryDerivedReferrer_MemberServiceList." + ky;
    }
    ...
    public String keepMemberId_QueryDerivedReferrer_MemberServiceListParameter(Object vl) {
        ...
        String ky = "subQueryParameterKey" + (_memberId_QueryDerivedReferrer_MemberServiceListParameterMap.size() + 1);
        _memberId_QueryDerivedReferrer_MemberServiceListParameterMap.put(ky, vl); return "memberId_QueryDerivedReferrer_MemberServiceListParameter." + ky;
    }
