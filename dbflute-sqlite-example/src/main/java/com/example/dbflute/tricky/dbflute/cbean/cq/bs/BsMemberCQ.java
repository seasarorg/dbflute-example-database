...
public class BsMemberCQ extends AbstractBsMemberCQ {
    ...
    protected Map<String, MemberServiceCQ> _memberId_ExistsReferrer_MemberServiceListMap;
    public Map<String, MemberServiceCQ> getMemberId_ExistsReferrer_MemberServiceList() { return _memberId_ExistsReferrer_MemberServiceListMap; }
    public String keepMemberId_ExistsReferrer_MemberServiceList(MemberServiceCQ subQuery) {
        if (_memberId_ExistsReferrer_MemberServiceListMap == null) { _memberId_ExistsReferrer_MemberServiceListMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_memberId_ExistsReferrer_MemberServiceListMap.size() + 1);
        _memberId_ExistsReferrer_MemberServiceListMap.put(key, subQuery); return "memberId_ExistsReferrer_MemberServiceList." + key;
    }
    ...
    protected Map<String, MemberServiceCQ> _memberId_NotExistsReferrer_MemberServiceListMap;
    public Map<String, MemberServiceCQ> getMemberId_NotExistsReferrer_MemberServiceList() { return _memberId_NotExistsReferrer_MemberServiceListMap; }
    public String keepMemberId_NotExistsReferrer_MemberServiceList(MemberServiceCQ subQuery) {
        if (_memberId_NotExistsReferrer_MemberServiceListMap == null) { _memberId_NotExistsReferrer_MemberServiceListMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_memberId_NotExistsReferrer_MemberServiceListMap.size() + 1);
        _memberId_NotExistsReferrer_MemberServiceListMap.put(key, subQuery); return "memberId_NotExistsReferrer_MemberServiceList." + key;
    }
    ...
    protected Map<String, MemberServiceCQ> _memberId_SpecifyDerivedReferrer_MemberServiceListMap;
    public Map<String, MemberServiceCQ> getMemberId_SpecifyDerivedReferrer_MemberServiceList() { return _memberId_SpecifyDerivedReferrer_MemberServiceListMap; }
    public String keepMemberId_SpecifyDerivedReferrer_MemberServiceList(MemberServiceCQ subQuery) {
        if (_memberId_SpecifyDerivedReferrer_MemberServiceListMap == null) { _memberId_SpecifyDerivedReferrer_MemberServiceListMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_memberId_SpecifyDerivedReferrer_MemberServiceListMap.size() + 1);
        _memberId_SpecifyDerivedReferrer_MemberServiceListMap.put(key, subQuery); return "memberId_SpecifyDerivedReferrer_MemberServiceList." + key;
    }
    ...
    protected Map<String, MemberServiceCQ> _memberId_InScopeRelation_MemberServiceListMap;
    public Map<String, MemberServiceCQ> getMemberId_InScopeRelation_MemberServiceList() { return _memberId_InScopeRelation_MemberServiceListMap; }
    public String keepMemberId_InScopeRelation_MemberServiceList(MemberServiceCQ subQuery) {
        if (_memberId_InScopeRelation_MemberServiceListMap == null) { _memberId_InScopeRelation_MemberServiceListMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_memberId_InScopeRelation_MemberServiceListMap.size() + 1);
        _memberId_InScopeRelation_MemberServiceListMap.put(key, subQuery); return "memberId_InScopeRelation_MemberServiceList." + key;
    }
    ...
    protected Map<String, MemberServiceCQ> _memberId_NotInScopeRelation_MemberServiceListMap;
    public Map<String, MemberServiceCQ> getMemberId_NotInScopeRelation_MemberServiceList() { return _memberId_NotInScopeRelation_MemberServiceListMap; }
    public String keepMemberId_NotInScopeRelation_MemberServiceList(MemberServiceCQ subQuery) {
        if (_memberId_NotInScopeRelation_MemberServiceListMap == null) { _memberId_NotInScopeRelation_MemberServiceListMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_memberId_NotInScopeRelation_MemberServiceListMap.size() + 1);
        _memberId_NotInScopeRelation_MemberServiceListMap.put(key, subQuery); return "memberId_NotInScopeRelation_MemberServiceList." + key;
    }
    ...
    protected Map<String, MemberServiceCQ> _memberId_QueryDerivedReferrer_MemberServiceListMap;
    public Map<String, MemberServiceCQ> getMemberId_QueryDerivedReferrer_MemberServiceList() { return _memberId_QueryDerivedReferrer_MemberServiceListMap; }
    public String keepMemberId_QueryDerivedReferrer_MemberServiceList(MemberServiceCQ subQuery) {
        if (_memberId_QueryDerivedReferrer_MemberServiceListMap == null) { _memberId_QueryDerivedReferrer_MemberServiceListMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_memberId_QueryDerivedReferrer_MemberServiceListMap.size() + 1);
        _memberId_QueryDerivedReferrer_MemberServiceListMap.put(key, subQuery); return "memberId_QueryDerivedReferrer_MemberServiceList." + key;
    }
    protected Map<String, Object> _memberId_QueryDerivedReferrer_MemberServiceListParameterMap;
    public Map<String, Object> getMemberId_QueryDerivedReferrer_MemberServiceListParameter() { return _memberId_QueryDerivedReferrer_MemberServiceListParameterMap; }
    public String keepMemberId_QueryDerivedReferrer_MemberServiceListParameter(Object parameterValue) {
        if (_memberId_QueryDerivedReferrer_MemberServiceListParameterMap == null) { _memberId_QueryDerivedReferrer_MemberServiceListParameterMap = newLinkedHashMapSized(4); }
        String key = "subQueryParameterKey" + (_memberId_QueryDerivedReferrer_MemberServiceListParameterMap.size() + 1);
        _memberId_QueryDerivedReferrer_MemberServiceListParameterMap.put(key, parameterValue); return "memberId_QueryDerivedReferrer_MemberServiceListParameter." + key;
    }
