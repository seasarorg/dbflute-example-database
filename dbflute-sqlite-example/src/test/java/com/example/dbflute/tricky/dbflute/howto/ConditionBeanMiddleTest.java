...
import com.example.dbflute.tricky.dbflute.exentity.MemberWithdrawal;
import com.example.dbflute.tricky.dbflute.exentity.Product;
import com.example.dbflute.tricky.dbflute.exentity.ProductStatus;
import com.example.dbflute.tricky.dbflute.exentity.Purchase;
import com.example.dbflute.tricky.dbflute.exentity.WithdrawalReason;
...
public class ConditionBeanMiddleTest extends AppContainerTestCase {
    ...
    public void test_query_setMemberStatusCode_Equal_Classification() {
        // ## Arrange ##
        MemberCB cb = new MemberCB();
        cb.query().setMemberStatusCode_Equal_FormalizedMember();// *Point!
    ...
    public void test_query_NotEqual_Classification() {
        // ## Arrange ##
        MemberCB cb = new MemberCB();
        cb.query().setMemberStatusCode_NotEqual_FormalizedMember();// *Point!
        ...
        assertNotSame(0, memberList.size());
        for (Member member : memberList) {
            assertFalse(member.isMemberStatusCodeFormalizedMember());
        }
    ...
    public void test_query_exists_ForeignReferrerCondition() {
        ...
        // ## Assert ##
        List<Integer> purchaseIdList = new ArrayList<Integer>();
    ...
    public void test_union() {
        ...
        cb.query().setMemberStatusCode_Equal_ProvisionalMember();
        ...
        for (Member member : memberList) {
            ...
            if (!memberName.startsWith("St")) {
                ...
                assertTrue(member.isMemberStatusCodeProvisionalMember());
            } else if (!member.isMemberStatusCodeProvisionalMember()) {
