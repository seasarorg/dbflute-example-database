...
public abstract class AbstractBsVendorCheckCQ extends AbstractConditionQuery {
     ...
     * <pre>e.g. setTypeOfNvarchar_LikeSearch("xxx", new <span style="color: #FD4747">LikeSearchOption</span>().likeContain());</pre>
    ...
    protected void regTypeOfNvarchar(ConditionKey k, Object v) { regQ(k, v, getCValueTypeOfNvarchar(), "TYPE_OF_NVARCHAR"); }
    abstract protected ConditionValue getCValueTypeOfNvarchar();
    ...
    protected void regTypeOfSmallinteger(ConditionKey k, Object v) { regQ(k, v, getCValueTypeOfSmallinteger(), "TYPE_OF_SMALLINTEGER"); }
    abstract protected ConditionValue getCValueTypeOfSmallinteger();
    ...
    protected void regTypeOfSmallmoney(ConditionKey k, Object v) { regQ(k, v, getCValueTypeOfSmallmoney(), "TYPE_OF_SMALLMONEY"); }
    abstract protected ConditionValue getCValueTypeOfSmallmoney();
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * TYPE_OF_DATETIME: {datetime(23, 3)}
     * <pre>e.g. setTypeOfDatetime_FromTo(fromDate, toDate, new <span style="color: #FD4747">FromToOption</span>().compareAsDate());</pre>
     ...
     */
    public void setTypeOfDatetime_FromTo(java.util.Date fromDatetime, java.util.Date toDatetime, FromToOption fromToOption) {
     ...
     */
    public void setTypeOfDatetime_DateFromTo(java.util.Date fromDate, java.util.Date toDate) {
    ...
    abstract protected ConditionValue getCValueTypeOfDatetime();
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * TYPE_OF_SMALLDATETIME: {smalldatetime(16)}
     * <pre>e.g. setTypeOfSmalldatetime_FromTo(fromDate, toDate, new <span style="color: #FD4747">FromToOption</span>().compareAsDate());</pre>
     ...
     * @param fromToOption The option of from-to. (NotNull)
     */
    public void setTypeOfSmalldatetime_FromTo(java.util.Date fromDatetime, java.util.Date toDatetime, FromToOption fromToOption) {
     ...
     */
    public void setTypeOfSmalldatetime_DateFromTo(java.util.Date fromDate, java.util.Date toDate) {
    ...
    protected void regTypeOfSmalldatetime(ConditionKey k, Object v) { regQ(k, v, getCValueTypeOfSmalldatetime(), "TYPE_OF_SMALLDATETIME"); }
    abstract protected ConditionValue getCValueTypeOfSmalldatetime();
    ...
    abstract protected ConditionValue getCValueTypeOfVarbinary();
    ...
    protected void regTypeOfUniqueidentifier(ConditionKey k, Object v) { regQ(k, v, getCValueTypeOfUniqueidentifier(), "TYPE_OF_UNIQUEIDENTIFIER"); }
    abstract protected ConditionValue getCValueTypeOfUniqueidentifier();
     ...
     * <pre>e.g. setTypeOfXml_LikeSearch("xxx", new <span style="color: #FD4747">LikeSearchOption</span>().likeContain());</pre>
