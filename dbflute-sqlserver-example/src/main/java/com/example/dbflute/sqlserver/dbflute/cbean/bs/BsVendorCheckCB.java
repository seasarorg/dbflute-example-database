...
public class BsVendorCheckCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<VendorCheckCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnTypeOfNvarchar() { return doColumn("TYPE_OF_NVARCHAR"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnTypeOfSmallinteger() { return doColumn("TYPE_OF_SMALLINTEGER"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnTypeOfSmallmoney() { return doColumn("TYPE_OF_SMALLMONEY"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnTypeOfSmalldatetime() { return doColumn("TYPE_OF_SMALLDATETIME"); }
        /**
         * TYPE_OF_BIT: {bit(1)}
         * @return The information object of specified column. (NotNull)
         */
