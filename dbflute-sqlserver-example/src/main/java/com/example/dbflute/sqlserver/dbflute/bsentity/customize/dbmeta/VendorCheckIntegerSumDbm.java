...
public class VendorCheckIntegerSumDbm extends AbstractDBMeta {
    ...
    public static class EpgIntegerNonDigitSum implements PropertyGateway {
        ...
        public void write(Entity e, Object v) { ((VendorCheckIntegerSum)e).setIntegerNonDigitSum(ctb(v)); }
    }
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnIntegerNonDigitSum = cci("INTEGER_NON_DIGIT_SUM", "INTEGER_NON_DIGIT_SUM", null, null, false, "integerNonDigitSum", java.math.BigDecimal.class, false, false, "numeric", 38, 0, null, false, null, null, null, null, null);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.sqlserver.dbflute.exentity.customize.VendorCheckIntegerSum"; }
