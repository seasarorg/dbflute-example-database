...
public abstract class BsWhiteDelimiterBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends WhiteDelimiter> ENTITY doSelectEntity(final WhiteDelimiterCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends WhiteDelimiter> ENTITY doSelectEntityWithDeletedCheck(final WhiteDelimiterCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends WhiteDelimiter> ListResultBean<ENTITY> doSelectList(WhiteDelimiterCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectListInternally(cb, tp, new InternalSelectListCallback<ENTITY, WhiteDelimiterCB>() {
            public List<ENTITY> callbackSelectList(WhiteDelimiterCB cb, Class<ENTITY> tp) { return delegateSelectList(cb, tp); } });
    }
