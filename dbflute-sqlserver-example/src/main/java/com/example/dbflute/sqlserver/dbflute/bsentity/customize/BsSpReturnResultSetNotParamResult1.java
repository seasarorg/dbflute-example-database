 ...
 */
public abstract class BsSpReturnResultSetNotParamResult1 implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.sqlserver.dbflute.bsentity.customize.dbmeta.SpReturnResultSetNotParamResult1Dbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSpReturnResultSetNotParamResult1)) { return false; }
        BsSpReturnResultSetNotParamResult1 otherEntity = (BsSpReturnResultSetNotParamResult1)other;
