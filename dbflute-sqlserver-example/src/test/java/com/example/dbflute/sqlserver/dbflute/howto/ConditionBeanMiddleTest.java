...
import com.example.dbflute.sqlserver.dbflute.exentity.ProductStatus;
import com.example.dbflute.sqlserver.dbflute.exentity.Purchase;
import com.example.dbflute.sqlserver.dbflute.exentity.WithdrawalReason;
...
public class ConditionBeanMiddleTest extends UnitContainerTestCase {
    ...
    public void test_toDisplaySql() {
        ...
        assertTrue(displaySql.contains("with (updlock)"));
        assertTrue(displaySql.contains(" order by "));
        assertTrue(displaySql.contains(" top "));
    }
