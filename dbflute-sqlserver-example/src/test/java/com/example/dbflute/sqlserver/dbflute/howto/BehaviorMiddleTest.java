...
import com.example.dbflute.sqlserver.dbflute.exbhv.pmbean.OptionMemberPmb;
...
import com.example.dbflute.sqlserver.dbflute.exentity.customize.OptionMember;
...
public class BehaviorMiddleTest extends UnitContainerTestCase {
    ...
    public void test_outsideSql_selectList_selectOptionMember_LikeSearchOption() {
        ...
        for (OptionMember member : memberList) {
            ...
            // SQLServerがカラムのテーブル情報を提供してくれないため、
            // この機能は利用できない。
