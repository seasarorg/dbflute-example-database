package com.example.dbflute.msaccess.dbflute.bsbhv.pmbean;
...
public class BsOptionMemberPmb implements ListHandlingPmb<MemberBhv, OptionMember>, EntityHandlingPmb<MemberBhv, OptionMember>, FetchBean {
    ...
    /** The parameter of displayOrder:ref(MemberStatus) :: refers to DISPLAY_ORDER: {VARCHAR(255)}. */
    protected Integer _displayOrder;

    /** The parameter of birthdate:fromDate|ref(Member.MEMBER_BIRTHDAY) :: refers to MEMBER_BIRTHDAY: {DATETIME(19)}. */
    protected Date _birthdate;

    /** The parameter of status:cls(MemberStatus)|ref(Member.MEMBER_STATUS_CODE) :: refers to MEMBER_STATUS_CODE: {VARCHAR(255), classification=MemberStatus}. */
    ...
    /**
     * [get] displayOrder:ref(MemberStatus) :: refers to DISPLAY_ORDER: {VARCHAR(255)} <br />
    ...
    /**
     * [set] displayOrder:ref(MemberStatus) :: refers to DISPLAY_ORDER: {VARCHAR(255)} <br />
    ...
    /**
     * [get] birthdate:fromDate|ref(Member.MEMBER_BIRTHDAY) :: refers to MEMBER_BIRTHDAY: {DATETIME(19)} <br />
    ...
    /**
     * [set as fromDate] birthdate:fromDate|ref(Member.MEMBER_BIRTHDAY) :: refers to MEMBER_BIRTHDAY: {DATETIME(19)} <br />
    ...
    /**
     * [get] status:cls(MemberStatus)|ref(Member.MEMBER_STATUS_CODE) :: refers to MEMBER_STATUS_CODE: {VARCHAR(255), classification=MemberStatus} <br />
    ...
    /**
     * [set] status:cls(MemberStatus)|ref(Member.MEMBER_STATUS_CODE) :: refers to MEMBER_STATUS_CODE: {VARCHAR(255), classification=MemberStatus} <br />
    ...
    /**
     * [set as Provisional] status:cls(MemberStatus)|ref(Member.MEMBER_STATUS_CODE) :: refers to MEMBER_STATUS_CODE: {VARCHAR(255), classification=MemberStatus} <br />
     * 仮会員を示す
     */
    ...
    /**
     * [set as Formalized] status:cls(MemberStatus)|ref(Member.MEMBER_STATUS_CODE) :: refers to MEMBER_STATUS_CODE: {VARCHAR(255), classification=MemberStatus} <br />
     * 正式会員を示す
     */
    ...
    /**
     * [set as Withdrawal] status:cls(MemberStatus)|ref(Member.MEMBER_STATUS_CODE) :: refers to MEMBER_STATUS_CODE: {VARCHAR(255), classification=MemberStatus} <br />
     * 退会会員を示す
     */
