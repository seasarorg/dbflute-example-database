...
public abstract class AbstractBsMemberWithdrawalCQ extends AbstractConditionQuery {
     ...
     * WITHDRAWAL_REASON_CODE: {VARCHAR(255), FK to WITHDRAWAL_REASON} <br />
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br />
     * WITHDRAWAL_REASON_INPUT_TEXT: {VARCHAR(255)} <br />
     ...
     * @param withdrawalDatetime The value of withdrawalDatetime as equal. (NullAllowed: if null (or empty), no condition)
     */
    public void setWithdrawalDatetime_Equal(String withdrawalDatetime) {
        doSetWithdrawalDatetime_Equal(fRES(withdrawalDatetime));
    }

    protected void doSetWithdrawalDatetime_Equal(String withdrawalDatetime) {
     ...
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br />
     * WITHDRAWAL_DATETIME: {VARCHAR(255)}
     * @param withdrawalDatetime The value of withdrawalDatetime as notEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setWithdrawalDatetime_NotEqual(String withdrawalDatetime) {
        doSetWithdrawalDatetime_NotEqual(fRES(withdrawalDatetime));
    }

    protected void doSetWithdrawalDatetime_NotEqual(String withdrawalDatetime) {
        regWithdrawalDatetime(CK_NES, withdrawalDatetime);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br />
     * WITHDRAWAL_DATETIME: {VARCHAR(255)}
     * @param withdrawalDatetime The value of withdrawalDatetime as greaterThan. (NullAllowed: if null (or empty), no condition)
     */
    public void setWithdrawalDatetime_GreaterThan(String withdrawalDatetime) {
        regWithdrawalDatetime(CK_GT, fRES(withdrawalDatetime));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br />
     * WITHDRAWAL_DATETIME: {VARCHAR(255)}
     * @param withdrawalDatetime The value of withdrawalDatetime as lessThan. (NullAllowed: if null (or empty), no condition)
     */
    public void setWithdrawalDatetime_LessThan(String withdrawalDatetime) {
        regWithdrawalDatetime(CK_LT, fRES(withdrawalDatetime));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br />
     * WITHDRAWAL_DATETIME: {VARCHAR(255)}
     * @param withdrawalDatetime The value of withdrawalDatetime as greaterEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setWithdrawalDatetime_GreaterEqual(String withdrawalDatetime) {
        regWithdrawalDatetime(CK_GE, fRES(withdrawalDatetime));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br />
     * WITHDRAWAL_DATETIME: {VARCHAR(255)}
     * @param withdrawalDatetime The value of withdrawalDatetime as lessEqual. (NullAllowed: if null (or empty), no condition)
     */
    public void setWithdrawalDatetime_LessEqual(String withdrawalDatetime) {
        regWithdrawalDatetime(CK_LE, fRES(withdrawalDatetime));
    }
     ...
     */
    public void setWithdrawalDatetime_InScope(Collection<String> withdrawalDatetimeList) {
        doSetWithdrawalDatetime_InScope(withdrawalDatetimeList);
    }

    public void doSetWithdrawalDatetime_InScope(Collection<String> withdrawalDatetimeList) {
     ...
     */
    public void setWithdrawalDatetime_NotInScope(Collection<String> withdrawalDatetimeList) {
        doSetWithdrawalDatetime_NotInScope(withdrawalDatetimeList);
    }

    public void doSetWithdrawalDatetime_NotInScope(Collection<String> withdrawalDatetimeList) {
     ...
     * PrefixSearch {like 'xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br />
     * WITHDRAWAL_DATETIME: {VARCHAR(255)}
     * @param withdrawalDatetime The value of withdrawalDatetime as prefixSearch. (NullAllowed: if null (or empty), no condition)
     */
    public void setWithdrawalDatetime_PrefixSearch(String withdrawalDatetime) {
        setWithdrawalDatetime_LikeSearch(withdrawalDatetime, cLSOP());
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br />
     * WITHDRAWAL_DATETIME: {VARCHAR(255)} <br />
     * <pre>e.g. setWithdrawalDatetime_LikeSearch("xxx", new <span style="color: #DD4747">LikeSearchOption</span>().likeContain());</pre>
     * @param withdrawalDatetime The value of withdrawalDatetime as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setWithdrawalDatetime_LikeSearch(String withdrawalDatetime, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(withdrawalDatetime), getCValueWithdrawalDatetime(), "WITHDRAWAL_DATETIME", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br />
     * WITHDRAWAL_DATETIME: {VARCHAR(255)}
     * @param withdrawalDatetime The value of withdrawalDatetime as notLikeSearch. (NullAllowed: if null (or empty), no condition)
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setWithdrawalDatetime_NotLikeSearch(String withdrawalDatetime, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(withdrawalDatetime), getCValueWithdrawalDatetime(), "WITHDRAWAL_DATETIME", likeSearchOption);
    }
     ...
     * WITHDRAWAL_DATETIME: {VARCHAR(255)}
     */
    public void setWithdrawalDatetime_IsNullOrEmpty() { regWithdrawalDatetime(CK_ISNOE, DOBJ); }
