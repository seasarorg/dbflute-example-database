...
public abstract class BsProductStatusBhv extends AbstractBehaviorWritable {
     ...
     * @param productStatusCode : PK, VARCHAR(255). (NotNull)
     ...
     * }
     * </pre>
     * @param productStatus The entity of update. (NotNull, PrimaryKeyNotNull, ConcurrencyColumnNotNull)
     ...
     * productStatusBhv.<span style="color: #DD4747">updateNonstrict</span>(productStatus);
     * </pre>
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void updateNonstrict(ProductStatus productStatus) {
        doUpdateNonstrict(productStatus, null);
    }

    protected void doUpdateNonstrict(ProductStatus et, UpdateOption<ProductStatusCB> op) {
        assertObjectNotNull("productStatus", et); prepareUpdateOption(op); helpUpdateNonstrictInternally(et, op);
    }
    ...
    public void insertOrUpdateNonstrict(ProductStatus productStatus) {
        doInsertOrUpdateNonstrict(productStatus, null, null);
    }

    protected void doInsertOrUpdateNonstrict(ProductStatus et, InsertOption<ProductStatusCB> iop, UpdateOption<ProductStatusCB> uop) {
        assertObjectNotNull("productStatus", et); helpInsertOrUpdateNonstrictInternally(et, iop, uop);
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//productStatus.setVersionNo(value);</span>
     * productStatusBhv.<span style="color: #DD4747">deleteNonstrict</span>(productStatus);
     * </pre>
    ...
    protected void doDeleteNonstrict(ProductStatus et, final DeleteOption<ProductStatusCB> op) {
        assertObjectNotNull("productStatus", et); prepareDeleteOption(op); helpDeleteNonstrictInternally(et, op);
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//productStatus.setVersionNo(value);</span>
     * productStatusBhv.<span style="color: #DD4747">deleteNonstrictIgnoreDeleted</span>(productStatus);
    ...
    protected void doDeleteNonstrictIgnoreDeleted(ProductStatus et, final DeleteOption<ProductStatusCB> op) {
        assertObjectNotNull("productStatus", et); prepareDeleteOption(op); helpDeleteNonstrictIgnoreDeletedInternally(et, op);
    }
     ...
     * </pre>
     * @param productStatusList The list of the entity. (NotNull, EmptyAllowed, PrimaryKeyNotNull, ConcurrencyColumnNotNull)
    ...
    public int[] batchUpdateNonstrict(List<ProductStatus> productStatusList) {
        return doBatchUpdateNonstrict(productStatusList, null);
    }

    protected int[] doBatchUpdateNonstrict(List<ProductStatus> ls, UpdateOption<ProductStatusCB> op) {
        assertObjectNotNull("productStatusList", ls);
        UpdateOption<ProductStatusCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
     ...
     * <pre>
     * <span style="color: #3F7E5E">// e.g. update two columns only</span>
     * productStatusBhv.<span style="color: #DD4747">batchUpdateNonstrict</span>(productStatusList, new SpecifyQuery<ProductStatusCB>() {
     *     public void specify(ProductStatusCB cb) { <span style="color: #3F7E5E">// the two only updated</span>
     *         cb.specify().<span style="color: #DD4747">columnFooStatusCode()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *         cb.specify().<span style="color: #DD4747">columnBarDate()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *     }
    ...
    protected int[] doBatchDeleteNonstrict(List<ProductStatus> ls, DeleteOption<ProductStatusCB> op) {
        assertObjectNotNull("productStatusList", ls);
        prepareDeleteOption(op);
     ...
     * productStatusBhv.<span style="color: #DD4747">varyingUpdateNonstrict</span>(productStatus, option);
     * </pre>
     * @param productStatus The entity of update. (NotNull, PrimaryKeyNotNull)
     * @param option The option of update for varying requests. (NotNull)
     * @exception EntityAlreadyDeletedException When the entity has already been deleted. (not found)
    ...
    public void varyingInsertOrUpdateNonstrict(ProductStatus productStatus, InsertOption<ProductStatusCB> insertOption, UpdateOption<ProductStatusCB> updateOption) {
        assertInsertOptionNotNull(insertOption); assertUpdateOptionNotNull(updateOption);
        doInsertOrUpdateNonstrict(productStatus, insertOption, updateOption);
    }
