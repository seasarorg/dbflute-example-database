...
public abstract class BsProductStatusBhv extends AbstractBehaviorWritable {
     ...
     * productStatusBhv.<span style="color: #FD4747">updateNonstrict</span>(productStatus);
     * </pre>
     * @param productStatus The entity of update target. (NotNull, PrimaryKeyNotNull)
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void updateNonstrict(final ProductStatus productStatus) {
        doUpdateNonstrict(productStatus, null);
    }

    protected void doUpdateNonstrict(ProductStatus productStatus, final UpdateOption<ProductStatusCB> option) {
        assertObjectNotNull("productStatus", productStatus);
        prepareUpdateOption(option);
        helpUpdateNonstrictInternally(productStatus, new InternalUpdateNonstrictCallback<ProductStatus>() {
            public int callbackDelegateUpdateNonstrict(ProductStatus entity) { return delegateUpdateNonstrict(entity, option); } });
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdateNonstrict(ProductStatus productStatus) {
        doInesrtOrUpdateNonstrict(productStatus, null, null);
    }

    protected void doInesrtOrUpdateNonstrict(ProductStatus productStatus, final InsertOption<ProductStatusCB> insertOption, final UpdateOption<ProductStatusCB> updateOption) {
        helpInsertOrUpdateInternally(productStatus, new InternalInsertOrUpdateNonstrictCallback<ProductStatus>() {
            public void callbackInsert(ProductStatus entity) { doInsert(entity, insertOption); }
            public void callbackUpdateNonstrict(ProductStatus entity) { doUpdateNonstrict(entity, updateOption); }
        });
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//productStatus.setVersionNo(value);</span>
     * productStatusBhv.<span style="color: #FD4747">deleteNonstrict</span>(productStatus);
     * </pre>
     * @param productStatus The entity of delete target. (NotNull, PrimaryKeyNotNull)
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
    public void deleteNonstrict(ProductStatus productStatus) {
        doDeleteNonstrict(productStatus, null);
    }

    protected void doDeleteNonstrict(ProductStatus productStatus, final DeleteOption<ProductStatusCB> option) {
        assertObjectNotNull("productStatus", productStatus);
        prepareDeleteOption(option);
        helpDeleteNonstrictInternally(productStatus, new InternalDeleteNonstrictCallback<ProductStatus>() {
            public int callbackDelegateDeleteNonstrict(ProductStatus entity) { return delegateDeleteNonstrict(entity, option); } });
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//productStatus.setVersionNo(value);</span>
     * productStatusBhv.<span style="color: #FD4747">deleteNonstrictIgnoreDeleted</span>(productStatus);
     * <span style="color: #3F7E5E">// if the target entity doesn't exist, no exception</span>
     * </pre>
     * @param productStatus The entity of delete target. (NotNull, PrimaryKeyNotNull)
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
    public void deleteNonstrictIgnoreDeleted(ProductStatus productStatus) {
        doDeleteNonstrictIgnoreDeleted(productStatus, null);
    }

    protected void doDeleteNonstrictIgnoreDeleted(ProductStatus productStatus, final DeleteOption<ProductStatusCB> option) {
        assertObjectNotNull("productStatus", productStatus);
        prepareDeleteOption(option);
        helpDeleteNonstrictIgnoreDeletedInternally(productStatus, new InternalDeleteNonstrictIgnoreDeletedCallback<ProductStatus>() {
            public int callbackDelegateDeleteNonstrict(ProductStatus entity) { return delegateDeleteNonstrict(entity, option); } });
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdateNonstrict(List<ProductStatus> productStatusList) {
        UpdateOption<ProductStatusCB> option = createPlainUpdateOption();
        return doBatchUpdateNonstrict(productStatusList, option);
    }

    protected int[] doBatchUpdateNonstrict(List<ProductStatus> productStatusList, UpdateOption<ProductStatusCB> option) {
        assertObjectNotNull("productStatusList", productStatusList);
        prepareBatchUpdateOption(productStatusList, option);
        return delegateBatchUpdateNonstrict(productStatusList, option);
    }
     ...
     * <pre>
     * <span style="color: #3F7E5E">// e.g. update two columns only</span> 
     * productStatusBhv.<span style="color: #FD4747">batchUpdateNonstrict</span>(productStatusList, new SpecifyQuery<ProductStatusCB>() {
     *     public void specify(ProductStatusCB cb) { <span style="color: #3F7E5E">// the two only updated</span>
     *         cb.specify().<span style="color: #FD4747">columnFooStatusCode()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *         cb.specify().<span style="color: #FD4747">columnBarDate()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *     }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdateNonstrict(List<ProductStatus> productStatusList, SpecifyQuery<ProductStatusCB> updateColumnSpec) {
        return doBatchUpdateNonstrict(productStatusList, createSpecifiedUpdateOption(updateColumnSpec));
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDeleteNonstrict(List<ProductStatus> productStatusList) {
        return doBatchDeleteNonstrict(productStatusList, null);
    }

    protected int[] doBatchDeleteNonstrict(List<ProductStatus> productStatusList, DeleteOption<ProductStatusCB> option) {
        assertObjectNotNull("productStatusList", productStatusList);
        prepareDeleteOption(option);
        return delegateBatchDeleteNonstrict(productStatusList, option);
    }
     ...
     * productStatusBhv.<span style="color: #FD4747">varyingUpdateNonstrict</span>(productStatus, option);
     * </pre>
     * @param productStatus The entity of update target. (NotNull, PrimaryKeyNotNull)
     * @param option The option of update for varying requests. (NotNull)
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdateNonstrict(ProductStatus productStatus, UpdateOption<ProductStatusCB> option) {
        assertUpdateOptionNotNull(option);
        doUpdateNonstrict(productStatus, option);
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdateNonstrict(ProductStatus productStatus, InsertOption<ProductStatusCB> insertOption, UpdateOption<ProductStatusCB> updateOption) {
        assertInsertOptionNotNull(insertOption); assertUpdateOptionNotNull(updateOption);
        doInesrtOrUpdateNonstrict(productStatus, insertOption, updateOption);
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDeleteNonstrict(ProductStatus productStatus, DeleteOption<ProductStatusCB> option) {
        assertDeleteOptionNotNull(option);
        doDeleteNonstrict(productStatus, option);
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdateNonstrict(List<ProductStatus> productStatusList, UpdateOption<ProductStatusCB> option) {
        assertUpdateOptionNotNull(option);
        return doBatchUpdateNonstrict(productStatusList, option);
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDeleteNonstrict(List<ProductStatus> productStatusList, DeleteOption<ProductStatusCB> option) {
        assertDeleteOptionNotNull(option);
        return doBatchDeleteNonstrict(productStatusList, option);
    }
