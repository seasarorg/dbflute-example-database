...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable {
     ...
     * @param memberStatusCode : PK, VARCHAR(255), classification=MemberStatus. (NotNull)
     ...
     * }
     * </pre>
     * @param memberStatus The entity of update. (NotNull, PrimaryKeyNotNull, ConcurrencyColumnNotNull)
     ...
     * memberStatusBhv.<span style="color: #DD4747">updateNonstrict</span>(memberStatus);
     * </pre>
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void updateNonstrict(MemberStatus memberStatus) {
        doUpdateNonstrict(memberStatus, null);
    }

    protected void doUpdateNonstrict(MemberStatus et, UpdateOption<MemberStatusCB> op) {
        assertObjectNotNull("memberStatus", et); prepareUpdateOption(op); helpUpdateNonstrictInternally(et, op);
    }
    ...
    public void insertOrUpdateNonstrict(MemberStatus memberStatus) {
        doInsertOrUpdateNonstrict(memberStatus, null, null);
    }

    protected void doInsertOrUpdateNonstrict(MemberStatus et, InsertOption<MemberStatusCB> iop, UpdateOption<MemberStatusCB> uop) {
        assertObjectNotNull("memberStatus", et); helpInsertOrUpdateNonstrictInternally(et, iop, uop);
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//memberStatus.setVersionNo(value);</span>
     * memberStatusBhv.<span style="color: #DD4747">deleteNonstrict</span>(memberStatus);
     * </pre>
    ...
    protected void doDeleteNonstrict(MemberStatus et, final DeleteOption<MemberStatusCB> op) {
        assertObjectNotNull("memberStatus", et); prepareDeleteOption(op); helpDeleteNonstrictInternally(et, op);
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//memberStatus.setVersionNo(value);</span>
     * memberStatusBhv.<span style="color: #DD4747">deleteNonstrictIgnoreDeleted</span>(memberStatus);
    ...
    protected void doDeleteNonstrictIgnoreDeleted(MemberStatus et, final DeleteOption<MemberStatusCB> op) {
        assertObjectNotNull("memberStatus", et); prepareDeleteOption(op); helpDeleteNonstrictIgnoreDeletedInternally(et, op);
    }
     ...
     * </pre>
     * @param memberStatusList The list of the entity. (NotNull, EmptyAllowed, PrimaryKeyNotNull, ConcurrencyColumnNotNull)
    ...
    public int[] batchUpdateNonstrict(List<MemberStatus> memberStatusList) {
        return doBatchUpdateNonstrict(memberStatusList, null);
    }

    protected int[] doBatchUpdateNonstrict(List<MemberStatus> ls, UpdateOption<MemberStatusCB> op) {
        assertObjectNotNull("memberStatusList", ls);
        UpdateOption<MemberStatusCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
     ...
     * <pre>
     * <span style="color: #3F7E5E">// e.g. update two columns only</span>
     * memberStatusBhv.<span style="color: #DD4747">batchUpdateNonstrict</span>(memberStatusList, new SpecifyQuery<MemberStatusCB>() {
     *     public void specify(MemberStatusCB cb) { <span style="color: #3F7E5E">// the two only updated</span>
     *         cb.specify().<span style="color: #DD4747">columnFooStatusCode()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *         cb.specify().<span style="color: #DD4747">columnBarDate()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *     }
    ...
    protected int[] doBatchDeleteNonstrict(List<MemberStatus> ls, DeleteOption<MemberStatusCB> op) {
        assertObjectNotNull("memberStatusList", ls);
        prepareDeleteOption(op);
     ...
     * memberStatusBhv.<span style="color: #DD4747">varyingUpdateNonstrict</span>(memberStatus, option);
     * </pre>
     * @param memberStatus The entity of update. (NotNull, PrimaryKeyNotNull)
     * @param option The option of update for varying requests. (NotNull)
     * @exception EntityAlreadyDeletedException When the entity has already been deleted. (not found)
    ...
    public void varyingInsertOrUpdateNonstrict(MemberStatus memberStatus, InsertOption<MemberStatusCB> insertOption, UpdateOption<MemberStatusCB> updateOption) {
        assertInsertOptionNotNull(insertOption); assertUpdateOptionNotNull(updateOption);
        doInsertOrUpdateNonstrict(memberStatus, insertOption, updateOption);
    }
