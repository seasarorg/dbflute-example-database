...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable {
     ...
     * memberStatusBhv.<span style="color: #FD4747">updateNonstrict</span>(memberStatus);
     * </pre>
     * @param memberStatus The entity of update target. (NotNull, PrimaryKeyNotNull)
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void updateNonstrict(final MemberStatus memberStatus) {
        doUpdateNonstrict(memberStatus, null);
    }

    protected void doUpdateNonstrict(MemberStatus memberStatus, final UpdateOption<MemberStatusCB> option) {
        assertObjectNotNull("memberStatus", memberStatus);
        prepareUpdateOption(option);
        helpUpdateNonstrictInternally(memberStatus, new InternalUpdateNonstrictCallback<MemberStatus>() {
            public int callbackDelegateUpdateNonstrict(MemberStatus entity) { return delegateUpdateNonstrict(entity, option); } });
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdateNonstrict(MemberStatus memberStatus) {
        doInesrtOrUpdateNonstrict(memberStatus, null, null);
    }

    protected void doInesrtOrUpdateNonstrict(MemberStatus memberStatus, final InsertOption<MemberStatusCB> insertOption, final UpdateOption<MemberStatusCB> updateOption) {
        helpInsertOrUpdateInternally(memberStatus, new InternalInsertOrUpdateNonstrictCallback<MemberStatus>() {
            public void callbackInsert(MemberStatus entity) { doInsert(entity, insertOption); }
            public void callbackUpdateNonstrict(MemberStatus entity) { doUpdateNonstrict(entity, updateOption); }
        });
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//memberStatus.setVersionNo(value);</span>
     * memberStatusBhv.<span style="color: #FD4747">deleteNonstrict</span>(memberStatus);
     * </pre>
     * @param memberStatus The entity of delete target. (NotNull, PrimaryKeyNotNull)
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
    public void deleteNonstrict(MemberStatus memberStatus) {
        doDeleteNonstrict(memberStatus, null);
    }

    protected void doDeleteNonstrict(MemberStatus memberStatus, final DeleteOption<MemberStatusCB> option) {
        assertObjectNotNull("memberStatus", memberStatus);
        prepareDeleteOption(option);
        helpDeleteNonstrictInternally(memberStatus, new InternalDeleteNonstrictCallback<MemberStatus>() {
            public int callbackDelegateDeleteNonstrict(MemberStatus entity) { return delegateDeleteNonstrict(entity, option); } });
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//memberStatus.setVersionNo(value);</span>
     * memberStatusBhv.<span style="color: #FD4747">deleteNonstrictIgnoreDeleted</span>(memberStatus);
     * <span style="color: #3F7E5E">// if the target entity doesn't exist, no exception</span>
     * </pre>
     * @param memberStatus The entity of delete target. (NotNull, PrimaryKeyNotNull)
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
    public void deleteNonstrictIgnoreDeleted(MemberStatus memberStatus) {
        doDeleteNonstrictIgnoreDeleted(memberStatus, null);
    }

    protected void doDeleteNonstrictIgnoreDeleted(MemberStatus memberStatus, final DeleteOption<MemberStatusCB> option) {
        assertObjectNotNull("memberStatus", memberStatus);
        prepareDeleteOption(option);
        helpDeleteNonstrictIgnoreDeletedInternally(memberStatus, new InternalDeleteNonstrictIgnoreDeletedCallback<MemberStatus>() {
            public int callbackDelegateDeleteNonstrict(MemberStatus entity) { return delegateDeleteNonstrict(entity, option); } });
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdateNonstrict(List<MemberStatus> memberStatusList) {
        UpdateOption<MemberStatusCB> option = createPlainUpdateOption();
        return doBatchUpdateNonstrict(memberStatusList, option);
    }

    protected int[] doBatchUpdateNonstrict(List<MemberStatus> memberStatusList, UpdateOption<MemberStatusCB> option) {
        assertObjectNotNull("memberStatusList", memberStatusList);
        prepareBatchUpdateOption(memberStatusList, option);
        return delegateBatchUpdateNonstrict(memberStatusList, option);
    }
     ...
     * <pre>
     * <span style="color: #3F7E5E">// e.g. update two columns only</span> 
     * memberStatusBhv.<span style="color: #FD4747">batchUpdateNonstrict</span>(memberStatusList, new SpecifyQuery<MemberStatusCB>() {
     *     public void specify(MemberStatusCB cb) { <span style="color: #3F7E5E">// the two only updated</span>
     *         cb.specify().<span style="color: #FD4747">columnFooStatusCode()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *         cb.specify().<span style="color: #FD4747">columnBarDate()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *     }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdateNonstrict(List<MemberStatus> memberStatusList, SpecifyQuery<MemberStatusCB> updateColumnSpec) {
        return doBatchUpdateNonstrict(memberStatusList, createSpecifiedUpdateOption(updateColumnSpec));
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDeleteNonstrict(List<MemberStatus> memberStatusList) {
        return doBatchDeleteNonstrict(memberStatusList, null);
    }

    protected int[] doBatchDeleteNonstrict(List<MemberStatus> memberStatusList, DeleteOption<MemberStatusCB> option) {
        assertObjectNotNull("memberStatusList", memberStatusList);
        prepareDeleteOption(option);
        return delegateBatchDeleteNonstrict(memberStatusList, option);
    }
     ...
     * memberStatusBhv.<span style="color: #FD4747">varyingUpdateNonstrict</span>(memberStatus, option);
     * </pre>
     * @param memberStatus The entity of update target. (NotNull, PrimaryKeyNotNull)
     * @param option The option of update for varying requests. (NotNull)
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdateNonstrict(MemberStatus memberStatus, UpdateOption<MemberStatusCB> option) {
        assertUpdateOptionNotNull(option);
        doUpdateNonstrict(memberStatus, option);
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdateNonstrict(MemberStatus memberStatus, InsertOption<MemberStatusCB> insertOption, UpdateOption<MemberStatusCB> updateOption) {
        assertInsertOptionNotNull(insertOption); assertUpdateOptionNotNull(updateOption);
        doInesrtOrUpdateNonstrict(memberStatus, insertOption, updateOption);
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDeleteNonstrict(MemberStatus memberStatus, DeleteOption<MemberStatusCB> option) {
        assertDeleteOptionNotNull(option);
        doDeleteNonstrict(memberStatus, option);
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdateNonstrict(List<MemberStatus> memberStatusList, UpdateOption<MemberStatusCB> option) {
        assertUpdateOptionNotNull(option);
        return doBatchUpdateNonstrict(memberStatusList, option);
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDeleteNonstrict(List<MemberStatus> memberStatusList, DeleteOption<MemberStatusCB> option) {
        assertDeleteOptionNotNull(option);
        return doBatchDeleteNonstrict(memberStatusList, option);
    }
