...
public class MemberLoginDbm extends AbstractDBMeta {
    ...
    public static class EpgLoginDatetime implements PropertyGateway {
        ...
        public void write(Entity et, Object vl) { ((MemberLogin)et).setLoginDatetime((String)vl); }
    }
    public static class EpgLoginMobileFlg implements PropertyGateway {
        public Object read(Entity et) { return ((MemberLogin)et).getLoginMobileFlg(); }
        public void write(Entity et, Object vl) { ((MemberLogin)et).setLoginMobileFlg((String)vl); }
    }
    ...
    public static class EpgRegisterDatetime implements PropertyGateway {
        public Object read(Entity et) { return ((MemberLogin)et).getRegisterDatetime(); }
        public void write(Entity et, Object vl) { ((MemberLogin)et).setRegisterDatetime((java.sql.Timestamp)vl); }
    }
    public static class EpgRegisterUser implements PropertyGateway {
        public Object read(Entity et) { return ((MemberLogin)et).getRegisterUser(); }
        public void write(Entity et, Object vl) { ((MemberLogin)et).setRegisterUser((String)vl); }
    }
    public static class EpgRegisterProcess implements PropertyGateway {
        public Object read(Entity et) { return ((MemberLogin)et).getRegisterProcess(); }
        public void write(Entity et, Object vl) { ((MemberLogin)et).setRegisterProcess((String)vl); }
    }
    public static class EpgUpdateDatetime implements PropertyGateway {
        public Object read(Entity et) { return ((MemberLogin)et).getUpdateDatetime(); }
        public void write(Entity et, Object vl) { ((MemberLogin)et).setUpdateDatetime((java.sql.Timestamp)vl); }
    }
    public static class EpgUpdateUser implements PropertyGateway {
        public Object read(Entity et) { return ((MemberLogin)et).getUpdateUser(); }
        public void write(Entity et, Object vl) { ((MemberLogin)et).setUpdateUser((String)vl); }
    }
    public static class EpgUpdateProcess implements PropertyGateway {
        public Object read(Entity et) { return ((MemberLogin)et).getUpdateProcess(); }
        public void write(Entity et, Object vl) { ((MemberLogin)et).setUpdateProcess((String)vl); }
    }
    public static class EpgVersionNo implements PropertyGateway {
        public Object read(Entity et) { return ((MemberLogin)et).getVersionNo(); }
        public void write(Entity et, Object vl) { ((MemberLogin)et).setVersionNo(cti(vl)); }
    }
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberLoginId = cci("MEMBER_LOGIN_ID", "MEMBER_LOGIN_ID", null, null, Integer.class, "memberLoginId", null, true, true, true, "COUNTER", 10, 0, null, false, null, null, null, null, null);
    ...
    protected final ColumnInfo _columnLoginDatetime = cci("LOGIN_DATETIME", "LOGIN_DATETIME", null, null, String.class, "loginDatetime", null, false, false, false, "VARCHAR", 255, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnLoginMobileFlg = cci("LOGIN_MOBILE_FLG", "LOGIN_MOBILE_FLG", null, null, String.class, "loginMobileFlg", null, false, false, false, "VARCHAR", 255, 0, null, false, null, null, null, null, CDef.DefMeta.Flg);
    protected final ColumnInfo _columnLoginMemberStatusCode = cci("LOGIN_MEMBER_STATUS_CODE", "LOGIN_MEMBER_STATUS_CODE", null, null, String.class, "loginMemberStatusCode", null, false, false, false, "VARCHAR", 255, 0, null, false, null, null, "memberStatus", null, null);
    ...
    public ForeignInfo foreignMemberStatus() {
        ...
        return cfi("FK_MEMBER_LOGIN_MEMBER_STATUS", "memberStatus", this, MemberStatusDbm.getInstance(), mp, 0, null, false, false, false, true, null, null, false, "memberLoginList");
    }
    /**
    ...
    public ForeignInfo foreignMember() {
        ...
        return cfi("FK_MEMBER_LOGIN_MEMBER", "member", this, MemberDbm.getInstance(), mp, 1, null, false, false, false, true, null, null, false, "memberLoginList");
    }
