package com.example.dbflute.msaccess.dbflute.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("MEMBER", "com.example.dbflute.msaccess.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("MEMBER_ADDRESS", "com.example.dbflute.msaccess.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("MEMBER_LOGIN", "com.example.dbflute.msaccess.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("MEMBER_SECURITY", "com.example.dbflute.msaccess.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("MEMBER_STATUS", "com.example.dbflute.msaccess.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("MEMBER_WITHDRAWAL", "com.example.dbflute.msaccess.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("PRODUCT", "com.example.dbflute.msaccess.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("PRODUCT_STATUS", "com.example.dbflute.msaccess.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("PURCHASE", "com.example.dbflute.msaccess.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("WITHDRAWAL_REASON", "com.example.dbflute.msaccess.dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
