package com.example.dbflute.msaccess.dbflute.cbean.bs;
...
import com.example.dbflute.msaccess.dbflute.allcommon.DBFluteConfig;
import com.example.dbflute.msaccess.dbflute.allcommon.DBMetaInstanceHandler;
import com.example.dbflute.msaccess.dbflute.allcommon.ImplementedInvokerAssistant;
import com.example.dbflute.msaccess.dbflute.allcommon.ImplementedSqlClauseCreator;
import com.example.dbflute.msaccess.dbflute.cbean.*;
import com.example.dbflute.msaccess.dbflute.cbean.cq.*;
import com.example.dbflute.msaccess.dbflute.cbean.nss.*;
...
public class BsMemberCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnMemberFormalizedDatetime() { return doColumn("MEMBER_FORMALIZED_DATETIME"); }
        /**
         * MEMBER_BIRTHDAY: {DATETIME(19)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnMemberBirthday() { return doColumn("MEMBER_BIRTHDAY"); }
        /**
