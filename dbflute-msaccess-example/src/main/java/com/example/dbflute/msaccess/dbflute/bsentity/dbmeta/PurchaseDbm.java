...
public class PurchaseDbm extends AbstractDBMeta {
    ...
    public static class EpgPaymentCompleteFlg implements PropertyGateway {
        ...
        public void write(Entity e, Object v) { ((Purchase)e).setPaymentCompleteFlg((String)v); }
    }
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPurchaseId = cci("PURCHASE_ID", "PURCHASE_ID", null, null, true, "purchaseId", Integer.class, true, true, "COUNTER", 10, 0, null, false, null, null, null, null, null);
    ...
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, null, false, "productId", Integer.class, false, false, "INTEGER", 10, 0, null, false, null, null, "product", null, null);
    protected final ColumnInfo _columnPurchaseDatetime = cci("PURCHASE_DATETIME", "PURCHASE_DATETIME", null, null, false, "purchaseDatetime", java.sql.Timestamp.class, false, false, "DATETIME", 19, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnPurchaseCount = cci("PURCHASE_COUNT", "PURCHASE_COUNT", null, null, false, "purchaseCount", Integer.class, false, false, "INTEGER", 10, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnPurchasePrice = cci("PURCHASE_PRICE", "PURCHASE_PRICE", null, null, false, "purchasePrice", Integer.class, false, false, "INTEGER", 10, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnPaymentCompleteFlg = cci("PAYMENT_COMPLETE_FLG", "PAYMENT_COMPLETE_FLG", null, null, false, "paymentCompleteFlg", String.class, false, false, "VARCHAR", 255, 0, null, false, null, null, null, null, CDef.DefMeta.Flg);
    ...
    public ForeignInfo foreignMember() {
        ...
        return cfi("FK_PURCHASE_MEMBER", "member", this, MemberDbm.getInstance(), map, 0, false, false, false, true, null, null, false, "purchaseList");
    }
    public ForeignInfo foreignProduct() {
        ...
        return cfi("FK_PURCHASE_PRODUCT", "product", this, ProductDbm.getInstance(), map, 1, false, false, false, true, null, null, false, "purchaseList");
    }
