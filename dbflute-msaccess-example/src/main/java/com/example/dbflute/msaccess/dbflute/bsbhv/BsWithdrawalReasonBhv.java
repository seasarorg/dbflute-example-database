...
public abstract class BsWithdrawalReasonBhv extends AbstractBehaviorWritable {
     ...
     * @param withdrawalReasonCode : PK, VARCHAR(255). (NotNull)
     ...
     * }
     * </pre>
     * @param withdrawalReason The entity of update. (NotNull, PrimaryKeyNotNull, ConcurrencyColumnNotNull)
     ...
     * withdrawalReasonBhv.<span style="color: #DD4747">updateNonstrict</span>(withdrawalReason);
     * </pre>
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void updateNonstrict(WithdrawalReason withdrawalReason) {
        doUpdateNonstrict(withdrawalReason, null);
    }

    protected void doUpdateNonstrict(WithdrawalReason et, UpdateOption<WithdrawalReasonCB> op) {
        assertObjectNotNull("withdrawalReason", et); prepareUpdateOption(op); helpUpdateNonstrictInternally(et, op);
    }
    ...
    public void insertOrUpdateNonstrict(WithdrawalReason withdrawalReason) {
        doInsertOrUpdateNonstrict(withdrawalReason, null, null);
    }

    protected void doInsertOrUpdateNonstrict(WithdrawalReason et, InsertOption<WithdrawalReasonCB> iop, UpdateOption<WithdrawalReasonCB> uop) {
        assertObjectNotNull("withdrawalReason", et); helpInsertOrUpdateNonstrictInternally(et, iop, uop);
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//withdrawalReason.setVersionNo(value);</span>
     * withdrawalReasonBhv.<span style="color: #DD4747">deleteNonstrict</span>(withdrawalReason);
     * </pre>
    ...
    protected void doDeleteNonstrict(WithdrawalReason et, final DeleteOption<WithdrawalReasonCB> op) {
        assertObjectNotNull("withdrawalReason", et); prepareDeleteOption(op); helpDeleteNonstrictInternally(et, op);
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//withdrawalReason.setVersionNo(value);</span>
     * withdrawalReasonBhv.<span style="color: #DD4747">deleteNonstrictIgnoreDeleted</span>(withdrawalReason);
    ...
    protected void doDeleteNonstrictIgnoreDeleted(WithdrawalReason et, final DeleteOption<WithdrawalReasonCB> op) {
        assertObjectNotNull("withdrawalReason", et); prepareDeleteOption(op); helpDeleteNonstrictIgnoreDeletedInternally(et, op);
    }
     ...
     * </pre>
     * @param withdrawalReasonList The list of the entity. (NotNull, EmptyAllowed, PrimaryKeyNotNull, ConcurrencyColumnNotNull)
    ...
    public int[] batchUpdateNonstrict(List<WithdrawalReason> withdrawalReasonList) {
        return doBatchUpdateNonstrict(withdrawalReasonList, null);
    }

    protected int[] doBatchUpdateNonstrict(List<WithdrawalReason> ls, UpdateOption<WithdrawalReasonCB> op) {
        assertObjectNotNull("withdrawalReasonList", ls);
        UpdateOption<WithdrawalReasonCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
     ...
     * <pre>
     * <span style="color: #3F7E5E">// e.g. update two columns only</span>
     * withdrawalReasonBhv.<span style="color: #DD4747">batchUpdateNonstrict</span>(withdrawalReasonList, new SpecifyQuery<WithdrawalReasonCB>() {
     *     public void specify(WithdrawalReasonCB cb) { <span style="color: #3F7E5E">// the two only updated</span>
     *         cb.specify().<span style="color: #DD4747">columnFooStatusCode()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *         cb.specify().<span style="color: #DD4747">columnBarDate()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *     }
    ...
    protected int[] doBatchDeleteNonstrict(List<WithdrawalReason> ls, DeleteOption<WithdrawalReasonCB> op) {
        assertObjectNotNull("withdrawalReasonList", ls);
        prepareDeleteOption(op);
     ...
     * withdrawalReasonBhv.<span style="color: #DD4747">varyingUpdateNonstrict</span>(withdrawalReason, option);
     * </pre>
     * @param withdrawalReason The entity of update. (NotNull, PrimaryKeyNotNull)
     * @param option The option of update for varying requests. (NotNull)
     * @exception EntityAlreadyDeletedException When the entity has already been deleted. (not found)
    ...
    public void varyingInsertOrUpdateNonstrict(WithdrawalReason withdrawalReason, InsertOption<WithdrawalReasonCB> insertOption, UpdateOption<WithdrawalReasonCB> updateOption) {
        assertInsertOptionNotNull(insertOption); assertUpdateOptionNotNull(updateOption);
        doInsertOrUpdateNonstrict(withdrawalReason, insertOption, updateOption);
    }
