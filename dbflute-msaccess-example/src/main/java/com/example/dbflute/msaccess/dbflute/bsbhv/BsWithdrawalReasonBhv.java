...
public abstract class BsWithdrawalReasonBhv extends AbstractBehaviorWritable {
     ...
     * withdrawalReasonBhv.<span style="color: #FD4747">updateNonstrict</span>(withdrawalReason);
     * </pre>
     * @param withdrawalReason The entity of update target. (NotNull, PrimaryKeyNotNull)
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void updateNonstrict(final WithdrawalReason withdrawalReason) {
        doUpdateNonstrict(withdrawalReason, null);
    }

    protected void doUpdateNonstrict(WithdrawalReason withdrawalReason, final UpdateOption<WithdrawalReasonCB> option) {
        assertObjectNotNull("withdrawalReason", withdrawalReason);
        prepareUpdateOption(option);
        helpUpdateNonstrictInternally(withdrawalReason, new InternalUpdateNonstrictCallback<WithdrawalReason>() {
            public int callbackDelegateUpdateNonstrict(WithdrawalReason entity) { return delegateUpdateNonstrict(entity, option); } });
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdateNonstrict(WithdrawalReason withdrawalReason) {
        doInesrtOrUpdateNonstrict(withdrawalReason, null, null);
    }

    protected void doInesrtOrUpdateNonstrict(WithdrawalReason withdrawalReason, final InsertOption<WithdrawalReasonCB> insertOption, final UpdateOption<WithdrawalReasonCB> updateOption) {
        helpInsertOrUpdateInternally(withdrawalReason, new InternalInsertOrUpdateNonstrictCallback<WithdrawalReason>() {
            public void callbackInsert(WithdrawalReason entity) { doInsert(entity, insertOption); }
            public void callbackUpdateNonstrict(WithdrawalReason entity) { doUpdateNonstrict(entity, updateOption); }
        });
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//withdrawalReason.setVersionNo(value);</span>
     * withdrawalReasonBhv.<span style="color: #FD4747">deleteNonstrict</span>(withdrawalReason);
     * </pre>
     * @param withdrawalReason The entity of delete target. (NotNull, PrimaryKeyNotNull)
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
    public void deleteNonstrict(WithdrawalReason withdrawalReason) {
        doDeleteNonstrict(withdrawalReason, null);
    }

    protected void doDeleteNonstrict(WithdrawalReason withdrawalReason, final DeleteOption<WithdrawalReasonCB> option) {
        assertObjectNotNull("withdrawalReason", withdrawalReason);
        prepareDeleteOption(option);
        helpDeleteNonstrictInternally(withdrawalReason, new InternalDeleteNonstrictCallback<WithdrawalReason>() {
            public int callbackDelegateDeleteNonstrict(WithdrawalReason entity) { return delegateDeleteNonstrict(entity, option); } });
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//withdrawalReason.setVersionNo(value);</span>
     * withdrawalReasonBhv.<span style="color: #FD4747">deleteNonstrictIgnoreDeleted</span>(withdrawalReason);
     * <span style="color: #3F7E5E">// if the target entity doesn't exist, no exception</span>
     * </pre>
     * @param withdrawalReason The entity of delete target. (NotNull, PrimaryKeyNotNull)
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
    public void deleteNonstrictIgnoreDeleted(WithdrawalReason withdrawalReason) {
        doDeleteNonstrictIgnoreDeleted(withdrawalReason, null);
    }

    protected void doDeleteNonstrictIgnoreDeleted(WithdrawalReason withdrawalReason, final DeleteOption<WithdrawalReasonCB> option) {
        assertObjectNotNull("withdrawalReason", withdrawalReason);
        prepareDeleteOption(option);
        helpDeleteNonstrictIgnoreDeletedInternally(withdrawalReason, new InternalDeleteNonstrictIgnoreDeletedCallback<WithdrawalReason>() {
            public int callbackDelegateDeleteNonstrict(WithdrawalReason entity) { return delegateDeleteNonstrict(entity, option); } });
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdateNonstrict(List<WithdrawalReason> withdrawalReasonList) {
        UpdateOption<WithdrawalReasonCB> option = createPlainUpdateOption();
        return doBatchUpdateNonstrict(withdrawalReasonList, option);
    }

    protected int[] doBatchUpdateNonstrict(List<WithdrawalReason> withdrawalReasonList, UpdateOption<WithdrawalReasonCB> option) {
        assertObjectNotNull("withdrawalReasonList", withdrawalReasonList);
        prepareBatchUpdateOption(withdrawalReasonList, option);
        return delegateBatchUpdateNonstrict(withdrawalReasonList, option);
    }
     ...
     * <pre>
     * <span style="color: #3F7E5E">// e.g. update two columns only</span> 
     * withdrawalReasonBhv.<span style="color: #FD4747">batchUpdateNonstrict</span>(withdrawalReasonList, new SpecifyQuery<WithdrawalReasonCB>() {
     *     public void specify(WithdrawalReasonCB cb) { <span style="color: #3F7E5E">// the two only updated</span>
     *         cb.specify().<span style="color: #FD4747">columnFooStatusCode()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *         cb.specify().<span style="color: #FD4747">columnBarDate()</span>; <span style="color: #3F7E5E">// should be modified in any entities</span>
     *     }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdateNonstrict(List<WithdrawalReason> withdrawalReasonList, SpecifyQuery<WithdrawalReasonCB> updateColumnSpec) {
        return doBatchUpdateNonstrict(withdrawalReasonList, createSpecifiedUpdateOption(updateColumnSpec));
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDeleteNonstrict(List<WithdrawalReason> withdrawalReasonList) {
        return doBatchDeleteNonstrict(withdrawalReasonList, null);
    }

    protected int[] doBatchDeleteNonstrict(List<WithdrawalReason> withdrawalReasonList, DeleteOption<WithdrawalReasonCB> option) {
        assertObjectNotNull("withdrawalReasonList", withdrawalReasonList);
        prepareDeleteOption(option);
        return delegateBatchDeleteNonstrict(withdrawalReasonList, option);
    }
     ...
     * withdrawalReasonBhv.<span style="color: #FD4747">varyingUpdateNonstrict</span>(withdrawalReason, option);
     * </pre>
     * @param withdrawalReason The entity of update target. (NotNull, PrimaryKeyNotNull)
     * @param option The option of update for varying requests. (NotNull)
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdateNonstrict(WithdrawalReason withdrawalReason, UpdateOption<WithdrawalReasonCB> option) {
        assertUpdateOptionNotNull(option);
        doUpdateNonstrict(withdrawalReason, option);
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdateNonstrict(WithdrawalReason withdrawalReason, InsertOption<WithdrawalReasonCB> insertOption, UpdateOption<WithdrawalReasonCB> updateOption) {
        assertInsertOptionNotNull(insertOption); assertUpdateOptionNotNull(updateOption);
        doInesrtOrUpdateNonstrict(withdrawalReason, insertOption, updateOption);
    }
     ...
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDeleteNonstrict(WithdrawalReason withdrawalReason, DeleteOption<WithdrawalReasonCB> option) {
        assertDeleteOptionNotNull(option);
        doDeleteNonstrict(withdrawalReason, option);
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdateNonstrict(List<WithdrawalReason> withdrawalReasonList, UpdateOption<WithdrawalReasonCB> option) {
        assertUpdateOptionNotNull(option);
        return doBatchUpdateNonstrict(withdrawalReasonList, option);
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDeleteNonstrict(List<WithdrawalReason> withdrawalReasonList, DeleteOption<WithdrawalReasonCB> option) {
        assertDeleteOptionNotNull(option);
        return doBatchDeleteNonstrict(withdrawalReasonList, option);
    }
