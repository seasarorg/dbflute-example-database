...
public class MemberDbm extends AbstractDBMeta {
    ...
    public static class EpgMemberFormalizedDatetime implements PropertyGateway {
        public Object read(Entity et) { return ((Member)et).getMemberFormalizedDatetime(); }
        public void write(Entity et, Object vl) { ((Member)et).setMemberFormalizedDatetime((java.sql.Timestamp)vl); }
    }
    public static class EpgMemberBirthday implements PropertyGateway {
        public Object read(Entity et) { return ((Member)et).getMemberBirthday(); }
        public void write(Entity et, Object vl) { ((Member)et).setMemberBirthday((java.sql.Timestamp)vl); }
    }
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, null, Integer.class, "memberId", null, true, true, true, "COUNTER", 10, 0, null, false, null, null, "memberAddressAsValid,memberWithdrawalAsOne,memberSecurityAsOne", "memberAddressList,purchaseList,memberLoginList", null);
    ...
    protected final ColumnInfo _columnMemberAccount = cci("MEMBER_ACCOUNT", "MEMBER_ACCOUNT", null, null, String.class, "memberAccount", null, false, false, false, "VARCHAR", 255, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnMemberStatusCode = cci("MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", null, null, String.class, "memberStatusCode", null, false, false, false, "VARCHAR", 255, 0, null, false, null, null, "memberStatus", null, CDef.DefMeta.MemberStatus);
    ...
    public ForeignInfo foreignMemberAddressAsValid() {
        ...
        return cfi("FK_MEMBER_MEMBER_ADDRESS_VALID", "memberAddressAsValid", this, MemberAddressDbm.getInstance(), mp, 0, null, true, true, false, true, "$$foreignAlias$$.VALID_BEGIN_DATE <= /*$$locationBase$$.parameterMapMemberAddressAsValid.targetDate*/null\n     and $$foreignAlias$$.VALID_END_DATE >= /*$$locationBase$$.parameterMapMemberAddressAsValid.targetDate*/null", newArrayList("targetDate"), false, null);
    }
    /**
    ...
    public ForeignInfo foreignMemberStatus() {
        ...
        return cfi("FK_MEMBER_MEMBER_STATUS", "memberStatus", this, MemberStatusDbm.getInstance(), mp, 1, null, false, false, false, true, null, null, false, "memberList");
    }
    /**
    ...
    public ForeignInfo foreignMemberWithdrawalAsOne() {
        ...
        return cfi("FK_MEMBER_WITHDRAWAL_MEMBER", "memberWithdrawalAsOne", this, MemberWithdrawalDbm.getInstance(), mp, 2, null, true, false, true, true, null, null, false, "member");
    }
    /**
    ...
    public ForeignInfo foreignMemberSecurityAsOne() {
        ...
        return cfi("FK_MEMBER_SECURITY_MEMBER", "memberSecurityAsOne", this, MemberSecurityDbm.getInstance(), mp, 3, null, true, false, true, true, null, null, false, "member");
    }
    ...
    public ReferrerInfo referrerMemberAddressList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnMemberId(), MemberAddressDbm.getInstance().columnMemberId());
        return cri("FK_MEMBER_ADDRESS_MEMBER_IMPLICIT", "memberAddressList", this, MemberAddressDbm.getInstance(), mp, false, "member");
    }
    /**
