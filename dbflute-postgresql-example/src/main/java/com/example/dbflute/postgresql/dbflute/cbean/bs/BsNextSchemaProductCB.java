...
public class BsNextSchemaProductCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public NextSchemaProductCB acceptPK(Integer productId) {
    ...
    public static class HpSpecification extends HpAbstractSpecification<NextSchemaProductCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #DD4747">derivedWhiteSameNameList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;WhiteSameNameCB&gt;() {
         *     public void query(WhiteSameNameCB subCB) {
         *         subCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, WhiteSameName.<span style="color: #DD4747">ALIAS_foo...</span>);
         * </pre>
        ...
        public HpSDRFunction<WhiteSameNameCB, NextSchemaProductCQ> derivedWhiteSameNameList() {
            ...
            return new HpSDRFunction<WhiteSameNameCB, NextSchemaProductCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteSameNameCB, NextSchemaProductCQ>() {
                public void setup(String fn, SubQuery<WhiteSameNameCB> sq, NextSchemaProductCQ cq, String al, DerivedReferrerOption op) {
                    cq.xsderiveWhiteSameNameList(fn, sq, al, op); } }, _dbmetaProvider);
        }
        /**
