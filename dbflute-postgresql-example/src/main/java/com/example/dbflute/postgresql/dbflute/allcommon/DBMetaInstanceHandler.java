...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("member_login", "com.example.dbflute.postgresql.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("member_security", "com.example.dbflute.postgresql.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("member_service", "com.example.dbflute.postgresql.dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("member_status", "com.example.dbflute.postgresql.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("member_withdrawal", "com.example.dbflute.postgresql.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("product", "com.example.dbflute.postgresql.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("product_category", "com.example.dbflute.postgresql.dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("product_status", "com.example.dbflute.postgresql.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("purchase", "com.example.dbflute.postgresql.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("purchase_payment", "com.example.dbflute.postgresql.dbflute.bsentity.dbmeta.PurchasePaymentDbm");
        ...
        tmpMap.put("white_compound_pk_ref", "com.example.dbflute.postgresql.dbflute.bsentity.dbmeta.WhiteCompoundPkRefDbm");
        tmpMap.put("white_compound_pk_wrong_order", "com.example.dbflute.postgresql.dbflute.bsentity.dbmeta.WhiteCompoundPkWrongOrderDbm");
        tmpMap.put("white_not_pk", "com.example.dbflute.postgresql.dbflute.bsentity.dbmeta.WhiteNotPkDbm");
        tmpMap.put("white_same_name", "com.example.dbflute.postgresql.dbflute.bsentity.dbmeta.WhiteSameNameDbm");
