...
public class BsNextschemaWhiteSameNameRefCB extends AbstractConditionBean {
    ...
    //                                                                 PrimaryKey Handling
    //                                                                 ===================
    public void acceptPrimaryKey(Long sameNameRefId) {
    ...
    public NextschemaWhiteSameNameRefCQ getConditionQuery() { // public for parameter comment and internal
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;NextschemaWhiteSameNameRefCB&gt;() {
     *     public void query(NextschemaWhiteSameNameRefCB unionCB) {
     ...
     */
    public void union(UnionQuery<NextschemaWhiteSameNameRefCB> unionQuery) {
        final NextschemaWhiteSameNameRefCB cb = new NextschemaWhiteSameNameRefCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;NextschemaWhiteSameNameRefCB&gt;() {
     *     public void query(NextschemaWhiteSameNameRefCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<NextschemaWhiteSameNameRefCB> unionQuery) {
        final NextschemaWhiteSameNameRefCB cb = new NextschemaWhiteSameNameRefCB();
        cb.xsetupForUnion(this); xsyncUQ(cb); unionQuery.query(cb); xsaveUCB(cb);
    ...
    public NextschemaWhiteSameNameNss getNssWhiteSameName() {
     ...
     * NextschemaWhiteSameNameRef whiteSameNameRef = whiteSameNameRefBhv.selectEntityWithDeletedCheck(cb);
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<NextschemaWhiteSameNameRefCQ>() {
                public boolean has() { return true; }
                public NextschemaWhiteSameNameRefCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<NextschemaWhiteSameNameRefCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnNextRefDate() { return doColumn("next_ref_date"); }
        ...
        public NextschemaWhiteSameNameCB.HpSpecification specifyWhiteSameName() {
            ...
            if (_whiteSameName == null) {
                _whiteSameName = new NextschemaWhiteSameNameCB.HpSpecification(_baseCB, new HpSpQyCall<NextschemaWhiteSameNameCQ>() {
                    public boolean has() { return _qyCall.has() && _qyCall.qy().hasConditionQueryWhiteSameName(); }
                    public NextschemaWhiteSameNameCQ qy() { return _qyCall.qy().queryWhiteSameName(); } }
                    , _purpose, _dbmetaProvider);
                if (xhasSyncQyCall()) { // inherits it
                    _whiteSameName.xsetSyncQyCall(new HpSpQyCall<NextschemaWhiteSameNameCQ>() {
                        public boolean has() { return xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryWhiteSameName(); }
                        public NextschemaWhiteSameNameCQ qy() { return xsyncQyCall().qy().queryWhiteSameName(); }
                    });
                }
            }
        ...
        public HpSDRFunction<NextschemaWhiteSameNameRefCB, NextschemaWhiteSameNameRefCQ> myselfDerived() {
            ...
            return new HpSDRFunction<NextschemaWhiteSameNameRefCB, NextschemaWhiteSameNameRefCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<NextschemaWhiteSameNameRefCB, NextschemaWhiteSameNameRefCQ>() {
                public void setup(String function, SubQuery<NextschemaWhiteSameNameRefCB> subQuery, NextschemaWhiteSameNameRefCQ cq, String aliasName, DerivedReferrerOption option) {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;NextschemaWhiteSameNameRefCB&gt;() {
     ...
     */
    public HpColQyOperand<NextschemaWhiteSameNameRefCB> columnQuery(final SpecifyQuery<NextschemaWhiteSameNameRefCB> leftSpecifyQuery) {
        return new HpColQyOperand<NextschemaWhiteSameNameRefCB>(new HpColQyHandler<NextschemaWhiteSameNameRefCB>() {
            public HpCalculator handle(SpecifyQuery<NextschemaWhiteSameNameRefCB> rightSp, String operand) {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;NextschemaWhiteSameNameRefCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<NextschemaWhiteSameNameRefCB> orQuery) {
        xorSQ((NextschemaWhiteSameNameRefCB)this, orQuery);
    }
     ...
     *     public void query(NextschemaWhiteSameNameRefCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;NextschemaWhiteSameNameRefCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<NextschemaWhiteSameNameRefCB> andQuery) {
        xorSQAP((NextschemaWhiteSameNameRefCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        ...
        specify().xsetSyncQyCall(new HpSpQyCall<NextschemaWhiteSameNameRefCQ>() {
            public boolean has() { return true; }
            public NextschemaWhiteSameNameRefCQ qy() { return cb.query(); }
        });
    }
    ...
    protected String getConditionBeanClassNameInternally() { return NextschemaWhiteSameNameRefCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return NextschemaWhiteSameNameRefCQ.class.getName(); }
