...
public abstract class BsVendorUuidFooBhv extends AbstractBehaviorWritable<VendorUuidFoo, VendorUuidFooCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends VendorUuidFoo> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.postgresql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends VendorUuidFoo> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
