...
public abstract class BsVendorPartManBhv extends AbstractBehaviorWritable<VendorPartMan, VendorPartManCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends VendorPartMan> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.postgresql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends VendorPartMan> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
