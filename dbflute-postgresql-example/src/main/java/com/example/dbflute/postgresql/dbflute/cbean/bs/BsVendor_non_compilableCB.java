...
public class BsVendor_non_compilableCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;Vendor_non_compilableCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;Vendor_non_compilableCB&gt;() {
     *     public void query(Vendor_non_compilableCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">setupSelect_Vendor_non_compilableSelf()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * Vendor_non_compilable vendor_non_compilable = vendor_non_compilableBhv.selectEntityWithDeletedCheck(cb);
     * ... = vendor_non_compilable.<span style="color: #FD4747">getVendor_non_compilableSelf()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<Vendor_non_compilableCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #FD4747">derivedVendor_non_compilableSelfList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;Vendor_non_compilableCB&gt;() {
         *     public void query(Vendor_non_compilableCB subCB) {
         *         subCB.specify().<span style="color: #FD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, Vendor_non_compilable.<span style="color: #FD4747">ALIAS_foo...</span>);
         * </pre>
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;Vendor_non_compilableCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;Vendor_non_compilableCB&gt;() {
     ...
     *     public void query(Vendor_non_compilableCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;Vendor_non_compilableCB&gt;() {
