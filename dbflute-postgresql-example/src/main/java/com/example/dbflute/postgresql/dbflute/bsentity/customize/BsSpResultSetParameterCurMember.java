 ...
 */
public abstract class BsSpResultSetParameterCurMember implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSpResultSetParameterCurMember)) { return false; }
        BsSpResultSetParameterCurMember otherEntity = (BsSpResultSetParameterCurMember)other;
