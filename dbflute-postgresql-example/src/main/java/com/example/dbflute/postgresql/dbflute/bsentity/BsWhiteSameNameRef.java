...
public abstract class BsWhiteSameNameRef implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteSameNameRef)) { return false; }
        BsWhiteSameNameRef otherEntity = (BsWhiteSameNameRef)other;
    ...
    protected String buildColumnString() {
        ...
        sb.append(delimiter).append(getNextSameNameId());
