...
/**
 * The base condition-bean of vendor_inherit_inu.
 * @author DBFlute(AutoGenerator)
 */
public class BsVendorInheritInuCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected VendorInheritInuCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsVendorInheritInuCB() {
     ...
     * @return this. (NotNull)
     */
    public VendorInheritInuCB acceptPK(Integer inuId) {
        assertObjectNotNull("inuId", inuId);
        BsVendorInheritInuCB cb = this;
        cb.query().setInuId_Equal(inuId);
        return (VendorInheritInuCB)this;
    }
     ...
     * @param inuId : PK, NotNull, int4(10). (NotNull)
     */
    public void acceptPrimaryKey(Integer inuId) {
        assertObjectNotNull("inuId", inuId);
        BsVendorInheritInuCB cb = this;
        cb.query().setInuId_Equal(inuId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_InuId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_InuId_Desc();
        return this;
    }
    ...
    protected VendorInheritInuCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected VendorInheritInuCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        VendorInheritInuCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected VendorInheritInuCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void union(UnionQuery<VendorInheritInuCB> unionQuery) {
        final VendorInheritInuCB cb = new VendorInheritInuCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final VendorInheritInuCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<VendorInheritInuCB> unionQuery) {
        final VendorInheritInuCB cb = new VendorInheritInuCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final VendorInheritInuCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<VendorInheritInuCQ> {
        ...
        @Override
        protected String getTableDbName() { return "vendor_inherit_inu"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<VendorInheritInuCB, VendorInheritInuCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return new HpSDRFunction<VendorInheritInuCB, VendorInheritInuCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<VendorInheritInuCB, VendorInheritInuCQ>() {
                public void setup(String fn, SubQuery<VendorInheritInuCB> sq, VendorInheritInuCQ cq, String al, DerivedReferrerOption op) {
     ...
     */
    public HpColQyOperand<VendorInheritInuCB> columnQuery(final SpecifyQuery<VendorInheritInuCB> leftSpecifyQuery) {
        return new HpColQyOperand<VendorInheritInuCB>(new HpColQyHandler<VendorInheritInuCB>() {
    ...
    protected VendorInheritInuCB xcreateColumnQueryCB() {
        VendorInheritInuCB cb = new VendorInheritInuCB();
        cb.xsetupForColumnQuery((VendorInheritInuCB)this);
        return cb;
    }
     ...
     */
    public VendorInheritInuCB dreamCruiseCB() {
        VendorInheritInuCB cb = new VendorInheritInuCB();
        cb.xsetupForDreamCruise((VendorInheritInuCB) this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<VendorInheritInuCB> orQuery) {
        xorSQ((VendorInheritInuCB)this, orQuery);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<VendorInheritInuCB> andQuery) {
        xorSQAP((VendorInheritInuCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final VendorInheritInuCB cb;
        if (mainCB != null) {
            cb = (VendorInheritInuCB)mainCB;
        } else {
            cb = new VendorInheritInuCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<VendorInheritInuCQ>() {
            public boolean has() { return true; }
            public VendorInheritInuCQ qy() { return cb.query(); }
        });
    }
