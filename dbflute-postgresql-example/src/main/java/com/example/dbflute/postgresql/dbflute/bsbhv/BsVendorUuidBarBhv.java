...
public abstract class BsVendorUuidBarBhv extends AbstractBehaviorWritable {
    ...
    protected void doInsert(VendorUuidBar et, InsertOption<VendorUuidBarCB> op) {
        assertObjectNotNull("vendorUuidBar", et); prepareInsertOption(op); delegateInsert(et, op);
    }
    ...
    protected void doUpdate(VendorUuidBar et, UpdateOption<VendorUuidBarCB> op) {
        assertObjectNotNull("vendorUuidBar", et); prepareUpdateOption(op); helpUpdateInternally(et, op);
    }
    ...
    protected void doInsertOrUpdate(VendorUuidBar et, InsertOption<VendorUuidBarCB> iop, UpdateOption<VendorUuidBarCB> uop) {
        assertObjectNotNull("vendorUuidBar", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doDelete(VendorUuidBar et, final DeleteOption<VendorUuidBarCB> op) {
        assertObjectNotNull("vendorUuidBar", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<VendorUuidBarCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int doQueryInsert(QueryInsertSetupper<VendorUuidBar, VendorUuidBarCB> sp, InsertOption<VendorUuidBarCB> op) {
        ...
        VendorUuidBar et = newEntity(); VendorUuidBarCB cb = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(VendorUuidBar et, VendorUuidBarCB cb, UpdateOption<VendorUuidBarCB> op) {
        assertObjectNotNull("vendorUuidBar", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<VendorUuidBar> typeOfSelectedEntity() { return VendorUuidBar.class; }
    protected VendorUuidBar downcast(Entity et) { return helpEntityDowncastInternally(et, VendorUuidBar.class); }
    protected VendorUuidBarCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, VendorUuidBarCB.class); }
    @SuppressWarnings("unchecked")
    protected List<VendorUuidBar> downcast(List<? extends Entity> ls) { return (List<VendorUuidBar>)ls; }
    @SuppressWarnings("unchecked")
    protected InsertOption<VendorUuidBarCB> downcast(InsertOption<? extends ConditionBean> op) { return (InsertOption<VendorUuidBarCB>)op; }
    @SuppressWarnings("unchecked")
    protected UpdateOption<VendorUuidBarCB> downcast(UpdateOption<? extends ConditionBean> op) { return (UpdateOption<VendorUuidBarCB>)op; }
    @SuppressWarnings("unchecked")
    protected DeleteOption<VendorUuidBarCB> downcast(DeleteOption<? extends ConditionBean> op) { return (DeleteOption<VendorUuidBarCB>)op; }
    @SuppressWarnings("unchecked")
