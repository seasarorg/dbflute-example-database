 ...
 */
public abstract class BsSpReturnResultSetWithReturnValue implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.postgresql.dbflute.bsentity.customize.dbmeta.SpReturnResultSetWithReturnValueDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSpReturnResultSetWithReturnValue)) { return false; }
        BsSpReturnResultSetWithReturnValue otherEntity = (BsSpReturnResultSetWithReturnValue)other;
