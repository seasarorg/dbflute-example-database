...
public abstract class BsWhiteSameNameRefBhv extends AbstractBehaviorWritable {
    ...
    protected void doUpdate(WhiteSameNameRef et, UpdateOption<WhiteSameNameRefCB> op) {
    ...
    protected void doInsertOrUpdate(WhiteSameNameRef et, InsertOption<WhiteSameNameRefCB> iop, UpdateOption<WhiteSameNameRefCB> uop) {
    ...
    protected void prepareDeleteOption(DeleteOption<WhiteSameNameRefCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int doQueryInsert(QueryInsertSetupper<WhiteSameNameRef, WhiteSameNameRefCB> sp, InsertOption<WhiteSameNameRefCB> op) {
        ...
        WhiteSameNameRef et = newEntity(); WhiteSameNameRefCB cb = createCBForQueryInsert();
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<WhiteSameNameRef> typeOfSelectedEntity() { return WhiteSameNameRef.class; }
    protected WhiteSameNameRef downcast(Entity et) { return helpEntityDowncastInternally(et, WhiteSameNameRef.class); }
    protected WhiteSameNameRefCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, WhiteSameNameRefCB.class); }
    @SuppressWarnings("unchecked")
    protected List<WhiteSameNameRef> downcast(List<? extends Entity> ls) { return (List<WhiteSameNameRef>)ls; }
    @SuppressWarnings("unchecked")
