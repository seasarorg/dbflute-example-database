...
public abstract class BsVendorCheckBhv extends AbstractBehaviorWritable {
    ...
    public static final String PATH_whitebox_vendorcheck_selectVendorCheckCursor = "whitebox:vendorcheck:selectVendorCheckCursor";
    ...
    protected <ENTITY extends VendorCheck> ENTITY doSelectByPKWithDeletedCheck(Long vendorCheckId, Class<ENTITY> entityType) {
