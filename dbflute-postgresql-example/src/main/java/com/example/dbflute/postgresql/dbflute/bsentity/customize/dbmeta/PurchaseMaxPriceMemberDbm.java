...
public class PurchaseMaxPriceMemberDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnMemberName = cci("member_name", "member_name", null, null, false, "memberName", String.class, false, false, "varchar", 200, 0, null, false, null, "// member's name", null, null, null);
    protected final ColumnInfo _columnPurchaseMaxPrice = cci("purchase_max_price", "purchase_max_price", null, null, false, "purchaseMaxPrice", Integer.class, false, false, "int4", 10, 0, null, false, null, "// max price of the member's purchases", null, null, null);
