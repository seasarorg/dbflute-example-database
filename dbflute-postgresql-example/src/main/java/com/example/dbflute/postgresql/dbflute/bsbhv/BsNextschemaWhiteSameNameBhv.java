...
public abstract class BsNextschemaWhiteSameNameBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends NextschemaWhiteSameName> void doSelectCursor(NextschemaWhiteSameNameCB cb, EntityRowHandler<ENTITY> handler, Class<ENTITY> tp) {
        ...
        helpSelectCursorInternally(cb, handler, tp, new InternalSelectCursorCallback<ENTITY, NextschemaWhiteSameNameCB>() {
            public void callbackSelectCursor(NextschemaWhiteSameNameCB lcb, EntityRowHandler<ENTITY> lhandler, Class<ENTITY> ltp) { delegateSelectCursor(lcb, lhandler, ltp); }
            public List<ENTITY> callbackSelectList(NextschemaWhiteSameNameCB lcb, Class<ENTITY> ltp) { return doSelectList(lcb, ltp); }
        });
    }
    ...
    protected NestedReferrerListGateway<NextschemaWhiteSameNameRef> doLoadWhiteSameNameRefList(List<NextschemaWhiteSameName> whiteSameNameList, LoadReferrerOption<NextschemaWhiteSameNameRefCB, NextschemaWhiteSameNameRef> option) {
        ...
        return helpLoadReferrerInternally(whiteSameNameList, option, new InternalLoadReferrerCallback<NextschemaWhiteSameName, Integer, NextschemaWhiteSameNameRefCB, NextschemaWhiteSameNameRef>() {
            ...
            public NextschemaWhiteSameNameRefCB newMyCB() { return referrerBhv.newConditionBean(); }
    ...
    protected void doUpdate(NextschemaWhiteSameName et, final UpdateOption<NextschemaWhiteSameNameCB> op) {
        assertObjectNotNull("whiteSameName", et);
        prepareUpdateOption(op);
        helpUpdateInternally(et, new InternalUpdateCallback<NextschemaWhiteSameName>() {
            public int callbackDelegateUpdate(NextschemaWhiteSameName let) { return delegateUpdate(let, op); } });
    }
    ...
    protected void doInsertOrUpdate(NextschemaWhiteSameName et, final InsertOption<NextschemaWhiteSameNameCB> iop, final UpdateOption<NextschemaWhiteSameNameCB> uop) {
        assertObjectNotNull("whiteSameName", et);
        helpInsertOrUpdateInternally(et, new InternalInsertOrUpdateCallback<NextschemaWhiteSameName, NextschemaWhiteSameNameCB>() {
            public void callbackInsert(NextschemaWhiteSameName let) { doInsert(let, iop); }
            public void callbackUpdate(NextschemaWhiteSameName let) { doUpdate(let, uop); }
            public NextschemaWhiteSameNameCB callbackNewMyConditionBean() { return newConditionBean(); }
    ...
    protected void doDelete(NextschemaWhiteSameName et, final DeleteOption<NextschemaWhiteSameNameCB> op) {
        ...
        helpDeleteInternally(et, new InternalDeleteCallback<NextschemaWhiteSameName>() {
            public int callbackDelegateDelete(NextschemaWhiteSameName let) { return delegateDelete(let, op); } });
    }
    ...
    protected int doQueryInsert(QueryInsertSetupper<NextschemaWhiteSameName, NextschemaWhiteSameNameCB> sp, InsertOption<NextschemaWhiteSameNameCB> op) {
        ...
        prepareInsertOption(op);
        NextschemaWhiteSameName et = newEntity();
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<NextschemaWhiteSameName> typeOfSelectedEntity()
    { return NextschemaWhiteSameName.class; }
