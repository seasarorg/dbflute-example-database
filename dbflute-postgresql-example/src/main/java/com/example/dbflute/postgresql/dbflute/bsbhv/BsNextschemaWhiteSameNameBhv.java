...
public abstract class BsNextschemaWhiteSameNameBhv extends AbstractBehaviorWritable {
     ...
     */
    public NestedReferrerLoader<NextschemaWhiteSameNameRef> loadWhiteSameNameRefList(List<NextschemaWhiteSameName> whiteSameNameList, ConditionBeanSetupper<NextschemaWhiteSameNameRefCB> setupper) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<NextschemaWhiteSameNameRef> loadWhiteSameNameRefList(NextschemaWhiteSameName whiteSameName, ConditionBeanSetupper<NextschemaWhiteSameNameRefCB> setupper) {
