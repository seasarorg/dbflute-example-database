 ...
 */
public abstract class BsSpResultSetParameterMoreCurMember implements Entity, Serializable, Cloneable {
    ...
    public String getTableDbName() {
        return "SpResultSetParameterMoreCurMember";
    }
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.postgresql.dbflute.bsentity.customize.dbmeta.SpResultSetParameterMoreCurMemberDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSpResultSetParameterMoreCurMember)) { return false; }
        BsSpResultSetParameterMoreCurMember otherEntity = (BsSpResultSetParameterMoreCurMember)other;
     ...
     */
    public SpResultSetParameterMoreCurMember clone() {
        try {
            return (SpResultSetParameterMoreCurMember)super.clone();
