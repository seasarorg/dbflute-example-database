...
/**
 * The base condition-bean of nextschema.white_same_name.
 * @author DBFlute(AutoGenerator)
 */
public class BsNextschemaWhiteSameNameCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected NextschemaWhiteSameNameCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsNextschemaWhiteSameNameCB() {
     ...
     * @return this. (NotNull)
     */
    public NextschemaWhiteSameNameCB acceptPK(Integer sameNameId) {
        assertObjectNotNull("sameNameId", sameNameId);
        BsNextschemaWhiteSameNameCB cb = this;
        cb.query().setSameNameId_Equal(sameNameId);
        return (NextschemaWhiteSameNameCB)this;
    }
     ...
     * @param sameNameId : PK, NotNull, int4(10). (NotNull)
     */
    public void acceptPrimaryKey(Integer sameNameId) {
        assertObjectNotNull("sameNameId", sameNameId);
        BsNextschemaWhiteSameNameCB cb = this;
        cb.query().setSameNameId_Equal(sameNameId);
    }
    ...
    protected NextschemaWhiteSameNameCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected NextschemaWhiteSameNameCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        NextschemaWhiteSameNameCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected NextschemaWhiteSameNameCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void union(UnionQuery<NextschemaWhiteSameNameCB> unionQuery) {
        final NextschemaWhiteSameNameCB cb = new NextschemaWhiteSameNameCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final NextschemaWhiteSameNameCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<NextschemaWhiteSameNameCB> unionQuery) {
        final NextschemaWhiteSameNameCB cb = new NextschemaWhiteSameNameCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final NextschemaWhiteSameNameCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<NextschemaWhiteSameNameCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<NextschemaWhiteSameNameCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "nextschema.white_same_name"; }
        /**
     ...
     */
    public HpColQyOperand<NextschemaWhiteSameNameCB> columnQuery(final SpecifyQuery<NextschemaWhiteSameNameCB> leftSpecifyQuery) {
        return new HpColQyOperand<NextschemaWhiteSameNameCB>(new HpColQyHandler<NextschemaWhiteSameNameCB>() {
    ...
    protected NextschemaWhiteSameNameCB xcreateColumnQueryCB() {
        NextschemaWhiteSameNameCB cb = new NextschemaWhiteSameNameCB();
        cb.xsetupForColumnQuery((NextschemaWhiteSameNameCB)this);
        return cb;
    }
     ...
     */
    public NextschemaWhiteSameNameCB dreamCruiseCB() {
        NextschemaWhiteSameNameCB cb = new NextschemaWhiteSameNameCB();
        cb.xsetupForDreamCruise((NextschemaWhiteSameNameCB) this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<NextschemaWhiteSameNameCB> orQuery) {
        xorSQ((NextschemaWhiteSameNameCB)this, orQuery);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<NextschemaWhiteSameNameCB> andQuery) {
        xorSQAP((NextschemaWhiteSameNameCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final NextschemaWhiteSameNameCB cb;
        if (mainCB != null) {
            cb = (NextschemaWhiteSameNameCB)mainCB;
        } else {
            cb = new NextschemaWhiteSameNameCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<NextschemaWhiteSameNameCQ>() {
            public boolean has() { return true; }
            public NextschemaWhiteSameNameCQ qy() { return cb.query(); }
        });
    }
