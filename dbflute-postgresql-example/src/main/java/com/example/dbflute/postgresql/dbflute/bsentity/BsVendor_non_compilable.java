...
public abstract class BsVendor_non_compilable implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsVendor_non_compilable)) { return false; }
        BsVendor_non_compilable otherEntity = (BsVendor_non_compilable)other;
        if (!xSV(getNon_compilable_id(), otherEntity.getNon_compilable_id())) { return false; }
        return true;
    }
