...
import com.example.dbflute.postgresql.dbflute.cbean.cq.bs.BsVendorInheritNekoCQ;

/**
 * The condition-query of vendor_inherit_neko.
 * <p>
 ...
 */
public class VendorInheritNekoCQ extends BsVendorInheritNekoCQ {
     ...
     */
    public VendorInheritNekoCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
