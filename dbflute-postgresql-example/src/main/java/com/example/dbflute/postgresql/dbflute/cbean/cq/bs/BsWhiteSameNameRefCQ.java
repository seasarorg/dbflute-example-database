...
public class BsWhiteSameNameRefCQ extends AbstractBsWhiteSameNameRefCQ {
    ...
    public String keepSameNameId_InScopeRelation_WhiteSameName(WhiteSameNameCQ subQuery) {
    ...
    public String keepSameNameId_NotInScopeRelation_WhiteSameName(WhiteSameNameCQ subQuery) {
    ...
    protected void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
        WhiteSameNameRefCQ baseQuery = (WhiteSameNameRefCQ)baseQueryAsSuper;
        WhiteSameNameRefCQ unionQuery = (WhiteSameNameRefCQ)unionQueryAsSuper;
    ...
    public String keepScalarCondition(WhiteSameNameRefCQ subQuery) {
    ...
    public String keepSpecifyMyselfDerived(WhiteSameNameRefCQ subQuery) {
    ...
    public String keepQueryMyselfDerived(WhiteSameNameRefCQ subQuery) {
    ...
    public String keepMyselfExists(WhiteSameNameRefCQ subQuery) {
    ...
    public String keepMyselfInScope(WhiteSameNameRefCQ subQuery) {
