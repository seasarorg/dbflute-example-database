...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable {
    ...
    protected <RESULT> RESULT delegateSelectNextValSub(Class<RESULT> rt, String col, String seq, Integer inc, Integer cac)
    { return invoke(createSelectNextValSubCommand(rt, col, seq, inc, cac)); }
