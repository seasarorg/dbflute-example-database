...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable<MemberStatus, MemberStatusCB> {
     ...
     * @param memberStatusCode (会員ステータスコード): PK, NotNull, bpchar(3), classification=MemberStatus. (NotNull)
    ...
    public Integer selectNextValForDisplayOrder() {
        return facadeSelectNextValForDisplayOrder();
    }

    protected Integer facadeSelectNextValForDisplayOrder() {
