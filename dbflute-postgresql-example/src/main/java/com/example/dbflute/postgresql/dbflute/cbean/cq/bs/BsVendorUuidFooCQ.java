...
public class BsVendorUuidFooCQ extends AbstractBsVendorUuidFooCQ {
    ...
    protected void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
        VendorUuidFooCQ baseQuery = (VendorUuidFooCQ)baseQueryAsSuper;
        VendorUuidFooCQ unionQuery = (VendorUuidFooCQ)unionQueryAsSuper;
        if (baseQuery.hasConditionQueryVendorUuidBar()) {
            unionQuery.queryVendorUuidBar().reflectRelationOnUnionQuery(baseQuery.queryVendorUuidBar(), unionQuery.queryVendorUuidBar());
        }
    }
