...
public abstract class BsVendorDatePkBhv extends AbstractBehaviorWritable<VendorDatePk, VendorDatePkCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends VendorDatePk> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.postgresql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends VendorDatePk> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
