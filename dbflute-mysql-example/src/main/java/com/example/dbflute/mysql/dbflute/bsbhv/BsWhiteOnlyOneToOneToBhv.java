...
public abstract class BsWhiteOnlyOneToOneToBhv extends AbstractBehaviorWritable<WhiteOnlyOneToOneTo, WhiteOnlyOneToOneToCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteOnlyOneToOneTo> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteOnlyOneToOneTo> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
