...
public abstract class BsWhiteAllInOneClsCompoundPkRefBhv extends AbstractBehaviorWritable<WhiteAllInOneClsCompoundPkRef, WhiteAllInOneClsCompoundPkRefCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteAllInOneClsCompoundPkRef> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteAllInOneClsCompoundPkRef> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
