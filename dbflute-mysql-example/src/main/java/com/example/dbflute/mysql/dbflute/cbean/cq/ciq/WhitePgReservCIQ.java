...
public class WhitePgReservCIQ extends AbstractBsWhitePgReservCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public WhitePgReservCIQ(ConditionQuery childQuery, SqlClause sqlClause
    ...
    public String keepClassSynonym_QueryDerivedReferrer_WhitePgReservRefListParameter(Object pv)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
