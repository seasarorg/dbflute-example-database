...
public class BsWhiteStilettoAliasCB extends AbstractConditionBean {
     ...
     * @param stilettoAliasId : PK, NotNull, INT(10). (NotNull)
     */
    public void acceptPrimaryKey(Integer stilettoAliasId) {
        assertObjectNotNull("stilettoAliasId", stilettoAliasId);
        BsWhiteStilettoAliasCB cb = this;
        cb.query().setStilettoAliasId_Equal(stilettoAliasId);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteStilettoAliasCQ> {
        ...
        public HpSDRFunction<WhiteStilettoAliasRefCB, WhiteStilettoAliasCQ> derivedWhiteStilettoAliasRefList() {
            ...
            return new HpSDRFunction<WhiteStilettoAliasRefCB, WhiteStilettoAliasCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteStilettoAliasRefCB, WhiteStilettoAliasCQ>() {
        ...
        public HpSDRFunction<WhiteStilettoAliasCB, WhiteStilettoAliasCQ> myselfDerived() {
            ...
            return new HpSDRFunction<WhiteStilettoAliasCB, WhiteStilettoAliasCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteStilettoAliasCB, WhiteStilettoAliasCQ>() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteStilettoAliasCB> orQuery) {
        xorSQ((WhiteStilettoAliasCB)this, orQuery);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteStilettoAliasCB> andQuery) {
        xorSQAP((WhiteStilettoAliasCB)this, andQuery);
    }
