...
public abstract class BsVendorTheLongAndWindingTableAndColumnRefBhv extends AbstractBehaviorWritable {
    ...
    protected void doUpdate(VendorTheLongAndWindingTableAndColumnRef et, UpdateOption<VendorTheLongAndWindingTableAndColumnRefCB> op) {
    ...
    protected void doInsertOrUpdate(VendorTheLongAndWindingTableAndColumnRef et, InsertOption<VendorTheLongAndWindingTableAndColumnRefCB> iop, UpdateOption<VendorTheLongAndWindingTableAndColumnRefCB> uop) {
    ...
    protected void prepareDeleteOption(DeleteOption<VendorTheLongAndWindingTableAndColumnRefCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int doQueryInsert(QueryInsertSetupper<VendorTheLongAndWindingTableAndColumnRef, VendorTheLongAndWindingTableAndColumnRefCB> sp, InsertOption<VendorTheLongAndWindingTableAndColumnRefCB> op) {
        ...
        VendorTheLongAndWindingTableAndColumnRef et = newEntity(); VendorTheLongAndWindingTableAndColumnRefCB cb = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(VendorTheLongAndWindingTableAndColumnRef et, VendorTheLongAndWindingTableAndColumnRefCB cb, UpdateOption<VendorTheLongAndWindingTableAndColumnRefCB> op) {
        assertObjectNotNull("vendorTheLongAndWindingTableAndColumnRef", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<VendorTheLongAndWindingTableAndColumnRef> typeOfSelectedEntity() { return VendorTheLongAndWindingTableAndColumnRef.class; }
    protected VendorTheLongAndWindingTableAndColumnRef downcast(Entity et) { return helpEntityDowncastInternally(et, VendorTheLongAndWindingTableAndColumnRef.class); }
    protected VendorTheLongAndWindingTableAndColumnRefCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, VendorTheLongAndWindingTableAndColumnRefCB.class); }
    @SuppressWarnings("unchecked")
    protected List<VendorTheLongAndWindingTableAndColumnRef> downcast(List<? extends Entity> ls) { return (List<VendorTheLongAndWindingTableAndColumnRef>)ls; }
    @SuppressWarnings("unchecked")
    protected InsertOption<VendorTheLongAndWindingTableAndColumnRefCB> downcast(InsertOption<? extends ConditionBean> op) { return (InsertOption<VendorTheLongAndWindingTableAndColumnRefCB>)op; }
    @SuppressWarnings("unchecked")
    protected UpdateOption<VendorTheLongAndWindingTableAndColumnRefCB> downcast(UpdateOption<? extends ConditionBean> op) { return (UpdateOption<VendorTheLongAndWindingTableAndColumnRefCB>)op; }
    @SuppressWarnings("unchecked")
    protected DeleteOption<VendorTheLongAndWindingTableAndColumnRefCB> downcast(DeleteOption<? extends ConditionBean> op) { return (DeleteOption<VendorTheLongAndWindingTableAndColumnRefCB>)op; }
    @SuppressWarnings("unchecked")
