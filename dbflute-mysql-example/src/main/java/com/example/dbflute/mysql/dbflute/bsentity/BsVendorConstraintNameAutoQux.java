 ...
 */
public abstract class BsVendorConstraintNameAutoQux implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsVendorConstraintNameAutoQux)) { return false; }
        BsVendorConstraintNameAutoQux otherEntity = (BsVendorConstraintNameAutoQux)other;
