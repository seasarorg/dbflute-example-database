...
public class BsWhiteSuppressJoinSqManyOneCB extends AbstractConditionBean {
     ...
     * @param manyOneId : PK, NotNull, INT(10). (NotNull)
     */
    public void acceptPrimaryKey(Integer manyOneId) {
        assertObjectNotNull("manyOneId", manyOneId);
        BsWhiteSuppressJoinSqManyOneCB cb = this;
        cb.query().setManyOneId_Equal(manyOneId);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteSuppressJoinSqManyOneCQ> {
        ...
        public HpSDRFunction<WhiteSuppressJoinSqManyCB, WhiteSuppressJoinSqManyOneCQ> derivedWhiteSuppressJoinSqManyList() {
            ...
            return new HpSDRFunction<WhiteSuppressJoinSqManyCB, WhiteSuppressJoinSqManyOneCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteSuppressJoinSqManyCB, WhiteSuppressJoinSqManyOneCQ>() {
        ...
        public HpSDRFunction<WhiteSuppressJoinSqManyOneCB, WhiteSuppressJoinSqManyOneCQ> myselfDerived() {
            ...
            return new HpSDRFunction<WhiteSuppressJoinSqManyOneCB, WhiteSuppressJoinSqManyOneCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteSuppressJoinSqManyOneCB, WhiteSuppressJoinSqManyOneCQ>() {
     ...
     */
    public HpColQyOperand<WhiteSuppressJoinSqManyOneCB> columnQuery(final SpecifyQuery<WhiteSuppressJoinSqManyOneCB> leftSpecifyQuery) {
        return new HpColQyOperand<WhiteSuppressJoinSqManyOneCB>(new HpColQyHandler<WhiteSuppressJoinSqManyOneCB>() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteSuppressJoinSqManyOneCB> orQuery) {
        xorSQ((WhiteSuppressJoinSqManyOneCB)this, orQuery);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteSuppressJoinSqManyOneCB> andQuery) {
        xorSQAP((WhiteSuppressJoinSqManyOneCB)this, andQuery);
    }
