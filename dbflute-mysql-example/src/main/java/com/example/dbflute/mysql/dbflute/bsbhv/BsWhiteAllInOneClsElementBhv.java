...
public abstract class BsWhiteAllInOneClsElementBhv extends AbstractBehaviorWritable<WhiteAllInOneClsElement, WhiteAllInOneClsElementCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteAllInOneClsElement> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteAllInOneClsElement> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
