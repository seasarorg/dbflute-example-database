...
public abstract class BsWhiteSuppressJoinSqOneBhv extends AbstractBehaviorWritable<WhiteSuppressJoinSqOne, WhiteSuppressJoinSqOneCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteSuppressJoinSqOne> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteSuppressJoinSqOne> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
