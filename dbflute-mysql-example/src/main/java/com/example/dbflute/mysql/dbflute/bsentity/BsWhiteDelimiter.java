...
public abstract class BsWhiteDelimiter implements Entity, Serializable, Cloneable {
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String delimiter = ", ";
        sb.append(delimiter).append(getDelimiterId());
        sb.append(delimiter).append(getNumberNullable());
        sb.append(delimiter).append(getStringConverted());
        sb.append(delimiter).append(getStringNonConverted());
        sb.append(delimiter).append(xfUD(getDateDefault()));
