...
public abstract class BsWhiteSuppressJoinSqManyBhv extends AbstractBehaviorWritable<WhiteSuppressJoinSqMany, WhiteSuppressJoinSqManyCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteSuppressJoinSqMany> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteSuppressJoinSqMany> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
