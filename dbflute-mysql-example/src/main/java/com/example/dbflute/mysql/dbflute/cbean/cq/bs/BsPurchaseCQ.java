...
public class BsPurchaseCQ extends AbstractBsPurchaseCQ {
    ...
    public Map<String, WhitePurchaseReferrerCQ> getPurchaseId_ExistsReferrer_WhitePurchaseReferrerAsOne() { return xgetSQueMap("purchaseId_ExistsReferrer_WhitePurchaseReferrerAsOne"); }
    public String keepPurchaseId_ExistsReferrer_WhitePurchaseReferrerAsOne(WhitePurchaseReferrerCQ sq) { return xkeepSQue("purchaseId_ExistsReferrer_WhitePurchaseReferrerAsOne", sq); }

    public Map<String, PurchaseCQ> getPurchaseId_ExistsReferrer_PurchaseSelfAsOne() { return xgetSQueMap("purchaseId_ExistsReferrer_PurchaseSelfAsOne"); }
    public String keepPurchaseId_ExistsReferrer_PurchaseSelfAsOne(PurchaseCQ sq) { return xkeepSQue("purchaseId_ExistsReferrer_PurchaseSelfAsOne", sq); }
    ...
    public Map<String, WhitePurchaseReferrerCQ> getPurchaseId_NotExistsReferrer_WhitePurchaseReferrerAsOne() { return xgetSQueMap("purchaseId_NotExistsReferrer_WhitePurchaseReferrerAsOne"); }
    public String keepPurchaseId_NotExistsReferrer_WhitePurchaseReferrerAsOne(WhitePurchaseReferrerCQ sq) { return xkeepSQue("purchaseId_NotExistsReferrer_WhitePurchaseReferrerAsOne", sq); }

    public Map<String, PurchaseCQ> getPurchaseId_NotExistsReferrer_PurchaseSelfAsOne() { return xgetSQueMap("purchaseId_NotExistsReferrer_PurchaseSelfAsOne"); }
    public String keepPurchaseId_NotExistsReferrer_PurchaseSelfAsOne(PurchaseCQ sq) { return xkeepSQue("purchaseId_NotExistsReferrer_PurchaseSelfAsOne", sq); }
    ...
    public Map<String, PurchaseCQ> getPurchaseId_InScopeRelation_PurchaseSelf() { return xgetSQueMap("purchaseId_InScopeRelation_PurchaseSelf"); }
    public String keepPurchaseId_InScopeRelation_PurchaseSelf(PurchaseCQ sq) { return xkeepSQue("purchaseId_InScopeRelation_PurchaseSelf", sq); }
    ...
    public Map<String, WhitePurchaseReferrerCQ> getPurchaseId_InScopeRelation_WhitePurchaseReferrerAsOne() { return xgetSQueMap("purchaseId_InScopeRelation_WhitePurchaseReferrerAsOne"); }
    public String keepPurchaseId_InScopeRelation_WhitePurchaseReferrerAsOne(WhitePurchaseReferrerCQ sq) { return xkeepSQue("purchaseId_InScopeRelation_WhitePurchaseReferrerAsOne", sq); }

    public Map<String, PurchaseCQ> getPurchaseId_InScopeRelation_PurchaseSelfAsOne() { return xgetSQueMap("purchaseId_InScopeRelation_PurchaseSelfAsOne"); }
    public String keepPurchaseId_InScopeRelation_PurchaseSelfAsOne(PurchaseCQ sq) { return xkeepSQue("purchaseId_InScopeRelation_PurchaseSelfAsOne", sq); }

    public Map<String, PurchaseCQ> getPurchaseId_NotInScopeRelation_PurchaseSelf() { return xgetSQueMap("purchaseId_NotInScopeRelation_PurchaseSelf"); }
    public String keepPurchaseId_NotInScopeRelation_PurchaseSelf(PurchaseCQ sq) { return xkeepSQue("purchaseId_NotInScopeRelation_PurchaseSelf", sq); }
    ...
    public Map<String, WhitePurchaseReferrerCQ> getPurchaseId_NotInScopeRelation_WhitePurchaseReferrerAsOne() { return xgetSQueMap("purchaseId_NotInScopeRelation_WhitePurchaseReferrerAsOne"); }
    public String keepPurchaseId_NotInScopeRelation_WhitePurchaseReferrerAsOne(WhitePurchaseReferrerCQ sq) { return xkeepSQue("purchaseId_NotInScopeRelation_WhitePurchaseReferrerAsOne", sq); }

    public Map<String, PurchaseCQ> getPurchaseId_NotInScopeRelation_PurchaseSelfAsOne() { return xgetSQueMap("purchaseId_NotInScopeRelation_PurchaseSelfAsOne"); }
    public String keepPurchaseId_NotInScopeRelation_PurchaseSelfAsOne(PurchaseCQ sq) { return xkeepSQue("purchaseId_NotInScopeRelation_PurchaseSelfAsOne", sq); }
