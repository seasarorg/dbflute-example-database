...
public class BsWhiteVariantRelationMasterBarCB extends AbstractConditionBean {
    ...
    //                                                                 PrimaryKey Handling
    //                                                                 ===================
    public void acceptPrimaryKey(Long masterBarId) {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;WhiteVariantRelationMasterBarCB&gt;() {
    ...
    public void union(UnionQuery<WhiteVariantRelationMasterBarCB> unionQuery) {
        final WhiteVariantRelationMasterBarCB cb = new WhiteVariantRelationMasterBarCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;WhiteVariantRelationMasterBarCB&gt;() {
     *     public void query(WhiteVariantRelationMasterBarCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteVariantRelationMasterBarCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #FD4747">derivedWhiteVariantRelationReferrerAsVariantList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;WhiteVariantRelationReferrerCB&gt;() {
         *     public void query(WhiteVariantRelationReferrerCB subCB) {
         *         subCB.specify().<span style="color: #FD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, WhiteVariantRelationReferrer.<span style="color: #FD4747">ALIAS_foo...</span>);
         * </pre>
        ...
        public HpSDRFunction<WhiteVariantRelationReferrerCB, WhiteVariantRelationMasterBarCQ> derivedWhiteVariantRelationReferrerAsVariantList() {
            ...
            return new HpSDRFunction<WhiteVariantRelationReferrerCB, WhiteVariantRelationMasterBarCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteVariantRelationReferrerCB, WhiteVariantRelationMasterBarCQ>() {
                public void setup(String function, SubQuery<WhiteVariantRelationReferrerCB> subQuery, WhiteVariantRelationMasterBarCQ cq, String aliasName, DerivedReferrerOption option) {
        ...
        public HpSDRFunction<WhiteVariantRelationMasterBarCB, WhiteVariantRelationMasterBarCQ> myselfDerived() {
            ...
            return new HpSDRFunction<WhiteVariantRelationMasterBarCB, WhiteVariantRelationMasterBarCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteVariantRelationMasterBarCB, WhiteVariantRelationMasterBarCQ>() {
                public void setup(String function, SubQuery<WhiteVariantRelationMasterBarCB> subQuery, WhiteVariantRelationMasterBarCQ cq, String aliasName, DerivedReferrerOption option) {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;WhiteVariantRelationMasterBarCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;WhiteVariantRelationMasterBarCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteVariantRelationMasterBarCB> orQuery) {
        xorSQ((WhiteVariantRelationMasterBarCB)this, orQuery);
    }
     ...
     *     public void query(WhiteVariantRelationMasterBarCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteVariantRelationMasterBarCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteVariantRelationMasterBarCB> andQuery) {
        xorSQAP((WhiteVariantRelationMasterBarCB)this, andQuery);
    }
