...
public abstract class BsWhiteImplicitReverseFkRefBhv extends AbstractBehaviorWritable<WhiteImplicitReverseFkRef, WhiteImplicitReverseFkRefCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteImplicitReverseFkRef> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteImplicitReverseFkRef> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
