...
public abstract class BsWhiteCompoundReferredNormallyBhv extends AbstractBehaviorWritable<WhiteCompoundReferredNormally, WhiteCompoundReferredNormallyCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteCompoundReferredNormally> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteCompoundReferredNormally> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
