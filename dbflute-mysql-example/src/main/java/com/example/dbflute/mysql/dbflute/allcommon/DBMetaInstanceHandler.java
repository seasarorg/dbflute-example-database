...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("purchase_payment", "com.example.dbflute.mysql.dbflute.bsentity.dbmeta.PurchasePaymentDbm");
        ...
        tmpMap.put("white_escaped_number_initial", "com.example.dbflute.mysql.dbflute.bsentity.dbmeta.WhiteEscapedNumberInitialDbm");
        tmpMap.put("white_geared_cipher", "com.example.dbflute.mysql.dbflute.bsentity.dbmeta.WhiteGearedCipherDbm");
        tmpMap.put("white_grouping_reference", "com.example.dbflute.mysql.dbflute.bsentity.dbmeta.WhiteGroupingReferenceDbm");
        ...
        tmpMap.put("white_stiletto_alias", "com.example.dbflute.mysql.dbflute.bsentity.dbmeta.WhiteStilettoAliasDbm");
        tmpMap.put("white_stiletto_alias_ref", "com.example.dbflute.mysql.dbflute.bsentity.dbmeta.WhiteStilettoAliasRefDbm");
        ...
        tmpMap.put("white_variant_relation_referrer_ref", "com.example.dbflute.mysql.dbflute.bsentity.dbmeta.WhiteVariantRelationReferrerRefDbm");
