...
public abstract class BsWhiteSuppressJoinSqBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends WhiteSuppressJoinSq> ENTITY doSelectEntity(WhiteSuppressJoinSqCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectEntityInternally(cb, tp, new InternalSelectEntityCallback<ENTITY, WhiteSuppressJoinSqCB>() {
    ...
    protected <ENTITY extends WhiteSuppressJoinSq> ENTITY doSelectEntityWithDeletedCheck(WhiteSuppressJoinSqCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", tp);
        return helpSelectEntityWithDeletedCheckInternally(cb, tp, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, WhiteSuppressJoinSqCB>() {
            public List<ENTITY> callbackSelectList(WhiteSuppressJoinSqCB lcb, Class<ENTITY> ltp) { return doSelectList(lcb, ltp); } });
    }
    ...
    protected <ENTITY extends WhiteSuppressJoinSq> ListResultBean<ENTITY> doSelectList(WhiteSuppressJoinSqCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectListInternally(cb, tp, new InternalSelectListCallback<ENTITY, WhiteSuppressJoinSqCB>() {
            public List<ENTITY> callbackSelectList(WhiteSuppressJoinSqCB lcb, Class<ENTITY> ltp) { return delegateSelectList(lcb, ltp); } });
    }
    ...
    protected <ENTITY extends WhiteSuppressJoinSq> PagingResultBean<ENTITY> doSelectPage(WhiteSuppressJoinSqCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", tp);
        return helpSelectPageInternally(cb, tp, new InternalSelectPageCallback<ENTITY, WhiteSuppressJoinSqCB>() {
            public int callbackSelectCount(WhiteSuppressJoinSqCB cb) { return doSelectCountPlainly(cb); }
    ...
    public List<WhiteSuppressJoinSqOne> pulloutWhiteSuppressJoinSqOneAsOne(List<WhiteSuppressJoinSq> whiteSuppressJoinSqList) {
        return helpPulloutInternally(whiteSuppressJoinSqList, new InternalPulloutCallback<WhiteSuppressJoinSq, WhiteSuppressJoinSqOne>() {
            public WhiteSuppressJoinSqOne getFr(WhiteSuppressJoinSq et)
            { return et.getWhiteSuppressJoinSqOneAsOne(); }
            public boolean hasRf() { return true; }
            public void setRfLs(WhiteSuppressJoinSqOne et, List<WhiteSuppressJoinSq> ls)
    ...
    public List<Integer> extractSuppressJoinSqIdList(List<WhiteSuppressJoinSq> whiteSuppressJoinSqList) {
        return helpExtractListInternally(whiteSuppressJoinSqList, new InternalExtractCallback<WhiteSuppressJoinSq, Integer>() {
            public Integer getCV(WhiteSuppressJoinSq et) { return et.getSuppressJoinSqId(); }
        });
    }
    ...
    //                                                Select
    //                                                ------
    protected int delegateSelectCountUniquely(WhiteSuppressJoinSqCB cb) { return invoke(createSelectCountCBCommand(cb, true)); }
    protected int delegateSelectCountPlainly(WhiteSuppressJoinSqCB cb) { return invoke(createSelectCountCBCommand(cb, false)); }
    protected <ENTITY extends WhiteSuppressJoinSq> void delegateSelectCursor(WhiteSuppressJoinSqCB cb, EntityRowHandler<ENTITY> rh, Class<ENTITY> tp)
    { invoke(createSelectCursorCBCommand(cb, rh, tp)); }
    protected <ENTITY extends WhiteSuppressJoinSq> List<ENTITY> delegateSelectList(WhiteSuppressJoinSqCB cb, Class<ENTITY> tp)
    { return invoke(createSelectListCBCommand(cb, tp)); }

    // -----------------------------------------------------
    //                                                Update
    //                                                ------
    protected int delegateInsert(WhiteSuppressJoinSq et, InsertOption<WhiteSuppressJoinSqCB> op)
    { if (!processBeforeInsert(et, op)) { return 0; }
      return invoke(createInsertEntityCommand(et, op)); }
    protected int delegateUpdate(WhiteSuppressJoinSq et, UpdateOption<WhiteSuppressJoinSqCB> op)
    { if (!processBeforeUpdate(et, op)) { return 0; }
      return delegateUpdateNonstrict(et, op); }
    protected int delegateUpdateNonstrict(WhiteSuppressJoinSq et, UpdateOption<WhiteSuppressJoinSqCB> op)
    { if (!processBeforeUpdate(et, op)) { return 0; }
      return invoke(createUpdateNonstrictEntityCommand(et, op)); }
    protected int delegateDelete(WhiteSuppressJoinSq et, DeleteOption<WhiteSuppressJoinSqCB> op)
    { if (!processBeforeDelete(et, op)) { return 0; }
      return delegateDeleteNonstrict(et, op); }
    protected int delegateDeleteNonstrict(WhiteSuppressJoinSq et, DeleteOption<WhiteSuppressJoinSqCB> op)
    { if (!processBeforeDelete(et, op)) { return 0; }
      return invoke(createDeleteNonstrictEntityCommand(et, op)); }

    protected int[] delegateBatchInsert(List<WhiteSuppressJoinSq> ls, InsertOption<WhiteSuppressJoinSqCB> op)
    { if (ls.isEmpty()) { return new int[]{}; }
      return invoke(createBatchInsertCommand(processBatchInternally(ls, op), op)); }
    protected int[] delegateBatchUpdate(List<WhiteSuppressJoinSq> ls, UpdateOption<WhiteSuppressJoinSqCB> op)
    { if (ls.isEmpty()) { return new int[]{}; }
      return delegateBatchUpdateNonstrict(ls, op); }
    protected int[] delegateBatchUpdateNonstrict(List<WhiteSuppressJoinSq> ls, UpdateOption<WhiteSuppressJoinSqCB> op)
    { if (ls.isEmpty()) { return new int[]{}; }
      return invoke(createBatchUpdateNonstrictCommand(processBatchInternally(ls, op, true), op)); }
    protected int[] delegateBatchDelete(List<WhiteSuppressJoinSq> ls, DeleteOption<WhiteSuppressJoinSqCB> op)
    { if (ls.isEmpty()) { return new int[]{}; }
      return delegateBatchDeleteNonstrict(ls, op); }
    protected int[] delegateBatchDeleteNonstrict(List<WhiteSuppressJoinSq> ls, DeleteOption<WhiteSuppressJoinSqCB> op)
    { if (ls.isEmpty()) { return new int[]{}; }
      return invoke(createBatchDeleteNonstrictCommand(processBatchInternally(ls, op, true), op)); }

    protected int delegateQueryInsert(WhiteSuppressJoinSq et, WhiteSuppressJoinSqCB inCB, ConditionBean resCB, InsertOption<WhiteSuppressJoinSqCB> op)
    { if (!processBeforeQueryInsert(et, inCB, resCB, op)) { return 0; } return invoke(createQueryInsertCBCommand(et, inCB, resCB, op));  }
    protected int delegateQueryUpdate(WhiteSuppressJoinSq et, WhiteSuppressJoinSqCB cb, UpdateOption<WhiteSuppressJoinSqCB> op)
    { if (!processBeforeQueryUpdate(et, cb, op)) { return 0; } return invoke(createQueryUpdateCBCommand(et, cb, op));  }
    protected int delegateQueryDelete(WhiteSuppressJoinSqCB cb, DeleteOption<WhiteSuppressJoinSqCB> op)
