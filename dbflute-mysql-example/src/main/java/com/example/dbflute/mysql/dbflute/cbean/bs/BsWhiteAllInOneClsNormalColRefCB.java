...
public class BsWhiteAllInOneClsNormalColRefCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;WhiteAllInOneClsNormalColRefCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;WhiteAllInOneClsNormalColRefCB&gt;() {
     *     public void query(WhiteAllInOneClsNormalColRefCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * ... = whiteAllInOneClsNormalColRef.<span style="color: #FD4747">getWhiteAllInOneClsElementAsFoo()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * cb.query().setFoo...(value);
     * WhiteAllInOneClsNormalColRef whiteAllInOneClsNormalColRef = whiteAllInOneClsNormalColRefBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteAllInOneClsNormalColRef.<span style="color: #FD4747">getWhiteAllInOneClsElementAsBar()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;WhiteAllInOneClsNormalColRefCB&gt;() {
     ...
     */
    public HpColQyOperand<WhiteAllInOneClsNormalColRefCB> columnQuery(final SpecifyQuery<WhiteAllInOneClsNormalColRefCB> leftSpecifyQuery) {
        return new HpColQyOperand<WhiteAllInOneClsNormalColRefCB>(new HpColQyHandler<WhiteAllInOneClsNormalColRefCB>() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;WhiteAllInOneClsNormalColRefCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteAllInOneClsNormalColRefCB> orQuery) {
        xorSQ((WhiteAllInOneClsNormalColRefCB)this, orQuery);
    }
     ...
     *     public void query(WhiteAllInOneClsNormalColRefCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteAllInOneClsNormalColRefCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteAllInOneClsNormalColRefCB> andQuery) {
        xorSQAP((WhiteAllInOneClsNormalColRefCB)this, andQuery);
    }
