...
public abstract class BsWhiteImplicitConvInteger implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteImplicitConvInteger)) { return false; }
        BsWhiteImplicitConvInteger otherEntity = (BsWhiteImplicitConvInteger)other;
        if (!xSV(getImplicitConvIntegerId(), otherEntity.getImplicitConvIntegerId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = xCH(result, getImplicitConvIntegerId());
        return result;
    }
