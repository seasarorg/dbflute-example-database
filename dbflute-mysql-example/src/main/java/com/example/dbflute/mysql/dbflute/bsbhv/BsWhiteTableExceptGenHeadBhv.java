...
public abstract class BsWhiteTableExceptGenHeadBhv extends AbstractBehaviorWritable<WhiteTableExceptGenHead, WhiteTableExceptGenHeadCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteTableExceptGenHead> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteTableExceptGenHead> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
