...
public abstract class BsWhiteBinaryBhv extends AbstractBehaviorWritable<WhiteBinary, WhiteBinaryCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteBinary> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteBinary> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
