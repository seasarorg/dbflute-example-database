...
public abstract class BsWhiteQuotedRef implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteQuotedRef)) { return false; }
        BsWhiteQuotedRef otherEntity = (BsWhiteQuotedRef)other;
        if (!xSV(getWhere(), otherEntity.getWhere())) { return false; }
        return true;
    }
