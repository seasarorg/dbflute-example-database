...
public class BsWhiteCompoundReferredPrimaryCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
     *     public void query(WhiteCompoundReferredPrimaryCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
     ...
     *     public void query(WhiteCompoundReferredPrimaryCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
