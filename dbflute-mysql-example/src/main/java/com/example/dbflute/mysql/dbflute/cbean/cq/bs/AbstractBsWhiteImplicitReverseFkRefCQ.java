...
public abstract class AbstractBsWhiteImplicitReverseFkRefCQ extends AbstractConditionQuery {
    ...
    public void inScopeWhiteImplicitReverseFk(SubQuery<WhiteImplicitReverseFkCB> subQuery) {
        ...
        WhiteImplicitReverseFkCB cb = new WhiteImplicitReverseFkCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepWhiteImplicitReverseFkId_InScopeRelation_WhiteImplicitReverseFk(cb.query());
    ...
    public void notInScopeWhiteImplicitReverseFk(SubQuery<WhiteImplicitReverseFkCB> subQuery) {
        ...
        WhiteImplicitReverseFkCB cb = new WhiteImplicitReverseFkCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepWhiteImplicitReverseFkId_NotInScopeRelation_WhiteImplicitReverseFk(cb.query());
    ...
    public void myselfInScope(SubQuery<WhiteImplicitReverseFkRefCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        WhiteImplicitReverseFkRefCB cb = new WhiteImplicitReverseFkRefCB(); cb.xsetupForMyselfInScope(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
