...
public abstract class BsWhiteImplicitConvNumericBhv extends AbstractBehaviorWritable {
    ...
    protected void doInsert(WhiteImplicitConvNumeric et, InsertOption<WhiteImplicitConvNumericCB> op) {
        assertObjectNotNull("whiteImplicitConvNumeric", et); prepareInsertOption(op); delegateInsert(et, op);
    }
    ...
    protected void doUpdate(WhiteImplicitConvNumeric et, UpdateOption<WhiteImplicitConvNumericCB> op) {
        assertObjectNotNull("whiteImplicitConvNumeric", et); prepareUpdateOption(op); helpUpdateInternally(et, op);
    }
    ...
    protected void doInsertOrUpdate(WhiteImplicitConvNumeric et, InsertOption<WhiteImplicitConvNumericCB> iop, UpdateOption<WhiteImplicitConvNumericCB> uop) {
        assertObjectNotNull("whiteImplicitConvNumeric", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doDelete(WhiteImplicitConvNumeric et, final DeleteOption<WhiteImplicitConvNumericCB> op) {
        assertObjectNotNull("whiteImplicitConvNumeric", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<WhiteImplicitConvNumericCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int doQueryInsert(QueryInsertSetupper<WhiteImplicitConvNumeric, WhiteImplicitConvNumericCB> sp, InsertOption<WhiteImplicitConvNumericCB> op) {
        ...
        WhiteImplicitConvNumeric et = newEntity(); WhiteImplicitConvNumericCB cb = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(WhiteImplicitConvNumeric et, WhiteImplicitConvNumericCB cb, UpdateOption<WhiteImplicitConvNumericCB> op) {
        assertObjectNotNull("whiteImplicitConvNumeric", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<WhiteImplicitConvNumeric> typeOfSelectedEntity() { return WhiteImplicitConvNumeric.class; }
    protected WhiteImplicitConvNumeric downcast(Entity et) { return helpEntityDowncastInternally(et, WhiteImplicitConvNumeric.class); }
    protected WhiteImplicitConvNumericCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, WhiteImplicitConvNumericCB.class); }
    @SuppressWarnings("unchecked")
    protected List<WhiteImplicitConvNumeric> downcast(List<? extends Entity> ls) { return (List<WhiteImplicitConvNumeric>)ls; }
    @SuppressWarnings("unchecked")
