...
public abstract class BsWhiteImplicitConvNumericBhv extends AbstractBehaviorWritable<WhiteImplicitConvNumeric, WhiteImplicitConvNumericCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteImplicitConvNumeric> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteImplicitConvNumeric> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
