...
public abstract class BsWhiteCompoundReferredPrimaryBhv extends AbstractBehaviorWritable<WhiteCompoundReferredPrimary, WhiteCompoundReferredPrimaryCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteCompoundReferredPrimary> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteCompoundReferredPrimary> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
