...
public abstract class BsWhitePerrottaOverTraceBhv extends AbstractBehaviorWritable<WhitePerrottaOverTrace, WhitePerrottaOverTraceCB> {
    ...
    public WhitePerrottaOverTraceDbm getMyDBMeta() { return WhitePerrottaOverTraceDbm.getInstance(); }
    ...
    public WhitePerrottaOverTraceCB newMyConditionBean() { return new WhitePerrottaOverTraceCB(); }
     ...
     * WhitePerrottaOverTraceCB cb = new WhitePerrottaOverTraceCB();
     * cb.query().setFoo...(value);
     * WhitePerrottaOverTrace whitePerrottaOverTrace = whitePerrottaOverTraceBhv.<span style="color: #DD4747">selectEntity</span>(cb);
     * if (whitePerrottaOverTrace != null) { <span style="color: #3F7E5E">// null check</span>
     ...
     */
    public WhitePerrottaOverTrace selectEntity(WhitePerrottaOverTraceCB cb) {
        return facadeSelectEntity(cb);
    }

    protected WhitePerrottaOverTrace facadeSelectEntity(WhitePerrottaOverTraceCB cb) {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public WhitePerrottaOverTrace selectByPKValue(Long traceId) {
        return facadeSelectByPKValue(traceId);
    }

    protected WhitePerrottaOverTrace facadeSelectByPKValue(Long traceId) {
        return doSelectByPK(traceId, typeOfSelectedEntity());
    }
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public WhitePerrottaOverTrace selectByPKValueWithDeletedCheck(Long traceId) {
        return doSelectByPKWithDeletedCheck(traceId, typeOfSelectedEntity());
    }

    protected <ENTITY extends WhitePerrottaOverTrace> ENTITY doSelectByPKWithDeletedCheck(Long traceId, Class<ENTITY> tp) {
        return doSelectEntityWithDeletedCheck(xprepareCBAsPK(traceId), tp);
    }
     ...
     */
    public void load(List<WhitePerrottaOverTrace> whitePerrottaOverTraceList, ReferrerLoaderHandler<LoaderOfWhitePerrottaOverTrace> handler) {
        xassLRArg(whitePerrottaOverTraceList, handler);
        handler.handle(new LoaderOfWhitePerrottaOverTrace().ready(whitePerrottaOverTraceList, _behaviorSelector));
    }
     ...
     * @param handler The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(WhitePerrottaOverTrace whitePerrottaOverTrace, ReferrerLoaderHandler<LoaderOfWhitePerrottaOverTrace> handler) {
        xassLRArg(whitePerrottaOverTrace, handler);
        handler.handle(new LoaderOfWhitePerrottaOverTrace().ready(xnewLRAryLs(whitePerrottaOverTrace), _behaviorSelector));
    }
     ...
     * whitePerrottaOverTraceBhv.<span style="color: #DD4747">batchUpdate</span>(whitePerrottaOverTraceList, new SpecifyQuery<WhitePerrottaOverTraceCB>() {
     *     public void specify(WhitePerrottaOverTraceCB cb) { <span style="color: #3F7E5E">// the two only updated</span>
     ...
     * whitePerrottaOverTraceBhv.<span style="color: #DD4747">batchUpdate</span>(whitePerrottaOverTraceList, new SpecifyQuery<WhitePerrottaOverTraceCB>() {
     *     public void specify(WhitePerrottaOverTraceCB cb) { <span style="color: #3F7E5E">// all columns are updated</span>
     ...
     * @exception EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<WhitePerrottaOverTrace> whitePerrottaOverTraceList, SpecifyQuery<WhitePerrottaOverTraceCB> updateColumnSpec) {
        return doBatchUpdate(whitePerrottaOverTraceList, createSpecifiedUpdateOption(updateColumnSpec));
    }
     ...
     */
    public int queryInsert(QueryInsertSetupper<WhitePerrottaOverTrace, WhitePerrottaOverTraceCB> setupper) {
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhitePerrottaOverTrace whitePerrottaOverTrace, InsertOption<WhitePerrottaOverTraceCB> option) {
        assertInsertOptionNotNull(option);
        doInsert(whitePerrottaOverTrace, option);
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhitePerrottaOverTrace whitePerrottaOverTrace, UpdateOption<WhitePerrottaOverTraceCB> option) {
        assertUpdateOptionNotNull(option);
        doUpdate(whitePerrottaOverTrace, option);
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhitePerrottaOverTrace whitePerrottaOverTrace, InsertOption<WhitePerrottaOverTraceCB> insertOption, UpdateOption<WhitePerrottaOverTraceCB> updateOption) {
        assertInsertOptionNotNull(insertOption); assertUpdateOptionNotNull(updateOption);
        doInsertOrUpdate(whitePerrottaOverTrace, insertOption, updateOption);
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhitePerrottaOverTrace whitePerrottaOverTrace, DeleteOption<WhitePerrottaOverTraceCB> option) {
        assertDeleteOptionNotNull(option);
        doDelete(whitePerrottaOverTrace, option);
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhitePerrottaOverTrace> whitePerrottaOverTraceList, InsertOption<WhitePerrottaOverTraceCB> option) {
        assertInsertOptionNotNull(option);
        return doBatchInsert(whitePerrottaOverTraceList, option);
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhitePerrottaOverTrace> whitePerrottaOverTraceList, UpdateOption<WhitePerrottaOverTraceCB> option) {
        assertUpdateOptionNotNull(option);
        return doBatchUpdate(whitePerrottaOverTraceList, option);
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhitePerrottaOverTrace> whitePerrottaOverTraceList, DeleteOption<WhitePerrottaOverTraceCB> option) {
        assertDeleteOptionNotNull(option);
        return doBatchDelete(whitePerrottaOverTraceList, option);
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhitePerrottaOverTrace, WhitePerrottaOverTraceCB> setupper, InsertOption<WhitePerrottaOverTraceCB> option) {
        assertInsertOptionNotNull(option);
     ...
     */
    public int varyingQueryUpdate(WhitePerrottaOverTrace whitePerrottaOverTrace, WhitePerrottaOverTraceCB cb, UpdateOption<WhitePerrottaOverTraceCB> option) {
        assertUpdateOptionNotNull(option);
        return doQueryUpdate(whitePerrottaOverTrace, cb, option);
    }
     ...
     */
    public int varyingQueryDelete(WhitePerrottaOverTraceCB cb, DeleteOption<WhitePerrottaOverTraceCB> option) {
        assertDeleteOptionNotNull(option);
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhitePerrottaOverTrace> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhitePerrottaOverTrace> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
