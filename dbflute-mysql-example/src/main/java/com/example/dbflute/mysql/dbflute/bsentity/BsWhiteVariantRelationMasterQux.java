...
public abstract class BsWhiteVariantRelationMasterQux implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteVariantRelationMasterQux)) { return false; }
        BsWhiteVariantRelationMasterQux otherEntity = (BsWhiteVariantRelationMasterQux)other;
        if (!xSV(getMasterQuxId(), otherEntity.getMasterQuxId())) { return false; }
        return true;
    }
