...
public abstract class AbstractBsWhiteDateAdjustmentCQ extends AbstractConditionQuery {
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * (adjusted)ADJUSTED_DATE: {DATE(10)}
     * <pre>e.g. setAdjustedDate_FromTo(fromDate, toDate, new <span style="color: #FD4747">FromToOption</span>().compareAsDate());</pre>
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * ADJUSTED_DATETIME: {DATETIME(19)}
     * <pre>e.g. setAdjustedDatetime_FromTo(fromDate, toDate, new <span style="color: #FD4747">FromToOption</span>().compareAsDate());</pre>
     ...
     * <pre>e.g. setAdjustedString_LikeSearch("xxx", new <span style="color: #FD4747">LikeSearchOption</span>().likeContain());</pre>
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;WhiteDateAdjustmentCB&gt;() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;WhiteDateAdjustmentCB&gt;() {
     *     public void query(WhiteDateAdjustmentCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;WhiteDateAdjustmentCB&gt;() {
     *     public void query(WhiteDateAdjustmentCB subCB) {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;WhiteDateAdjustmentCB&gt;() {
     *     public void query(WhiteDateAdjustmentCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;WhiteDateAdjustmentCB&gt;() {
     *     public void query(WhiteDateAdjustmentCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WhiteDateAdjustmentCB&gt;() {
     *     public void query(WhiteDateAdjustmentCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public void xsmyselfDerive(String fn, SubQuery<WhiteDateAdjustmentCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WhiteDateAdjustmentCB cb = new WhiteDateAdjustmentCB(); cb.xsetupForDerivedReferrer(this); sq.query(cb);
    ...
    public void myselfExists(SubQuery<WhiteDateAdjustmentCB> subQuery) {
        ...
        WhiteDateAdjustmentCB cb = new WhiteDateAdjustmentCB(); cb.xsetupForMyselfExists(this); subQuery.query(cb);
    ...
    public void myselfInScope(SubQuery<WhiteDateAdjustmentCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        WhiteDateAdjustmentCB cb = new WhiteDateAdjustmentCB(); cb.xsetupForMyselfInScope(this); subQuery.query(cb);
