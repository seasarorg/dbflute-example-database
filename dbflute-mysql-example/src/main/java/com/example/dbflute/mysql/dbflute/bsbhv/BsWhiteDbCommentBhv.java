...
public abstract class BsWhiteDbCommentBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends WhiteDbComment> void doSelectCursor(WhiteDbCommentCB cb, EntityRowHandler<ENTITY> handler, Class<ENTITY> tp) {
        ...
        helpSelectCursorInternally(cb, handler, tp, new InternalSelectCursorCallback<ENTITY, WhiteDbCommentCB>() {
            public void callbackSelectCursor(WhiteDbCommentCB lcb, EntityRowHandler<ENTITY> lhandler, Class<ENTITY> ltp) { delegateSelectCursor(lcb, lhandler, ltp); }
            public List<ENTITY> callbackSelectList(WhiteDbCommentCB lcb, Class<ENTITY> ltp) { return doSelectList(lcb, ltp); }
        });
    }
    ...
    protected void doInsert(WhiteDbComment et, InsertOption<WhiteDbCommentCB> op) {
        assertObjectNotNull("whiteDbComment", et);
    ...
    protected void doUpdate(WhiteDbComment et, final UpdateOption<WhiteDbCommentCB> op) {
        assertObjectNotNull("whiteDbComment", et);
        prepareUpdateOption(op);
        helpUpdateInternally(et, new InternalUpdateCallback<WhiteDbComment>() {
            public int callbackDelegateUpdate(WhiteDbComment let) { return delegateUpdate(let, op); } });
    }
    ...
    protected void doInsertOrUpdate(WhiteDbComment et, final InsertOption<WhiteDbCommentCB> iop, final UpdateOption<WhiteDbCommentCB> uop) {
        assertObjectNotNull("whiteDbComment", et);
        helpInsertOrUpdateInternally(et, new InternalInsertOrUpdateCallback<WhiteDbComment, WhiteDbCommentCB>() {
            public void callbackInsert(WhiteDbComment let) { doInsert(let, iop); }
            public void callbackUpdate(WhiteDbComment let) { doUpdate(let, uop); }
            public WhiteDbCommentCB callbackNewMyConditionBean() { return newConditionBean(); }
    ...
    protected void doDelete(WhiteDbComment et, final DeleteOption<WhiteDbCommentCB> op) {
        ...
        helpDeleteInternally(et, new InternalDeleteCallback<WhiteDbComment>() {
            public int callbackDelegateDelete(WhiteDbComment let) { return delegateDelete(let, op); } });
    }
    ...
    protected int doQueryUpdate(WhiteDbComment et, WhiteDbCommentCB cb, UpdateOption<WhiteDbCommentCB> op) {
        assertObjectNotNull("whiteDbComment", et); assertCBStateValid(cb);
        prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<WhiteDbComment> typeOfSelectedEntity()
    { return WhiteDbComment.class; }
