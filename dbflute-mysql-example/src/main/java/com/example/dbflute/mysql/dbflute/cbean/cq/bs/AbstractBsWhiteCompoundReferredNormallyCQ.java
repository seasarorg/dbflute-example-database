...
public abstract class AbstractBsWhiteCompoundReferredNormallyCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsWhiteCompoundReferredNormallyCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">existsWhiteCompoundPkList</span>(new SubQuery&lt;WhiteCompoundPkCB&gt;() {
     ...
     * white_compound_pk by REFERRED_ID, named 'whiteCompoundPkAsOne'.
     * <pre>
     * cb.query().<span style="color: #FD4747">notExistsWhiteCompoundPkList</span>(new SubQuery&lt;WhiteCompoundPkCB&gt;() {
     *     public void query(WhiteCompoundPkCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
     ...
     * white_compound_pk by REFERRED_ID, named 'whiteCompoundPkAsOne'.
     * <pre>
     * cb.query().<span style="color: #FD4747">derivedWhiteCompoundPkList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;WhiteCompoundPkCB&gt;() {
     *     public void query(WhiteCompoundPkCB subCB) {
     ...
     * <pre>e.g. setReferredName_LikeSearch("xxx", new <span style="color: #FD4747">LikeSearchOption</span>().likeContain());</pre>
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;WhiteCompoundReferredNormallyCB&gt;() {
    ...
    public HpSSQFunction<WhiteCompoundReferredNormallyCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ.getOperand(), WhiteCompoundReferredNormallyCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;WhiteCompoundReferredNormallyCB&gt;() {
     *     public void query(WhiteCompoundReferredNormallyCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
    ...
    public HpSSQFunction<WhiteCompoundReferredNormallyCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES.getOperand(), WhiteCompoundReferredNormallyCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;WhiteCompoundReferredNormallyCB&gt;() {
     *     public void query(WhiteCompoundReferredNormallyCB subCB) {
    ...
    public HpSSQFunction<WhiteCompoundReferredNormallyCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT.getOperand(), WhiteCompoundReferredNormallyCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;WhiteCompoundReferredNormallyCB&gt;() {
     *     public void query(WhiteCompoundReferredNormallyCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteCompoundReferredNormallyCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT.getOperand(), WhiteCompoundReferredNormallyCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;WhiteCompoundReferredNormallyCB&gt;() {
     *     public void query(WhiteCompoundReferredNormallyCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteCompoundReferredNormallyCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE.getOperand(), WhiteCompoundReferredNormallyCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WhiteCompoundReferredNormallyCB&gt;() {
     *     public void query(WhiteCompoundReferredNormallyCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteCompoundReferredNormallyCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE.getOperand(), WhiteCompoundReferredNormallyCB.class);
    }
    ...
    public void xsmyselfDerive(String fn, SubQuery<WhiteCompoundReferredNormallyCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WhiteCompoundReferredNormallyCB cb = new WhiteCompoundReferredNormallyCB(); cb.xsetupForDerivedReferrer(this); sq.query(cb);
    ...
    public void myselfExists(SubQuery<WhiteCompoundReferredNormallyCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        WhiteCompoundReferredNormallyCB cb = new WhiteCompoundReferredNormallyCB(); cb.xsetupForMyselfExists(this); subQuery.query(cb);
    ...
    public void myselfInScope(SubQuery<WhiteCompoundReferredNormallyCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        WhiteCompoundReferredNormallyCB cb = new WhiteCompoundReferredNormallyCB(); cb.xsetupForMyselfInScope(this); subQuery.query(cb);
