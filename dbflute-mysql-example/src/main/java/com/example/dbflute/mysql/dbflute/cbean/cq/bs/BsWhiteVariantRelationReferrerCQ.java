...
public class BsWhiteVariantRelationReferrerCQ extends AbstractBsWhiteVariantRelationReferrerCQ {
    ...
    protected void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
        WhiteVariantRelationReferrerCQ baseQuery = (WhiteVariantRelationReferrerCQ)baseQueryAsSuper;
        WhiteVariantRelationReferrerCQ unionQuery = (WhiteVariantRelationReferrerCQ)unionQueryAsSuper;
        if (baseQuery.hasConditionQueryWhiteVariantRelationMasterFooAsVariant()) {
            unionQuery.queryWhiteVariantRelationMasterFooAsVariant().reflectRelationOnUnionQuery(baseQuery.queryWhiteVariantRelationMasterFooAsVariant(), unionQuery.queryWhiteVariantRelationMasterFooAsVariant());
        }
        if (baseQuery.hasConditionQueryWhiteVariantRelationMasterBarAsVariant()) {
            unionQuery.queryWhiteVariantRelationMasterBarAsVariant().reflectRelationOnUnionQuery(baseQuery.queryWhiteVariantRelationMasterBarAsVariant(), unionQuery.queryWhiteVariantRelationMasterBarAsVariant());
        }
        if (baseQuery.hasConditionQueryWhiteVariantRelationMasterQuxAsVariantByQue()) {
            unionQuery.queryWhiteVariantRelationMasterQuxAsVariantByQue().reflectRelationOnUnionQuery(baseQuery.queryWhiteVariantRelationMasterQuxAsVariantByQue(), unionQuery.queryWhiteVariantRelationMasterQuxAsVariantByQue());
        }
        if (baseQuery.hasConditionQueryWhiteVariantRelationMasterCorgeAsVariantByQuxType()) {
            unionQuery.xsetParameterMapWhiteVariantRelationMasterCorgeAsVariantByQuxType(baseQuery.getParameterMapWhiteVariantRelationMasterCorgeAsVariantByQuxType());
            unionQuery.getConditionQueryWhiteVariantRelationMasterCorgeAsVariantByQuxType().reflectRelationOnUnionQuery(baseQuery.getConditionQueryWhiteVariantRelationMasterCorgeAsVariantByQuxType(), unionQuery.getConditionQueryWhiteVariantRelationMasterCorgeAsVariantByQuxType());
        }
    }
