...
public class BsWhitePgReservCQ extends AbstractBsWhitePgReservCQ {
    ...
    public Map<String, WhitePgReservRefCQ> getClassSynonym_InScopeRelation_WhitePgReservRefList() { return xgetSQueMap("classSynonym_InScopeRelation_WhitePgReservRefList"); }
    public String keepClassSynonym_InScopeRelation_WhitePgReservRefList(WhitePgReservRefCQ sq) { return xkeepSQue("classSynonym_InScopeRelation_WhitePgReservRefList", sq); }

    public Map<String, WhitePgReservRefCQ> getClassSynonym_NotInScopeRelation_WhitePgReservRefList() { return xgetSQueMap("classSynonym_NotInScopeRelation_WhitePgReservRefList"); }
    public String keepClassSynonym_NotInScopeRelation_WhitePgReservRefList(WhitePgReservRefCQ sq) { return xkeepSQue("classSynonym_NotInScopeRelation_WhitePgReservRefList", sq); }
