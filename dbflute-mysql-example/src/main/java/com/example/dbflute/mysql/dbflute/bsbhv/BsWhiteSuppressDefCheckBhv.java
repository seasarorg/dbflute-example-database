...
public abstract class BsWhiteSuppressDefCheckBhv extends AbstractBehaviorWritable<WhiteSuppressDefCheck, WhiteSuppressDefCheckCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteSuppressDefCheck> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteSuppressDefCheck> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
