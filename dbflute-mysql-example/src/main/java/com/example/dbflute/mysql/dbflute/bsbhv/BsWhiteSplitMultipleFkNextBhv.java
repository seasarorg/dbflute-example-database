...
public abstract class BsWhiteSplitMultipleFkNextBhv extends AbstractBehaviorWritable<WhiteSplitMultipleFkNext, WhiteSplitMultipleFkNextCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteSplitMultipleFkNext> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteSplitMultipleFkNext> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
