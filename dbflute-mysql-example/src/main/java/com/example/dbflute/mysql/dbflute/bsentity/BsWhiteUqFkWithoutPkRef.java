...
public abstract class BsWhiteUqFkWithoutPkRef implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteUqFkWithoutPkRef)) { return false; }
        BsWhiteUqFkWithoutPkRef otherEntity = (BsWhiteUqFkWithoutPkRef)other;
        if (!xSV(getUqFkRefId(), otherEntity.getUqFkRefId())) { return false; }
        if (!xSV(getFkToUqCode(), otherEntity.getFkToUqCode())) { return false; }
        return true;
    }
