...
public abstract class BsWhiteVariantRelationMasterFooBhv extends AbstractBehaviorWritable {
    ...
    protected void doInsert(WhiteVariantRelationMasterFoo et, InsertOption<WhiteVariantRelationMasterFooCB> op) {
        assertObjectNotNull("whiteVariantRelationMasterFoo", et); prepareInsertOption(op); delegateInsert(et, op);
    }
    ...
    protected void doUpdate(WhiteVariantRelationMasterFoo et, UpdateOption<WhiteVariantRelationMasterFooCB> op) {
        assertObjectNotNull("whiteVariantRelationMasterFoo", et); prepareUpdateOption(op); helpUpdateInternally(et, op);
    }
    ...
    protected void doInsertOrUpdate(WhiteVariantRelationMasterFoo et, InsertOption<WhiteVariantRelationMasterFooCB> iop, UpdateOption<WhiteVariantRelationMasterFooCB> uop) {
        assertObjectNotNull("whiteVariantRelationMasterFoo", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doDelete(WhiteVariantRelationMasterFoo et, final DeleteOption<WhiteVariantRelationMasterFooCB> op) {
        assertObjectNotNull("whiteVariantRelationMasterFoo", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<WhiteVariantRelationMasterFooCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int doQueryInsert(QueryInsertSetupper<WhiteVariantRelationMasterFoo, WhiteVariantRelationMasterFooCB> sp, InsertOption<WhiteVariantRelationMasterFooCB> op) {
        ...
        WhiteVariantRelationMasterFoo et = newEntity(); WhiteVariantRelationMasterFooCB cb = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(WhiteVariantRelationMasterFoo et, WhiteVariantRelationMasterFooCB cb, UpdateOption<WhiteVariantRelationMasterFooCB> op) {
        assertObjectNotNull("whiteVariantRelationMasterFoo", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<WhiteVariantRelationMasterFoo> typeOfSelectedEntity() { return WhiteVariantRelationMasterFoo.class; }
    protected WhiteVariantRelationMasterFoo downcast(Entity et) { return helpEntityDowncastInternally(et, WhiteVariantRelationMasterFoo.class); }
    protected WhiteVariantRelationMasterFooCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, WhiteVariantRelationMasterFooCB.class); }
    @SuppressWarnings("unchecked")
    protected List<WhiteVariantRelationMasterFoo> downcast(List<? extends Entity> ls) { return (List<WhiteVariantRelationMasterFoo>)ls; }
    @SuppressWarnings("unchecked")
