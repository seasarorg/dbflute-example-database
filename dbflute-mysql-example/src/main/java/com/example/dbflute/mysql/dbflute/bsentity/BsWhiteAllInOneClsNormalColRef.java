...
public abstract class BsWhiteAllInOneClsNormalColRef implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteAllInOneClsNormalColRef)) { return false; }
        BsWhiteAllInOneClsNormalColRef otherEntity = (BsWhiteAllInOneClsNormalColRef)other;
