...
public abstract class BsWhiteVariantRelationMasterCorge implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteVariantRelationMasterCorge)) { return false; }
        BsWhiteVariantRelationMasterCorge otherEntity = (BsWhiteVariantRelationMasterCorge)other;
        if (!xSV(getMasterCorgeId(), otherEntity.getMasterCorgeId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = xCH(result, getMasterCorgeId());
        return result;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String delimiter = ", ";
        sb.append(delimiter).append(getMasterCorgeId());
        sb.append(delimiter).append(getMasterCorgeName());
        sb.append(delimiter).append(getCorgeTypeCode());
