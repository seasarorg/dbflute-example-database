 ...
 */
public abstract class BsWrongPackageBqp implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.mysql.dbflute.bsentity.customize.dbmeta.WrongPackageBqpDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWrongPackageBqp)) { return false; }
        BsWrongPackageBqp otherEntity = (BsWrongPackageBqp)other;
