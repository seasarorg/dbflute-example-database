...
public abstract class BsWhiteEscapedJavaDoc implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteEscapedJavaDoc)) { return false; }
        BsWhiteEscapedJavaDoc otherEntity = (BsWhiteEscapedJavaDoc)other;
        if (!xSV(getEscapedJavaDocCode(), otherEntity.getEscapedJavaDocCode())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = xCH(result, getEscapedJavaDocCode());
        return result;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String delimiter = ", ";
        sb.append(delimiter).append(getEscapedJavaDocCode());
        sb.append(delimiter).append(getEscapedJavaDocName());
