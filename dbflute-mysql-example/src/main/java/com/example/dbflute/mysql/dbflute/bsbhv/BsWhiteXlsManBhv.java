...
public abstract class BsWhiteXlsManBhv extends AbstractBehaviorWritable<WhiteXlsMan, WhiteXlsManCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteXlsMan> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteXlsMan> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
