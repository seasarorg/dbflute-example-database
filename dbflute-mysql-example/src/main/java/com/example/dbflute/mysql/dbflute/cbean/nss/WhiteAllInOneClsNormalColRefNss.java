...
import com.example.dbflute.mysql.dbflute.cbean.cq.WhiteAllInOneClsNormalColRefCQ;
...
public class WhiteAllInOneClsNormalColRefNss {
    ...
    public WhiteAllInOneClsElementNss withWhiteAllInOneClsElementAsFoo() {
        _query.doNss(new WhiteAllInOneClsNormalColRefCQ.NssCall() { public ConditionQuery qf() { return _query.queryWhiteAllInOneClsElementAsFoo(); }});
