...
public class LoaderOfVendorTheLongAndWindingTableAndColumn {
    ...
    public NestedReferrerLoaderGateway<LoaderOfVendorTheLongAndWindingTableAndColumnRef> loadVendorTheLongAndWindingTableAndColumnRefList(ConditionBeanSetupper<VendorTheLongAndWindingTableAndColumnRefCB> setupper) {
        myBhv().loadVendorTheLongAndWindingTableAndColumnRefList(_selectedList, setupper).withNestedReferrer(new ReferrerListHandler<VendorTheLongAndWindingTableAndColumnRef>() {
