...
/**
 * The condition-query for in-line of white_uq_reference_ref_nest.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteUqReferenceRefNestCIQ extends AbstractBsWhiteUqReferenceRefNestCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteUqReferenceRefNestCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteUqReferenceRefNestCIQ(ConditionQuery childQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteUqReferenceRefNestCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue getCValueUqReferenceRefNestId() { return _myCQ.getUqReferenceRefNestId(); }
    ...
    protected String xinCB() { return WhiteUqReferenceRefNestCB.class.getName(); }
    protected String xinCQ() { return WhiteUqReferenceRefNestCQ.class.getName(); }
}
