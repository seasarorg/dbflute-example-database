...
public abstract class BsWhitePerrottaOverProductBhv extends AbstractBehaviorWritable<WhitePerrottaOverProduct, WhitePerrottaOverProductCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhitePerrottaOverProduct> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhitePerrottaOverProduct> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
