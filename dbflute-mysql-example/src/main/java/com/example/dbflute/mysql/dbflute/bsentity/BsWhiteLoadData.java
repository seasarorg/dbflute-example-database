 ...
 */
public abstract class BsWhiteLoadData implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteLoadData)) { return false; }
        BsWhiteLoadData otherEntity = (BsWhiteLoadData)other;
        if (!xSV(getLoadDataId(), otherEntity.getLoadDataId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = xCH(result, getLoadDataId());
        return result;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String delimiter = ", ";
        sb.append(delimiter).append(getLoadDataId());
        sb.append(delimiter).append(getLoadDataName());
