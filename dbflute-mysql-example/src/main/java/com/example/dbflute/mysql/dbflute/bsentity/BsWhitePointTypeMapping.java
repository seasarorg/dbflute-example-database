...
public abstract class BsWhitePointTypeMapping implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhitePointTypeMapping)) { return false; }
        BsWhitePointTypeMapping otherEntity = (BsWhitePointTypeMapping)other;
        if (!xSV(getPointTypeMappingId(), otherEntity.getPointTypeMappingId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = xCH(result, getPointTypeMappingId());
        return result;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String delimiter = ", ";
        sb.append(delimiter).append(getPointTypeMappingId());
        sb.append(delimiter).append(getPointTypeMappingMemberName());
        sb.append(delimiter).append(getPointTypeMappingPriceCount());
        sb.append(delimiter).append(getPointTypeMappingSaleDate());
        sb.append(delimiter).append(xfUD(getPointTypeMappingWantedDatetime()));
