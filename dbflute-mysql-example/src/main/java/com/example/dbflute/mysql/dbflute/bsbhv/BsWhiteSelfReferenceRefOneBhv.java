...
public abstract class BsWhiteSelfReferenceRefOneBhv extends AbstractBehaviorWritable<WhiteSelfReferenceRefOne, WhiteSelfReferenceRefOneCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteSelfReferenceRefOne> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteSelfReferenceRefOne> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
