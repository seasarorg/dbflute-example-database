...
public abstract class BsWhiteColumnExceptBhv extends AbstractBehaviorWritable<WhiteColumnExcept, WhiteColumnExceptCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteColumnExcept> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteColumnExcept> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
