...
public abstract class BsWhiteUqFkWithoutPkBhv extends AbstractBehaviorReadable<WhiteUqFkWithoutPk, WhiteUqFkWithoutPkCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteUqFkWithoutPk> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteUqFkWithoutPk> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
