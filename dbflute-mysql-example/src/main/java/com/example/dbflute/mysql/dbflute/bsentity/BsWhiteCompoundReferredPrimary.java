 ...
 */
public abstract class BsWhiteCompoundReferredPrimary implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteCompoundReferredPrimary)) { return false; }
        BsWhiteCompoundReferredPrimary otherEntity = (BsWhiteCompoundReferredPrimary)other;
