...
public abstract class AbstractBsWhiteNoPkRelationCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsWhiteNoPkRelationCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    protected String xabCB() { return WhiteNoPkRelationCB.class.getName(); }
