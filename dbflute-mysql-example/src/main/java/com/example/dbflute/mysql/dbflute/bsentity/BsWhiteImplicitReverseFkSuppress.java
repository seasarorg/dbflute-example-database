...
public abstract class BsWhiteImplicitReverseFkSuppress implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteImplicitReverseFkSuppress)) { return false; }
        BsWhiteImplicitReverseFkSuppress otherEntity = (BsWhiteImplicitReverseFkSuppress)other;
        if (!xSV(getWhiteImplicitReverseFkSuppressId(), otherEntity.getWhiteImplicitReverseFkSuppressId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = xCH(result, getWhiteImplicitReverseFkSuppressId());
        return result;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String delimiter = ", ";
        sb.append(delimiter).append(getWhiteImplicitReverseFkSuppressId());
