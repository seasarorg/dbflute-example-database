...
public abstract class BsWhitePgReservRefBhv extends AbstractBehaviorWritable {
    ...
    protected void doInsert(WhitePgReservRef et, InsertOption<WhitePgReservRefCB> op) {
        assertObjectNotNull("whitePgReservRef", et); prepareInsertOption(op); delegateInsert(et, op);
    }
    ...
    protected void doUpdate(WhitePgReservRef et, UpdateOption<WhitePgReservRefCB> op) {
        assertObjectNotNull("whitePgReservRef", et); prepareUpdateOption(op); helpUpdateInternally(et, op);
    }
    ...
    protected void doInsertOrUpdate(WhitePgReservRef et, InsertOption<WhitePgReservRefCB> iop, UpdateOption<WhitePgReservRefCB> uop) {
        assertObjectNotNull("whitePgReservRef", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doDelete(WhitePgReservRef et, final DeleteOption<WhitePgReservRefCB> op) {
        assertObjectNotNull("whitePgReservRef", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<WhitePgReservRefCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int doQueryInsert(QueryInsertSetupper<WhitePgReservRef, WhitePgReservRefCB> sp, InsertOption<WhitePgReservRefCB> op) {
        ...
        WhitePgReservRef et = newEntity(); WhitePgReservRefCB cb = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(WhitePgReservRef et, WhitePgReservRefCB cb, UpdateOption<WhitePgReservRefCB> op) {
        assertObjectNotNull("whitePgReservRef", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<WhitePgReservRef> typeOfSelectedEntity() { return WhitePgReservRef.class; }
    protected WhitePgReservRef downcast(Entity et) { return helpEntityDowncastInternally(et, WhitePgReservRef.class); }
    protected WhitePgReservRefCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, WhitePgReservRefCB.class); }
    @SuppressWarnings("unchecked")
    protected List<WhitePgReservRef> downcast(List<? extends Entity> ls) { return (List<WhitePgReservRef>)ls; }
    @SuppressWarnings("unchecked")
