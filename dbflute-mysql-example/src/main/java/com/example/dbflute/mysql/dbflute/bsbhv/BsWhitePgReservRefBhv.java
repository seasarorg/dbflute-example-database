...
public abstract class BsWhitePgReservRefBhv extends AbstractBehaviorWritable<WhitePgReservRef, WhitePgReservRefCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhitePgReservRef> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhitePgReservRef> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
