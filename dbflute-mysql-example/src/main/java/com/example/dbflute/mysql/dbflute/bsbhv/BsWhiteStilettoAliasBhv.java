...
public abstract class BsWhiteStilettoAliasBhv extends AbstractBehaviorWritable<WhiteStilettoAlias, WhiteStilettoAliasCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteStilettoAlias> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteStilettoAlias> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
