...
public abstract class BsWhiteUqClassificationBhv extends AbstractBehaviorWritable<WhiteUqClassification, WhiteUqClassificationCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteUqClassification> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteUqClassification> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
