...
public abstract class BsWhiteAdditionalBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends WhiteAdditional> ENTITY doSelectEntity(final WhiteAdditionalCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends WhiteAdditional> ENTITY doSelectEntityWithDeletedCheck(final WhiteAdditionalCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends WhiteAdditional> ListResultBean<ENTITY> doSelectList(WhiteAdditionalCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectListInternally(cb, tp, new InternalSelectListCallback<ENTITY, WhiteAdditionalCB>() {
            public List<ENTITY> callbackSelectList(WhiteAdditionalCB cb, Class<ENTITY> tp) { return delegateSelectList(cb, tp); } });
    }
