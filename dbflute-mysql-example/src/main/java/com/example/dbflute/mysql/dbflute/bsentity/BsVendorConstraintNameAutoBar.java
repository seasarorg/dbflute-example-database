 ...
 */
public abstract class BsVendorConstraintNameAutoBar implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsVendorConstraintNameAutoBar)) { return false; }
        BsVendorConstraintNameAutoBar otherEntity = (BsVendorConstraintNameAutoBar)other;
