...
public abstract class BsWhiteOnlyOneToOneFromBhv extends AbstractBehaviorWritable {
    ...
    protected void doInsert(WhiteOnlyOneToOneFrom et, InsertOption<WhiteOnlyOneToOneFromCB> op) {
        assertObjectNotNull("whiteOnlyOneToOneFrom", et); prepareInsertOption(op); delegateInsert(et, op);
    }
    ...
    protected void doUpdate(WhiteOnlyOneToOneFrom et, UpdateOption<WhiteOnlyOneToOneFromCB> op) {
        assertObjectNotNull("whiteOnlyOneToOneFrom", et); prepareUpdateOption(op); helpUpdateInternally(et, op);
    }
    ...
    protected void doInsertOrUpdate(WhiteOnlyOneToOneFrom et, InsertOption<WhiteOnlyOneToOneFromCB> iop, UpdateOption<WhiteOnlyOneToOneFromCB> uop) {
        assertObjectNotNull("whiteOnlyOneToOneFrom", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doDelete(WhiteOnlyOneToOneFrom et, final DeleteOption<WhiteOnlyOneToOneFromCB> op) {
        assertObjectNotNull("whiteOnlyOneToOneFrom", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<WhiteOnlyOneToOneFromCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int doQueryInsert(QueryInsertSetupper<WhiteOnlyOneToOneFrom, WhiteOnlyOneToOneFromCB> sp, InsertOption<WhiteOnlyOneToOneFromCB> op) {
        ...
        WhiteOnlyOneToOneFrom et = newEntity(); WhiteOnlyOneToOneFromCB cb = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(WhiteOnlyOneToOneFrom et, WhiteOnlyOneToOneFromCB cb, UpdateOption<WhiteOnlyOneToOneFromCB> op) {
        assertObjectNotNull("whiteOnlyOneToOneFrom", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<WhiteOnlyOneToOneFrom> typeOfSelectedEntity() { return WhiteOnlyOneToOneFrom.class; }
    protected WhiteOnlyOneToOneFrom downcast(Entity et) { return helpEntityDowncastInternally(et, WhiteOnlyOneToOneFrom.class); }
    protected WhiteOnlyOneToOneFromCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, WhiteOnlyOneToOneFromCB.class); }
    @SuppressWarnings("unchecked")
    protected List<WhiteOnlyOneToOneFrom> downcast(List<? extends Entity> ls) { return (List<WhiteOnlyOneToOneFrom>)ls; }
    @SuppressWarnings("unchecked")
    protected InsertOption<WhiteOnlyOneToOneFromCB> downcast(InsertOption<? extends ConditionBean> op) { return (InsertOption<WhiteOnlyOneToOneFromCB>)op; }
    @SuppressWarnings("unchecked")
    protected UpdateOption<WhiteOnlyOneToOneFromCB> downcast(UpdateOption<? extends ConditionBean> op) { return (UpdateOption<WhiteOnlyOneToOneFromCB>)op; }
    @SuppressWarnings("unchecked")
    protected DeleteOption<WhiteOnlyOneToOneFromCB> downcast(DeleteOption<? extends ConditionBean> op) { return (DeleteOption<WhiteOnlyOneToOneFromCB>)op; }
    @SuppressWarnings("unchecked")
