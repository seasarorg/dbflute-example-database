...
public abstract class BsWhiteOnlyOneToOneFromBhv extends AbstractBehaviorWritable<WhiteOnlyOneToOneFrom, WhiteOnlyOneToOneFromCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteOnlyOneToOneFrom> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteOnlyOneToOneFrom> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
