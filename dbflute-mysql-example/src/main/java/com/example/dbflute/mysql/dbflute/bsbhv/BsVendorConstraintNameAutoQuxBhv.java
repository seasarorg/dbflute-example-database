...
public abstract class BsVendorConstraintNameAutoQuxBhv extends AbstractBehaviorWritable<VendorConstraintNameAutoQux, VendorConstraintNameAutoQuxCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends VendorConstraintNameAutoQux> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends VendorConstraintNameAutoQux> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
