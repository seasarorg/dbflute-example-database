...
public abstract class BsVendorConstraintNameAutoQuxBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends VendorConstraintNameAutoQux> ENTITY doSelectEntity(final VendorConstraintNameAutoQuxCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends VendorConstraintNameAutoQux> ENTITY doSelectEntityWithDeletedCheck(final VendorConstraintNameAutoQuxCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends VendorConstraintNameAutoQux> ListResultBean<ENTITY> doSelectList(VendorConstraintNameAutoQuxCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectListInternally(cb, tp, new InternalSelectListCallback<ENTITY, VendorConstraintNameAutoQuxCB>() {
            public List<ENTITY> callbackSelectList(VendorConstraintNameAutoQuxCB cb, Class<ENTITY> tp) { return delegateSelectList(cb, tp); } });
    }
