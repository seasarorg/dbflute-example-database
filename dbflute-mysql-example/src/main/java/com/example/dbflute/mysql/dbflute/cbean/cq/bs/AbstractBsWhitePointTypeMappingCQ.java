...
public abstract class AbstractBsWhitePointTypeMappingCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsWhitePointTypeMappingCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * POINT_TYPE_MAPPING_SALE_DATE: {BIGINT(19)}
     * <pre>e.g. setPointTypeMappingSaleDate_FromTo(fromDate, toDate, new <span style="color: #FD4747">FromToOption</span>().compareAsDate());</pre>
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * POINT_TYPE_MAPPING_WANTED_DATETIME: {DATETIME(19)}
     * <pre>e.g. setPointTypeMappingWantedDatetime_FromTo(fromDate, toDate, new <span style="color: #FD4747">FromToOption</span>().compareAsDate());</pre>
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;WhitePointTypeMappingCB&gt;() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;WhitePointTypeMappingCB&gt;() {
     *     public void query(WhitePointTypeMappingCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;WhitePointTypeMappingCB&gt;() {
     *     public void query(WhitePointTypeMappingCB subCB) {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;WhitePointTypeMappingCB&gt;() {
     *     public void query(WhitePointTypeMappingCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;WhitePointTypeMappingCB&gt;() {
     *     public void query(WhitePointTypeMappingCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WhitePointTypeMappingCB&gt;() {
     *     public void query(WhitePointTypeMappingCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public void xsmyselfDerive(String fn, SubQuery<WhitePointTypeMappingCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WhitePointTypeMappingCB cb = new WhitePointTypeMappingCB(); cb.xsetupForDerivedReferrer(this); sq.query(cb);
    ...
    public void myselfExists(SubQuery<WhitePointTypeMappingCB> subQuery) {
        ...
        WhitePointTypeMappingCB cb = new WhitePointTypeMappingCB(); cb.xsetupForMyselfExists(this); subQuery.query(cb);
    ...
    public void myselfInScope(SubQuery<WhitePointTypeMappingCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        WhitePointTypeMappingCB cb = new WhitePointTypeMappingCB(); cb.xsetupForMyselfInScope(this); subQuery.query(cb);
