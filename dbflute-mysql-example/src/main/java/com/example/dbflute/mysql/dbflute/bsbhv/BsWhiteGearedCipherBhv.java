...
public abstract class BsWhiteGearedCipherBhv extends AbstractBehaviorWritable<WhiteGearedCipher, WhiteGearedCipherCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteGearedCipher> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteGearedCipher> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
