...
public abstract class BsWhiteNoPkBhv extends AbstractBehaviorReadable<WhiteNoPk, WhiteNoPkCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteNoPk> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteNoPk> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
