...
public class BsWhiteImplicitConvIntegerCB extends AbstractConditionBean {
     ...
     */
    public HpColQyOperand.HpExtendedColQyOperandMySql<WhiteImplicitConvIntegerCB> columnQuery(final SpecifyQuery<WhiteImplicitConvIntegerCB> leftSpecifyQuery) {
