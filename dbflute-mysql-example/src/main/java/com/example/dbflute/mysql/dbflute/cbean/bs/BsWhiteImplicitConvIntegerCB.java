...
public class BsWhiteImplicitConvIntegerCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;WhiteImplicitConvIntegerCB&gt;() {
    ...
    public void union(UnionQuery<WhiteImplicitConvIntegerCB> unionQuery) {
        final WhiteImplicitConvIntegerCB cb = new WhiteImplicitConvIntegerCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;WhiteImplicitConvIntegerCB&gt;() {
     *     public void query(WhiteImplicitConvIntegerCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * ... = whiteImplicitConvInteger.<span style="color: #FD4747">getWhiteImplicitConvNumeric()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * <pre>
     * WhiteImplicitConvIntegerCB cb = new WhiteImplicitConvIntegerCB();
     * cb.<span style="color: #FD4747">setupSelect_WhiteImplicitConvString()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * WhiteImplicitConvInteger whiteImplicitConvInteger = whiteImplicitConvIntegerBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteImplicitConvInteger.<span style="color: #FD4747">getWhiteImplicitConvString()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteImplicitConvIntegerCQ> {
        ...
        public HpSDRFunction<WhiteImplicitConvNumericCB, WhiteImplicitConvIntegerCQ> derivedWhiteImplicitConvNumericList() {
            ...
            return new HpSDRFunction<WhiteImplicitConvNumericCB, WhiteImplicitConvIntegerCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteImplicitConvNumericCB, WhiteImplicitConvIntegerCQ>() {
                public void setup(String function, SubQuery<WhiteImplicitConvNumericCB> subQuery, WhiteImplicitConvIntegerCQ cq, String aliasName, DerivedReferrerOption option) {
                    cq.xsderiveWhiteImplicitConvNumericList(function, subQuery, aliasName, option); } }, _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer. <br />
         ...
         * <pre>
         * cb.specify().<span style="color: #FD4747">derivedWhiteImplicitConvStringList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;WhiteImplicitConvStringCB&gt;() {
         *     public void query(WhiteImplicitConvStringCB subCB) {
         *         subCB.specify().<span style="color: #FD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, WhiteImplicitConvString.<span style="color: #FD4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<WhiteImplicitConvStringCB, WhiteImplicitConvIntegerCQ> derivedWhiteImplicitConvStringList() {
            ...
            return new HpSDRFunction<WhiteImplicitConvStringCB, WhiteImplicitConvIntegerCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteImplicitConvStringCB, WhiteImplicitConvIntegerCQ>() {
                public void setup(String function, SubQuery<WhiteImplicitConvStringCB> subQuery, WhiteImplicitConvIntegerCQ cq, String aliasName, DerivedReferrerOption option) {
        ...
        public HpSDRFunction<WhiteImplicitConvIntegerCB, WhiteImplicitConvIntegerCQ> myselfDerived() {
            ...
            return new HpSDRFunction<WhiteImplicitConvIntegerCB, WhiteImplicitConvIntegerCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteImplicitConvIntegerCB, WhiteImplicitConvIntegerCQ>() {
                public void setup(String function, SubQuery<WhiteImplicitConvIntegerCB> subQuery, WhiteImplicitConvIntegerCQ cq, String aliasName, DerivedReferrerOption option) {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;WhiteImplicitConvIntegerCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;WhiteImplicitConvIntegerCB&gt;() {
     ...
     *     public void query(WhiteImplicitConvIntegerCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteImplicitConvIntegerCB&gt;() {
