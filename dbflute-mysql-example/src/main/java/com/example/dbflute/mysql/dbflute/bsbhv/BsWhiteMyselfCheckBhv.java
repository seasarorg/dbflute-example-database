...
public abstract class BsWhiteMyselfCheckBhv extends AbstractBehaviorWritable<WhiteMyselfCheck, WhiteMyselfCheckCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteMyselfCheck> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteMyselfCheck> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
