 ...
 */
public abstract class BsWhiteColumnExceptGenOnly implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteColumnExceptGenOnly)) { return false; }
        BsWhiteColumnExceptGenOnly otherEntity = (BsWhiteColumnExceptGenOnly)other;
        if (!xSV(getGenOnlyId(), otherEntity.getGenOnlyId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = xCH(result, getGenOnlyId());
        return result;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String delimiter = ", ";
        sb.append(delimiter).append(getGenOnlyId());
        sb.append(delimiter).append(getGenOnlyName());
