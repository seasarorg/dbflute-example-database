...
public abstract class BsWhiteAllInOneClsNormalColRefBhv extends AbstractBehaviorWritable<WhiteAllInOneClsNormalColRef, WhiteAllInOneClsNormalColRefCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteAllInOneClsNormalColRef> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteAllInOneClsNormalColRef> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
