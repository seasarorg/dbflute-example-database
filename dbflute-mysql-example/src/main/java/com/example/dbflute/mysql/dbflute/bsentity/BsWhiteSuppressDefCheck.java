 ...
 */
public abstract class BsWhiteSuppressDefCheck implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteSuppressDefCheck)) { return false; }
        BsWhiteSuppressDefCheck otherEntity = (BsWhiteSuppressDefCheck)other;
        if (!xSV(getDefCheckId(), otherEntity.getDefCheckId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = xCH(result, getDefCheckId());
        return result;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String delimiter = ", ";
        sb.append(delimiter).append(getDefCheckId());
        sb.append(delimiter).append(getDefCheckName());
