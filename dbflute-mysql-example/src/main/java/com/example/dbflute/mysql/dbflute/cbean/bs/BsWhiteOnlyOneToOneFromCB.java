...
public class BsWhiteOnlyOneToOneFromCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteOnlyOneToOneFromCQ> {
        ...
        public HpSDRFunction<WhiteOnlyOneToOneFromCB, WhiteOnlyOneToOneFromCQ> myselfDerived() {
            ...
            return new HpSDRFunction<WhiteOnlyOneToOneFromCB, WhiteOnlyOneToOneFromCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteOnlyOneToOneFromCB, WhiteOnlyOneToOneFromCQ>() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteOnlyOneToOneFromCB> orQuery) {
        xorSQ((WhiteOnlyOneToOneFromCB)this, orQuery);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteOnlyOneToOneFromCB> andQuery) {
        xorSQAP((WhiteOnlyOneToOneFromCB)this, andQuery);
    }
