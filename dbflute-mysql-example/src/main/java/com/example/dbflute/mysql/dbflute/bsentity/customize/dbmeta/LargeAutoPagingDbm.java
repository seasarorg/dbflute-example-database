...
public class LargeAutoPagingDbm extends AbstractDBMeta {
    ...
    public static class EpgLargeDataRefId implements PropertyGateway {
        public Object read(Entity et) { return ((LargeAutoPaging)et).getLargeDataRefId(); }
        public void write(Entity et, Object vl) { ((LargeAutoPaging)et).setLargeDataRefId(ctl(vl)); }
    }
    public static class EpgLargeDataId implements PropertyGateway {
        public Object read(Entity et) { return ((LargeAutoPaging)et).getLargeDataId(); }
        public void write(Entity et, Object vl) { ((LargeAutoPaging)et).setLargeDataId(ctl(vl)); }
    }
    public static class EpgDateIndex implements PropertyGateway {
        public Object read(Entity et) { return ((LargeAutoPaging)et).getDateIndex(); }
        public void write(Entity et, Object vl) { ((LargeAutoPaging)et).setDateIndex((java.util.Date)vl); }
    }
    public static class EpgDateNoIndex implements PropertyGateway {
        public Object read(Entity et) { return ((LargeAutoPaging)et).getDateNoIndex(); }
        public void write(Entity et, Object vl) { ((LargeAutoPaging)et).setDateNoIndex((java.util.Date)vl); }
    }
    public static class EpgTimestampIndex implements PropertyGateway {
        public Object read(Entity et) { return ((LargeAutoPaging)et).getTimestampIndex(); }
        public void write(Entity et, Object vl) { ((LargeAutoPaging)et).setTimestampIndex((java.sql.Timestamp)vl); }
    }
    public static class EpgTimestampNoIndex implements PropertyGateway {
        public Object read(Entity et) { return ((LargeAutoPaging)et).getTimestampNoIndex(); }
        public void write(Entity et, Object vl) { ((LargeAutoPaging)et).setTimestampNoIndex((java.sql.Timestamp)vl); }
    }
    public static class EpgNullableDecimalIndex implements PropertyGateway {
        public Object read(Entity et) { return ((LargeAutoPaging)et).getNullableDecimalIndex(); }
        public void write(Entity et, Object vl) { ((LargeAutoPaging)et).setNullableDecimalIndex(ctb(vl)); }
    }
    public static class EpgNullableDecimalNoIndex implements PropertyGateway {
        public Object read(Entity et) { return ((LargeAutoPaging)et).getNullableDecimalNoIndex(); }
        public void write(Entity et, Object vl) { ((LargeAutoPaging)et).setNullableDecimalNoIndex(ctb(vl)); }
    }
    public static class EpgSelfParentId implements PropertyGateway {
        public Object read(Entity et) { return ((LargeAutoPaging)et).getSelfParentId(); }
        public void write(Entity et, Object vl) { ((LargeAutoPaging)et).setSelfParentId(ctl(vl)); }
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.mysql.dbflute.exentity.customize.LargeAutoPaging"; }
    ...
    public LargeAutoPaging newMyEntity() { return new LargeAutoPaging(); }
