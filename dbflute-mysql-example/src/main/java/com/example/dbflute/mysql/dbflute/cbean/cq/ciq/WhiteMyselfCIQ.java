...
public class WhiteMyselfCIQ extends AbstractBsWhiteMyselfCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteMyselfCIQ(ConditionQuery childQuery, SqlClause sqlClause
    ...
    { return _myCQ.keepMyselfId_InScopeRelation_WhiteMyselfCheckList(sq); }
    public String keepMyselfId_NotInScopeRelation_WhiteMyselfCheckList(WhiteMyselfCheckCQ sq)
    { return _myCQ.keepMyselfId_NotInScopeRelation_WhiteMyselfCheckList(sq); }
