...
public class BsWhiteVariantRelationMasterFooCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;WhiteVariantRelationMasterFooCB&gt;() {
    ...
    public void union(UnionQuery<WhiteVariantRelationMasterFooCB> unionQuery) {
        final WhiteVariantRelationMasterFooCB cb = new WhiteVariantRelationMasterFooCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;WhiteVariantRelationMasterFooCB&gt;() {
     *     public void query(WhiteVariantRelationMasterFooCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;WhiteVariantRelationMasterFooCB&gt;() {
     ...
     */
    public HpColQyOperand<WhiteVariantRelationMasterFooCB> columnQuery(final SpecifyQuery<WhiteVariantRelationMasterFooCB> leftSpecifyQuery) {
        return new HpColQyOperand<WhiteVariantRelationMasterFooCB>(new HpColQyHandler<WhiteVariantRelationMasterFooCB>() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;WhiteVariantRelationMasterFooCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteVariantRelationMasterFooCB> orQuery) {
        xorSQ((WhiteVariantRelationMasterFooCB)this, orQuery);
    }
     ...
     *     public void query(WhiteVariantRelationMasterFooCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteVariantRelationMasterFooCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteVariantRelationMasterFooCB> andQuery) {
        xorSQAP((WhiteVariantRelationMasterFooCB)this, andQuery);
    }
