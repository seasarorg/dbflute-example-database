...
public abstract class BsWhiteSplitMultipleFkBase implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteSplitMultipleFkBase)) { return false; }
        BsWhiteSplitMultipleFkBase otherEntity = (BsWhiteSplitMultipleFkBase)other;
        if (!xSV(getBaseId(), otherEntity.getBaseId())) { return false; }
        return true;
    }
