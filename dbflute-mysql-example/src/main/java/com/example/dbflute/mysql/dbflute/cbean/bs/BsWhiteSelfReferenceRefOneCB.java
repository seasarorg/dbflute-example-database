...
public class BsWhiteSelfReferenceRefOneCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;WhiteSelfReferenceRefOneCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;WhiteSelfReferenceRefOneCB&gt;() {
     *     public void query(WhiteSelfReferenceRefOneCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">setupSelect_WhiteSelfReference()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * WhiteSelfReferenceRefOne whiteSelfReferenceRefOne = whiteSelfReferenceRefOneBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteSelfReferenceRefOne.<span style="color: #FD4747">getWhiteSelfReference()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * <pre>
     * WhiteSelfReferenceRefOneCB cb = new WhiteSelfReferenceRefOneCB();
     * cb.<span style="color: #FD4747">setupSelect_WhiteSelfReferenceAsDirectParent()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * WhiteSelfReferenceRefOne whiteSelfReferenceRefOne = whiteSelfReferenceRefOneBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteSelfReferenceRefOne.<span style="color: #FD4747">getWhiteSelfReferenceAsDirectParent()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteSelfReferenceRefOneCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #FD4747">derivedWhiteSelfReferenceByParentIdList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;WhiteSelfReferenceCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;WhiteSelfReferenceRefOneCB&gt;() {
     ...
     */
    public HpColQyOperand<WhiteSelfReferenceRefOneCB> columnQuery(final SpecifyQuery<WhiteSelfReferenceRefOneCB> leftSpecifyQuery) {
        return new HpColQyOperand<WhiteSelfReferenceRefOneCB>(new HpColQyHandler<WhiteSelfReferenceRefOneCB>() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;WhiteSelfReferenceRefOneCB&gt;() {
     ...
     *     public void query(WhiteSelfReferenceRefOneCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteSelfReferenceRefOneCB&gt;() {
