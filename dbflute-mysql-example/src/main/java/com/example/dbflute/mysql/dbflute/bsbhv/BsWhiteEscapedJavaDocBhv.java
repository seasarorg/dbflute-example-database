...
public abstract class BsWhiteEscapedJavaDocBhv extends AbstractBehaviorWritable {
     ...
     * int count = whiteEscapedJavaDocBhv.<span style="color: #FD4747">selectCount</span>(cb);
     * </pre>
     ...
     * WhiteEscapedJavaDocCB cb = new WhiteEscapedJavaDocCB();
     * cb.query().setFoo...(value);
     * WhiteEscapedJavaDoc whiteEscapedJavaDoc = whiteEscapedJavaDocBhv.<span style="color: #FD4747">selectEntity</span>(cb);
     * if (whiteEscapedJavaDoc != null) {
    ...
    protected <ENTITY extends WhiteEscapedJavaDoc> ENTITY doSelectEntity(final WhiteEscapedJavaDocCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityInternally(cb, entityType, new InternalSelectEntityCallback<ENTITY, WhiteEscapedJavaDocCB>() {
            public List<ENTITY> callbackSelectList(WhiteEscapedJavaDocCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); } });
    }
     ...
     * WhiteEscapedJavaDocCB cb = new WhiteEscapedJavaDocCB();
     * cb.query().setFoo...(value);
     * WhiteEscapedJavaDoc whiteEscapedJavaDoc = whiteEscapedJavaDocBhv.<span style="color: #FD4747">selectEntityWithDeletedCheck</span>(cb);
    ...
    protected <ENTITY extends WhiteEscapedJavaDoc> ENTITY doSelectEntityWithDeletedCheck(final WhiteEscapedJavaDocCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityWithDeletedCheckInternally(cb, entityType, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, WhiteEscapedJavaDocCB>() {
            public List<ENTITY> callbackSelectList(WhiteEscapedJavaDocCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); } });
    }
     ...
     * ListResultBean&lt;WhiteEscapedJavaDoc&gt; whiteEscapedJavaDocList = whiteEscapedJavaDocBhv.<span style="color: #FD4747">selectList</span>(cb);
    ...
    protected <ENTITY extends WhiteEscapedJavaDoc> ListResultBean<ENTITY> doSelectList(WhiteEscapedJavaDocCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", entityType);
        assertSpecifyDerivedReferrerEntityProperty(cb, entityType);
        return helpSelectListInternally(cb, entityType, new InternalSelectListCallback<ENTITY, WhiteEscapedJavaDocCB>() {
            public List<ENTITY> callbackSelectList(WhiteEscapedJavaDocCB cb, Class<ENTITY> entityType) { return delegateSelectList(cb, entityType); } });
    }
     ...
     * PagingResultBean&lt;WhiteEscapedJavaDoc&gt; page = whiteEscapedJavaDocBhv.<span style="color: #FD4747">selectPage</span>(cb);
    ...
    protected <ENTITY extends WhiteEscapedJavaDoc> PagingResultBean<ENTITY> doSelectPage(WhiteEscapedJavaDocCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", entityType);
        return helpSelectPageInternally(cb, entityType, new InternalSelectPageCallback<ENTITY, WhiteEscapedJavaDocCB>() {
     ...
     * WhiteEscapedJavaDocCB cb = new WhiteEscapedJavaDocCB();
     * cb.query().setFoo...(value);
     * whiteEscapedJavaDocBhv.<span style="color: #FD4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteEscapedJavaDoc&gt;() {
    ...
    protected <ENTITY extends WhiteEscapedJavaDoc> void doSelectCursor(WhiteEscapedJavaDocCB cb, EntityRowHandler<ENTITY> entityRowHandler, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityRowHandler<WhiteEscapedJavaDoc>", entityRowHandler); assertObjectNotNull("entityType", entityType);
        assertSpecifyDerivedReferrerEntityProperty(cb, entityType);
        helpSelectCursorInternally(cb, entityRowHandler, entityType, new InternalSelectCursorCallback<ENTITY, WhiteEscapedJavaDocCB>() {
            public void callbackSelectCursor(WhiteEscapedJavaDocCB cb, EntityRowHandler<ENTITY> entityRowHandler, Class<ENTITY> entityType) { delegateSelectCursor(cb, entityRowHandler, entityType); }
            public List<ENTITY> callbackSelectList(WhiteEscapedJavaDocCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); }
        });
    }
     ...
     * <pre>
     * whiteEscapedJavaDocBhv.<span style="color: #FD4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
    ...
    protected <RESULT, CB extends WhiteEscapedJavaDocCB> SLFunction<CB, RESULT> doScalarSelect(Class<RESULT> resultType, CB cb) {
        assertObjectNotNull("resultType", resultType); assertCBStateValid(cb);
        cb.xsetupForScalarSelect(); cb.getSqlClause().disableSelectIndex(); // for when you use union
        return createSLFunction(cb, resultType);
    }

    protected <RESULT, CB extends WhiteEscapedJavaDocCB> SLFunction<CB, RESULT> createSLFunction(CB cb, Class<RESULT> resultType) {
    ...
    public List<String> extractEscapedJavaDocCodeList(List<WhiteEscapedJavaDoc> whiteEscapedJavaDocList) {
        return helpExtractListInternally(whiteEscapedJavaDocList, new InternalExtractCallback<WhiteEscapedJavaDoc, String>() {
            public String getCV(WhiteEscapedJavaDoc e) { return e.getEscapedJavaDocCode(); }
        });
    }
     ...
     * whiteEscapedJavaDocBhv.<span style="color: #FD4747">insert</span>(whiteEscapedJavaDoc);
    ...
    protected void doInsert(WhiteEscapedJavaDoc whiteEscapedJavaDoc, InsertOption<WhiteEscapedJavaDocCB> option) {
        assertObjectNotNull("whiteEscapedJavaDoc", whiteEscapedJavaDoc);
        prepareInsertOption(option);
        delegateInsert(whiteEscapedJavaDoc, option);
    }

    protected void prepareInsertOption(InsertOption<WhiteEscapedJavaDocCB> option) {
     ...
     * whiteEscapedJavaDoc.<span style="color: #FD4747">setVersionNo</span>(value);
     * try {
     *     whiteEscapedJavaDocBhv.<span style="color: #FD4747">update</span>(whiteEscapedJavaDoc);
    ...
    protected void doUpdate(WhiteEscapedJavaDoc whiteEscapedJavaDoc, final UpdateOption<WhiteEscapedJavaDocCB> option) {
        assertObjectNotNull("whiteEscapedJavaDoc", whiteEscapedJavaDoc);
        prepareUpdateOption(option);
        helpUpdateInternally(whiteEscapedJavaDoc, new InternalUpdateCallback<WhiteEscapedJavaDoc>() {
            public int callbackDelegateUpdate(WhiteEscapedJavaDoc entity) { return delegateUpdate(entity, option); } });
    }

    protected void prepareUpdateOption(UpdateOption<WhiteEscapedJavaDocCB> option) {
        if (option == null) { return; }
    ...
    protected void doInesrtOrUpdate(WhiteEscapedJavaDoc whiteEscapedJavaDoc, final InsertOption<WhiteEscapedJavaDocCB> insertOption, final UpdateOption<WhiteEscapedJavaDocCB> updateOption) {
        helpInsertOrUpdateInternally(whiteEscapedJavaDoc, new InternalInsertOrUpdateCallback<WhiteEscapedJavaDoc, WhiteEscapedJavaDocCB>() {
            public void callbackInsert(WhiteEscapedJavaDoc entity) { doInsert(entity, insertOption); }
            public void callbackUpdate(WhiteEscapedJavaDoc entity) { doUpdate(entity, updateOption); }
    ...
    protected void doCreateOrModify(Entity entity, InsertOption<? extends ConditionBean> insertOption,
        ...
        if (insertOption == null && updateOption == null) { insertOrUpdate(downcast(entity)); }
            ...
            insertOption = insertOption == null ? new InsertOption<WhiteEscapedJavaDocCB>() : insertOption;
            updateOption = updateOption == null ? new UpdateOption<WhiteEscapedJavaDocCB>() : updateOption;
     ...
     * whiteEscapedJavaDoc.<span style="color: #FD4747">setVersionNo</span>(value);
     * try {
     *     whiteEscapedJavaDocBhv.<span style="color: #FD4747">delete</span>(whiteEscapedJavaDoc);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * } 
     * </pre>
    ...
    protected void doDelete(WhiteEscapedJavaDoc whiteEscapedJavaDoc, final DeleteOption<WhiteEscapedJavaDocCB> option) {
        assertObjectNotNull("whiteEscapedJavaDoc", whiteEscapedJavaDoc);
        prepareDeleteOption(option);
        helpDeleteInternally(whiteEscapedJavaDoc, new InternalDeleteCallback<WhiteEscapedJavaDoc>() {
            public int callbackDelegateDelete(WhiteEscapedJavaDoc entity) { return delegateDelete(entity, option); } });
    }

    protected void prepareDeleteOption(DeleteOption<WhiteEscapedJavaDocCB> option) {
        if (option == null) { return; }
     ...
     * }
     * whiteEscapedJavaDocBhv.<span style="color: #FD4747">batchInsert</span>(whiteEscapedJavaDocList);
     * </pre>
    ...
    public int[] batchInsert(List<WhiteEscapedJavaDoc> whiteEscapedJavaDocList) {
        InsertOption<WhiteEscapedJavaDocCB> option = createInsertUpdateOption();
        return doBatchInsert(whiteEscapedJavaDocList, option);
    }

    protected int[] doBatchInsert(List<WhiteEscapedJavaDoc> whiteEscapedJavaDocList, InsertOption<WhiteEscapedJavaDocCB> option) {
        assertObjectNotNull("whiteEscapedJavaDocList", whiteEscapedJavaDocList);
        prepareBatchInsertOption(whiteEscapedJavaDocList, option);
        return delegateBatchInsert(whiteEscapedJavaDocList, option);
    }

    protected void prepareBatchInsertOption(List<WhiteEscapedJavaDoc> whiteEscapedJavaDocList, InsertOption<WhiteEscapedJavaDocCB> option) {
        option.xallowInsertColumnModifiedPropertiesFragmented();
        option.xacceptInsertColumnModifiedPropertiesIfNeeds(whiteEscapedJavaDocList);
        prepareInsertOption(option);
    }
     ...
     *     whiteEscapedJavaDocList.add(whiteEscapedJavaDoc);
     * }
     * whiteEscapedJavaDocBhv.<span style="color: #FD4747">batchUpdate</span>(whiteEscapedJavaDocList);
     * </pre>
    ...
    public int[] batchUpdate(List<WhiteEscapedJavaDoc> whiteEscapedJavaDocList) {
        UpdateOption<WhiteEscapedJavaDocCB> option = createPlainUpdateOption();
        return doBatchUpdate(whiteEscapedJavaDocList, option);
    }

    protected int[] doBatchUpdate(List<WhiteEscapedJavaDoc> whiteEscapedJavaDocList, UpdateOption<WhiteEscapedJavaDocCB> option) {
        assertObjectNotNull("whiteEscapedJavaDocList", whiteEscapedJavaDocList);
        prepareBatchUpdateOption(whiteEscapedJavaDocList, option);
        return delegateBatchUpdate(whiteEscapedJavaDocList, option);
    }

    protected void prepareBatchUpdateOption(List<WhiteEscapedJavaDoc> whiteEscapedJavaDocList, UpdateOption<WhiteEscapedJavaDocCB> option) {
        option.xacceptUpdateColumnModifiedPropertiesIfNeeds(whiteEscapedJavaDocList);
        prepareUpdateOption(option);
    }
     ...
     * whiteEscapedJavaDocBhv.<span style="color: #FD4747">batchUpdate</span>(whiteEscapedJavaDocList, new SpecifyQuery<WhiteEscapedJavaDocCB>() {
    ...
    protected int[] doBatchDelete(List<WhiteEscapedJavaDoc> whiteEscapedJavaDocList, DeleteOption<WhiteEscapedJavaDocCB> option) {
        assertObjectNotNull("whiteEscapedJavaDocList", whiteEscapedJavaDocList);
        prepareDeleteOption(option);
        return delegateBatchDelete(whiteEscapedJavaDocList, option);
    }
     ...
     * <pre>
     * whiteEscapedJavaDocBhv.<span style="color: #FD4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteEscapedJavaDoc, WhiteEscapedJavaDocCB&gt;() {
    ...
    protected int doQueryInsert(QueryInsertSetupper<WhiteEscapedJavaDoc, WhiteEscapedJavaDocCB> setupper, InsertOption<WhiteEscapedJavaDocCB> option) {
        assertObjectNotNull("setupper", setupper);
        prepareInsertOption(option);
        WhiteEscapedJavaDoc entity = new WhiteEscapedJavaDoc();
        WhiteEscapedJavaDocCB intoCB = createCBForQueryInsert();
     ...
     * WhiteEscapedJavaDocCB cb = new WhiteEscapedJavaDocCB();
     * cb.query().setFoo...(value);
     * whiteEscapedJavaDocBhv.<span style="color: #FD4747">queryUpdate</span>(whiteEscapedJavaDoc, cb);
     * </pre>
    ...
    protected int doQueryUpdate(WhiteEscapedJavaDoc whiteEscapedJavaDoc, WhiteEscapedJavaDocCB cb, UpdateOption<WhiteEscapedJavaDocCB> option) {
        assertObjectNotNull("whiteEscapedJavaDoc", whiteEscapedJavaDoc); assertCBStateValid(cb);
        prepareUpdateOption(option);
        return checkCountBeforeQueryUpdateIfNeeds(cb) ? delegateQueryUpdate(whiteEscapedJavaDoc, cb, option) : 0;
    }

    @Override
    protected int doRangeModify(Entity entity, ConditionBean cb, UpdateOption<? extends ConditionBean> option) {
        if (option == null) { return queryUpdate(downcast(entity), (WhiteEscapedJavaDocCB)cb); }
        else { return varyingQueryUpdate(downcast(entity), (WhiteEscapedJavaDocCB)cb, downcast(option)); }
    }
     ...
     * WhiteEscapedJavaDocCB cb = new WhiteEscapedJavaDocCB();
     * cb.query().setFoo...(value);
     * whiteEscapedJavaDocBhv.<span style="color: #FD4747">queryDelete</span>(whiteEscapedJavaDoc, cb);
     * </pre>
     * @param cb The condition-bean of WhiteEscapedJavaDoc. (NotNull)
    ...
    protected int doQueryDelete(WhiteEscapedJavaDocCB cb, DeleteOption<WhiteEscapedJavaDocCB> option) {
        assertCBStateValid(cb);
        prepareDeleteOption(option);
    ...
    protected int doRangeRemove(ConditionBean cb, DeleteOption<? extends ConditionBean> option) {
        if (option == null) { return queryDelete((WhiteEscapedJavaDocCB)cb); }
        else { return varyingQueryDelete((WhiteEscapedJavaDocCB)cb, downcast(option)); }
    }
     ...
     * whiteEscapedJavaDocBhv.<span style="color: #FD4747">varyingInsert</span>(whiteEscapedJavaDoc, option);
     * ... = whiteEscapedJavaDoc.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteEscapedJavaDoc The entity of insert target. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     whiteEscapedJavaDocBhv.<span style="color: #FD4747">varyingUpdate</span>(whiteEscapedJavaDoc, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * whiteEscapedJavaDocBhv.<span style="color: #FD4747">varyingQueryUpdate</span>(whiteEscapedJavaDoc, cb, option);
     * </pre>
    ...
    protected <ENTITY extends WhiteEscapedJavaDoc> void delegateSelectCursor(WhiteEscapedJavaDocCB cb, EntityRowHandler<ENTITY> erh, Class<ENTITY> et)
    { invoke(createSelectCursorCBCommand(cb, erh, et)); }
    protected <ENTITY extends WhiteEscapedJavaDoc> List<ENTITY> delegateSelectList(WhiteEscapedJavaDocCB cb, Class<ENTITY> et)
    { return invoke(createSelectListCBCommand(cb, et)); }

    // -----------------------------------------------------
    //                                                Update
    //                                                ------
    protected int delegateInsert(WhiteEscapedJavaDoc e, InsertOption<WhiteEscapedJavaDocCB> op)
    { if (!processBeforeInsert(e, op)) { return 0; }
      return invoke(createInsertEntityCommand(e, op)); }
    protected int delegateUpdate(WhiteEscapedJavaDoc e, UpdateOption<WhiteEscapedJavaDocCB> op)
    { if (!processBeforeUpdate(e, op)) { return 0; }
      return delegateUpdateNonstrict(e, op); }
    protected int delegateUpdateNonstrict(WhiteEscapedJavaDoc e, UpdateOption<WhiteEscapedJavaDocCB> op)
    { if (!processBeforeUpdate(e, op)) { return 0; }
      return invoke(createUpdateNonstrictEntityCommand(e, op)); }
    protected int delegateDelete(WhiteEscapedJavaDoc e, DeleteOption<WhiteEscapedJavaDocCB> op)
    { if (!processBeforeDelete(e, op)) { return 0; }
      return delegateDeleteNonstrict(e, op); }
    protected int delegateDeleteNonstrict(WhiteEscapedJavaDoc e, DeleteOption<WhiteEscapedJavaDocCB> op)
    { if (!processBeforeDelete(e, op)) { return 0; }
    ...
    protected int delegateQueryInsert(WhiteEscapedJavaDoc e, WhiteEscapedJavaDocCB inCB, ConditionBean resCB, InsertOption<WhiteEscapedJavaDocCB> op)
    { if (!processBeforeQueryInsert(e, inCB, resCB, op)) { return 0; } return invoke(createQueryInsertCBCommand(e, inCB, resCB, op));  }
    protected int delegateQueryUpdate(WhiteEscapedJavaDoc e, WhiteEscapedJavaDocCB cb, UpdateOption<WhiteEscapedJavaDocCB> op)
    ...
    //                                                                     Downcast Helper
    //                                                                     ===============
    protected WhiteEscapedJavaDoc downcast(Entity entity) {
        return helpEntityDowncastInternally(entity, WhiteEscapedJavaDoc.class);
    }
    ...
    protected List<WhiteEscapedJavaDoc> downcast(List<? extends Entity> entityList) {
        return (List<WhiteEscapedJavaDoc>)entityList;
    }

    @SuppressWarnings("unchecked")
    protected InsertOption<WhiteEscapedJavaDocCB> downcast(InsertOption<? extends ConditionBean> option) {
        return (InsertOption<WhiteEscapedJavaDocCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected UpdateOption<WhiteEscapedJavaDocCB> downcast(UpdateOption<? extends ConditionBean> option) {
        return (UpdateOption<WhiteEscapedJavaDocCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected DeleteOption<WhiteEscapedJavaDocCB> downcast(DeleteOption<? extends ConditionBean> option) {
        return (DeleteOption<WhiteEscapedJavaDocCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected QueryInsertSetupper<WhiteEscapedJavaDoc, WhiteEscapedJavaDocCB> downcast(QueryInsertSetupper<? extends Entity, ? extends ConditionBean> option) {
        return (QueryInsertSetupper<WhiteEscapedJavaDoc, WhiteEscapedJavaDocCB>)option;
    }
}
