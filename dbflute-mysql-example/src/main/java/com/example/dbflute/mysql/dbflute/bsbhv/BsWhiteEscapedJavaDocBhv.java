...
public abstract class BsWhiteEscapedJavaDocBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends WhiteEscapedJavaDoc> ENTITY doSelectEntity(final WhiteEscapedJavaDocCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends WhiteEscapedJavaDoc> ENTITY doSelectEntityWithDeletedCheck(final WhiteEscapedJavaDocCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends WhiteEscapedJavaDoc> ListResultBean<ENTITY> doSelectList(WhiteEscapedJavaDocCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectListInternally(cb, tp, new InternalSelectListCallback<ENTITY, WhiteEscapedJavaDocCB>() {
            public List<ENTITY> callbackSelectList(WhiteEscapedJavaDocCB cb, Class<ENTITY> tp) { return delegateSelectList(cb, tp); } });
    }
