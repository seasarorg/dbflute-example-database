...
public class BsWhiteTableExceptGenRefCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;WhiteTableExceptGenRefCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;WhiteTableExceptGenRefCB&gt;() {
     *     public void query(WhiteTableExceptGenRefCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;WhiteTableExceptGenRefCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;WhiteTableExceptGenRefCB&gt;() {
     ...
     *     public void query(WhiteTableExceptGenRefCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteTableExceptGenRefCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteTableExceptGenRefCB> andQuery) {
        xorSQAP((WhiteTableExceptGenRefCB)this, andQuery);
    }
