...
public abstract class BsWhitePerrottaOverMemberBhv extends AbstractBehaviorWritable<WhitePerrottaOverMember, WhitePerrottaOverMemberCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhitePerrottaOverMember> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhitePerrottaOverMember> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
