...
public abstract class AbstractBsWhiteNoPkCQ extends AbstractConditionQuery {
     ...
     * <pre>e.g. setNoPkName_LikeSearch("xxx", new <span style="color: #FD4747">LikeSearchOption</span>().likeContain());</pre>
    ...
    protected String xabCB() { return WhiteNoPkCB.class.getName(); }
