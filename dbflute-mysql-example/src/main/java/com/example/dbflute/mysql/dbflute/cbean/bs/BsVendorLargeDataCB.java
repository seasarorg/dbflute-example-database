...
public class BsVendorLargeDataCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;VendorLargeDataCB&gt;() {
    ...
    public void union(UnionQuery<VendorLargeDataCB> unionQuery) {
        final VendorLargeDataCB cb = new VendorLargeDataCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;VendorLargeDataCB&gt;() {
     *     public void query(VendorLargeDataCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<VendorLargeDataCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #FD4747">derivedVendorLargeDataRefList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;VendorLargeDataRefCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;VendorLargeDataCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;VendorLargeDataCB&gt;() {
     ...
     *     public void query(VendorLargeDataCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;VendorLargeDataCB&gt;() {
