...
public abstract class BsWhiteImplicitReverseFkBhv extends AbstractBehaviorWritable<WhiteImplicitReverseFk, WhiteImplicitReverseFkCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteImplicitReverseFk> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteImplicitReverseFk> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
