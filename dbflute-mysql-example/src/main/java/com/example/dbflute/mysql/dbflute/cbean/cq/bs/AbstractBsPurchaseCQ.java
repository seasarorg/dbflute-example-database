...
public abstract class AbstractBsPurchaseCQ extends AbstractConditionQuery {
    ...
    public void existsWhitePurchaseReferrerAsOne(SubQuery<WhitePurchaseReferrerCB> subQuery) {
        ...
        String subQueryPropertyName = keepPurchaseId_ExistsReferrer_WhitePurchaseReferrerAsOne(cb.query()); // for saving query-value.
        registerExistsReferrer(cb.query(), "PURCHASE_ID", "PURCHASE_REFERRER_ID", subQueryPropertyName, "whitePurchaseReferrerAsOne");
    }
    public abstract String keepPurchaseId_ExistsReferrer_WhitePurchaseReferrerAsOne(WhitePurchaseReferrerCQ subQuery);
    ...
    public void notExistsWhitePurchaseReferrerAsOne(SubQuery<WhitePurchaseReferrerCB> subQuery) {
        assertObjectNotNull("subQuery<WhitePurchaseReferrerCB>", subQuery);
        WhitePurchaseReferrerCB cb = new WhitePurchaseReferrerCB(); cb.xsetupForExistsReferrer(this); subQuery.query(cb);
        String subQueryPropertyName = keepPurchaseId_NotExistsReferrer_WhitePurchaseReferrerAsOne(cb.query()); // for saving query-value.
        registerNotExistsReferrer(cb.query(), "PURCHASE_ID", "PURCHASE_REFERRER_ID", subQueryPropertyName, "whitePurchaseReferrerAsOne");
    }
    public abstract String keepPurchaseId_NotExistsReferrer_WhitePurchaseReferrerAsOne(WhitePurchaseReferrerCQ subQuery);
    ...
    public void inScopeWhitePurchaseReferrerAsOne(SubQuery<WhitePurchaseReferrerCB> subQuery) {
        ...
        String subQueryPropertyName = keepPurchaseId_InScopeRelation_WhitePurchaseReferrerAsOne(cb.query()); // for saving query-value.
        registerInScopeRelation(cb.query(), "PURCHASE_ID", "PURCHASE_REFERRER_ID", subQueryPropertyName, "whitePurchaseReferrerAsOne");
    }
    public abstract String keepPurchaseId_InScopeRelation_WhitePurchaseReferrerAsOne(WhitePurchaseReferrerCQ subQuery);
    ...
    public void notInScopeWhitePurchaseReferrerAsOne(SubQuery<WhitePurchaseReferrerCB> subQuery) {
        assertObjectNotNull("subQuery<WhitePurchaseReferrerCB>", subQuery);
        WhitePurchaseReferrerCB cb = new WhitePurchaseReferrerCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String subQueryPropertyName = keepPurchaseId_NotInScopeRelation_WhitePurchaseReferrerAsOne(cb.query()); // for saving query-value.
        registerNotInScopeRelation(cb.query(), "PURCHASE_ID", "PURCHASE_REFERRER_ID", subQueryPropertyName, "whitePurchaseReferrerAsOne");
    }
    public abstract String keepPurchaseId_NotInScopeRelation_WhitePurchaseReferrerAsOne(WhitePurchaseReferrerCQ subQuery);
