...
public class BsWhiteAllInOneClsNormalColRefCQ extends AbstractBsWhiteAllInOneClsNormalColRefCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteAllInOneClsNormalColRefCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    protected void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
        WhiteAllInOneClsNormalColRefCQ baseQuery = (WhiteAllInOneClsNormalColRefCQ)baseQueryAsSuper;
        WhiteAllInOneClsNormalColRefCQ unionQuery = (WhiteAllInOneClsNormalColRefCQ)unionQueryAsSuper;
