...
public class SpReturnResultSetMoreNotParamResult1Dbm extends AbstractDBMeta {
    ...
    public class EpgMemberStatusCode implements PropertyGateway {
        ...
        public void write(Entity e, Object v) {
            ...
            ccls(col, v);
            ((SpReturnResultSetMoreNotParamResult1)e).setMemberStatusCodeAsMemberStatus((CDef.MemberStatus)gcls(col, v));
        }
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.mysql.dbflute.exentity.customize.SpReturnResultSetMoreNotParamResult1"; }
