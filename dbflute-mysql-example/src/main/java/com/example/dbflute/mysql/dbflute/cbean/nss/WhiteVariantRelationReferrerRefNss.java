...
import com.example.dbflute.mysql.dbflute.cbean.cq.WhiteVariantRelationReferrerRefCQ;
...
public class WhiteVariantRelationReferrerRefNss {
    ...
    public WhiteVariantRelationReferrerNss withWhiteVariantRelationReferrer() {
        _query.doNss(new WhiteVariantRelationReferrerRefCQ.NssCall() { public ConditionQuery qf() { return _query.queryWhiteVariantRelationReferrer(); }});
