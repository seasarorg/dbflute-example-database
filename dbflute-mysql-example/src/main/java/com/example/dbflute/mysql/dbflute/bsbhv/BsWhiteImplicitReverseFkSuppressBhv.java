...
public abstract class BsWhiteImplicitReverseFkSuppressBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends WhiteImplicitReverseFkSuppress> OptionalEntity<ENTITY> doSelectOptionalEntity(WhiteImplicitReverseFkSuppressCB cb, Class<ENTITY> tp) {
    ...
    protected void doInsert(WhiteImplicitReverseFkSuppress et, InsertOption<WhiteImplicitReverseFkSuppressCB> op) {
        assertObjectNotNull("whiteImplicitReverseFkSuppress", et); prepareInsertOption(op); delegateInsert(et, op);
    }
    ...
    protected void doUpdate(WhiteImplicitReverseFkSuppress et, UpdateOption<WhiteImplicitReverseFkSuppressCB> op) {
        assertObjectNotNull("whiteImplicitReverseFkSuppress", et); prepareUpdateOption(op); helpUpdateInternally(et, op);
    }
    ...
    protected void doInsertOrUpdate(WhiteImplicitReverseFkSuppress et, InsertOption<WhiteImplicitReverseFkSuppressCB> iop, UpdateOption<WhiteImplicitReverseFkSuppressCB> uop) {
        assertObjectNotNull("whiteImplicitReverseFkSuppress", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doDelete(WhiteImplicitReverseFkSuppress et, final DeleteOption<WhiteImplicitReverseFkSuppressCB> op) {
        assertObjectNotNull("whiteImplicitReverseFkSuppress", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<WhiteImplicitReverseFkSuppressCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int doQueryInsert(QueryInsertSetupper<WhiteImplicitReverseFkSuppress, WhiteImplicitReverseFkSuppressCB> sp, InsertOption<WhiteImplicitReverseFkSuppressCB> op) {
        ...
        WhiteImplicitReverseFkSuppress et = newEntity(); WhiteImplicitReverseFkSuppressCB cb = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(WhiteImplicitReverseFkSuppress et, WhiteImplicitReverseFkSuppressCB cb, UpdateOption<WhiteImplicitReverseFkSuppressCB> op) {
        assertObjectNotNull("whiteImplicitReverseFkSuppress", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<WhiteImplicitReverseFkSuppress> typeOfSelectedEntity() { return WhiteImplicitReverseFkSuppress.class; }
    protected WhiteImplicitReverseFkSuppress downcast(Entity et) { return helpEntityDowncastInternally(et, WhiteImplicitReverseFkSuppress.class); }
    protected WhiteImplicitReverseFkSuppressCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, WhiteImplicitReverseFkSuppressCB.class); }
    @SuppressWarnings("unchecked")
    protected List<WhiteImplicitReverseFkSuppress> downcast(List<? extends Entity> ls) { return (List<WhiteImplicitReverseFkSuppress>)ls; }
    @SuppressWarnings("unchecked")
