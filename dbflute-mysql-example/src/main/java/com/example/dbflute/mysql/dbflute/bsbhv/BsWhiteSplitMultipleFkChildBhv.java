...
public abstract class BsWhiteSplitMultipleFkChildBhv extends AbstractBehaviorWritable<WhiteSplitMultipleFkChild, WhiteSplitMultipleFkChildCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteSplitMultipleFkChild> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteSplitMultipleFkChild> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
