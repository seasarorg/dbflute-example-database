 ...
 */
public abstract class BsWhiteColumnExcept implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteColumnExcept)) { return false; }
        BsWhiteColumnExcept otherEntity = (BsWhiteColumnExcept)other;
        if (!xSV(getExceptColumnId(), otherEntity.getExceptColumnId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = xCH(result, getExceptColumnId());
        return result;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String delimiter = ", ";
        sb.append(delimiter).append(getExceptColumnId());
        sb.append(delimiter).append(getColumnExceptTest());
