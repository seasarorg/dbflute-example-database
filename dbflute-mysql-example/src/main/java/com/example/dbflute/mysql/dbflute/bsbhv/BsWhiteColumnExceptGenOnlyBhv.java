...
public abstract class BsWhiteColumnExceptGenOnlyBhv extends AbstractBehaviorWritable<WhiteColumnExceptGenOnly, WhiteColumnExceptGenOnlyCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteColumnExceptGenOnly> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteColumnExceptGenOnly> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
