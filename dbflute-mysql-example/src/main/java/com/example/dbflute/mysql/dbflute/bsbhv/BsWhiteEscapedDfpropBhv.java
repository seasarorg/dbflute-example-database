...
public abstract class BsWhiteEscapedDfpropBhv extends AbstractBehaviorWritable<WhiteEscapedDfprop, WhiteEscapedDfpropCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteEscapedDfprop> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteEscapedDfprop> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
