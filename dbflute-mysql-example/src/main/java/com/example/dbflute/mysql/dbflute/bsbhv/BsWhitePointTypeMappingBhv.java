...
public abstract class BsWhitePointTypeMappingBhv extends AbstractBehaviorWritable {
     ...
     * int count = whitePointTypeMappingBhv.<span style="color: #FD4747">selectCount</span>(cb);
     * </pre>
     ...
     * WhitePointTypeMappingCB cb = new WhitePointTypeMappingCB();
     * cb.query().setFoo...(value);
     * WhitePointTypeMapping whitePointTypeMapping = whitePointTypeMappingBhv.<span style="color: #FD4747">selectEntity</span>(cb);
     * if (whitePointTypeMapping != null) {
     ...
     * WhitePointTypeMappingCB cb = new WhitePointTypeMappingCB();
     * cb.query().setFoo...(value);
     * WhitePointTypeMapping whitePointTypeMapping = whitePointTypeMappingBhv.<span style="color: #FD4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * ListResultBean&lt;WhitePointTypeMapping&gt; whitePointTypeMappingList = whitePointTypeMappingBhv.<span style="color: #FD4747">selectList</span>(cb);
     ...
     * PagingResultBean&lt;WhitePointTypeMapping&gt; page = whitePointTypeMappingBhv.<span style="color: #FD4747">selectPage</span>(cb);
     ...
     * WhitePointTypeMappingCB cb = new WhitePointTypeMappingCB();
     * cb.query().setFoo...(value);
     * whitePointTypeMappingBhv.<span style="color: #FD4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhitePointTypeMapping&gt;() {
     ...
     * <pre>
     * whitePointTypeMappingBhv.<span style="color: #FD4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * whitePointTypeMappingBhv.<span style="color: #FD4747">insert</span>(whitePointTypeMapping);
     ...
     * whitePointTypeMapping.<span style="color: #FD4747">setVersionNo</span>(value);
     * try {
     *     whitePointTypeMappingBhv.<span style="color: #FD4747">update</span>(whitePointTypeMapping);
     ...
     * whitePointTypeMapping.<span style="color: #FD4747">setVersionNo</span>(value);
     * try {
     *     whitePointTypeMappingBhv.<span style="color: #FD4747">delete</span>(whitePointTypeMapping);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * whitePointTypeMappingBhv.<span style="color: #FD4747">batchInsert</span>(whitePointTypeMappingList);
     * </pre>
     ...
     *     whitePointTypeMappingList.add(whitePointTypeMapping);
     * }
     * whitePointTypeMappingBhv.<span style="color: #FD4747">batchUpdate</span>(whitePointTypeMappingList);
     * </pre>
     ...
     * whitePointTypeMappingBhv.<span style="color: #FD4747">batchUpdate</span>(whitePointTypeMappingList, new SpecifyQuery<WhitePointTypeMappingCB>() {
     ...
     * <pre>
     * whitePointTypeMappingBhv.<span style="color: #FD4747">queryInsert</span>(new QueryInsertSetupper&lt;WhitePointTypeMapping, WhitePointTypeMappingCB&gt;() {
     ...
     * WhitePointTypeMappingCB cb = new WhitePointTypeMappingCB();
     * cb.query().setFoo...(value);
     * whitePointTypeMappingBhv.<span style="color: #FD4747">queryUpdate</span>(whitePointTypeMapping, cb);
     * </pre>
     ...
     * WhitePointTypeMappingCB cb = new WhitePointTypeMappingCB();
     * cb.query().setFoo...(value);
     * whitePointTypeMappingBhv.<span style="color: #FD4747">queryDelete</span>(whitePointTypeMapping, cb);
     * </pre>
     * @param cb The condition-bean of WhitePointTypeMapping. (NotNull)
     ...
     * whitePointTypeMappingBhv.<span style="color: #FD4747">varyingInsert</span>(whitePointTypeMapping, option);
     * ... = whitePointTypeMapping.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whitePointTypeMapping The entity of insert target. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     whitePointTypeMappingBhv.<span style="color: #FD4747">varyingUpdate</span>(whitePointTypeMapping, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * whitePointTypeMappingBhv.<span style="color: #FD4747">varyingQueryUpdate</span>(whitePointTypeMapping, cb, option);
     * </pre>
