...
public class BsWhiteImplicitReverseFkCQ extends AbstractBsWhiteImplicitReverseFkCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteImplicitReverseFkCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public String keepWhiteImplicitReverseFkId_ExistsReferrer_WhiteImplicitReverseFkRefList(WhiteImplicitReverseFkRefCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_whiteImplicitReverseFkId_ExistsReferrer_WhiteImplicitReverseFkRefListMap.size() + 1);
        _whiteImplicitReverseFkId_ExistsReferrer_WhiteImplicitReverseFkRefListMap.put(key, subQuery); return "whiteImplicitReverseFkId_ExistsReferrer_WhiteImplicitReverseFkRefList." + key;
    }
    ...
    public String keepWhiteImplicitReverseFkId_NotExistsReferrer_WhiteImplicitReverseFkRefList(WhiteImplicitReverseFkRefCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_whiteImplicitReverseFkId_NotExistsReferrer_WhiteImplicitReverseFkRefListMap.size() + 1);
        _whiteImplicitReverseFkId_NotExistsReferrer_WhiteImplicitReverseFkRefListMap.put(key, subQuery); return "whiteImplicitReverseFkId_NotExistsReferrer_WhiteImplicitReverseFkRefList." + key;
    }
    ...
    public String keepWhiteImplicitReverseFkId_SpecifyDerivedReferrer_WhiteImplicitReverseFkRefList(WhiteImplicitReverseFkRefCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_whiteImplicitReverseFkId_SpecifyDerivedReferrer_WhiteImplicitReverseFkRefListMap.size() + 1);
        _whiteImplicitReverseFkId_SpecifyDerivedReferrer_WhiteImplicitReverseFkRefListMap.put(key, subQuery); return "whiteImplicitReverseFkId_SpecifyDerivedReferrer_WhiteImplicitReverseFkRefList." + key;
    }
    ...
    public String keepWhiteImplicitReverseFkId_InScopeRelation_WhiteImplicitReverseFkRefList(WhiteImplicitReverseFkRefCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_whiteImplicitReverseFkId_InScopeRelation_WhiteImplicitReverseFkRefListMap.size() + 1);
        _whiteImplicitReverseFkId_InScopeRelation_WhiteImplicitReverseFkRefListMap.put(key, subQuery); return "whiteImplicitReverseFkId_InScopeRelation_WhiteImplicitReverseFkRefList." + key;
    }
    ...
    public String keepWhiteImplicitReverseFkId_NotInScopeRelation_WhiteImplicitReverseFkRefList(WhiteImplicitReverseFkRefCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_whiteImplicitReverseFkId_NotInScopeRelation_WhiteImplicitReverseFkRefListMap.size() + 1);
        _whiteImplicitReverseFkId_NotInScopeRelation_WhiteImplicitReverseFkRefListMap.put(key, subQuery); return "whiteImplicitReverseFkId_NotInScopeRelation_WhiteImplicitReverseFkRefList." + key;
    }
    ...
    public String keepWhiteImplicitReverseFkId_QueryDerivedReferrer_WhiteImplicitReverseFkRefList(WhiteImplicitReverseFkRefCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_whiteImplicitReverseFkId_QueryDerivedReferrer_WhiteImplicitReverseFkRefListMap.size() + 1);
        _whiteImplicitReverseFkId_QueryDerivedReferrer_WhiteImplicitReverseFkRefListMap.put(key, subQuery); return "whiteImplicitReverseFkId_QueryDerivedReferrer_WhiteImplicitReverseFkRefList." + key;
    }
    ...
    public String keepWhiteImplicitReverseFkId_QueryDerivedReferrer_WhiteImplicitReverseFkRefListParameter(Object parameterValue) {
        ...
        String key = "subQueryParameterKey" + (_whiteImplicitReverseFkId_QueryDerivedReferrer_WhiteImplicitReverseFkRefListParameterMap.size() + 1);
        _whiteImplicitReverseFkId_QueryDerivedReferrer_WhiteImplicitReverseFkRefListParameterMap.put(key, parameterValue); return "whiteImplicitReverseFkId_QueryDerivedReferrer_WhiteImplicitReverseFkRefListParameter." + key;
    }
    ...
    protected void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
        WhiteImplicitReverseFkCQ baseQuery = (WhiteImplicitReverseFkCQ)baseQueryAsSuper;
        WhiteImplicitReverseFkCQ unionQuery = (WhiteImplicitReverseFkCQ)unionQueryAsSuper;
        if (baseQuery.hasConditionQueryWhiteImplicitReverseFkRefWithImplicitReverseFK()) {
            unionQuery.xsetParameterMapWhiteImplicitReverseFkRefWithImplicitReverseFK(baseQuery.getParameterMapWhiteImplicitReverseFkRefWithImplicitReverseFK());
            unionQuery.getConditionQueryWhiteImplicitReverseFkRefWithImplicitReverseFK().reflectRelationOnUnionQuery(baseQuery.getConditionQueryWhiteImplicitReverseFkRefWithImplicitReverseFK(), unionQuery.getConditionQueryWhiteImplicitReverseFkRefWithImplicitReverseFK());
        }
        if (baseQuery.hasConditionQueryWhiteImplicitReverseFkSuppressSuppressImplicitReverseFK()) {
            unionQuery.xsetParameterMapWhiteImplicitReverseFkSuppressSuppressImplicitReverseFK(baseQuery.getParameterMapWhiteImplicitReverseFkSuppressSuppressImplicitReverseFK());
            unionQuery.getConditionQueryWhiteImplicitReverseFkSuppressSuppressImplicitReverseFK().reflectRelationOnUnionQuery(baseQuery.getConditionQueryWhiteImplicitReverseFkSuppressSuppressImplicitReverseFK(), unionQuery.getConditionQueryWhiteImplicitReverseFkSuppressSuppressImplicitReverseFK());
        }
    }
    ...
    public String keepScalarCondition(WhiteImplicitReverseFkCQ subQuery) {
    ...
    public String keepSpecifyMyselfDerived(WhiteImplicitReverseFkCQ subQuery) {
    ...
    public String keepQueryMyselfDerived(WhiteImplicitReverseFkCQ subQuery) {
    ...
    public String keepMyselfExists(WhiteImplicitReverseFkCQ subQuery) {
    ...
    public String keepMyselfInScope(WhiteImplicitReverseFkCQ subQuery) {
