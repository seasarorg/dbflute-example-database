...
public class BsWhiteEscapedNumberInitialCB extends AbstractConditionBean {
     ...
     * @param numberInitialCode : PK, NotNull, CHAR(3), classification=EscapedNumberInitialCls. (NotNull)
     */
    public void acceptPrimaryKey(CDef.EscapedNumberInitialCls numberInitialCode) {
        assertObjectNotNull("numberInitialCode", numberInitialCode);
        BsWhiteEscapedNumberInitialCB cb = this;
        cb.query().setNumberInitialCode_Equal_AsEscapedNumberInitialCls(numberInitialCode);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteEscapedNumberInitialCQ> {
        ...
        public HpSDRFunction<WhiteEscapedNumberInitialCB, WhiteEscapedNumberInitialCQ> myselfDerived() {
            ...
            return new HpSDRFunction<WhiteEscapedNumberInitialCB, WhiteEscapedNumberInitialCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteEscapedNumberInitialCB, WhiteEscapedNumberInitialCQ>() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteEscapedNumberInitialCB> orQuery) {
        xorSQ((WhiteEscapedNumberInitialCB)this, orQuery);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteEscapedNumberInitialCB> andQuery) {
        xorSQAP((WhiteEscapedNumberInitialCB)this, andQuery);
    }
