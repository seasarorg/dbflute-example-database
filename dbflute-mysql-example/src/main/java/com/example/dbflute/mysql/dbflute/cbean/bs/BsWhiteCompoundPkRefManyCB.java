...
public class BsWhiteCompoundPkRefManyCB extends AbstractConditionBean {
    ...
    public void union(UnionQuery<WhiteCompoundPkRefManyCB> unionQuery) {
        final WhiteCompoundPkRefManyCB cb = new WhiteCompoundPkRefManyCB();
     ...
     */
    public HpColQyOperand<WhiteCompoundPkRefManyCB> columnQuery(final SpecifyQuery<WhiteCompoundPkRefManyCB> leftSpecifyQuery) {
        return new HpColQyOperand<WhiteCompoundPkRefManyCB>(new HpColQyHandler<WhiteCompoundPkRefManyCB>() {
