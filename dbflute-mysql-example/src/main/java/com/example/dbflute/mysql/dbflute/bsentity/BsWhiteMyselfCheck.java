...
public abstract class BsWhiteMyselfCheck implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteMyselfCheck)) { return false; }
        BsWhiteMyselfCheck otherEntity = (BsWhiteMyselfCheck)other;
    ...
    public String toStringWithRelation() {
        ...
        { sb.append(l).append(xbRDS(_whiteMyself, "whiteMyself")); }
        return sb.toString();
    }
    ...
    protected String buildRelationString() {
        StringBuilder sb = new StringBuilder();
        String c = ",";
        if (_whiteMyself != null) { sb.append(c).append("whiteMyself"); }
