...
public abstract class BsWhitePgReservBhv extends AbstractBehaviorWritable<WhitePgReserv, WhitePgReservCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhitePgReserv> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhitePgReserv> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
