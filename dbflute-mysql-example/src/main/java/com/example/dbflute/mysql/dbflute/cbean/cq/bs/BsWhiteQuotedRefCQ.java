...
public class BsWhiteQuotedRefCQ extends AbstractBsWhiteQuotedRefCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteQuotedRefCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public String keepOrder_InScopeRelation_WhiteQuoted(WhiteQuotedCQ subQuery) {
        if (_order_InScopeRelation_WhiteQuotedMap == null) { _order_InScopeRelation_WhiteQuotedMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_order_InScopeRelation_WhiteQuotedMap.size() + 1);
        _order_InScopeRelation_WhiteQuotedMap.put(key, subQuery); return "order_InScopeRelation_WhiteQuoted." + key;
    }
    ...
    public String keepOrder_NotInScopeRelation_WhiteQuoted(WhiteQuotedCQ subQuery) {
        if (_order_NotInScopeRelation_WhiteQuotedMap == null) { _order_NotInScopeRelation_WhiteQuotedMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_order_NotInScopeRelation_WhiteQuotedMap.size() + 1);
        _order_NotInScopeRelation_WhiteQuotedMap.put(key, subQuery); return "order_NotInScopeRelation_WhiteQuoted." + key;
    }
    ...
    protected void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
        WhiteQuotedRefCQ baseQuery = (WhiteQuotedRefCQ)baseQueryAsSuper;
        WhiteQuotedRefCQ unionQuery = (WhiteQuotedRefCQ)unionQueryAsSuper;
        if (baseQuery.hasConditionQueryWhiteQuoted()) {
            unionQuery.queryWhiteQuoted().reflectRelationOnUnionQuery(baseQuery.queryWhiteQuoted(), unionQuery.queryWhiteQuoted());
        }
    }
    ...
    public String keepScalarCondition(WhiteQuotedRefCQ subQuery) {
    ...
    public String keepSpecifyMyselfDerived(WhiteQuotedRefCQ subQuery) {
    ...
    public String keepQueryMyselfDerived(WhiteQuotedRefCQ subQuery) {
    ...
    public String keepMyselfExists(WhiteQuotedRefCQ subQuery) {
    ...
    public String keepMyselfInScope(WhiteQuotedRefCQ subQuery) {
