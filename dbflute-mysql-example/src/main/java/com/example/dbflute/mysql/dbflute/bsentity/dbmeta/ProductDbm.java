...
public class ProductDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnRegularPrice = cci("REGULAR_PRICE", "REGULAR_PRICE", null, "定価", true, "regularPrice", Integer.class, false, false, "INT", 10, 0, null, false, null, "特に割引などがない場合の販売価格", null, null, null);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.mysql.dbflute.exentity.Product"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.mysql.dbflute.cbean.ProductCB"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.mysql.dbflute.exbhv.ProductBhv"; }
