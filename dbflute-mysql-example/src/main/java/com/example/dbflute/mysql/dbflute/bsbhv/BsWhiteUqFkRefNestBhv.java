...
public abstract class BsWhiteUqFkRefNestBhv extends AbstractBehaviorWritable {
    ...
    protected void doInsert(WhiteUqFkRefNest et, InsertOption<WhiteUqFkRefNestCB> op) {
        assertObjectNotNull("whiteUqFkRefNest", et); prepareInsertOption(op); delegateInsert(et, op);
    }
    ...
    protected void doUpdate(WhiteUqFkRefNest et, UpdateOption<WhiteUqFkRefNestCB> op) {
        assertObjectNotNull("whiteUqFkRefNest", et); prepareUpdateOption(op); helpUpdateInternally(et, op);
    }
    ...
    protected void doInsertOrUpdate(WhiteUqFkRefNest et, InsertOption<WhiteUqFkRefNestCB> iop, UpdateOption<WhiteUqFkRefNestCB> uop) {
        assertObjectNotNull("whiteUqFkRefNest", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doDelete(WhiteUqFkRefNest et, final DeleteOption<WhiteUqFkRefNestCB> op) {
        assertObjectNotNull("whiteUqFkRefNest", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<WhiteUqFkRefNestCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int doQueryInsert(QueryInsertSetupper<WhiteUqFkRefNest, WhiteUqFkRefNestCB> sp, InsertOption<WhiteUqFkRefNestCB> op) {
        ...
        WhiteUqFkRefNest et = newEntity(); WhiteUqFkRefNestCB cb = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(WhiteUqFkRefNest et, WhiteUqFkRefNestCB cb, UpdateOption<WhiteUqFkRefNestCB> op) {
        assertObjectNotNull("whiteUqFkRefNest", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<WhiteUqFkRefNest> typeOfSelectedEntity() { return WhiteUqFkRefNest.class; }
    protected WhiteUqFkRefNest downcast(Entity et) { return helpEntityDowncastInternally(et, WhiteUqFkRefNest.class); }
    protected WhiteUqFkRefNestCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, WhiteUqFkRefNestCB.class); }
    @SuppressWarnings("unchecked")
    protected List<WhiteUqFkRefNest> downcast(List<? extends Entity> ls) { return (List<WhiteUqFkRefNest>)ls; }
    @SuppressWarnings("unchecked")
    protected InsertOption<WhiteUqFkRefNestCB> downcast(InsertOption<? extends ConditionBean> op) { return (InsertOption<WhiteUqFkRefNestCB>)op; }
    @SuppressWarnings("unchecked")
    protected UpdateOption<WhiteUqFkRefNestCB> downcast(UpdateOption<? extends ConditionBean> op) { return (UpdateOption<WhiteUqFkRefNestCB>)op; }
    @SuppressWarnings("unchecked")
    protected DeleteOption<WhiteUqFkRefNestCB> downcast(DeleteOption<? extends ConditionBean> op) { return (DeleteOption<WhiteUqFkRefNestCB>)op; }
    @SuppressWarnings("unchecked")
