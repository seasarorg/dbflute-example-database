...
public abstract class BsWhiteEscapedDfprop implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteEscapedDfprop)) { return false; }
        BsWhiteEscapedDfprop otherEntity = (BsWhiteEscapedDfprop)other;
        if (!xSV(getEscapedDfpropCode(), otherEntity.getEscapedDfpropCode())) { return false; }
        return true;
    }
