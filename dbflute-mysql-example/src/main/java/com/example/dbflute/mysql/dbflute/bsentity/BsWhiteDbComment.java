 ...
 */
public abstract class BsWhiteDbComment implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteDbComment)) { return false; }
        BsWhiteDbComment otherEntity = (BsWhiteDbComment)other;
        if (!xSV(getDbCommentCode(), otherEntity.getDbCommentCode())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = xCH(result, getDbCommentCode());
        return result;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String delimiter = ", ";
        sb.append(delimiter).append(getDbCommentCode());
        sb.append(delimiter).append(getDbCommentName());
