...
public abstract class BsWhiteLoadDataBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends WhiteLoadData> ENTITY doSelectEntity(final WhiteLoadDataCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends WhiteLoadData> ENTITY doSelectEntityWithDeletedCheck(final WhiteLoadDataCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends WhiteLoadData> ListResultBean<ENTITY> doSelectList(WhiteLoadDataCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectListInternally(cb, tp, new InternalSelectListCallback<ENTITY, WhiteLoadDataCB>() {
            public List<ENTITY> callbackSelectList(WhiteLoadDataCB cb, Class<ENTITY> tp) { return delegateSelectList(cb, tp); } });
    }
