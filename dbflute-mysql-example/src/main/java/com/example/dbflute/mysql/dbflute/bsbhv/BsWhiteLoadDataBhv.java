...
public abstract class BsWhiteLoadDataBhv extends AbstractBehaviorWritable<WhiteLoadData, WhiteLoadDataCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteLoadData> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteLoadData> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
