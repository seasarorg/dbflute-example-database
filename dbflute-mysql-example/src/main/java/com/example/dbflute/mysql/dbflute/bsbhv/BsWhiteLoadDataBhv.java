...
public abstract class BsWhiteLoadDataBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends WhiteLoadData> ENTITY doSelectEntity(final WhiteLoadDataCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityInternally(cb, entityType, new InternalSelectEntityCallback<ENTITY, WhiteLoadDataCB>() {
            public List<ENTITY> callbackSelectList(WhiteLoadDataCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends WhiteLoadData> ENTITY doSelectEntityWithDeletedCheck(final WhiteLoadDataCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityWithDeletedCheckInternally(cb, entityType, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, WhiteLoadDataCB>() {
            public List<ENTITY> callbackSelectList(WhiteLoadDataCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends WhiteLoadData> ListResultBean<ENTITY> doSelectList(WhiteLoadDataCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", entityType);
        assertSpecifyDerivedReferrerEntityProperty(cb, entityType);
        return helpSelectListInternally(cb, entityType, new InternalSelectListCallback<ENTITY, WhiteLoadDataCB>() {
            public List<ENTITY> callbackSelectList(WhiteLoadDataCB cb, Class<ENTITY> entityType) { return delegateSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends WhiteLoadData> PagingResultBean<ENTITY> doSelectPage(WhiteLoadDataCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", entityType);
        return helpSelectPageInternally(cb, entityType, new InternalSelectPageCallback<ENTITY, WhiteLoadDataCB>() {
    ...
    protected <ENTITY extends WhiteLoadData> void doSelectCursor(WhiteLoadDataCB cb, EntityRowHandler<ENTITY> entityRowHandler, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityRowHandler<WhiteLoadData>", entityRowHandler); assertObjectNotNull("entityType", entityType);
        assertSpecifyDerivedReferrerEntityProperty(cb, entityType);
        helpSelectCursorInternally(cb, entityRowHandler, entityType, new InternalSelectCursorCallback<ENTITY, WhiteLoadDataCB>() {
            public void callbackSelectCursor(WhiteLoadDataCB cb, EntityRowHandler<ENTITY> entityRowHandler, Class<ENTITY> entityType) { delegateSelectCursor(cb, entityRowHandler, entityType); }
            public List<ENTITY> callbackSelectList(WhiteLoadDataCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); }
        });
    }
    ...
    protected <RESULT, CB extends WhiteLoadDataCB> SLFunction<CB, RESULT> doScalarSelect(Class<RESULT> resultType, CB cb) {
        assertObjectNotNull("resultType", resultType); assertCBStateValid(cb);
        cb.xsetupForScalarSelect(); cb.getSqlClause().disableSelectIndex(); // for when you use union
        return createSLFunction(cb, resultType);
    }

    protected <RESULT, CB extends WhiteLoadDataCB> SLFunction<CB, RESULT> createSLFunction(CB cb, Class<RESULT> resultType) {
    ...
    public List<Long> extractLoadDataIdList(List<WhiteLoadData> whiteLoadDataList) {
        return helpExtractListInternally(whiteLoadDataList, new InternalExtractCallback<WhiteLoadData, Long>() {
            public Long getCV(WhiteLoadData e) { return e.getLoadDataId(); }
        });
    }
    ...
    protected void doInsert(WhiteLoadData whiteLoadData, InsertOption<WhiteLoadDataCB> option) {
        assertObjectNotNull("whiteLoadData", whiteLoadData);
        prepareInsertOption(option);
        delegateInsert(whiteLoadData, option);
    }

    protected void prepareInsertOption(InsertOption<WhiteLoadDataCB> option) {
    ...
    protected void doUpdate(WhiteLoadData whiteLoadData, final UpdateOption<WhiteLoadDataCB> option) {
        assertObjectNotNull("whiteLoadData", whiteLoadData);
        prepareUpdateOption(option);
        helpUpdateInternally(whiteLoadData, new InternalUpdateCallback<WhiteLoadData>() {
            public int callbackDelegateUpdate(WhiteLoadData entity) { return delegateUpdate(entity, option); } });
    }

    protected void prepareUpdateOption(UpdateOption<WhiteLoadDataCB> option) {
        if (option == null) { return; }
    ...
    protected void doInesrtOrUpdate(WhiteLoadData whiteLoadData, final InsertOption<WhiteLoadDataCB> insertOption, final UpdateOption<WhiteLoadDataCB> updateOption) {
        helpInsertOrUpdateInternally(whiteLoadData, new InternalInsertOrUpdateCallback<WhiteLoadData, WhiteLoadDataCB>() {
            public void callbackInsert(WhiteLoadData entity) { doInsert(entity, insertOption); }
            public void callbackUpdate(WhiteLoadData entity) { doUpdate(entity, updateOption); }
    ...
    protected void doCreateOrModify(Entity entity, InsertOption<? extends ConditionBean> insertOption,
        ...
        if (insertOption == null && updateOption == null) { insertOrUpdate(downcast(entity)); }
            ...
            insertOption = insertOption == null ? new InsertOption<WhiteLoadDataCB>() : insertOption;
            updateOption = updateOption == null ? new UpdateOption<WhiteLoadDataCB>() : updateOption;
    ...
    protected void doDelete(WhiteLoadData whiteLoadData, final DeleteOption<WhiteLoadDataCB> option) {
        assertObjectNotNull("whiteLoadData", whiteLoadData);
        prepareDeleteOption(option);
        helpDeleteInternally(whiteLoadData, new InternalDeleteCallback<WhiteLoadData>() {
            public int callbackDelegateDelete(WhiteLoadData entity) { return delegateDelete(entity, option); } });
    }

    protected void prepareDeleteOption(DeleteOption<WhiteLoadDataCB> option) {
        if (option == null) { return; }
    ...
    public int[] batchInsert(List<WhiteLoadData> whiteLoadDataList) {
        InsertOption<WhiteLoadDataCB> option = createInsertUpdateOption();
        return doBatchInsert(whiteLoadDataList, option);
    }

    protected int[] doBatchInsert(List<WhiteLoadData> whiteLoadDataList, InsertOption<WhiteLoadDataCB> option) {
        assertObjectNotNull("whiteLoadDataList", whiteLoadDataList);
        prepareBatchInsertOption(whiteLoadDataList, option);
        return delegateBatchInsert(whiteLoadDataList, option);
    }

    protected void prepareBatchInsertOption(List<WhiteLoadData> whiteLoadDataList, InsertOption<WhiteLoadDataCB> option) {
        option.xallowInsertColumnModifiedPropertiesFragmented();
        option.xacceptInsertColumnModifiedPropertiesIfNeeds(whiteLoadDataList);
        prepareInsertOption(option);
    }
    ...
    public int[] batchUpdate(List<WhiteLoadData> whiteLoadDataList) {
        UpdateOption<WhiteLoadDataCB> option = createPlainUpdateOption();
        return doBatchUpdate(whiteLoadDataList, option);
    }

    protected int[] doBatchUpdate(List<WhiteLoadData> whiteLoadDataList, UpdateOption<WhiteLoadDataCB> option) {
        assertObjectNotNull("whiteLoadDataList", whiteLoadDataList);
        prepareBatchUpdateOption(whiteLoadDataList, option);
        return delegateBatchUpdate(whiteLoadDataList, option);
    }

    protected void prepareBatchUpdateOption(List<WhiteLoadData> whiteLoadDataList, UpdateOption<WhiteLoadDataCB> option) {
        option.xacceptUpdateColumnModifiedPropertiesIfNeeds(whiteLoadDataList);
        prepareUpdateOption(option);
    }
    ...
    protected int[] doBatchDelete(List<WhiteLoadData> whiteLoadDataList, DeleteOption<WhiteLoadDataCB> option) {
        assertObjectNotNull("whiteLoadDataList", whiteLoadDataList);
        prepareDeleteOption(option);
        return delegateBatchDelete(whiteLoadDataList, option);
    }
    ...
    protected int doQueryInsert(QueryInsertSetupper<WhiteLoadData, WhiteLoadDataCB> setupper, InsertOption<WhiteLoadDataCB> option) {
        assertObjectNotNull("setupper", setupper);
        prepareInsertOption(option);
        WhiteLoadData entity = new WhiteLoadData();
        WhiteLoadDataCB intoCB = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(WhiteLoadData whiteLoadData, WhiteLoadDataCB cb, UpdateOption<WhiteLoadDataCB> option) {
        assertObjectNotNull("whiteLoadData", whiteLoadData); assertCBStateValid(cb);
        prepareUpdateOption(option);
        return checkCountBeforeQueryUpdateIfNeeds(cb) ? delegateQueryUpdate(whiteLoadData, cb, option) : 0;
    }

    @Override
    protected int doRangeModify(Entity entity, ConditionBean cb, UpdateOption<? extends ConditionBean> option) {
        if (option == null) { return queryUpdate(downcast(entity), (WhiteLoadDataCB)cb); }
        else { return varyingQueryUpdate(downcast(entity), (WhiteLoadDataCB)cb, downcast(option)); }
    }
    ...
    protected int doQueryDelete(WhiteLoadDataCB cb, DeleteOption<WhiteLoadDataCB> option) {
        assertCBStateValid(cb);
        prepareDeleteOption(option);
    ...
    protected int doRangeRemove(ConditionBean cb, DeleteOption<? extends ConditionBean> option) {
        if (option == null) { return queryDelete((WhiteLoadDataCB)cb); }
        else { return varyingQueryDelete((WhiteLoadDataCB)cb, downcast(option)); }
    }
    ...
    protected <ENTITY extends WhiteLoadData> void delegateSelectCursor(WhiteLoadDataCB cb, EntityRowHandler<ENTITY> erh, Class<ENTITY> et)
    { invoke(createSelectCursorCBCommand(cb, erh, et)); }
    protected <ENTITY extends WhiteLoadData> List<ENTITY> delegateSelectList(WhiteLoadDataCB cb, Class<ENTITY> et)
    { return invoke(createSelectListCBCommand(cb, et)); }

    // -----------------------------------------------------
    //                                                Update
    //                                                ------
    protected int delegateInsert(WhiteLoadData e, InsertOption<WhiteLoadDataCB> op)
    { if (!processBeforeInsert(e, op)) { return 0; }
      return invoke(createInsertEntityCommand(e, op)); }
    protected int delegateUpdate(WhiteLoadData e, UpdateOption<WhiteLoadDataCB> op)
    { if (!processBeforeUpdate(e, op)) { return 0; }
      return delegateUpdateNonstrict(e, op); }
    protected int delegateUpdateNonstrict(WhiteLoadData e, UpdateOption<WhiteLoadDataCB> op)
    { if (!processBeforeUpdate(e, op)) { return 0; }
      return invoke(createUpdateNonstrictEntityCommand(e, op)); }
    protected int delegateDelete(WhiteLoadData e, DeleteOption<WhiteLoadDataCB> op)
    { if (!processBeforeDelete(e, op)) { return 0; }
      return delegateDeleteNonstrict(e, op); }
    protected int delegateDeleteNonstrict(WhiteLoadData e, DeleteOption<WhiteLoadDataCB> op)
    { if (!processBeforeDelete(e, op)) { return 0; }
    ...
    protected int delegateQueryInsert(WhiteLoadData e, WhiteLoadDataCB inCB, ConditionBean resCB, InsertOption<WhiteLoadDataCB> op)
    { if (!processBeforeQueryInsert(e, inCB, resCB, op)) { return 0; } return invoke(createQueryInsertCBCommand(e, inCB, resCB, op));  }
    protected int delegateQueryUpdate(WhiteLoadData e, WhiteLoadDataCB cb, UpdateOption<WhiteLoadDataCB> op)
    ...
    //                                                                     Downcast Helper
    //                                                                     ===============
    protected WhiteLoadData downcast(Entity entity) {
        return helpEntityDowncastInternally(entity, WhiteLoadData.class);
    }
    ...
    protected List<WhiteLoadData> downcast(List<? extends Entity> entityList) {
        return (List<WhiteLoadData>)entityList;
    }

    @SuppressWarnings("unchecked")
    protected InsertOption<WhiteLoadDataCB> downcast(InsertOption<? extends ConditionBean> option) {
        return (InsertOption<WhiteLoadDataCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected UpdateOption<WhiteLoadDataCB> downcast(UpdateOption<? extends ConditionBean> option) {
        return (UpdateOption<WhiteLoadDataCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected DeleteOption<WhiteLoadDataCB> downcast(DeleteOption<? extends ConditionBean> option) {
        return (DeleteOption<WhiteLoadDataCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected QueryInsertSetupper<WhiteLoadData, WhiteLoadDataCB> downcast(QueryInsertSetupper<? extends Entity, ? extends ConditionBean> option) {
        return (QueryInsertSetupper<WhiteLoadData, WhiteLoadDataCB>)option;
    }
}
