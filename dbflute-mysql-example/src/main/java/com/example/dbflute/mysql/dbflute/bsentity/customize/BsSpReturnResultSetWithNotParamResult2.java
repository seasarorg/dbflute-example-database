 ...
 */
public abstract class BsSpReturnResultSetWithNotParamResult2 implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.mysql.dbflute.bsentity.customize.dbmeta.SpReturnResultSetWithNotParamResult2Dbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSpReturnResultSetWithNotParamResult2)) { return false; }
        BsSpReturnResultSetWithNotParamResult2 otherEntity = (BsSpReturnResultSetWithNotParamResult2)other;
