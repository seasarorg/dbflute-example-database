...
public abstract class BsWhiteVariantRelationLocalPkReferrerBhv extends AbstractBehaviorWritable<WhiteVariantRelationLocalPkReferrer, WhiteVariantRelationLocalPkReferrerCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteVariantRelationLocalPkReferrer> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteVariantRelationLocalPkReferrer> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
