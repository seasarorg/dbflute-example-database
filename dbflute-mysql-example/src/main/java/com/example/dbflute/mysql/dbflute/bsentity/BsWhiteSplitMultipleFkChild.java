...
public abstract class BsWhiteSplitMultipleFkChild implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteSplitMultipleFkChild)) { return false; }
        BsWhiteSplitMultipleFkChild otherEntity = (BsWhiteSplitMultipleFkChild)other;
        if (!xSV(getChildId(), otherEntity.getChildId())) { return false; }
        return true;
    }
    ...
    public String toStringWithRelation() {
        ...
        { sb.append(l).append(xbRDS(_whiteSplitMultipleFkBase, "whiteSplitMultipleFkBase")); }
        return sb.toString();
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String delimiter = ", ";
        sb.append(delimiter).append(getChildId());
        sb.append(delimiter).append(getBaseId());
        sb.append(delimiter).append(getChildName());
    ...
    protected String buildRelationString() {
        StringBuilder sb = new StringBuilder();
        String c = ",";
        if (_whiteSplitMultipleFkBase != null) { sb.append(c).append("whiteSplitMultipleFkBase"); }
