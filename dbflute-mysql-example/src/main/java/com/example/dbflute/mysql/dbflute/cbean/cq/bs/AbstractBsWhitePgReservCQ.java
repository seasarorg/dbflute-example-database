...
public abstract class AbstractBsWhitePgReservCQ extends AbstractConditionQuery {
    ...
    public void inScopeWhitePgReservRefList(SubQuery<WhitePgReservRefCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        WhitePgReservRefCB cb = new WhitePgReservRefCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepClassSynonym_InScopeRelation_WhitePgReservRefList(cb.query());
    ...
    public void notInScopeWhitePgReservRefList(SubQuery<WhitePgReservRefCB> subQuery) {
        ...
        WhitePgReservRefCB cb = new WhitePgReservRefCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepClassSynonym_NotInScopeRelation_WhitePgReservRefList(cb.query());
    ...
    public HpSSQFunction<WhitePgReservCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ.getOperand(), WhitePgReservCB.class);
    }
    ...
    public HpSSQFunction<WhitePgReservCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES.getOperand(), WhitePgReservCB.class);
    }
    ...
    public HpSSQFunction<WhitePgReservCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT.getOperand(), WhitePgReservCB.class);
    }
    ...
    public HpSSQFunction<WhitePgReservCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT.getOperand(), WhitePgReservCB.class);
    }
    ...
    public HpSSQFunction<WhitePgReservCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE.getOperand(), WhitePgReservCB.class);
    }
    ...
    public HpSSQFunction<WhitePgReservCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE.getOperand(), WhitePgReservCB.class);
    }
    ...
    public void myselfInScope(SubQuery<WhitePgReservCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        WhitePgReservCB cb = new WhitePgReservCB(); cb.xsetupForMyselfInScope(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
