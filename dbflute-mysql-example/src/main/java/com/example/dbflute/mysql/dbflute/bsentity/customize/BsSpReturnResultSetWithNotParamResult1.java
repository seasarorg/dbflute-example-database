 ...
 */
public abstract class BsSpReturnResultSetWithNotParamResult1 implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.mysql.dbflute.bsentity.customize.dbmeta.SpReturnResultSetWithNotParamResult1Dbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSpReturnResultSetWithNotParamResult1)) { return false; }
        BsSpReturnResultSetWithNotParamResult1 otherEntity = (BsSpReturnResultSetWithNotParamResult1)other;
