...
public class BsWhiteQuotedCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;WhiteQuotedCB&gt;() {
    ...
    public void union(UnionQuery<WhiteQuotedCB> unionQuery) {
        final WhiteQuotedCB cb = new WhiteQuotedCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;WhiteQuotedCB&gt;() {
     *     public void query(WhiteQuotedCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteQuotedCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #FD4747">derivedWhiteQuotedRefList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;WhiteQuotedRefCB&gt;() {
         *     public void query(WhiteQuotedRefCB subCB) {
         *         subCB.specify().<span style="color: #FD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, WhiteQuotedRef.<span style="color: #FD4747">ALIAS_foo...</span>);
         * </pre>
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;WhiteQuotedCB&gt;() {
     ...
     */
    public HpColQyOperand<WhiteQuotedCB> columnQuery(final SpecifyQuery<WhiteQuotedCB> leftSpecifyQuery) {
        return new HpColQyOperand<WhiteQuotedCB>(new HpColQyHandler<WhiteQuotedCB>() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;WhiteQuotedCB&gt;() {
     ...
     *     public void query(WhiteQuotedCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteQuotedCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteQuotedCB> andQuery) {
        xorSQAP((WhiteQuotedCB)this, andQuery);
    }
