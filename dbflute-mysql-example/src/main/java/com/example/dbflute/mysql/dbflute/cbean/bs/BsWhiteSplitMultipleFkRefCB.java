...
public class BsWhiteSplitMultipleFkRefCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;WhiteSplitMultipleFkRefCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;WhiteSplitMultipleFkRefCB&gt;() {
     *     public void query(WhiteSplitMultipleFkRefCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;WhiteSplitMultipleFkRefCB&gt;() {
     ...
     */
    public HpColQyOperand<WhiteSplitMultipleFkRefCB> columnQuery(final SpecifyQuery<WhiteSplitMultipleFkRefCB> leftSpecifyQuery) {
        return new HpColQyOperand<WhiteSplitMultipleFkRefCB>(new HpColQyHandler<WhiteSplitMultipleFkRefCB>() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;WhiteSplitMultipleFkRefCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteSplitMultipleFkRefCB> orQuery) {
        xorSQ((WhiteSplitMultipleFkRefCB)this, orQuery);
    }
     ...
     *     public void query(WhiteSplitMultipleFkRefCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteSplitMultipleFkRefCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteSplitMultipleFkRefCB> andQuery) {
        xorSQAP((WhiteSplitMultipleFkRefCB)this, andQuery);
    }
