...
public abstract class BsWhiteVariantRelationReferrer implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWhiteVariantRelationReferrer)) { return false; }
        BsWhiteVariantRelationReferrer otherEntity = (BsWhiteVariantRelationReferrer)other;
        if (!xSV(getReferrerId(), otherEntity.getReferrerId())) { return false; }
        return true;
    }
