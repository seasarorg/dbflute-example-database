 ...
 */
public abstract class BsLargeAutoPaging extends AbstractEntity {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.mysql.dbflute.bsentity.customize.dbmeta.LargeAutoPagingDbm.getInstance();
    }
