...
public abstract class BsWhitePurchaseReferrerBhv extends AbstractBehaviorWritable {
    ...
    protected int facadeSelectCount(WhitePurchaseReferrerCB cb) {
    ...
    protected <ENTITY extends WhitePurchaseReferrer> OptionalEntity<ENTITY> doSelectOptionalEntity(WhitePurchaseReferrerCB cb, Class<ENTITY> tp) {
    ...
    protected WhitePurchaseReferrer facadeSelectEntityWithDeletedCheck(WhitePurchaseReferrerCB cb) {
    ...
    protected <ENTITY extends WhitePurchaseReferrer> ENTITY doSelectByPK(Long purchaseReferrerId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(purchaseReferrerId), tp);
    }

    protected <ENTITY extends WhitePurchaseReferrer> OptionalEntity<ENTITY> doSelectOptionalByPK(Long purchaseReferrerId, Class<ENTITY> tp) {
    ...
    protected ListResultBean<WhitePurchaseReferrer> facadeSelectList(WhitePurchaseReferrerCB cb) {
    ...
    protected PagingResultBean<WhitePurchaseReferrer> facadeSelectPage(WhitePurchaseReferrerCB cb) {
    ...
    protected void facadeSelectCursor(WhitePurchaseReferrerCB cb, EntityRowHandler<WhitePurchaseReferrer> entityRowHandler) {
    ...
    protected <RESULT> HpSLSFunction<WhitePurchaseReferrerCB, RESULT> facadeScalarSelect(Class<RESULT> resultType) {
        return doScalarSelect(resultType, newConditionBean());
    }

    protected <RESULT, CB extends WhitePurchaseReferrerCB> HpSLSFunction<CB, RESULT> doScalarSelect(final Class<RESULT> tp, final CB cb) {
    ...
    protected void doInsert(WhitePurchaseReferrer et, InsertOption<WhitePurchaseReferrerCB> op) {
        assertObjectNotNull("whitePurchaseReferrer", et); prepareInsertOption(op); delegateInsert(et, op);
    }
    ...
    protected void doUpdate(WhitePurchaseReferrer et, UpdateOption<WhitePurchaseReferrerCB> op) {
        assertObjectNotNull("whitePurchaseReferrer", et); prepareUpdateOption(op); helpUpdateInternally(et, op);
    }
    ...
    { WhitePurchaseReferrerCB cb = newConditionBean(); cb.xsetupForVaryingUpdate(); return cb; }

    protected WhitePurchaseReferrerCB createCBForSpecifiedUpdate()
    { WhitePurchaseReferrerCB cb = newConditionBean(); cb.xsetupForSpecifiedUpdate(); return cb; }
    ...
    protected void doInsertOrUpdate(WhitePurchaseReferrer et, InsertOption<WhitePurchaseReferrerCB> iop, UpdateOption<WhitePurchaseReferrerCB> uop) {
        assertObjectNotNull("whitePurchaseReferrer", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doDelete(WhitePurchaseReferrer et, final DeleteOption<WhitePurchaseReferrerCB> op) {
        assertObjectNotNull("whitePurchaseReferrer", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<WhitePurchaseReferrerCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int[] doBatchInsert(List<WhitePurchaseReferrer> ls, InsertOption<WhitePurchaseReferrerCB> op) {
        assertObjectNotNull("whitePurchaseReferrerList", ls);
        InsertOption<WhitePurchaseReferrerCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainInsertOption(); }
        prepareBatchInsertOption(ls, rlop); // required
        return delegateBatchInsert(ls, rlop);
    }

    protected void prepareBatchInsertOption(List<WhitePurchaseReferrer> ls, InsertOption<WhitePurchaseReferrerCB> op) {
    ...
    protected int[] doBatchUpdate(List<WhitePurchaseReferrer> ls, UpdateOption<WhitePurchaseReferrerCB> op) {
        assertObjectNotNull("whitePurchaseReferrerList", ls);
        UpdateOption<WhitePurchaseReferrerCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
        prepareBatchUpdateOption(ls, rlop); // required
        return delegateBatchUpdate(ls, rlop);
    }

    protected void prepareBatchUpdateOption(List<WhitePurchaseReferrer> ls, UpdateOption<WhitePurchaseReferrerCB> op) {
    ...
    protected int[] doBatchDelete(List<WhitePurchaseReferrer> ls, DeleteOption<WhitePurchaseReferrerCB> op) {
        assertObjectNotNull("whitePurchaseReferrerList", ls);
    ...
    protected int doQueryInsert(QueryInsertSetupper<WhitePurchaseReferrer, WhitePurchaseReferrerCB> sp, InsertOption<WhitePurchaseReferrerCB> op) {
        ...
        WhitePurchaseReferrer et = newEntity(); WhitePurchaseReferrerCB cb = createCBForQueryInsert();
        return delegateQueryInsert(et, cb, sp.setup(et, cb), op);
    }

    protected WhitePurchaseReferrerCB createCBForQueryInsert()
    { WhitePurchaseReferrerCB cb = newConditionBean(); cb.xsetupForQueryInsert(); return cb; }
    ...
    protected int doQueryUpdate(WhitePurchaseReferrer et, WhitePurchaseReferrerCB cb, UpdateOption<WhitePurchaseReferrerCB> op) {
        assertObjectNotNull("whitePurchaseReferrer", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<WhitePurchaseReferrer> typeOfSelectedEntity() { return WhitePurchaseReferrer.class; }
    protected WhitePurchaseReferrer downcast(Entity et) { return helpEntityDowncastInternally(et, WhitePurchaseReferrer.class); }
    protected WhitePurchaseReferrerCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, WhitePurchaseReferrerCB.class); }
    @SuppressWarnings("unchecked")
    protected List<WhitePurchaseReferrer> downcast(List<? extends Entity> ls) { return (List<WhitePurchaseReferrer>)ls; }
    @SuppressWarnings("unchecked")
