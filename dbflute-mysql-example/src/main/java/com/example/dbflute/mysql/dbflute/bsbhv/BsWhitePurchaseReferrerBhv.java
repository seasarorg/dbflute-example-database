...
public abstract class BsWhitePurchaseReferrerBhv extends AbstractBehaviorWritable<WhitePurchaseReferrer, WhitePurchaseReferrerCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhitePurchaseReferrer> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.mysql.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhitePurchaseReferrer> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
