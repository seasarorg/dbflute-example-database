...
public abstract class BsWhitePurchaseReferrerBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends WhitePurchaseReferrer> void doSelectCursor(WhitePurchaseReferrerCB cb, EntityRowHandler<ENTITY> handler, Class<ENTITY> tp) {
        ...
        helpSelectCursorInternally(cb, handler, tp, new InternalSelectCursorCallback<ENTITY, WhitePurchaseReferrerCB>() {
            public void callbackSelectCursor(WhitePurchaseReferrerCB lcb, EntityRowHandler<ENTITY> lhandler, Class<ENTITY> ltp) { delegateSelectCursor(lcb, lhandler, ltp); }
            public List<ENTITY> callbackSelectList(WhitePurchaseReferrerCB lcb, Class<ENTITY> ltp) { return doSelectList(lcb, ltp); }
        });
    }
    ...
    protected void doInsert(WhitePurchaseReferrer et, InsertOption<WhitePurchaseReferrerCB> op) {
        assertObjectNotNull("whitePurchaseReferrer", et);
    ...
    protected void doUpdate(WhitePurchaseReferrer et, final UpdateOption<WhitePurchaseReferrerCB> op) {
        assertObjectNotNull("whitePurchaseReferrer", et);
        prepareUpdateOption(op);
        helpUpdateInternally(et, new InternalUpdateCallback<WhitePurchaseReferrer>() {
            public int callbackDelegateUpdate(WhitePurchaseReferrer let) { return delegateUpdate(let, op); } });
    }
    ...
    protected void doInsertOrUpdate(WhitePurchaseReferrer et, final InsertOption<WhitePurchaseReferrerCB> iop, final UpdateOption<WhitePurchaseReferrerCB> uop) {
        assertObjectNotNull("whitePurchaseReferrer", et);
        helpInsertOrUpdateInternally(et, new InternalInsertOrUpdateCallback<WhitePurchaseReferrer, WhitePurchaseReferrerCB>() {
            public void callbackInsert(WhitePurchaseReferrer let) { doInsert(let, iop); }
            public void callbackUpdate(WhitePurchaseReferrer let) { doUpdate(let, uop); }
            public WhitePurchaseReferrerCB callbackNewMyConditionBean() { return newConditionBean(); }
    ...
    protected void doDelete(WhitePurchaseReferrer et, final DeleteOption<WhitePurchaseReferrerCB> op) {
        ...
        helpDeleteInternally(et, new InternalDeleteCallback<WhitePurchaseReferrer>() {
            public int callbackDelegateDelete(WhitePurchaseReferrer let) { return delegateDelete(let, op); } });
    }
    ...
    protected int doQueryInsert(QueryInsertSetupper<WhitePurchaseReferrer, WhitePurchaseReferrerCB> sp, InsertOption<WhitePurchaseReferrerCB> op) {
        ...
        prepareInsertOption(op);
        WhitePurchaseReferrer et = newEntity();
    ...
    protected int doQueryUpdate(WhitePurchaseReferrer et, WhitePurchaseReferrerCB cb, UpdateOption<WhitePurchaseReferrerCB> op) {
        assertObjectNotNull("whitePurchaseReferrer", et); assertCBStateValid(cb);
        prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<WhitePurchaseReferrer> typeOfSelectedEntity()
    { return WhitePurchaseReferrer.class; }
