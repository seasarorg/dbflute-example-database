...
public class BsWhiteSplitMultipleFkChildCQ extends AbstractBsWhiteSplitMultipleFkChildCQ {
    ...
    public String keepBaseId_InScopeRelation_WhiteSplitMultipleFkBase(WhiteSplitMultipleFkBaseCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_baseId_InScopeRelation_WhiteSplitMultipleFkBaseMap.size() + 1);
        _baseId_InScopeRelation_WhiteSplitMultipleFkBaseMap.put(key, subQuery); return "baseId_InScopeRelation_WhiteSplitMultipleFkBase." + key;
    }
    ...
    public String keepBaseId_NotInScopeRelation_WhiteSplitMultipleFkBase(WhiteSplitMultipleFkBaseCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_baseId_NotInScopeRelation_WhiteSplitMultipleFkBaseMap.size() + 1);
        _baseId_NotInScopeRelation_WhiteSplitMultipleFkBaseMap.put(key, subQuery); return "baseId_NotInScopeRelation_WhiteSplitMultipleFkBase." + key;
    }
    ...
    protected void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
        WhiteSplitMultipleFkChildCQ baseQuery = (WhiteSplitMultipleFkChildCQ)baseQueryAsSuper;
        WhiteSplitMultipleFkChildCQ unionQuery = (WhiteSplitMultipleFkChildCQ)unionQueryAsSuper;
        if (baseQuery.hasConditionQueryWhiteSplitMultipleFkBase()) {
            unionQuery.queryWhiteSplitMultipleFkBase().reflectRelationOnUnionQuery(baseQuery.queryWhiteSplitMultipleFkBase(), unionQuery.queryWhiteSplitMultipleFkBase());
        }
    }
