...
CREATE TABLE WHITE_UQ_REFERENCE_WITHOUT_PK (
	UQ_REFERENCE_CODE CHAR(3) NOT NULL,
	UQ_REFERENCE_NAME VARCHAR(64) NOT NULL,
	UNIQUE (UQ_REFERENCE_CODE)
) ;

CREATE TABLE WHITE_UQ_REFERENCE_WITHOUT_PK_REF (
	UQ_REFERENCE_REF_ID NUMERIC(16) NOT NULL,
	UQ_REFERENCE_CODE CHAR(3) NOT NULL
) ;

ALTER TABLE WHITE_UQ_REFERENCE_WITHOUT_PK_REF ADD CONSTRAINT FK_WHITE_UQ_REFERENCE_WITHOUT_PK_REF
	FOREIGN KEY (UQ_REFERENCE_CODE) REFERENCES WHITE_UQ_REFERENCE_WITHOUT_PK (UQ_REFERENCE_CODE) ;
