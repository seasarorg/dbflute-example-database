...
public class BsPurchaseCB extends AbstractConditionBean {
     ...
     * @param purchaseId : PK, ID, NotNull, INTEGER(2000000000, 10). (NotNull)
     */
    public void acceptPrimaryKey(Integer purchaseId) {
        assertObjectNotNull("purchaseId", purchaseId);
        BsPurchaseCB cb = this;
        cb.query().setPurchaseId_Equal(purchaseId);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<PurchaseCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnPurchaseRegisterDatetime() { return doColumn("PURCHASE_REGISTER_DATETIME"); }
        /**
         * PURCHASE_REGISTER_USER: {NotNull, TEXT(2000000000, 10)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnPurchaseRegisterUser() { return doColumn("PURCHASE_REGISTER_USER"); }
        /**
         * PURCHASE_REGISTER_PROCESS: {NotNull, TEXT(2000000000, 10)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnPurchaseRegisterProcess() { return doColumn("PURCHASE_REGISTER_PROCESS"); }
        /**
         * PURCHASE_UPDATE_DATETIME: {NotNull, DATETIME(2000000000, 10)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnPurchaseUpdateDatetime() { return doColumn("PURCHASE_UPDATE_DATETIME"); }
        /**
         * PURCHASE_UPDATE_USER: {NotNull, TEXT(2000000000, 10)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnPurchaseUpdateUser() { return doColumn("PURCHASE_UPDATE_USER"); }
        /**
         * PURCHASE_UPDATE_PROCESS: {NotNull, TEXT(2000000000, 10)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnPurchaseUpdateProcess() { return doColumn("PURCHASE_UPDATE_PROCESS"); }
        /**
