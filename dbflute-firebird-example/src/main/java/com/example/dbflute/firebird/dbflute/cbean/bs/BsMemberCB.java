package com.example.dbflute.firebird.dbflute.cbean.bs;
...
import com.example.dbflute.firebird.dbflute.allcommon.DBFluteConfig;
import com.example.dbflute.firebird.dbflute.allcommon.DBMetaInstanceHandler;
import com.example.dbflute.firebird.dbflute.allcommon.ImplementedInvokerAssistant;
import com.example.dbflute.firebird.dbflute.allcommon.ImplementedSqlClauseCreator;
import com.example.dbflute.firebird.dbflute.cbean.*;
import com.example.dbflute.firebird.dbflute.cbean.cq.*;
import com.example.dbflute.firebird.dbflute.cbean.nss.*;
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberCQ> {
        ...
        public HpSDRFunction<MemberServiceCB, MemberCQ> derivedMemberServiceList() {
            ...
            return new HpSDRFunction<MemberServiceCB, MemberCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<MemberServiceCB, MemberCQ>() {
                public void setup(String fn, SubQuery<MemberServiceCB> sq, MemberCQ cq, String al, DerivedReferrerOption op) {
