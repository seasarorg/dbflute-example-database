...
public class DBFluteModule extends AbstractModule {
    ...
    protected DBFluteInitializer createDBFluteInitializer() {
        return new com.example.dbflute.firebird.dbflute.allcommon.DBFluteInitializer();
    }
    ...
    protected ImplementedInvokerAssistant createImplementedInvokerAssistant() {
        ImplementedInvokerAssistant invokerAssistant = new com.example.dbflute.firebird.dbflute.nogen.ExtendedInvokerAssistant();
    ...
    protected ImplementedCommonColumnAutoSetupper createImplementedCommonColumnAutoSetupper() {
        return new com.example.dbflute.firebird.dbflute.allcommon.ImplementedCommonColumnAutoSetupper();
    }
