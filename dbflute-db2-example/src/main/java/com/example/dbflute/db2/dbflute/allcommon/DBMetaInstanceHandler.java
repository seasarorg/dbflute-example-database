package com.example.dbflute.db2.dbflute.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("ALIAS_EXCEPT", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.AliasExceptDbm");
        tmpMap.put("ALIAS_MEMBER", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.AliasMemberDbm");
        tmpMap.put("ALIAS_MEMBER_LOGIN", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.AliasMemberLoginDbm");
        tmpMap.put("ALIAS_REF_EXCEPT", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.AliasRefExceptDbm");
        tmpMap.put("MEMBER", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("MEMBER_ADDRESS", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("MEMBER_FOLLOWING", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.MemberFollowingDbm");
        tmpMap.put("MEMBER_LOGIN", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("MEMBER_SECURITY", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("MEMBER_SERVICE", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("MEMBER_STATUS", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("MEMBER_WITHDRAWAL", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("PRODUCT", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("PRODUCT_CATEGORY", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("PRODUCT_STATUS", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("PURCHASE", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("REGION", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.RegionDbm");
        ...
        tmpMap.put("SUMMARY_MEMBER_PURCHASE", "com.example.dbflute.db2.dbflute.bsentity.dbmeta.SummaryMemberPurchaseDbm");
