...
public abstract class BsMemberStatus extends AbstractEntity {
    ...
    /**
     * [get] ALIAS_MEMBER by MEMBER_STATUS_CODE, named 'aliasMemberList'.
    ...
    /**
     * [set] ALIAS_MEMBER by MEMBER_STATUS_CODE, named 'aliasMemberList'.
    ...
    /**
     * [get] ALIAS_MEMBER_LOGIN by LOGIN_MEMBER_STATUS_CODE, named 'aliasMemberLoginList'.
    ...
    /**
     * [set] ALIAS_MEMBER_LOGIN by LOGIN_MEMBER_STATUS_CODE, named 'aliasMemberLoginList'.
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_aliasMemberList != null) { for (AliasMember et : _aliasMemberList)
        { if (et != null) { sb.append(li).append(xbRDS(et, "aliasMemberList")); } } }
        if (_aliasMemberLoginList != null) { for (AliasMemberLogin et : _aliasMemberLoginList)
    ...
    protected String doBuildRelationString(String dm) {
        ...
        { sb.append(dm).append("aliasMemberList"); }
        if (_aliasMemberLoginList != null && !_aliasMemberLoginList.isEmpty())
        { sb.append(dm).append("aliasMemberLoginList"); }
