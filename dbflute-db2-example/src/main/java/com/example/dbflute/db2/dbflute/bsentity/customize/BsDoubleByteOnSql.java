...
public abstract class BsDoubleByteOnSql extends AbstractEntity {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.db2.dbflute.bsentity.customize.dbmeta.DoubleByteOnSqlDbm.getInstance();
    }
    ...
    /**
     * [get] MEMBER_NAME_WITH_SPACE: {VARCHAR(203)} <br />
    ...
    /**
     * [set] MEMBER_NAME_WITH_SPACE: {VARCHAR(203)} <br />
