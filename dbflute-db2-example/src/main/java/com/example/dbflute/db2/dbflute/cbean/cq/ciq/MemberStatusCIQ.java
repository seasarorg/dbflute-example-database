...
public class MemberStatusCIQ extends AbstractBsMemberStatusCQ {
    ...
    { return _myCQ.keepMemberStatusCode_InScopeRelation_AliasMemberList(sq); }
    public String keepMemberStatusCode_InScopeRelation_AliasMemberLoginList(AliasMemberLoginCQ sq)
    { return _myCQ.keepMemberStatusCode_InScopeRelation_AliasMemberLoginList(sq); }
    ...
    { return _myCQ.keepMemberStatusCode_NotInScopeRelation_AliasMemberList(sq); }
    public String keepMemberStatusCode_NotInScopeRelation_AliasMemberLoginList(AliasMemberLoginCQ sq)
    { return _myCQ.keepMemberStatusCode_NotInScopeRelation_AliasMemberLoginList(sq); }
