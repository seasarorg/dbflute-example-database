...
public class MemberStatusCIQ extends AbstractBsMemberStatusCQ {
    ...
    public String keepMemberStatusCode_QueryDerivedReferrer_AliasMemberListParameter(Object pv)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepMemberStatusCode_QueryDerivedReferrer_AliasMemberLoginList(AliasMemberLoginCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepMemberStatusCode_QueryDerivedReferrer_AliasMemberLoginListParameter(Object pv)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
