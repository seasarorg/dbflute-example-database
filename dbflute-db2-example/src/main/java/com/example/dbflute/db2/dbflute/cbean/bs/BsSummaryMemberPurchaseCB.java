...
/**
 * The base condition-bean of SUMMARY_MEMBER_PURCHASE.
 * @author DBFlute(AutoGenerator)
 */
public class BsSummaryMemberPurchaseCB extends AbstractConditionBean {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSummaryMemberPurchaseCB() {
    ...
    public SummaryMemberPurchaseCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected SummaryMemberPurchaseCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected SummaryMemberPurchaseCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        SummaryMemberPurchaseCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected SummaryMemberPurchaseCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;SummaryMemberPurchaseCB&gt;() {
     *     public void query(SummaryMemberPurchaseCB unionCB) {
     ...
     */
    public void union(UnionQuery<SummaryMemberPurchaseCB> unionQuery) {
        final SummaryMemberPurchaseCB cb = new SummaryMemberPurchaseCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final SummaryMemberPurchaseCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;SummaryMemberPurchaseCB&gt;() {
     *     public void query(SummaryMemberPurchaseCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<SummaryMemberPurchaseCB> unionQuery) {
        final SummaryMemberPurchaseCB cb = new SummaryMemberPurchaseCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final SummaryMemberPurchaseCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<SummaryMemberPurchaseCQ>() {
                public boolean has() { return true; }
                public SummaryMemberPurchaseCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<SummaryMemberPurchaseCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<SummaryMemberPurchaseCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnAllsumPurchasePrice() { return doColumn("ALLSUM_PURCHASE_PRICE"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "SUMMARY_MEMBER_PURCHASE"; }
        /**
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;SummaryMemberPurchaseCB&gt;() {
     *     public void query(SummaryMemberPurchaseCB cb) {
     *         cb.specify().<span style="color: #DD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;SummaryMemberPurchaseCB&gt;() {
     *     public void query(SummaryMemberPurchaseCB cb) {
     ...
     */
    public SummaryMemberPurchaseCB dreamCruiseCB() {
        SummaryMemberPurchaseCB cb = new SummaryMemberPurchaseCB();
        cb.xsetupForDreamCruise((SummaryMemberPurchaseCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;SummaryMemberPurchaseCB&gt;() {
     *     public void query(SummaryMemberPurchaseCB orCB) {
     ...
     *     public void query(SummaryMemberPurchaseCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;SummaryMemberPurchaseCB&gt;() {
     *             public void query(SummaryMemberPurchaseCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<SummaryMemberPurchaseCB> andQuery) {
        xorSQAP((SummaryMemberPurchaseCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final SummaryMemberPurchaseCB cb;
        if (mainCB != null) {
            cb = (SummaryMemberPurchaseCB)mainCB;
        } else {
            cb = new SummaryMemberPurchaseCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<SummaryMemberPurchaseCQ>() {
            public boolean has() { return true; }
            public SummaryMemberPurchaseCQ qy() { return cb.query(); }
        });
    }
    ...
    protected String getConditionBeanClassNameInternally() { return SummaryMemberPurchaseCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return SummaryMemberPurchaseCQ.class.getName(); }
