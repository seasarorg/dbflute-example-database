 ...
 */
public class BsAliasRefExceptCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected AliasRefExceptCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsAliasRefExceptCB() {
     ...
     */
    public AliasRefExceptCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return getConditionQuery();
    }

    public AliasRefExceptCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected AliasRefExceptCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected AliasRefExceptCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        AliasRefExceptCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected AliasRefExceptCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new AliasRefExceptCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<AliasRefExceptCQ>() {
                public boolean has() { return true; }
                public AliasRefExceptCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<AliasRefExceptCQ> {
        protected AliasExceptCB.HpSpecification _aliasExcept;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<AliasRefExceptCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryAliasExcept()
                    || qyCall().qy().xgetReferrerQuery() instanceof AliasExceptCQ) {
                columnExceptId(); // FK or one-to-one referrer
            }
        }
        @Override
        protected String getTableDbName() { return "ALIAS_REF_EXCEPT"; }
        /**
         * Prepare to specify functions about relation table. <br />
         * ALIAS_EXCEPT by my EXCEPT_ID, named 'aliasExcept'.
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public AliasExceptCB.HpSpecification specifyAliasExcept() {
            assertRelation("aliasExcept");
            if (_aliasExcept == null) {
                _aliasExcept = new AliasExceptCB.HpSpecification(_baseCB, new HpSpQyCall<AliasExceptCQ>() {
                    public boolean has() { return _qyCall.has() && _qyCall.qy().hasConditionQueryAliasExcept(); }
                    public AliasExceptCQ qy() { return _qyCall.qy().queryAliasExcept(); } }
                    , _purpose, _dbmetaProvider);
                if (xhasSyncQyCall()) { // inherits it
                    _aliasExcept.xsetSyncQyCall(new HpSpQyCall<AliasExceptCQ>() {
                        public boolean has() { return xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryAliasExcept(); }
                        public AliasExceptCQ qy() { return xsyncQyCall().qy().queryAliasExcept(); }
                    });
                }
            }
            return _aliasExcept;
         ...
         */
        public HpSDRFunction<AliasRefExceptCB, AliasRefExceptCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return new HpSDRFunction<AliasRefExceptCB, AliasRefExceptCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<AliasRefExceptCB, AliasRefExceptCQ>() {
                public void setup(String fn, SubQuery<AliasRefExceptCB> sq, AliasRefExceptCQ cq, String al, DerivedReferrerOption op) {
    ...
    protected AliasRefExceptCB xcreateColumnQueryCB() {
        AliasRefExceptCB cb = new AliasRefExceptCB();
        cb.xsetupForColumnQuery((AliasRefExceptCB)this);
        return cb;
    }
     ...
     */
    public AliasRefExceptCB dreamCruiseCB() {
        AliasRefExceptCB cb = new AliasRefExceptCB();
        cb.xsetupForDreamCruise((AliasRefExceptCB) this);
        return cb;
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<AliasRefExceptCB> andQuery) {
        xorSQAP((AliasRefExceptCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final AliasRefExceptCB cb;
        if (mainCB != null) {
            cb = (AliasRefExceptCB)mainCB;
        } else {
            cb = new AliasRefExceptCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<AliasRefExceptCQ>() {
            public boolean has() { return true; }
            public AliasRefExceptCQ qy() { return cb.query(); }
        });
    }
    ...
    protected String getConditionBeanClassNameInternally() { return AliasRefExceptCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return AliasRefExceptCQ.class.getName(); }
