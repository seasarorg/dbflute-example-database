...
public class BsVendorCheckCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<VendorCheckCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnTypeOfCharForBitData() { return doColumn("TYPE_OF_CHAR_FOR_BIT_DATA"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnTypeOfVarcharForBitData() { return doColumn("TYPE_OF_VARCHAR_FOR_BIT_DATA"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnTypeOfDbclob() { return doColumn("TYPE_OF_DBCLOB"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnTypeOfSmallint() { return doColumn("TYPE_OF_SMALLINT"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnTypeOfGraphic() { return doColumn("TYPE_OF_GRAPHIC"); }
        /**
         * TYPE_OF_VARGRAPHIC: {VARGRAPHIC(64)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnTypeOfVargraphic() { return doColumn("TYPE_OF_VARGRAPHIC"); }
        /**
         * TYPE_OF_LONG_VARGRAPHIC: {LONG VARGRAPHIC(32700)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnTypeOfLongVargraphic() { return doColumn("TYPE_OF_LONG_VARGRAPHIC"); }
        ...
        public HpSDRFunction<VendorCheckCB, VendorCheckCQ> myselfDerived() {
            ...
            return new HpSDRFunction<VendorCheckCB, VendorCheckCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<VendorCheckCB, VendorCheckCQ>() {
                public void setup(String function, SubQuery<VendorCheckCB> subQuery, VendorCheckCQ cq, String aliasName, DerivedReferrerOption option) {
