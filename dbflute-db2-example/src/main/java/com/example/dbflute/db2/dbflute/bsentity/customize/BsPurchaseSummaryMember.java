...
public abstract class BsPurchaseSummaryMember extends AbstractEntity {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.db2.dbflute.bsentity.customize.dbmeta.PurchaseSummaryMemberDbm.getInstance();
    }
    ...
    /**
     * [get] PURCHASE_SUMMARY: {INTEGER(10)} <br />
    ...
    /**
     * [set] PURCHASE_SUMMARY: {INTEGER(10)} <br />
