...
public class BsMemberStatusCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberStatusCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #FD4747">derivedAliasMemberList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;AliasMemberCB&gt;() {
         *     public void query(AliasMemberCB subCB) {
         *         subCB.specify().<span style="color: #FD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, AliasMember.<span style="color: #FD4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<AliasMemberCB, MemberStatusCQ> derivedAliasMemberList() {
            assertDerived("aliasMemberList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return new HpSDRFunction<AliasMemberCB, MemberStatusCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<AliasMemberCB, MemberStatusCQ>() {
                public void setup(String function, SubQuery<AliasMemberCB> subQuery, MemberStatusCQ cq, String aliasName, DerivedReferrerOption option) {
                    cq.xsderiveAliasMemberList(function, subQuery, aliasName, option); } }, _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer. <br />
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<AliasMemberLoginCB, MemberStatusCQ> derivedAliasMemberLoginList() {
            assertDerived("aliasMemberLoginList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return new HpSDRFunction<AliasMemberLoginCB, MemberStatusCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<AliasMemberLoginCB, MemberStatusCQ>() {
                public void setup(String function, SubQuery<AliasMemberLoginCB> subQuery, MemberStatusCQ cq, String aliasName, DerivedReferrerOption option) {
