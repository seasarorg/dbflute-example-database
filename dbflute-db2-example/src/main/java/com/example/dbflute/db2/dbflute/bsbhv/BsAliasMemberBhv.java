...
public abstract class BsAliasMemberBhv extends AbstractBehaviorWritable {
    ...
    protected int facadeSelectCount(AliasMemberCB cb) {
    ...
    protected AliasMember facadeSelectEntityWithDeletedCheck(AliasMemberCB cb) {
    ...
    protected <ENTITY extends AliasMember> ENTITY doSelectByPK(Integer memberId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberId), tp);
    }

    protected <ENTITY extends AliasMember> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer memberId, Class<ENTITY> tp) {
    ...
    protected <ENTITY extends AliasMember> OptionalEntity<ENTITY> doSelectByUniqueOf(String memberAccount, Class<ENTITY> tp) {
    ...
    protected ListResultBean<AliasMember> facadeSelectList(AliasMemberCB cb) {
    ...
    protected PagingResultBean<AliasMember> facadeSelectPage(AliasMemberCB cb) {
    ...
    protected void facadeSelectCursor(AliasMemberCB cb, EntityRowHandler<AliasMember> entityRowHandler) {
    ...
    protected <RESULT> HpSLSFunction<AliasMemberCB, RESULT> facadeScalarSelect(Class<RESULT> resultType) {
        return doScalarSelect(resultType, newConditionBean());
    }

    protected <RESULT, CB extends AliasMemberCB> HpSLSFunction<CB, RESULT> doScalarSelect(final Class<RESULT> tp, final CB cb) {
    ...
    protected void doInsert(AliasMember et, InsertOption<AliasMemberCB> op) {
        assertObjectNotNull("aliasMember", et); prepareInsertOption(op); delegateInsert(et, op);
    }
    ...
    protected void doUpdate(AliasMember et, UpdateOption<AliasMemberCB> op) {
        assertObjectNotNull("aliasMember", et); prepareUpdateOption(op); helpUpdateInternally(et, op);
    }
    ...
    { AliasMemberCB cb = newConditionBean(); cb.xsetupForVaryingUpdate(); return cb; }

    protected AliasMemberCB createCBForSpecifiedUpdate()
    { AliasMemberCB cb = newConditionBean(); cb.xsetupForSpecifiedUpdate(); return cb; }
    ...
    protected void doUpdateNonstrict(AliasMember et, UpdateOption<AliasMemberCB> op) {
        assertObjectNotNull("aliasMember", et); prepareUpdateOption(op); helpUpdateNonstrictInternally(et, op);
    }
    ...
    protected void doInsertOrUpdate(AliasMember et, InsertOption<AliasMemberCB> iop, UpdateOption<AliasMemberCB> uop) {
        assertObjectNotNull("aliasMember", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doInsertOrUpdateNonstrict(AliasMember et, InsertOption<AliasMemberCB> iop, UpdateOption<AliasMemberCB> uop) {
        assertObjectNotNull("aliasMember", et); helpInsertOrUpdateNonstrictInternally(et, iop, uop);
    }
    ...
    protected void doDelete(AliasMember et, final DeleteOption<AliasMemberCB> op) {
        assertObjectNotNull("aliasMember", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<AliasMemberCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected void doDeleteNonstrict(AliasMember et, final DeleteOption<AliasMemberCB> op) {
        assertObjectNotNull("aliasMember", et); prepareDeleteOption(op); helpDeleteNonstrictInternally(et, op);
    }
    ...
    protected int[] doBatchInsert(List<AliasMember> ls, InsertOption<AliasMemberCB> op) {
        assertObjectNotNull("aliasMemberList", ls);
        InsertOption<AliasMemberCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainInsertOption(); }
        prepareBatchInsertOption(ls, rlop); // required
        return delegateBatchInsert(ls, rlop);
    }

    protected void prepareBatchInsertOption(List<AliasMember> ls, InsertOption<AliasMemberCB> op) {
    ...
    protected int[] doBatchUpdate(List<AliasMember> ls, UpdateOption<AliasMemberCB> op) {
        assertObjectNotNull("aliasMemberList", ls);
        UpdateOption<AliasMemberCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
        prepareBatchUpdateOption(ls, rlop); // required
        return delegateBatchUpdate(ls, rlop);
    }

    protected void prepareBatchUpdateOption(List<AliasMember> ls, UpdateOption<AliasMemberCB> op) {
    ...
    protected int[] doBatchUpdateNonstrict(List<AliasMember> ls, UpdateOption<AliasMemberCB> op) {
        assertObjectNotNull("aliasMemberList", ls);
        UpdateOption<AliasMemberCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
    ...
    protected int[] doBatchDelete(List<AliasMember> ls, DeleteOption<AliasMemberCB> op) {
        assertObjectNotNull("aliasMemberList", ls);
    ...
    protected int[] doBatchDeleteNonstrict(List<AliasMember> ls, DeleteOption<AliasMemberCB> op) {
        assertObjectNotNull("aliasMemberList", ls);
        prepareDeleteOption(op);
    ...
    protected int doQueryInsert(QueryInsertSetupper<AliasMember, AliasMemberCB> sp, InsertOption<AliasMemberCB> op) {
        ...
        AliasMember et = newEntity(); AliasMemberCB cb = createCBForQueryInsert();
        return delegateQueryInsert(et, cb, sp.setup(et, cb), op);
    }

    protected AliasMemberCB createCBForQueryInsert()
    { AliasMemberCB cb = newConditionBean(); cb.xsetupForQueryInsert(); return cb; }
    ...
    protected int doQueryUpdate(AliasMember et, AliasMemberCB cb, UpdateOption<AliasMemberCB> op) {
        assertObjectNotNull("aliasMember", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<AliasMember> typeOfSelectedEntity() { return AliasMember.class; }
    protected AliasMember downcast(Entity et) { return helpEntityDowncastInternally(et, AliasMember.class); }
    protected AliasMemberCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, AliasMemberCB.class); }
    @SuppressWarnings("unchecked")
    protected List<AliasMember> downcast(List<? extends Entity> ls) { return (List<AliasMember>)ls; }
    @SuppressWarnings("unchecked")
    protected InsertOption<AliasMemberCB> downcast(InsertOption<? extends ConditionBean> op) { return (InsertOption<AliasMemberCB>)op; }
    @SuppressWarnings("unchecked")
    protected UpdateOption<AliasMemberCB> downcast(UpdateOption<? extends ConditionBean> op) { return (UpdateOption<AliasMemberCB>)op; }
    @SuppressWarnings("unchecked")
    protected DeleteOption<AliasMemberCB> downcast(DeleteOption<? extends ConditionBean> op) { return (DeleteOption<AliasMemberCB>)op; }
    @SuppressWarnings("unchecked")
