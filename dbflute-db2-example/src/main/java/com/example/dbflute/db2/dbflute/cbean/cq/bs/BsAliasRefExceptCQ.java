...
public class BsAliasRefExceptCQ extends AbstractBsAliasRefExceptCQ {
    ...
    public String keepExceptId_InScopeRelation_AliasExcept(AliasExceptCQ subQuery) {
        if (_exceptId_InScopeRelation_AliasExceptMap == null) { _exceptId_InScopeRelation_AliasExceptMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_exceptId_InScopeRelation_AliasExceptMap.size() + 1);
        _exceptId_InScopeRelation_AliasExceptMap.put(key, subQuery); return "exceptId_InScopeRelation_AliasExcept." + key;
    }
    ...
    public String keepExceptId_NotInScopeRelation_AliasExcept(AliasExceptCQ subQuery) {
        if (_exceptId_NotInScopeRelation_AliasExceptMap == null) { _exceptId_NotInScopeRelation_AliasExceptMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_exceptId_NotInScopeRelation_AliasExceptMap.size() + 1);
        _exceptId_NotInScopeRelation_AliasExceptMap.put(key, subQuery); return "exceptId_NotInScopeRelation_AliasExcept." + key;
    }
    ...
    protected void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
        AliasRefExceptCQ baseQuery = (AliasRefExceptCQ)baseQueryAsSuper;
        AliasRefExceptCQ unionQuery = (AliasRefExceptCQ)unionQueryAsSuper;
        if (baseQuery.hasConditionQueryAliasExcept()) {
            unionQuery.queryAliasExcept().reflectRelationOnUnionQuery(baseQuery.queryAliasExcept(), unionQuery.queryAliasExcept());
        }
    }
