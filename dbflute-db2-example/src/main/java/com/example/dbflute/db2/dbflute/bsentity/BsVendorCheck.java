...
public abstract class BsVendorCheck implements Entity, Serializable, Cloneable {
    ...
    protected String buildColumnString() {
        ...
        sb.append(delimiter).append(xfBA(getTypeOfCharForBitData()));
        sb.append(delimiter).append(getTypeOfVarchar());
        sb.append(delimiter).append(xfBA(getTypeOfVarcharForBitData()));
        sb.append(delimiter).append(getTypeOfClob());
        sb.append(delimiter).append(getTypeOfDbclob());
        ...
        sb.append(delimiter).append(getTypeOfSmallint());
        ...
        sb.append(delimiter).append(getTypeOfGraphic());
        sb.append(delimiter).append(getTypeOfVargraphic());
        sb.append(delimiter).append(getTypeOfLongVargraphic());
