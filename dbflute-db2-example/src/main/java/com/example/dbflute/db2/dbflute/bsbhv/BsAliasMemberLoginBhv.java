 ...
 */
public abstract class BsAliasMemberLoginBhv extends AbstractBehaviorWritable<AliasMemberLogin, AliasMemberLoginCB> {
    ...
    protected <ENTITY extends AliasMemberLogin> OptionalEntity<ENTITY> doSelectOptionalEntity(AliasMemberLoginCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends AliasMemberLogin> ENTITY doSelectByPK(Long memberLoginId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberLoginId), tp);
    }

    protected <ENTITY extends AliasMemberLogin> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberLoginId, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends AliasMemberLogin> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer memberId, java.sql.Timestamp loginDatetime, Class<? extends ENTITY> tp) {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends AliasMemberLogin> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.db2.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends AliasMemberLogin> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends AliasMemberLogin> typeOfSelectedEntity() { return AliasMemberLogin.class; }
    protected Class<AliasMemberLogin> typeOfHandlingEntity() { return AliasMemberLogin.class; }
    protected Class<AliasMemberLoginCB> typeOfHandlingConditionBean() { return AliasMemberLoginCB.class; }
}
