...
public abstract class BsOptionMember implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.db2.dbflute.bsentity.customize.dbmeta.OptionMemberDbm.getInstance();
    }
    ...
    /**
     * [get] STATUS_DISPLAY_ORDER: {INTEGER(10), refers to MEMBER_STATUS} <br />
    ...
    /**
     * [set] STATUS_DISPLAY_ORDER: {INTEGER(10), refers to MEMBER_STATUS} <br />
