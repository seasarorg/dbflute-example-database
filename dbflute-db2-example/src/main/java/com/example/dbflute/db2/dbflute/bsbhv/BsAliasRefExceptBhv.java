...
public abstract class BsAliasRefExceptBhv extends AbstractBehaviorWritable {
    ...
    protected int facadeSelectCount(AliasRefExceptCB cb) {
    ...
    protected <ENTITY extends AliasRefExcept> ENTITY doSelectEntity(AliasRefExceptCB cb, Class<ENTITY> tp) {
        return helpSelectEntityInternally(cb, tp);
    }

    protected <ENTITY extends AliasRefExcept> OptionalEntity<ENTITY> doSelectOptionalEntity(AliasRefExceptCB cb, Class<ENTITY> tp) {
    ...
    protected AliasRefExcept facadeSelectEntityWithDeletedCheck(AliasRefExceptCB cb) {
        return doSelectEntityWithDeletedCheck(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends AliasRefExcept> ENTITY doSelectEntityWithDeletedCheck(AliasRefExceptCB cb, Class<ENTITY> tp) {
    ...
    protected <ENTITY extends AliasRefExcept> ENTITY doSelectByPK(Long refExceptId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(refExceptId), tp);
    }

    protected <ENTITY extends AliasRefExcept> OptionalEntity<ENTITY> doSelectOptionalByPK(Long refExceptId, Class<ENTITY> tp) {
    ...
    protected ListResultBean<AliasRefExcept> facadeSelectList(AliasRefExceptCB cb) {
    ...
    protected PagingResultBean<AliasRefExcept> facadeSelectPage(AliasRefExceptCB cb) {
    ...
    protected void facadeSelectCursor(AliasRefExceptCB cb, EntityRowHandler<AliasRefExcept> entityRowHandler) {
    ...
    protected <RESULT> HpSLSFunction<AliasRefExceptCB, RESULT> facadeScalarSelect(Class<RESULT> resultType) {
        return doScalarSelect(resultType, newConditionBean());
    }

    protected <RESULT, CB extends AliasRefExceptCB> HpSLSFunction<CB, RESULT> doScalarSelect(final Class<RESULT> tp, final CB cb) {
    ...
    protected void doInsert(AliasRefExcept et, InsertOption<AliasRefExceptCB> op) {
        assertObjectNotNull("aliasRefExcept", et); prepareInsertOption(op); delegateInsert(et, op);
    }
    ...
    protected void doUpdate(AliasRefExcept et, UpdateOption<AliasRefExceptCB> op) {
        assertObjectNotNull("aliasRefExcept", et); prepareUpdateOption(op); helpUpdateInternally(et, op);
    }
    ...
    { AliasRefExceptCB cb = newConditionBean(); cb.xsetupForVaryingUpdate(); return cb; }

    protected AliasRefExceptCB createCBForSpecifiedUpdate()
    { AliasRefExceptCB cb = newConditionBean(); cb.xsetupForSpecifiedUpdate(); return cb; }
    ...
    protected void doInsertOrUpdate(AliasRefExcept et, InsertOption<AliasRefExceptCB> iop, UpdateOption<AliasRefExceptCB> uop) {
        assertObjectNotNull("aliasRefExcept", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doDelete(AliasRefExcept et, final DeleteOption<AliasRefExceptCB> op) {
        assertObjectNotNull("aliasRefExcept", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<AliasRefExceptCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int[] doBatchInsert(List<AliasRefExcept> ls, InsertOption<AliasRefExceptCB> op) {
        assertObjectNotNull("aliasRefExceptList", ls);
        InsertOption<AliasRefExceptCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainInsertOption(); }
        prepareBatchInsertOption(ls, rlop); // required
        return delegateBatchInsert(ls, rlop);
    }

    protected void prepareBatchInsertOption(List<AliasRefExcept> ls, InsertOption<AliasRefExceptCB> op) {
    ...
    protected int[] doBatchUpdate(List<AliasRefExcept> ls, UpdateOption<AliasRefExceptCB> op) {
        assertObjectNotNull("aliasRefExceptList", ls);
        UpdateOption<AliasRefExceptCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
        prepareBatchUpdateOption(ls, rlop); // required
        return delegateBatchUpdate(ls, rlop);
    }

    protected void prepareBatchUpdateOption(List<AliasRefExcept> ls, UpdateOption<AliasRefExceptCB> op) {
    ...
    protected int[] doBatchDelete(List<AliasRefExcept> ls, DeleteOption<AliasRefExceptCB> op) {
        assertObjectNotNull("aliasRefExceptList", ls);
    ...
    protected int doQueryInsert(QueryInsertSetupper<AliasRefExcept, AliasRefExceptCB> sp, InsertOption<AliasRefExceptCB> op) {
        ...
        AliasRefExcept et = newEntity(); AliasRefExceptCB cb = createCBForQueryInsert();
        return delegateQueryInsert(et, cb, sp.setup(et, cb), op);
    }

    protected AliasRefExceptCB createCBForQueryInsert()
    { AliasRefExceptCB cb = newConditionBean(); cb.xsetupForQueryInsert(); return cb; }
    ...
    protected int doQueryUpdate(AliasRefExcept et, AliasRefExceptCB cb, UpdateOption<AliasRefExceptCB> op) {
        assertObjectNotNull("aliasRefExcept", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<AliasRefExcept> typeOfSelectedEntity() { return AliasRefExcept.class; }
    protected AliasRefExcept downcast(Entity et) { return helpEntityDowncastInternally(et, AliasRefExcept.class); }
    protected AliasRefExceptCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, AliasRefExceptCB.class); }
    @SuppressWarnings("unchecked")
    protected List<AliasRefExcept> downcast(List<? extends Entity> ls) { return (List<AliasRefExcept>)ls; }
    @SuppressWarnings("unchecked")
    protected InsertOption<AliasRefExceptCB> downcast(InsertOption<? extends ConditionBean> op) { return (InsertOption<AliasRefExceptCB>)op; }
    @SuppressWarnings("unchecked")
    protected UpdateOption<AliasRefExceptCB> downcast(UpdateOption<? extends ConditionBean> op) { return (UpdateOption<AliasRefExceptCB>)op; }
    @SuppressWarnings("unchecked")
    protected DeleteOption<AliasRefExceptCB> downcast(DeleteOption<? extends ConditionBean> op) { return (DeleteOption<AliasRefExceptCB>)op; }
    @SuppressWarnings("unchecked")
