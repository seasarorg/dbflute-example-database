...
public abstract class BsSummaryMemberPurchaseBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends SummaryMemberPurchase> ENTITY doSelectByPK(Integer memberId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberId), tp);
    }

    protected <ENTITY extends SummaryMemberPurchase> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer memberId, Class<ENTITY> tp) {
    ...
    protected void doInsert(SummaryMemberPurchase et, InsertOption<SummaryMemberPurchaseCB> op) {
        assertObjectNotNull("summaryMemberPurchase", et); prepareInsertOption(op); delegateInsert(et, op);
    }
    ...
    protected void doUpdate(SummaryMemberPurchase et, UpdateOption<SummaryMemberPurchaseCB> op) {
        assertObjectNotNull("summaryMemberPurchase", et); prepareUpdateOption(op); helpUpdateInternally(et, op);
    }
    ...
    { SummaryMemberPurchaseCB cb = newConditionBean(); cb.xsetupForVaryingUpdate(); return cb; }

    protected SummaryMemberPurchaseCB createCBForSpecifiedUpdate()
    { SummaryMemberPurchaseCB cb = newConditionBean(); cb.xsetupForSpecifiedUpdate(); return cb; }
    ...
    protected void doInsertOrUpdate(SummaryMemberPurchase et, InsertOption<SummaryMemberPurchaseCB> iop, UpdateOption<SummaryMemberPurchaseCB> uop) {
        assertObjectNotNull("summaryMemberPurchase", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doDelete(SummaryMemberPurchase et, final DeleteOption<SummaryMemberPurchaseCB> op) {
        assertObjectNotNull("summaryMemberPurchase", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<SummaryMemberPurchaseCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int[] doBatchInsert(List<SummaryMemberPurchase> ls, InsertOption<SummaryMemberPurchaseCB> op) {
        assertObjectNotNull("summaryMemberPurchaseList", ls);
        InsertOption<SummaryMemberPurchaseCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainInsertOption(); }
        prepareBatchInsertOption(ls, rlop); // required
        return delegateBatchInsert(ls, rlop);
    }

    protected void prepareBatchInsertOption(List<SummaryMemberPurchase> ls, InsertOption<SummaryMemberPurchaseCB> op) {
    ...
    protected int[] doBatchUpdate(List<SummaryMemberPurchase> ls, UpdateOption<SummaryMemberPurchaseCB> op) {
        assertObjectNotNull("summaryMemberPurchaseList", ls);
        UpdateOption<SummaryMemberPurchaseCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
        prepareBatchUpdateOption(ls, rlop); // required
        return delegateBatchUpdate(ls, rlop);
    }

    protected void prepareBatchUpdateOption(List<SummaryMemberPurchase> ls, UpdateOption<SummaryMemberPurchaseCB> op) {
    ...
    protected int[] doBatchDelete(List<SummaryMemberPurchase> ls, DeleteOption<SummaryMemberPurchaseCB> op) {
        assertObjectNotNull("summaryMemberPurchaseList", ls);
    ...
    protected int doQueryInsert(QueryInsertSetupper<SummaryMemberPurchase, SummaryMemberPurchaseCB> sp, InsertOption<SummaryMemberPurchaseCB> op) {
        ...
        SummaryMemberPurchase et = newEntity(); SummaryMemberPurchaseCB cb = createCBForQueryInsert();
        return delegateQueryInsert(et, cb, sp.setup(et, cb), op);
    }

    protected SummaryMemberPurchaseCB createCBForQueryInsert()
    { SummaryMemberPurchaseCB cb = newConditionBean(); cb.xsetupForQueryInsert(); return cb; }
    ...
    protected int doQueryUpdate(SummaryMemberPurchase et, SummaryMemberPurchaseCB cb, UpdateOption<SummaryMemberPurchaseCB> op) {
        assertObjectNotNull("summaryMemberPurchase", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    @SuppressWarnings("unchecked")
    protected InsertOption<SummaryMemberPurchaseCB> downcast(InsertOption<? extends ConditionBean> op) { return (InsertOption<SummaryMemberPurchaseCB>)op; }
    @SuppressWarnings("unchecked")
    protected UpdateOption<SummaryMemberPurchaseCB> downcast(UpdateOption<? extends ConditionBean> op) { return (UpdateOption<SummaryMemberPurchaseCB>)op; }
    @SuppressWarnings("unchecked")
    protected DeleteOption<SummaryMemberPurchaseCB> downcast(DeleteOption<? extends ConditionBean> op) { return (DeleteOption<SummaryMemberPurchaseCB>)op; }
    @SuppressWarnings("unchecked")
