...
public abstract class BsVendorCheckDecimalSum implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.db2.dbflute.bsentity.customize.dbmeta.VendorCheckDecimalSumDbm.getInstance();
    }
    ...
    //                                                                            ========
    /**
     * [get] DECIMAL_DIGIT_SUM: {DECIMAL(31, 3)} <br />
    ...
    /**
     * [set] DECIMAL_DIGIT_SUM: {DECIMAL(31, 3)} <br />
