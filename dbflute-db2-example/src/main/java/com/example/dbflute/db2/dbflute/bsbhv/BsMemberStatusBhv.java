...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable {
    ...
    //                                                                       =============
    /**
     * Load referrer of aliasMemberList by the set-upper of referrer. <br />
     * ALIAS_MEMBER by MEMBER_STATUS_CODE, named 'aliasMemberList'.
     * <pre>
     * memberStatusBhv.<span style="color: #DD4747">loadAliasMemberList</span>(memberStatusList, new ConditionBeanSetupper&lt;AliasMemberCB&gt;() {
     *     public void setup(AliasMemberCB cb) {
     *         cb.setupSelect...();
     *         cb.query().setFoo...(value);
     *         cb.query().addOrderBy_Bar...();
     *     }
     ...
     * <span style="color: #3F7E5E">//});</span>
     * for (MemberStatus memberStatus : memberStatusList) {
     *     ... = memberStatus.<span style="color: #DD4747">getAliasMemberList()</span>;
     * }
     * </pre>
     ...
     */
    public NestedReferrerLoader<AliasMember> loadAliasMemberList(List<MemberStatus> memberStatusList, ConditionBeanSetupper<AliasMemberCB> setupper) {
        xassLRArg(memberStatusList, setupper);
        return doLoadAliasMemberList(memberStatusList, new LoadReferrerOption<AliasMemberCB, AliasMember>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<AliasMember> loadAliasMemberList(MemberStatus memberStatus, ConditionBeanSetupper<AliasMemberCB> setupper) {
        xassLRArg(memberStatus, setupper);
        return doLoadAliasMemberList(xnewLRLs(memberStatus), new LoadReferrerOption<AliasMemberCB, AliasMember>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<AliasMember> loadAliasMemberList(MemberStatus memberStatus, LoadReferrerOption<AliasMemberCB, AliasMember> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
        return loadAliasMemberList(xnewLRLs(memberStatus), loadReferrerOption);
    }
    ...
    public NestedReferrerLoader<AliasMember> loadAliasMemberList(List<MemberStatus> memberStatusList, LoadReferrerOption<AliasMemberCB, AliasMember> loadReferrerOption) {
        xassLRArg(memberStatusList, loadReferrerOption);
        if (memberStatusList.isEmpty()) { return (NestedReferrerLoader<AliasMember>)EMPTY_LOADER; }
        return doLoadAliasMemberList(memberStatusList, loadReferrerOption);
    }

    protected NestedReferrerLoader<AliasMember> doLoadAliasMemberList(List<MemberStatus> memberStatusList, LoadReferrerOption<AliasMemberCB, AliasMember> option) {
        final AliasMemberBhv referrerBhv = xgetBSFLR().select(AliasMemberBhv.class);
        return helpLoadReferrerInternally(memberStatusList, option, new InternalLoadReferrerCallback<MemberStatus, String, AliasMemberCB, AliasMember>() {
            ...
            public AliasMemberCB newMyCB() { return referrerBhv.newMyConditionBean(); }
            public void qyFKIn(AliasMemberCB cb, List<String> ls)
            { cb.query().setMemberStatusCode_InScope(ls); }
            public void qyOdFKAsc(AliasMemberCB cb) { cb.query().addOrderBy_MemberStatusCode_Asc(); }
            public void spFKCol(AliasMemberCB cb) { cb.specify().columnMemberStatusCode(); }
            public List<AliasMember> selRfLs(AliasMemberCB cb) { return referrerBhv.selectList(cb); }
            public String getFKVal(AliasMember re) { return re.getMemberStatusCode(); }
            public void setlcEt(AliasMember re, MemberStatus le)
            { re.setMemberStatus(le); }
            public String getRfPrNm() { return "aliasMemberList"; }
        });
    }
     ...
     * <pre>
     * memberStatusBhv.<span style="color: #DD4747">loadAliasMemberLoginList</span>(memberStatusList, new ConditionBeanSetupper&lt;AliasMemberLoginCB&gt;() {
     ...
     * <span style="color: #3F7E5E">//});</span>
     * for (MemberStatus memberStatus : memberStatusList) {
     *     ... = memberStatus.<span style="color: #DD4747">getAliasMemberLoginList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br />
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<AliasMemberLogin> loadAliasMemberLoginList(List<MemberStatus> memberStatusList, ConditionBeanSetupper<AliasMemberLoginCB> setupper) {
        xassLRArg(memberStatusList, setupper);
        return doLoadAliasMemberLoginList(memberStatusList, new LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<AliasMemberLogin> loadAliasMemberLoginList(MemberStatus memberStatus, ConditionBeanSetupper<AliasMemberLoginCB> setupper) {
        xassLRArg(memberStatus, setupper);
        return doLoadAliasMemberLoginList(xnewLRLs(memberStatus), new LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<AliasMemberLogin> loadAliasMemberLoginList(MemberStatus memberStatus, LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
        return loadAliasMemberLoginList(xnewLRLs(memberStatus), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerLoader<AliasMemberLogin> loadAliasMemberLoginList(List<MemberStatus> memberStatusList, LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin> loadReferrerOption) {
        xassLRArg(memberStatusList, loadReferrerOption);
        if (memberStatusList.isEmpty()) { return (NestedReferrerLoader<AliasMemberLogin>)EMPTY_LOADER; }
        return doLoadAliasMemberLoginList(memberStatusList, loadReferrerOption);
    }

    protected NestedReferrerLoader<AliasMemberLogin> doLoadAliasMemberLoginList(List<MemberStatus> memberStatusList, LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin> option) {
        final AliasMemberLoginBhv referrerBhv = xgetBSFLR().select(AliasMemberLoginBhv.class);
        return helpLoadReferrerInternally(memberStatusList, option, new InternalLoadReferrerCallback<MemberStatus, String, AliasMemberLoginCB, AliasMemberLogin>() {
            public String getPKVal(MemberStatus et)
            { return et.getMemberStatusCode(); }
            ...
            public void qyFKIn(AliasMemberLoginCB cb, List<String> ls)
            { cb.query().setLoginMemberStatusCode_InScope(ls); }
            public void qyOdFKAsc(AliasMemberLoginCB cb) { cb.query().addOrderBy_LoginMemberStatusCode_Asc(); }
            public void spFKCol(AliasMemberLoginCB cb) { cb.specify().columnLoginMemberStatusCode(); }
            public List<AliasMemberLogin> selRfLs(AliasMemberLoginCB cb) { return referrerBhv.selectList(cb); }
            public String getFKVal(AliasMemberLogin re) { return re.getLoginMemberStatusCode(); }
            public void setlcEt(AliasMemberLogin re, MemberStatus le)
            { re.setMemberStatus(le); }
