...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable {
     ...
     */
    public void loadAliasMemberList(MemberStatus memberStatus, ConditionBeanSetupper<AliasMemberCB> conditionBeanSetupper) {
        xassLRArg(memberStatus, conditionBeanSetupper);
        loadAliasMemberList(xnewLRLs(memberStatus), conditionBeanSetupper);
    }
    /**
     * Load referrer of aliasMemberList with the set-upper for condition-bean of referrer. <br />
     * ALIAS_MEMBER by MEMBER_STATUS_CODE, named 'aliasMemberList'.
     * <pre>
     * memberStatusBhv.<span style="color: #FD4747">loadAliasMemberList</span>(memberStatusList, new ConditionBeanSetupper&lt;AliasMemberCB&gt;() {
     ...
     * });
     * for (MemberStatus memberStatus : memberStatusList) {
     *     ... = memberStatus.<span style="color: #FD4747">getAliasMemberList()</span>;
     * }
     * </pre>
     ...
     * @param conditionBeanSetupper The instance of referrer condition-bean set-upper for registering referrer condition. (NotNull)
     */
    public void loadAliasMemberList(List<MemberStatus> memberStatusList, ConditionBeanSetupper<AliasMemberCB> conditionBeanSetupper) {
        xassLRArg(memberStatusList, conditionBeanSetupper);
        loadAliasMemberList(memberStatusList, new LoadReferrerOption<AliasMemberCB, AliasMember>().xinit(conditionBeanSetupper));
    }
    /**
     * {Refer to overload method that has an argument of the list of entity.}
     * @param memberStatus The entity of memberStatus. (NotNull)
     ...
     */
    public void loadAliasMemberList(MemberStatus memberStatus, LoadReferrerOption<AliasMemberCB, AliasMember> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
        loadAliasMemberList(xnewLRLs(memberStatus), loadReferrerOption);
    }
    /**
     ...
     * @param loadReferrerOption The option of load-referrer. (NotNull)
     */
    public void loadAliasMemberList(List<MemberStatus> memberStatusList, LoadReferrerOption<AliasMemberCB, AliasMember> loadReferrerOption) {
        ...
        helpLoadReferrerInternally(memberStatusList, loadReferrerOption, new InternalLoadReferrerCallback<MemberStatus, String, AliasMemberCB, AliasMember>() {
     ...
     * @param conditionBeanSetupper The instance of referrer condition-bean set-upper for registering referrer condition. (NotNull)
     */
    public void loadAliasMemberLoginList(MemberStatus memberStatus, ConditionBeanSetupper<AliasMemberLoginCB> conditionBeanSetupper) {
        xassLRArg(memberStatus, conditionBeanSetupper);
        loadAliasMemberLoginList(xnewLRLs(memberStatus), conditionBeanSetupper);
    }
    /**
     ...
     * <pre>
     * memberStatusBhv.<span style="color: #FD4747">loadAliasMemberLoginList</span>(memberStatusList, new ConditionBeanSetupper&lt;AliasMemberLoginCB&gt;() {
     ...
     * });
     * for (MemberStatus memberStatus : memberStatusList) {
     *     ... = memberStatus.<span style="color: #FD4747">getAliasMemberLoginList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key(and others too) is treated as case-insensitive. <br />
     * The condition-bean that the set-upper provides have settings before you touch it. It is as follows:
     ...
     * @param conditionBeanSetupper The instance of referrer condition-bean set-upper for registering referrer condition. (NotNull)
     */
    public void loadAliasMemberLoginList(List<MemberStatus> memberStatusList, ConditionBeanSetupper<AliasMemberLoginCB> conditionBeanSetupper) {
        xassLRArg(memberStatusList, conditionBeanSetupper);
        loadAliasMemberLoginList(memberStatusList, new LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin>().xinit(conditionBeanSetupper));
    }
    /**
     * {Refer to overload method that has an argument of the list of entity.}
     * @param memberStatus The entity of memberStatus. (NotNull)
     * @param loadReferrerOption The option of load-referrer. (NotNull)
     */
    public void loadAliasMemberLoginList(MemberStatus memberStatus, LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
        loadAliasMemberLoginList(xnewLRLs(memberStatus), loadReferrerOption);
    }
    /**
     * {Refer to overload method that has an argument of condition-bean setupper.}
     * @param memberStatusList The entity list of memberStatus. (NotNull)
     * @param loadReferrerOption The option of load-referrer. (NotNull)
     */
    public void loadAliasMemberLoginList(List<MemberStatus> memberStatusList, LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin> loadReferrerOption) {
        xassLRArg(memberStatusList, loadReferrerOption);
        if (memberStatusList.isEmpty()) { return; }
        final AliasMemberLoginBhv referrerBhv = xgetBSFLR().select(AliasMemberLoginBhv.class);
        helpLoadReferrerInternally(memberStatusList, loadReferrerOption, new InternalLoadReferrerCallback<MemberStatus, String, AliasMemberLoginCB, AliasMemberLogin>() {
            public String getPKVal(MemberStatus et)
            { return et.getMemberStatusCode(); }
