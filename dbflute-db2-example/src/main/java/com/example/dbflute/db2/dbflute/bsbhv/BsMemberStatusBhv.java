...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable<MemberStatus, MemberStatusCB> {
     ...
     */
    public NestedReferrerListGateway<AliasMember> loadAliasMemberList(List<MemberStatus> memberStatusList, ConditionBeanSetupper<AliasMemberCB> setupper) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<AliasMember> loadAliasMemberList(MemberStatus memberStatus, ConditionBeanSetupper<AliasMemberCB> setupper) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<AliasMember> loadAliasMemberList(MemberStatus memberStatus, LoadReferrerOption<AliasMemberCB, AliasMember> loadReferrerOption) {
    ...
    public NestedReferrerListGateway<AliasMember> loadAliasMemberList(List<MemberStatus> memberStatusList, LoadReferrerOption<AliasMemberCB, AliasMember> loadReferrerOption) {
        xassLRArg(memberStatusList, loadReferrerOption);
        if (memberStatusList.isEmpty()) { return (NestedReferrerListGateway<AliasMember>)EMPTY_NREF_LGWAY; }
        return doLoadAliasMemberList(memberStatusList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<AliasMember> doLoadAliasMemberList(List<MemberStatus> memberStatusList, LoadReferrerOption<AliasMemberCB, AliasMember> option) {
        return helpLoadReferrerInternally(memberStatusList, option, "aliasMemberList");
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<AliasMemberLogin> loadAliasMemberLoginList(List<MemberStatus> memberStatusList, ConditionBeanSetupper<AliasMemberLoginCB> setupper) {
        xassLRArg(memberStatusList, setupper);
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<AliasMemberLogin> loadAliasMemberLoginList(MemberStatus memberStatus, ConditionBeanSetupper<AliasMemberLoginCB> setupper) {
        xassLRArg(memberStatus, setupper);
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<AliasMemberLogin> loadAliasMemberLoginList(MemberStatus memberStatus, LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<AliasMemberLogin> loadAliasMemberLoginList(List<MemberStatus> memberStatusList, LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin> loadReferrerOption) {
        xassLRArg(memberStatusList, loadReferrerOption);
        if (memberStatusList.isEmpty()) { return (NestedReferrerListGateway<AliasMemberLogin>)EMPTY_NREF_LGWAY; }
        return doLoadAliasMemberLoginList(memberStatusList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<AliasMemberLogin> doLoadAliasMemberLoginList(List<MemberStatus> memberStatusList, LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin> option) {
        return helpLoadReferrerInternally(memberStatusList, option, "aliasMemberLoginList");
    }
