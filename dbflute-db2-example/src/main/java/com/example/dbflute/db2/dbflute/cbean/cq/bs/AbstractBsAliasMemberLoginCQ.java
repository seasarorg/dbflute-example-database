...
public abstract class AbstractBsAliasMemberLoginCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsAliasMemberLoginCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public void inScopeAliasMember(SubQuery<AliasMemberCB> subQuery) {
        ...
        String pp = keepMemberId_InScopeRelation_AliasMember(cb.query());
        registerInScopeRelation(cb.query(), "MEMBER_ID", "MEMBER_ID", pp, "aliasMember");
    }
    public abstract String keepMemberId_InScopeRelation_AliasMember(AliasMemberCQ sq);
    ...
    public void notInScopeAliasMember(SubQuery<AliasMemberCB> subQuery) {
        ...
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberId_NotInScopeRelation_AliasMember(cb.query());
        registerNotInScopeRelation(cb.query(), "MEMBER_ID", "MEMBER_ID", pp, "aliasMember");
    }
    public abstract String keepMemberId_NotInScopeRelation_AliasMember(AliasMemberCQ sq);
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_Equal()</span>.max(new SubQuery&lt;AliasMemberLoginCB&gt;() {
    ...
    public HpSSQFunction<AliasMemberLoginCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ.getOperand(), AliasMemberLoginCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;AliasMemberLoginCB&gt;() {
     *     public void query(AliasMemberLoginCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
    ...
    public HpSSQFunction<AliasMemberLoginCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES.getOperand(), AliasMemberLoginCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;AliasMemberLoginCB&gt;() {
     *     public void query(AliasMemberLoginCB subCB) {
    ...
    public HpSSQFunction<AliasMemberLoginCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT.getOperand(), AliasMemberLoginCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessThan()</span>.max(new SubQuery&lt;AliasMemberLoginCB&gt;() {
     *     public void query(AliasMemberLoginCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<AliasMemberLoginCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT.getOperand(), AliasMemberLoginCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;AliasMemberLoginCB&gt;() {
     *     public void query(AliasMemberLoginCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<AliasMemberLoginCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE.getOperand(), AliasMemberLoginCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;AliasMemberLoginCB&gt;() {
     *     public void query(AliasMemberLoginCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<AliasMemberLoginCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE.getOperand(), AliasMemberLoginCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSSQOption<CB> op) {
        assertObjectNotNull("subQuery", sq);
        AliasMemberLoginCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        op.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, op);
    }
    public abstract String keepScalarCondition(AliasMemberLoginCQ sq);

    protected AliasMemberLoginCB xcreateScalarConditionCB() {
        AliasMemberLoginCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected AliasMemberLoginCB xcreateScalarConditionPartitionByCB() {
        AliasMemberLoginCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<AliasMemberLoginCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
    ...
    public abstract String keepSpecifyMyselfDerived(AliasMemberLoginCQ sq);
    ...
    public HpQDRFunction<AliasMemberLoginCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(AliasMemberLoginCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "MEMBER_LOGIN_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(AliasMemberLoginCQ sq);
    ...
    public void myselfExists(SubQuery<AliasMemberLoginCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForMyselfExists(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(AliasMemberLoginCQ sq);
    ...
    public void myselfInScope(SubQuery<AliasMemberLoginCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForMyselfInScope(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected AliasMemberLoginCB newMyCB() {
