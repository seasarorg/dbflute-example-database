...
public class MemberStatusDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberStatusCode = cci("MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", null, "会員ステータスコード", true, "memberStatusCode", String.class, true, false, "CHAR", 3, 0, null, false, null, null, null, "aliasMemberList,aliasMemberLoginList,memberList,memberLoginList", CDef.DefMeta.MemberStatus);
    ...
    public ReferrerInfo referrerAliasMemberList() {
        Map<ColumnInfo, ColumnInfo> map = newLinkedHashMap(columnMemberStatusCode(), AliasMemberDbm.getInstance().columnMemberStatusCode());
        return cri("FK_MEMBER_MEMBER_STATUS", "aliasMemberList", this, AliasMemberDbm.getInstance(), map, false, "memberStatus");
    }
    public ReferrerInfo referrerAliasMemberLoginList() {
        Map<ColumnInfo, ColumnInfo> map = newLinkedHashMap(columnMemberStatusCode(), AliasMemberLoginDbm.getInstance().columnLoginMemberStatusCode());
        return cri("FK_MEMBER_LOGIN_MEMBER_STATUS", "aliasMemberLoginList", this, AliasMemberLoginDbm.getInstance(), map, false, "memberStatus");
    }
