...
public class MemberStatusDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberStatusCode = cci("MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", null, "会員ステータスコード", String.class, "memberStatusCode", null, true, false, true, "CHAR", 3, 0, null, false, null, null, null, "aliasMemberList,aliasMemberLoginList,memberList,memberLoginList", CDef.DefMeta.MemberStatus);
     ...
     */
    public ReferrerInfo referrerAliasMemberList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnMemberStatusCode(), AliasMemberDbm.getInstance().columnMemberStatusCode());
        return cri("FK_MEMBER_MEMBER_STATUS", "aliasMemberList", this, AliasMemberDbm.getInstance(), mp, false, "memberStatus");
    }
    /**
    ...
    public ReferrerInfo referrerAliasMemberLoginList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnMemberStatusCode(), AliasMemberLoginDbm.getInstance().columnLoginMemberStatusCode());
        return cri("FK_MEMBER_LOGIN_MEMBER_STATUS", "aliasMemberLoginList", this, AliasMemberLoginDbm.getInstance(), mp, false, "memberStatus");
    }
    /**
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.db2.dbflute.exentity.MemberStatus"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.db2.dbflute.cbean.MemberStatusCB"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.db2.dbflute.exbhv.MemberStatusBhv"; }
