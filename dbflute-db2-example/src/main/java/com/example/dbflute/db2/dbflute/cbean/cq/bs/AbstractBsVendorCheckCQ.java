...
public abstract class AbstractBsVendorCheckCQ extends AbstractConditionQuery {
     ...
     * <pre>e.g. setTypeOfDbclob_LikeSearch("xxx", new <span style="color: #DD4747">LikeSearchOption</span>().likeContain());</pre>
     ...
     * <pre>e.g. setTypeOfGraphic_LikeSearch("xxx", new <span style="color: #DD4747">LikeSearchOption</span>().likeContain());</pre>
     ...
     * <pre>e.g. setTypeOfVargraphic_LikeSearch("xxx", new <span style="color: #DD4747">LikeSearchOption</span>().likeContain());</pre>
     ...
     * <pre>e.g. setTypeOfLongVargraphic_LikeSearch("xxx", new <span style="color: #DD4747">LikeSearchOption</span>().likeContain());</pre>
