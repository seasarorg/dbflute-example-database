...
public abstract class BsWhiteRefTargetBhv extends AbstractBehaviorWritable<WhiteRefTarget, WhiteRefTargetCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public WhiteRefTargetDbm getDBMeta() { return WhiteRefTargetDbm.getInstance(); }
    ...
    public OutsideSqlBasicExecutor<WhiteRefTargetBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<WhiteRefTargetBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends WhiteRefTarget> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.db2.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends WhiteRefTarget> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
