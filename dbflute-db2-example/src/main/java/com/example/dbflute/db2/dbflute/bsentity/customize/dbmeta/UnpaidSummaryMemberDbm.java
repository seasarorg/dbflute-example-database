...
public class UnpaidSummaryMemberDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnUnpaidManId = cci("UNPAID_MAN_ID", "UNPAID_MAN_ID", null, null, Integer.class, "unpaidManId", null, true, false, false, "INTEGER", 10, 0, null, false, null, null, null, null, null);
    ...
    protected final ColumnInfo _columnUnpaidPriceSummary = cci("UNPAID_PRICE_SUMMARY", "UNPAID_PRICE_SUMMARY", null, null, Integer.class, "unpaidPriceSummary", null, false, false, false, "INTEGER", 10, 0, null, false, null, null, null, null, null);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.db2.dbflute.exentity.customize.UnpaidSummaryMember"; }
