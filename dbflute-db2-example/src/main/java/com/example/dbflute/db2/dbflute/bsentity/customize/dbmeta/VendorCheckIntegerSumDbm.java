...
public class VendorCheckIntegerSumDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnIntegerNonDigitSum = cci("INTEGER_NON_DIGIT_SUM", "INTEGER_NON_DIGIT_SUM", null, null, java.math.BigDecimal.class, "integerNonDigitSum", null, false, false, false, "DECIMAL", 31, 0, null, false, null, null, null, null, null);

    /**
     * INTEGER_NON_DIGIT_SUM: {DECIMAL(31)}
