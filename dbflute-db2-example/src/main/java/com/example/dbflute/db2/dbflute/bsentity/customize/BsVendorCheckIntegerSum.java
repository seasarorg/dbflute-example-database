 ...
 */
public abstract class BsVendorCheckIntegerSum implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.db2.dbflute.bsentity.customize.dbmeta.VendorCheckIntegerSumDbm.getInstance();
    }
    ...
    //                                                                            ========
    /**
     * [get] INTEGER_NON_DIGIT_SUM: {DECIMAL(31)} <br />
    ...
    /**
     * [set] INTEGER_NON_DIGIT_SUM: {DECIMAL(31)} <br />
