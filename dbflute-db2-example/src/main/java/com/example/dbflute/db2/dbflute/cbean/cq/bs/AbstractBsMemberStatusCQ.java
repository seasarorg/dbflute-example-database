...
public abstract class AbstractBsMemberStatusCQ extends AbstractConditionQuery {
     ...
     * {exists (select MEMBER_STATUS_CODE from ALIAS_MEMBER where ...)} <br />
     * ALIAS_MEMBER by MEMBER_STATUS_CODE, named 'aliasMemberAsOne'.
     * <pre>
     * cb.query().<span style="color: #FD4747">existsAliasMemberList</span>(new SubQuery&lt;AliasMemberCB&gt;() {
     *     public void query(AliasMemberCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
     * </pre>
     * @param subQuery The sub-query of AliasMemberList for 'exists'. (NotNull)
     */
    public void existsAliasMemberList(SubQuery<AliasMemberCB> subQuery) {
        assertObjectNotNull("subQuery<AliasMemberCB>", subQuery);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForExistsReferrer(this); subQuery.query(cb);
        String subQueryPropertyName = keepMemberStatusCode_ExistsReferrer_AliasMemberList(cb.query()); // for saving query-value.
        registerExistsReferrer(cb.query(), "MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", subQueryPropertyName, "aliasMemberList");
    }
    public abstract String keepMemberStatusCode_ExistsReferrer_AliasMemberList(AliasMemberCQ subQuery);

    /**
     * Set up ExistsReferrer (co-related sub-query). <br />
     * {exists (select LOGIN_MEMBER_STATUS_CODE from ALIAS_MEMBER_LOGIN where ...)} <br />
     * ALIAS_MEMBER_LOGIN by LOGIN_MEMBER_STATUS_CODE, named 'aliasMemberLoginAsOne'.
     * <pre>
    ...
    public void existsAliasMemberLoginList(SubQuery<AliasMemberLoginCB> subQuery) {
        ...
        String subQueryPropertyName = keepMemberStatusCode_ExistsReferrer_AliasMemberLoginList(cb.query()); // for saving query-value.
        registerExistsReferrer(cb.query(), "MEMBER_STATUS_CODE", "LOGIN_MEMBER_STATUS_CODE", subQueryPropertyName, "aliasMemberLoginList");
    }
    public abstract String keepMemberStatusCode_ExistsReferrer_AliasMemberLoginList(AliasMemberLoginCQ subQuery);
     ...
     * {not exists (select MEMBER_STATUS_CODE from ALIAS_MEMBER where ...)} <br />
     * ALIAS_MEMBER by MEMBER_STATUS_CODE, named 'aliasMemberAsOne'.
     * <pre>
     * cb.query().<span style="color: #FD4747">notExistsAliasMemberList</span>(new SubQuery&lt;AliasMemberCB&gt;() {
     *     public void query(AliasMemberCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
     * </pre>
     * @param subQuery The sub-query of MemberStatusCode_NotExistsReferrer_AliasMemberList for 'not exists'. (NotNull)
     */
    public void notExistsAliasMemberList(SubQuery<AliasMemberCB> subQuery) {
        assertObjectNotNull("subQuery<AliasMemberCB>", subQuery);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForExistsReferrer(this); subQuery.query(cb);
        String subQueryPropertyName = keepMemberStatusCode_NotExistsReferrer_AliasMemberList(cb.query()); // for saving query-value.
        registerNotExistsReferrer(cb.query(), "MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", subQueryPropertyName, "aliasMemberList");
    }
    public abstract String keepMemberStatusCode_NotExistsReferrer_AliasMemberList(AliasMemberCQ subQuery);

    /**
     * Set up NotExistsReferrer (co-related sub-query). <br />
     * {not exists (select LOGIN_MEMBER_STATUS_CODE from ALIAS_MEMBER_LOGIN where ...)} <br />
     * ALIAS_MEMBER_LOGIN by LOGIN_MEMBER_STATUS_CODE, named 'aliasMemberLoginAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subQuery The sub-query of MemberStatusCode_NotExistsReferrer_AliasMemberLoginList for 'not exists'. (NotNull)
     */
    public void notExistsAliasMemberLoginList(SubQuery<AliasMemberLoginCB> subQuery) {
        assertObjectNotNull("subQuery<AliasMemberLoginCB>", subQuery);
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForExistsReferrer(this); subQuery.query(cb);
        String subQueryPropertyName = keepMemberStatusCode_NotExistsReferrer_AliasMemberLoginList(cb.query()); // for saving query-value.
        registerNotExistsReferrer(cb.query(), "MEMBER_STATUS_CODE", "LOGIN_MEMBER_STATUS_CODE", subQueryPropertyName, "aliasMemberLoginList");
    }
    public abstract String keepMemberStatusCode_NotExistsReferrer_AliasMemberLoginList(AliasMemberLoginCQ subQuery);
     ...
     * {in (select MEMBER_STATUS_CODE from ALIAS_MEMBER where ...)} <br />
     * ALIAS_MEMBER by MEMBER_STATUS_CODE, named 'aliasMemberAsOne'.
     * @param subQuery The sub-query of AliasMemberList for 'in-scope'. (NotNull)
     */
    public void inScopeAliasMemberList(SubQuery<AliasMemberCB> subQuery) {
        assertObjectNotNull("subQuery<AliasMemberCB>", subQuery);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String subQueryPropertyName = keepMemberStatusCode_InScopeRelation_AliasMemberList(cb.query()); // for saving query-value.
        registerInScopeRelation(cb.query(), "MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", subQueryPropertyName, "aliasMemberList");
    }
    public abstract String keepMemberStatusCode_InScopeRelation_AliasMemberList(AliasMemberCQ subQuery);

    /**
     * Set up InScopeRelation (sub-query). <br />
     * {in (select LOGIN_MEMBER_STATUS_CODE from ALIAS_MEMBER_LOGIN where ...)} <br />
     * ALIAS_MEMBER_LOGIN by LOGIN_MEMBER_STATUS_CODE, named 'aliasMemberLoginAsOne'.
    ...
    public void inScopeAliasMemberLoginList(SubQuery<AliasMemberLoginCB> subQuery) {
        ...
        String subQueryPropertyName = keepMemberStatusCode_InScopeRelation_AliasMemberLoginList(cb.query()); // for saving query-value.
        registerInScopeRelation(cb.query(), "MEMBER_STATUS_CODE", "LOGIN_MEMBER_STATUS_CODE", subQueryPropertyName, "aliasMemberLoginList");
    }
    public abstract String keepMemberStatusCode_InScopeRelation_AliasMemberLoginList(AliasMemberLoginCQ subQuery);
     ...
     * {not in (select MEMBER_STATUS_CODE from ALIAS_MEMBER where ...)} <br />
     * ALIAS_MEMBER by MEMBER_STATUS_CODE, named 'aliasMemberAsOne'.
     * @param subQuery The sub-query of AliasMemberList for 'not in-scope'. (NotNull)
     */
    public void notInScopeAliasMemberList(SubQuery<AliasMemberCB> subQuery) {
        assertObjectNotNull("subQuery<AliasMemberCB>", subQuery);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String subQueryPropertyName = keepMemberStatusCode_NotInScopeRelation_AliasMemberList(cb.query()); // for saving query-value.
        registerNotInScopeRelation(cb.query(), "MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", subQueryPropertyName, "aliasMemberList");
    }
    public abstract String keepMemberStatusCode_NotInScopeRelation_AliasMemberList(AliasMemberCQ subQuery);

    /**
     * Set up NotInScopeRelation (sub-query). <br />
     * {not in (select LOGIN_MEMBER_STATUS_CODE from ALIAS_MEMBER_LOGIN where ...)} <br />
     * ALIAS_MEMBER_LOGIN by LOGIN_MEMBER_STATUS_CODE, named 'aliasMemberLoginAsOne'.
    ...
    public void notInScopeAliasMemberLoginList(SubQuery<AliasMemberLoginCB> subQuery) {
        assertObjectNotNull("subQuery<AliasMemberLoginCB>", subQuery);
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String subQueryPropertyName = keepMemberStatusCode_NotInScopeRelation_AliasMemberLoginList(cb.query()); // for saving query-value.
        registerNotInScopeRelation(cb.query(), "MEMBER_STATUS_CODE", "LOGIN_MEMBER_STATUS_CODE", subQueryPropertyName, "aliasMemberLoginList");
    }
    public abstract String keepMemberStatusCode_NotInScopeRelation_AliasMemberLoginList(AliasMemberLoginCQ subQuery);
    ...
    public void xsderiveAliasMemberList(String function, SubQuery<AliasMemberCB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<AliasMemberCB>", subQuery);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
        String subQueryPropertyName = keepMemberStatusCode_SpecifyDerivedReferrer_AliasMemberList(cb.query()); // for saving query-value.
        registerSpecifyDerivedReferrer(function, cb.query(), "MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", subQueryPropertyName, "aliasMemberList", aliasName, option);
    }
    public abstract String keepMemberStatusCode_SpecifyDerivedReferrer_AliasMemberList(AliasMemberCQ subQuery);
    ...
    public void xsderiveAliasMemberLoginList(String function, SubQuery<AliasMemberLoginCB> subQuery, String aliasName, DerivedReferrerOption option) {
        ...
        String subQueryPropertyName = keepMemberStatusCode_SpecifyDerivedReferrer_AliasMemberLoginList(cb.query()); // for saving query-value.
        registerSpecifyDerivedReferrer(function, cb.query(), "MEMBER_STATUS_CODE", "LOGIN_MEMBER_STATUS_CODE", subQueryPropertyName, "aliasMemberLoginList", aliasName, option);
    }
    public abstract String keepMemberStatusCode_SpecifyDerivedReferrer_AliasMemberLoginList(AliasMemberLoginCQ subQuery);
     ...
     * {FOO &lt;= (select max(BAR) from ALIAS_MEMBER where ...)} <br />
     * ALIAS_MEMBER by MEMBER_STATUS_CODE, named 'aliasMemberAsOne'.
     * <pre>
     * cb.query().<span style="color: #FD4747">derivedAliasMemberList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;AliasMemberCB&gt;() {
     *     public void query(AliasMemberCB subCB) {
     ...
     */
    public HpQDRFunction<AliasMemberCB> derivedAliasMemberList() {
        return xcreateQDRFunctionAliasMemberList();
    }
    protected HpQDRFunction<AliasMemberCB> xcreateQDRFunctionAliasMemberList() {
        return new HpQDRFunction<AliasMemberCB>(new HpQDRSetupper<AliasMemberCB>() {
            public void setup(String function, SubQuery<AliasMemberCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
                xqderiveAliasMemberList(function, subQuery, operand, value, option);
            }
        });
    }
    public void xqderiveAliasMemberList(String function, SubQuery<AliasMemberCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<AliasMemberCB>", subQuery);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
        String subQueryPropertyName = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberList(cb.query()); // for saving query-value.
        String parameterPropertyName = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberListParameter(value);
        registerQueryDerivedReferrer(function, cb.query(), "MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", subQueryPropertyName, "aliasMemberList", operand, value, parameterPropertyName, option);
    }
    public abstract String keepMemberStatusCode_QueryDerivedReferrer_AliasMemberList(AliasMemberCQ subQuery);
    public abstract String keepMemberStatusCode_QueryDerivedReferrer_AliasMemberListParameter(Object parameterValue);
    ...
    public void xqderiveAliasMemberLoginList(String function, SubQuery<AliasMemberLoginCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<AliasMemberLoginCB>", subQuery);
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
        String subQueryPropertyName = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberLoginList(cb.query()); // for saving query-value.
        String parameterPropertyName = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberLoginListParameter(value);
        registerQueryDerivedReferrer(function, cb.query(), "MEMBER_STATUS_CODE", "LOGIN_MEMBER_STATUS_CODE", subQueryPropertyName, "aliasMemberLoginList", operand, value, parameterPropertyName, option);
    }
    public abstract String keepMemberStatusCode_QueryDerivedReferrer_AliasMemberLoginList(AliasMemberLoginCQ subQuery);
    public abstract String keepMemberStatusCode_QueryDerivedReferrer_AliasMemberLoginListParameter(Object parameterValue);
