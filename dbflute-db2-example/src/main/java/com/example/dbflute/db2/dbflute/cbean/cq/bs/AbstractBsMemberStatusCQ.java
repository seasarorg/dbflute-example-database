...
public abstract class AbstractBsMemberStatusCQ extends AbstractConditionQuery {
    ...
    public void existsAliasMemberList(SubQuery<AliasMemberCB> subQuery) {
        ...
        String pp = keepMemberStatusCode_ExistsReferrer_AliasMemberList(cb.query()); // for saving query-value.
    ...
    public void existsAliasMemberLoginList(SubQuery<AliasMemberLoginCB> subQuery) {
        ...
        String pp = keepMemberStatusCode_ExistsReferrer_AliasMemberLoginList(cb.query()); // for saving query-value.
    ...
    public void notExistsAliasMemberList(SubQuery<AliasMemberCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForExistsReferrer(this); subQuery.query(cb);
        String pp = keepMemberStatusCode_NotExistsReferrer_AliasMemberList(cb.query()); // for saving query-value.
    ...
    public void notExistsAliasMemberLoginList(SubQuery<AliasMemberLoginCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForExistsReferrer(this); subQuery.query(cb);
        String pp = keepMemberStatusCode_NotExistsReferrer_AliasMemberLoginList(cb.query()); // for saving query-value.
    ...
    public void inScopeAliasMemberList(SubQuery<AliasMemberCB> subQuery) {
        ...
        String pp = keepMemberStatusCode_InScopeRelation_AliasMemberList(cb.query()); // for saving query-value.
    ...
    public void inScopeAliasMemberLoginList(SubQuery<AliasMemberLoginCB> subQuery) {
        ...
        String pp = keepMemberStatusCode_InScopeRelation_AliasMemberLoginList(cb.query()); // for saving query-value.
    ...
    public void notInScopeAliasMemberList(SubQuery<AliasMemberCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String pp = keepMemberStatusCode_NotInScopeRelation_AliasMemberList(cb.query()); // for saving query-value.
    ...
    public void notInScopeAliasMemberLoginList(SubQuery<AliasMemberLoginCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String pp = keepMemberStatusCode_NotInScopeRelation_AliasMemberLoginList(cb.query()); // for saving query-value.
    ...
    public void xsderiveAliasMemberList(String fn, SubQuery<AliasMemberCB> sq, String al, DerivedReferrerOption op) {
        ...
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForDerivedReferrer(this); sq.query(cb);
        String pp = keepMemberStatusCode_SpecifyDerivedReferrer_AliasMemberList(cb.query()); // for saving query-value.
    ...
    public void xsderiveAliasMemberLoginList(String fn, SubQuery<AliasMemberLoginCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForDerivedReferrer(this); sq.query(cb);
        String pp = keepMemberStatusCode_SpecifyDerivedReferrer_AliasMemberLoginList(cb.query()); // for saving query-value.
    ...
    public void xqderiveAliasMemberList(String fn, SubQuery<AliasMemberCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForDerivedReferrer(this); sq.query(cb);
        String sqpp = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberList(cb.query()); // for saving query-value.
        String prpp = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberListParameter(vl);
    ...
    public void xqderiveAliasMemberLoginList(String fn, SubQuery<AliasMemberLoginCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForDerivedReferrer(this); sq.query(cb);
        String sqpp = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberLoginList(cb.query()); // for saving query-value.
        String prpp = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberLoginListParameter(vl);
