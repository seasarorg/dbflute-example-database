...
public abstract class AbstractBsMemberStatusCQ extends AbstractConditionQuery {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">existsAliasMemberList</span>(new SubQuery&lt;AliasMemberCB&gt;() {
    ...
    public void existsAliasMemberList(SubQuery<AliasMemberCB> subQuery) {
        ...
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForExistsReferrer(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_ExistsReferrer_AliasMemberList(cb.query());
        registerExistsReferrer(cb.query(), "MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", pp, "aliasMemberList");
    }
    public abstract String keepMemberStatusCode_ExistsReferrer_AliasMemberList(AliasMemberCQ sq);
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">existsAliasMemberLoginList</span>(new SubQuery&lt;AliasMemberLoginCB&gt;() {
    ...
    public void existsAliasMemberLoginList(SubQuery<AliasMemberLoginCB> subQuery) {
        ...
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_ExistsReferrer_AliasMemberLoginList(cb.query());
        registerExistsReferrer(cb.query(), "MEMBER_STATUS_CODE", "LOGIN_MEMBER_STATUS_CODE", pp, "aliasMemberLoginList");
    }
    public abstract String keepMemberStatusCode_ExistsReferrer_AliasMemberLoginList(AliasMemberLoginCQ sq);
     ...
     * ALIAS_MEMBER by MEMBER_STATUS_CODE, named 'aliasMemberAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">notExistsAliasMemberList</span>(new SubQuery&lt;AliasMemberCB&gt;() {
     *     public void query(AliasMemberCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
    ...
    public void notExistsAliasMemberList(SubQuery<AliasMemberCB> subQuery) {
        ...
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForExistsReferrer(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_NotExistsReferrer_AliasMemberList(cb.query());
        registerNotExistsReferrer(cb.query(), "MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", pp, "aliasMemberList");
    }
    public abstract String keepMemberStatusCode_NotExistsReferrer_AliasMemberList(AliasMemberCQ sq);
     ...
     * ALIAS_MEMBER_LOGIN by LOGIN_MEMBER_STATUS_CODE, named 'aliasMemberLoginAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">notExistsAliasMemberLoginList</span>(new SubQuery&lt;AliasMemberLoginCB&gt;() {
     *     public void query(AliasMemberLoginCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
    ...
    public void notExistsAliasMemberLoginList(SubQuery<AliasMemberLoginCB> subQuery) {
        ...
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForExistsReferrer(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_NotExistsReferrer_AliasMemberLoginList(cb.query());
        registerNotExistsReferrer(cb.query(), "MEMBER_STATUS_CODE", "LOGIN_MEMBER_STATUS_CODE", pp, "aliasMemberLoginList");
    }
    public abstract String keepMemberStatusCode_NotExistsReferrer_AliasMemberLoginList(AliasMemberLoginCQ sq);
    ...
    public void inScopeAliasMemberList(SubQuery<AliasMemberCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_InScopeRelation_AliasMemberList(cb.query());
        registerInScopeRelation(cb.query(), "MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", pp, "aliasMemberList");
    }
    public abstract String keepMemberStatusCode_InScopeRelation_AliasMemberList(AliasMemberCQ sq);
    ...
    public void inScopeAliasMemberLoginList(SubQuery<AliasMemberLoginCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_InScopeRelation_AliasMemberLoginList(cb.query());
        registerInScopeRelation(cb.query(), "MEMBER_STATUS_CODE", "LOGIN_MEMBER_STATUS_CODE", pp, "aliasMemberLoginList");
    }
    public abstract String keepMemberStatusCode_InScopeRelation_AliasMemberLoginList(AliasMemberLoginCQ sq);
    ...
    public void notInScopeAliasMemberList(SubQuery<AliasMemberCB> subQuery) {
        ...
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_NotInScopeRelation_AliasMemberList(cb.query());
        registerNotInScopeRelation(cb.query(), "MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", pp, "aliasMemberList");
    }
    public abstract String keepMemberStatusCode_NotInScopeRelation_AliasMemberList(AliasMemberCQ sq);
    ...
    public void notInScopeAliasMemberLoginList(SubQuery<AliasMemberLoginCB> subQuery) {
        ...
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_NotInScopeRelation_AliasMemberLoginList(cb.query());
        registerNotInScopeRelation(cb.query(), "MEMBER_STATUS_CODE", "LOGIN_MEMBER_STATUS_CODE", pp, "aliasMemberLoginList");
    }
    public abstract String keepMemberStatusCode_NotInScopeRelation_AliasMemberLoginList(AliasMemberLoginCQ sq);
    ...
    public void xsderiveAliasMemberList(String fn, SubQuery<AliasMemberCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForDerivedReferrer(this);
        try { lock(); sq.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_SpecifyDerivedReferrer_AliasMemberList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", pp, "aliasMemberList", al, op);
    }
    public abstract String keepMemberStatusCode_SpecifyDerivedReferrer_AliasMemberList(AliasMemberCQ sq);
    ...
    public void xsderiveAliasMemberLoginList(String fn, SubQuery<AliasMemberLoginCB> sq, String al, DerivedReferrerOption op) {
        ...
        try { lock(); sq.query(cb); } finally { unlock(); }
        String pp = keepMemberStatusCode_SpecifyDerivedReferrer_AliasMemberLoginList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "MEMBER_STATUS_CODE", "LOGIN_MEMBER_STATUS_CODE", pp, "aliasMemberLoginList", al, op);
    }
    public abstract String keepMemberStatusCode_SpecifyDerivedReferrer_AliasMemberLoginList(AliasMemberLoginCQ sq);
     ...
     * ALIAS_MEMBER by MEMBER_STATUS_CODE, named 'aliasMemberAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedAliasMemberList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;AliasMemberCB&gt;() {
     *     public void query(AliasMemberCB subCB) {
    ...
    protected HpQDRFunction<AliasMemberCB> xcreateQDRFunctionAliasMemberList() {
        return new HpQDRFunction<AliasMemberCB>(new HpQDRSetupper<AliasMemberCB>() {
            public void setup(String fn, SubQuery<AliasMemberCB> sq, String rd, Object vl, DerivedReferrerOption op) {
                xqderiveAliasMemberList(fn, sq, rd, vl, op);
            }
        });
    }
    public void xqderiveAliasMemberList(String fn, SubQuery<AliasMemberCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForDerivedReferrer(this);
        try { lock(); sq.query(cb); } finally { unlock(); }
        String sqpp = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberList(cb.query()); String prpp = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", sqpp, "aliasMemberList", rd, vl, prpp, op);
    }
    public abstract String keepMemberStatusCode_QueryDerivedReferrer_AliasMemberList(AliasMemberCQ sq);
    public abstract String keepMemberStatusCode_QueryDerivedReferrer_AliasMemberListParameter(Object vl);
     ...
     * ALIAS_MEMBER_LOGIN by LOGIN_MEMBER_STATUS_CODE, named 'aliasMemberLoginAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedAliasMemberLoginList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;AliasMemberLoginCB&gt;() {
     *     public void query(AliasMemberLoginCB subCB) {
     *         subCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
     *     }
    ...
    protected HpQDRFunction<AliasMemberLoginCB> xcreateQDRFunctionAliasMemberLoginList() {
        return new HpQDRFunction<AliasMemberLoginCB>(new HpQDRSetupper<AliasMemberLoginCB>() {
            public void setup(String fn, SubQuery<AliasMemberLoginCB> sq, String rd, Object vl, DerivedReferrerOption op) {
                xqderiveAliasMemberLoginList(fn, sq, rd, vl, op);
            }
        });
    }
    public void xqderiveAliasMemberLoginList(String fn, SubQuery<AliasMemberLoginCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        ...
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForDerivedReferrer(this);
        try { lock(); sq.query(cb); } finally { unlock(); }
        String sqpp = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberLoginList(cb.query()); String prpp = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberLoginListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "MEMBER_STATUS_CODE", "LOGIN_MEMBER_STATUS_CODE", sqpp, "aliasMemberLoginList", rd, vl, prpp, op);
    }
    public abstract String keepMemberStatusCode_QueryDerivedReferrer_AliasMemberLoginList(AliasMemberLoginCQ sq);
    public abstract String keepMemberStatusCode_QueryDerivedReferrer_AliasMemberLoginListParameter(Object vl);
