...
public class WithdrawalReasonDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnWithdrawalReasonCode = cci("WITHDRAWAL_REASON_CODE", "WITHDRAWAL_REASON_CODE", null, "退会理由コード", String.class, "withdrawalReasonCode", null, true, false, true, "CHAR", 3, 0, null, false, null, null, null, "memberWithdrawalList", null);
    protected final ColumnInfo _columnWithdrawalReasonText = cci("WITHDRAWAL_REASON_TEXT", "WITHDRAWAL_REASON_TEXT", null, "退会理由テキスト", String.class, "withdrawalReasonText", null, false, false, true, "CLOB", 1048576, 0, null, false, null, null, null, null, null);
    ...
    /**
     * (退会理由テキスト)WITHDRAWAL_REASON_TEXT: {NotNull, CLOB(1048576)}
     * @return The information object of specified column. (NotNull)
     */
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.db2.dbflute.exentity.WithdrawalReason"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.db2.dbflute.cbean.WithdrawalReasonCB"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.db2.dbflute.exbhv.WithdrawalReasonBhv"; }
