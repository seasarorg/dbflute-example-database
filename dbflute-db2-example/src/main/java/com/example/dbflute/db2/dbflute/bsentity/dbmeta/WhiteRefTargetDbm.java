...
public class WhiteRefTargetDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnRefTargetId = cci("REF_TARGET_ID", "REF_TARGET_ID", null, null, true, "refTargetId", Long.class, true, false, "DECIMAL", 16, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnTargetId = cci("TARGET_ID", "TARGET_ID", null, null, true, "targetId", Long.class, false, false, "DECIMAL", 16, 0, null, false, null, null, "whiteTarget", null, null);
    ...
    public ForeignInfo foreignWhiteTarget() {
        ...
        return cfi("FK_WHITE_REF_TARGET", "whiteTarget", this, WhiteTargetDbm.getInstance(), mp, 0, false, false, false, false, null, null, false, "whiteRefTargetList");
    }
