...
import com.example.dbflute.db2.dbflute.exentity.MemberAddress;
import com.example.dbflute.db2.dbflute.exentity.MemberWithdrawal;
import com.example.dbflute.db2.dbflute.exentity.Product;
...
public class ConditionBeanPlatinumTest extends UnitContainerTestCase {
    ...
    // DB2にて、unionしたorder-byに制限があるっぽい
    // --> order by case when MEMBER_BIRTHDAY is not null then 0 else 1 end asc, MEMBER_BIRTHDAY asc
    // 
    //    /**
