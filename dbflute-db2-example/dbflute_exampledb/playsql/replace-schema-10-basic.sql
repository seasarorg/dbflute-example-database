...
create table MEMBER(
	MEMBER_ID INTEGER generated by default as identity NOT NULL PRIMARY KEY,
	MEMBER_NAME VARCHAR(200) NOT NULL,
	MEMBER_ACCOUNT VARCHAR(50) NOT NULL,
	MEMBER_STATUS_CODE CHAR(3) NOT NULL,
	FORMALIZED_DATETIME TIMESTAMP,
	BIRTHDATE DATE,
...
create table MEMBER_ADDRESS(
	MEMBER_ADDRESS_ID INTEGER generated by default as identity NOT NULL PRIMARY KEY,
...
create table MEMBER_FOLLOWING(
    MEMBER_FOLLOWING_ID BIGINT generated by default as identity NOT NULL PRIMARY KEY,
    MY_MEMBER_ID INTEGER NOT NULL,
    YOUR_MEMBER_ID INTEGER NOT NULL,
    FOLLOW_DATETIME TIMESTAMP NOT NULL
);


create table MEMBER_LOGIN(
	MEMBER_LOGIN_ID BIGINT generated by default as identity NOT NULL PRIMARY KEY,
	MEMBER_ID INTEGER NOT NULL,
...
create table MEMBER_SERVICE(
    MEMBER_SERVICE_ID INTEGER generated by default as identity NOT NULL PRIMARY KEY,
    MEMBER_ID INTEGER NOT NULL,
...
create table PURCHASE(
	PURCHASE_ID BIGINT generated by default as identity NOT NULL PRIMARY KEY,
	MEMBER_ID INTEGER NOT NULL,
...
create table PRODUCT(
	PRODUCT_ID INTEGER generated by default as identity NOT NULL PRIMARY KEY,
